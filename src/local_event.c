...
# 6 "kernel/yloop/local_event.c" 2
...
# 7 "kernel/yloop/local_event.c" 2
...
# 8 "kernel/yloop/local_event.c" 2
...
# 9 "kernel/yloop/local_event.c" 2

# 1 "./kernel/vfs/include/event_device.h" 1
# 11 "kernel/yloop/local_event.c" 2
...
# 12 "kernel/yloop/local_event.c" 2
# 1 "./board/mk3060/./k_config.h" 1
# 13 "kernel/yloop/local_event.c" 2
typedef struct {
    dlist_t node;
    aos_event_cb cb;
    void *priv;
...
# 47 "kernel/yloop/local_event.c" 3 4
                                   ((void *)0)
# 47 "kernel/yloop/local_event.c"
                                       ;
...
# 59 "kernel/yloop/local_event.c" 3 4
   _Bool 
# 59 "kernel/yloop/local_event.c"
...
# 88 "kernel/yloop/local_event.c" 3 4
                                       ((void *)0)
# 88 "kernel/yloop/local_event.c"
                                           );
...
# 96 "kernel/yloop/local_event.c" 3 4
                                              ((void *)0)
# 96 "kernel/yloop/local_event.c"
                                                  );
    aos_close(fd);
}
...
{
    if (cb == 
# 113 "kernel/yloop/local_event.c" 3 4
             ((void *)0)
# 113 "kernel/yloop/local_event.c"
                 ) {
        return -
# 114 "kernel/yloop/local_event.c" 3
               22
# 114 "kernel/yloop/local_event.c"
                     ;
    }

    event_list_node_t *event_node = aos_malloc(sizeof(event_list_node_t));
    if (
# 118 "kernel/yloop/local_event.c" 3 4
       ((void *)0) 
# 118 "kernel/yloop/local_event.c"
            == event_node) {
        return -
# 119 "kernel/yloop/local_event.c" 3
               12
# 119 "kernel/yloop/local_event.c"
                     ;
    }
...
{
    event_list_node_t *event_node = 
# 133 "kernel/yloop/local_event.c" 3 4
                                   ((void *)0)
# 133 "kernel/yloop/local_event.c"
                                       ;
    for (event_node = ((event_list_node_t *) ((char *) ((&g_local_event_list)->next) - ((size_t)&(((event_list_node_t *)0)->node)))); &event_node->node != (&g_local_event_list); event_node = ((event_list_node_t *) ((char *) (event_node->node.next) - ((size_t)&(((event_list_node_t *)0)->node))))) {
    ...
    return -
# 152 "kernel/yloop/local_event.c" 3
           22
# 152 "kernel/yloop/local_event.c"
                 ;
}
...
# 159 "kernel/yloop/local_event.c" 3 4
                         _Bool 
# 159 "kernel/yloop/local_event.c"
                              urgent)
{

    if (fun == 
# 162 "kernel/yloop/local_event.c" 3 4
              ((void *)0) 
# 162 "kernel/yloop/local_event.c"
                   || g_main_ctx == 
# 162 "kernel/yloop/local_event.c" 3 4
                                    ((void *)0)
# 162 "kernel/yloop/local_event.c"
        ...
        return -
# 163 "kernel/yloop/local_event.c" 3
               22
# 163 "kernel/yloop/local_event.c"
                     ;
    }
...
# 184 "kernel/yloop/local_event.c" 3 4
                                         1
# 184 "kernel/yloop/local_event.c"
                                             );
}
...
{
    return _schedule_call(loop, fun, arg, 
# 189 "kernel/yloop/local_event.c" 3 4
                                         0
# 189 "kernel/yloop/local_event.c"
                                              );
}
...
# 194 "kernel/yloop/local_event.c" 3 4
                         ((void *)0)
# 194 "kernel/yloop/local_event.c"
                             , fun, arg, 
# 194 "kernel/yloop/local_event.c" 3 4
                                         0
# 194 "kernel/yloop/local_event.c"
...
void aos_cancel_work(void *w, aos_call_t action, void *arg1)
{
    ...
    if (wpar == 
# 231 "kernel/yloop/local_event.c" 3 4
               ((void *)0)
# 231 "kernel/yloop/local_event.c"
                   ) {
        return;
    }
                             ...
                             aos_call_t fini_cb, void *arg2)
{
    ...
    if (action == 
# 256 "kernel/yloop/local_event.c" 3 4
                 ((void *)0)
# 256 "kernel/yloop/local_event.c"
                     ) {
        return 
# 257 "kernel/yloop/local_event.c" 3 4
              ((void *)0)
# 257 "kernel/yloop/local_event.c"
                  ;
    }
...
err_out:
    ...
    aos_free(wpar);
    return 
# 287 "kernel/yloop/local_event.c" 3 4
          ((void *)0)
# 287 "kernel/yloop/local_event.c"
              ;
}
