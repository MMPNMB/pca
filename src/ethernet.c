# 1 "kernel/protocols/net/netif/ethernet.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/netif/ethernet.c"
# 41 "kernel/protocols/net/netif/ethernet.c"
...
# 42 "kernel/protocols/net/netif/ethernet.c" 2



# 1 "./kernel/protocols/net/include/netif/ethernet.h" 1
# 46 "./kernel/protocols/net/include/netif/ethernet.h"
...
# 47 "./kernel/protocols/net/include/netif/ethernet.h" 2
...
# 48 "./kernel/protocols/net/include/netif/ethernet.h" 2
...
# 49 "./kernel/protocols/net/include/netif/ethernet.h" 2
...
# 46 "kernel/protocols/net/netif/ethernet.c" 2


# 1 "./kernel/protocols/net/include/lwip/etharp.h" 1
# 52 "./kernel/protocols/net/include/lwip/etharp.h"
...
# 61 "./kernel/protocols/net/include/lwip/etharp.h"
...
# 49 "kernel/protocols/net/netif/ethernet.c" 2
...
# 53 "kernel/protocols/net/netif/ethernet.c" 2

# 1 "./kernel/protocols/net/include/netif/ppp/ppp_opts.h" 1
# 55 "kernel/protocols/net/netif/ethernet.c" 2





# 59 "kernel/protocols/net/netif/ethernet.c"
const struct eth_addr ethbroadcast = {{0xff,0xff,0xff,0xff,0xff,0xff}};
const struct eth_addr ethzero = {{0,0,0,0,0,0}};
# 76 "kernel/protocols/net/netif/ethernet.c"
err_t
ethernet_input(struct pbuf *p, struct netif *netif)
{
  ...
  do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("ethernet_input: dest:%""2x"":%""2x"":%""2x"":%""2x"":%""2x"":%""2x"", src:%""2x"":%""2x"":%""2x"":%""2x"":%""2x"":%""2x"", type:%""4x""\n", (unsigned)ethhdr->dest.addr[0], (unsigned)ethhdr->dest.addr[1], (unsigned)ethhdr->dest.addr[2], (unsigned)ethhdr->dest.addr[3], (unsigned)ethhdr->dest.addr[4], (unsigned)ethhdr->dest.addr[5], (unsigned)ethhdr->src.addr[0], (unsigned)ethhdr->src.addr[1], (unsigned)ethhdr->src.addr[2], (unsigned)ethhdr->src.addr[3], (unsigned)ethhdr->src.addr[4], (unsigned)ethhdr->src.addr[5], lwip_htons(ethhdr->type)) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0)
  ...
  type = ethhdr->type;
# 136 "kernel/protocols/net/netif/ethernet.c"
  ...
  switch (type) {
    ...
    case ((((ETHTYPE_IP) & 0xff) << 8) | (((ETHTYPE_IP) & 0xff00) >> 8)):
      ...
      if ((p->len < ip_hdr_offset) || pbuf_header(p, (s16_t)-ip_hdr_offset)) {
        do { if ( ((0x00U | 0x40U | 0x01) & 0x80U) && ((0x00U | 0x40U | 0x01) & 0x80U) && ((s16_t)((0x00U | 0x40U | 0x01) & 0x03) >= 0x00)) { do {bk_printf ("ethernet_input: IPv4 packet dropped, too short (%""4d""/%""4d"")\n", p->tot_len, ip_hdr_offset) ;} while(0); if ((0x00U | 0x40U | 0x01) & 0x08U) { while(1); } } } while(0)

                                     ;
        do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("Can't move over header in packet") ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
        goto free_and_return;
      } else {
    ...
    case ((((ETHTYPE_ARP) & 0xff) << 8) | (((ETHTYPE_ARP) & 0xff00) >> 8)):
      ...
      if ((p->len < ip_hdr_offset) || pbuf_header(p, (s16_t)-ip_hdr_offset)) {
        do { if ( ((0x00U | 0x40U | 0x01) & 0x80U) && ((0x00U | 0x40U | 0x01) & 0x80U) && ((s16_t)((0x00U | 0x40U | 0x01) & 0x03) >= 0x00)) { do {bk_printf ("ethernet_input: ARP response packet dropped, too short (%""4d""/%""4d"")\n", p->tot_len, ip_hdr_offset) ;} while(0); if ((0x00U | 0x40U | 0x01) & 0x08U) { while(1); } } } while(0)
      ...
      break;
# 224 "kernel/protocols/net/netif/ethernet.c"
    default:
...
# 259 "kernel/protocols/net/netif/ethernet.c"
err_t
...
# 284 "kernel/protocols/net/netif/ethernet.c"
  {
  ...
  memcpy(&ethhdr->src,src,6);
                                          ...
                                          ;
  do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("ethernet_output: sending packet %p\n", (void *)p) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0)
                                                        ;
...
pbuf_header_failed:
  do { if ( ((0x00U | 0x40U | 0x02) & 0x80U) && ((0x00U | 0x40U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x40U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("ethernet_output: could not allocate room for header.\n") ;} while(0); if ((0x00U | 0x40U | 0x02) & 0x08U) { while(1); } } } while(0)
                                                               ;
  ;
  return ERR_BUF;
}
