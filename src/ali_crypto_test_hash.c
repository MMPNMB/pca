# 1 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c"
...
# 6 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c" 2
...
# 7 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c" 2
...
int ali_crypto_hash_test(void)
{
    ...
    hash_type_t type;
    void *hash_ctx = 
# 72 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c" 3 4
                    ((void *)0)
# 72 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c"
                        ;
    ...
    result = ali_hash_get_ctx_size(HASH_NONE, 
# 84 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c" 3 4
                                             ((void *)0)
# 84 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c"
                                                 );
    if (result == ALI_CRYPTO_SUCCESS) {
        return -1;
    }
    ...
    result = ali_hash_init(HASH_NONE, 
# 90 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c" 3 4
                                     ((void *)0)
# 90 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c"
                                         );
    if (result == ALI_CRYPTO_SUCCESS) {
        return -1;
    }
    ...
    result = ali_hash_update(_g_test_data, 13, 
# 102 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c" 3 4
                                              ((void *)0)
# 102 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c"
                                                  );
    if (result == ALI_CRYPTO_SUCCESS) {
        return -1;
    }
    ...
    result = ali_hash_update(
# 108 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c" 3 4
                            ((void *)0)
# 108 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c"
                                , 13, (void *) - 1);
    if (result == ALI_CRYPTO_SUCCESS) {
        return -1;
    }
    ...
    result = ali_hash_final(hash, 
# 114 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c" 3 4
                                 ((void *)0)
# 114 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c"
                                     );
    if (result == ALI_CRYPTO_SUCCESS) {
        return -1;
    }
    ...
    result = ali_hash_final(hash, 
# 120 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c" 3 4
                                 ((void *)0)
# 120 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c"
                                     );
    if (result == ALI_CRYPTO_SUCCESS) {
        return -1;
    }
    ...
    result = ali_hash_reset(
# 126 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c" 3 4
                           ((void *)0)
# 126 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c"
                               );
    if (result == ALI_CRYPTO_SUCCESS) {
        return -1;
    }
    ...
    result = ali_hash_copy_context(
# 132 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c" 3 4
                                  ((void *)0)
# 132 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c"
                                      , 
# 132 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c" 3 4
                                        ((void *)0)
# 132 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c"
    ...
    for (type = SHA1; type <= MD5; type++) {
        if (type == SHA512 || type == SHA384) {
            printf("I %s %d: ""hash not support hash 384 512\n", __FUNCTION__, 139);
            continue;
        }
        result = ali_hash_get_ctx_size(type, &hash_ctx_size);
        if (result != ALI_CRYPTO_SUCCESS) {
            do { printf("E %s %d: ""get ctx size fail(%08x)\n", __FUNCTION__, 144, result); result = result; goto _OUT; } while (0);;
        }

        hash_ctx = malloc(hash_ctx_size);
        if (hash_ctx == 
# 148 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c" 3 4
                       ((void *)0)
# 148 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c"
                           ) {
            do { printf("E %s %d: ""malloc(%d) fail\n", __FUNCTION__, 149, (int)hash_ctx_size); result = result; goto _OUT; } while (0);;
        }
        memset(hash_ctx, 0, hash_ctx_size);

        result = ali_hash_init(type, hash_ctx);
        if (result != ALI_CRYPTO_SUCCESS) {
            do { printf("E %s %d: ""init fail(%08x)", __FUNCTION__, 155, result); result = result; goto _OUT; } while (0);;
        }

        result = ali_hash_update(_g_test_data, 13, hash_ctx);
        if (result != ALI_CRYPTO_SUCCESS) {
            do { printf("E %s %d: ""update 1th fail(%08x)", __FUNCTION__, 160, result); result = result; goto _OUT; } while (0);;
        }
        result = ali_hash_update(_g_test_data + 13, 63, hash_ctx);
        if (result != ALI_CRYPTO_SUCCESS) {
            do { printf("E %s %d: ""update 2th fail(%08x)", __FUNCTION__, 164, result); result = result; goto _OUT; } while (0);;
        }
        result = ali_hash_update(_g_test_data + 13 + 63, 65, hash_ctx);
        if (result != ALI_CRYPTO_SUCCESS) {
            do { printf("E %s %d: ""update 3th fail(%08x)", __FUNCTION__, 168, result); result = result; goto _OUT; } while (0);;
        }

        result = ali_hash_final(hash, hash_ctx);
        if (result != ALI_CRYPTO_SUCCESS) {
            do { printf("E %s %d: ""final fail(%08x)", __FUNCTION__, 173, result); result = result; goto _OUT; } while (0);;
        }

        result = ali_hash_digest(type, _g_test_data, (141), hash_all);
        if (result != ALI_CRYPTO_SUCCESS) {
            do { printf("E %s %d: ""digest fail(%08x)", __FUNCTION__, 178, result); result = result; goto _OUT; } while (0);;
        }
        ...
        free(hash_ctx);
        hash_ctx = 
# 194 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c" 3 4
                  ((void *)0)
# 194 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c"
                      ;

        if (type == SHA1) {
            if (memcmp(hash, hash_sha1, SHA1_HASH_SIZE) ||
                memcmp(hash_all, hash_sha1, SHA1_HASH_SIZE)) {
                ali_crypto_print_data("sha1", hash, SHA1_HASH_SIZE);
                do { printf("E %s %d: ""SHA1 test fail!", __FUNCTION__, 200); result = -1; goto _OUT; } while (0);;
            } else {
                printf("I %s %d: ""SHA1 test success!\n", __FUNCTION__, 202);
            }
        } else if (type == SHA224) {
            if (memcmp(hash, hash_sha224, SHA224_HASH_SIZE) ||
                memcmp(hash_all, hash_sha224, SHA224_HASH_SIZE)) {
                ali_crypto_print_data("sha224", hash, SHA224_HASH_SIZE);
                do { printf("E %s %d: ""SHA224 test fail!\n", __FUNCTION__, 208); result = -1; goto _OUT; } while (0);;
            } else {
                printf("I %s %d: ""SHA224 test success!\n", __FUNCTION__, 210);
            }
        } else if (type == SHA256) {
            if (memcmp(hash, hash_sha256, SHA256_HASH_SIZE) ||
                memcmp(hash_all, hash_sha256, SHA256_HASH_SIZE)) {
                ali_crypto_print_data("sha256", hash, SHA256_HASH_SIZE);
                do { printf("E %s %d: ""SHA256 test fail!\n", __FUNCTION__, 216); result = -1; goto _OUT; } while (0);;
            } else {
                printf("I %s %d: ""SHA256 test success!\n", __FUNCTION__, 218);
            }
# 238 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hash.c"
        } else if (type == MD5) {
            if (memcmp(hash, hash_md5, MD5_HASH_SIZE) ||
                memcmp(hash_all, hash_md5, MD5_HASH_SIZE)) {
                ali_crypto_print_data("md5", hash, MD5_HASH_SIZE);
                do { printf("E %s %d: ""md5 test fail!\n", __FUNCTION__, 242); result = -1; goto _OUT; } while (0);;
            } else {
                printf("I %s %d: ""md5 test success!\n", __FUNCTION__, 244);
            }
        }
    }
