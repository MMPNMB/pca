# 1 "kernel/protocols/net/api/netifapi.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/api/netifapi.c"
# 41 "kernel/protocols/net/api/netifapi.c"
...
# 42 "kernel/protocols/net/api/netifapi.c" 2



# 1 "./kernel/protocols/net/include/lwip/netifapi.h" 1
# 39 "./kernel/protocols/net/include/lwip/netifapi.h"
...
# 40 "./kernel/protocols/net/include/lwip/netifapi.h" 2
...
# 41 "./kernel/protocols/net/include/lwip/netifapi.h" 2
...
# 44 "./kernel/protocols/net/include/lwip/netifapi.h" 2
...
err_t netifapi_netif_common(struct netif *netif, netifapi_void_fn voidfunc,
                            netifapi_errt_fn errtfunc);
# 46 "kernel/protocols/net/api/netifapi.c" 2
# 57 "kernel/protocols/net/api/netifapi.c"
static err_t
...
# 109 "kernel/protocols/net/api/netifapi.c" 3 4
                                 ((void *)0)
# 109 "kernel/protocols/net/api/netifapi.c"
                                     ) {
...
# 124 "kernel/protocols/net/api/netifapi.c"
err_t
                   ...
                   void *state, netif_init_fn init, netif_input_fn input)
{
  ...
  if (ipaddr == 
# 136 "kernel/protocols/net/api/netifapi.c" 3 4
               ((void *)0)
# 136 "kernel/protocols/net/api/netifapi.c"
                   ) {
    ipaddr = ((&ip_addr_any));
  }
  if (netmask == 
# 139 "kernel/protocols/net/api/netifapi.c" 3 4
                ((void *)0)
# 139 "kernel/protocols/net/api/netifapi.c"
                    ) {
    netmask = ((&ip_addr_any));
  }
  if (gw == 
# 142 "kernel/protocols/net/api/netifapi.c" 3 4
           ((void *)0)
# 142 "kernel/protocols/net/api/netifapi.c"
               ) {
    gw = ((&ip_addr_any));
  }
...
# 169 "kernel/protocols/net/api/netifapi.c"
err_t
                        ...
                        const ip4_addr_t *gw)
{
  ...
  if (ipaddr == 
# 179 "kernel/protocols/net/api/netifapi.c" 3 4
               ((void *)0)
# 179 "kernel/protocols/net/api/netifapi.c"
                   ) {
    ipaddr = ((&ip_addr_any));
  }
  if (netmask == 
# 182 "kernel/protocols/net/api/netifapi.c" 3 4
                ((void *)0)
# 182 "kernel/protocols/net/api/netifapi.c"
                    ) {
    netmask = ((&ip_addr_any));
  }
  if (gw == 
# 185 "kernel/protocols/net/api/netifapi.c" 3 4
           ((void *)0)
# 185 "kernel/protocols/net/api/netifapi.c"
               ) {
    gw = ((&ip_addr_any));
  }
...
# 205 "kernel/protocols/net/api/netifapi.c"
err_t
