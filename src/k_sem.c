                          ...
                          uint8_t mm_alloc_flag)
{
    ...
    do { if (sem == 
# 13 "kernel/rhino/core/k_sem.c" 3 4
   ((void *)0)
# 13 "kernel/rhino/core/k_sem.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    do { if (name == 
# 14 "kernel/rhino/core/k_sem.c" 3 4
   ((void *)0)
# 14 "kernel/rhino/core/k_sem.c"
   ) { return RHINO_NULL_PTR; } } while (0);
...
kstat_t krhino_sem_create(ksem_t *sem, const name_t *name, sem_count_t count)
{
    return sem_create(sem, name, count, 1u);
}
...
kstat_t krhino_sem_del(ksem_t *sem)
{
    ...
    do { if (sem == 
# 50 "kernel/rhino/core/k_sem.c" 3 4
   ((void *)0)
# 50 "kernel/rhino/core/k_sem.c"
   ) { return RHINO_NULL_PTR; } } while (0);
                              ...
                              sem_count_t count)
{
    ...
    do { if (sem == 
# 91 "kernel/rhino/core/k_sem.c" 3 4
   ((void *)0)
# 91 "kernel/rhino/core/k_sem.c"
   ) { return RHINO_NULL_PTR; } } while (0);

    sem_obj = krhino_mm_alloc(sizeof(ksem_t));

    if (sem_obj == 
# 95 "kernel/rhino/core/k_sem.c" 3 4
                  ((void *)0)
# 95 "kernel/rhino/core/k_sem.c"
                      ) {
        return RHINO_NO_MEM;
    }

    stat = sem_create(sem_obj, name, count, 2u);
...
kstat_t krhino_sem_dyn_del(ksem_t *sem)
{
    ...
    do { if (sem == 
# 117 "kernel/rhino/core/k_sem.c" 3 4
   ((void *)0)
# 117 "kernel/rhino/core/k_sem.c"
   ) { return RHINO_NULL_PTR; } } while (0);
...
static kstat_t sem_give(ksem_t *sem, uint8_t opt_wake_all)
{
    ...
    if (opt_wake_all) {
        while (!is_klist_empty(blk_list_head)) {
            ...
            pend_task_wakeup(((ktask_t *)((uint8_t *)(blk_list_head->next) - (size_t)(&((ktask_t *)0)->task_list))));
        }
...
{
    do { if (sem == 
# 226 "kernel/rhino/core/k_sem.c" 3 4
   ((void *)0)
# 226 "kernel/rhino/core/k_sem.c"
   ) { return RHINO_NULL_PTR; } } while (0);

    return sem_give(sem, 0u);
}

kstat_t krhino_sem_give_all(ksem_t *sem)
{
    do { if (sem == 
# 233 "kernel/rhino/core/k_sem.c" 3 4
   ((void *)0)
# 233 "kernel/rhino/core/k_sem.c"
   ) { return RHINO_NULL_PTR; } } while (0);

    return sem_give(sem, 1u);
}
...
kstat_t krhino_sem_take(ksem_t *sem, tick_t ticks)
{
    ...
    do { if (sem == 
# 245 "kernel/rhino/core/k_sem.c" 3 4
   ((void *)0)
# 245 "kernel/rhino/core/k_sem.c"
   ) { return RHINO_NULL_PTR; } } while (0);
...
kstat_t krhino_sem_count_set(ksem_t *sem, sem_count_t sem_count)
{
    ...
    do { if (sem == 
# 299 "kernel/rhino/core/k_sem.c" 3 4
   ((void *)0)
# 299 "kernel/rhino/core/k_sem.c"
   ) { return RHINO_NULL_PTR; } } while (0);
...
kstat_t krhino_sem_count_get(ksem_t *sem, sem_count_t *count)
{
    ...
    do { if (sem == 
# 338 "kernel/rhino/core/k_sem.c" 3 4
   ((void *)0)
# 338 "kernel/rhino/core/k_sem.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    do { if (count == 
# 339 "kernel/rhino/core/k_sem.c" 3 4
   ((void *)0)
# 339 "kernel/rhino/core/k_sem.c"
   ) { return RHINO_NULL_PTR; } } while (0);
