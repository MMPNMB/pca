# 1 "kernel/protocols/net/api/tcpip.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/api/tcpip.c"
# 39 "kernel/protocols/net/api/tcpip.c"
...
# 40 "kernel/protocols/net/api/tcpip.c" 2
...
# 44 "./kernel/protocols/net/include/lwip/tcpip.h"
...
# 45 "./kernel/protocols/net/include/lwip/tcpip.h" 2
...
# 47 "./kernel/protocols/net/include/lwip/tcpip.h" 2
...
# 44 "kernel/protocols/net/api/tcpip.c" 2
...
void lwip_init(void);
# 48 "kernel/protocols/net/api/tcpip.c" 2
...
# 49 "kernel/protocols/net/api/tcpip.c" 2
...
# 51 "kernel/protocols/net/api/tcpip.c" 2
...
# 52 "kernel/protocols/net/api/tcpip.c" 2
...
# 86 "kernel/protocols/net/api/tcpip.c"
static void
tcpip_thread(void *arg)
{
  ...
  if (tcpip_init_done != 
# 92 "kernel/protocols/net/api/tcpip.c" 3 4
                        ((void *)0)
# 92 "kernel/protocols/net/api/tcpip.c"
                            ) {
  ...
  while (1) {
    ...
    sys_mutex_lock(&lock_tcpip_core);
    if (msg == 
# 103 "kernel/protocols/net/api/tcpip.c" 3 4
              ((void *)0)
# 103 "kernel/protocols/net/api/tcpip.c"
                  ) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcpip_thread: invalid message: NULL\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      ;
      continue;
    }
    switch (msg->type) {
# 122 "kernel/protocols/net/api/tcpip.c"
    case TCPIP_MSG_INPKT:
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcpip_thread: PACKET %p\n", (void *)msg) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      msg->msg.inp.input_fn(msg->msg.inp.p, msg->msg.inp.netif);
      memp_free(MEMP_TCPIP_MSG_INPKT, msg);
      break;
# 142 "kernel/protocols/net/api/tcpip.c"
    case TCPIP_MSG_CALLBACK:
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcpip_thread: CALLBACK %p\n", (void *)msg) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      msg->msg.cb.function(msg->msg.cb.ctx);
      memp_free(MEMP_TCPIP_MSG_API, msg);
      break;

    case TCPIP_MSG_CALLBACK_STATIC:
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcpip_thread: CALLBACK_STATIC %p\n", (void *)msg) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      msg->msg.cb.function(msg->msg.cb.ctx);
      break;
    ...
    default:
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcpip_thread: invalid message: %d\n", msg->type) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      ;
      break;
    }
  }
}
# 207 "kernel/protocols/net/api/tcpip.c"
err_t
tcpip_inpkt(struct pbuf *p, struct netif *inp, netif_input_fn input_fn)
{
# 218 "kernel/protocols/net/api/tcpip.c"
  struct tcpip_msg *msg;
  ...
  if (msg == 
# 223 "kernel/protocols/net/api/tcpip.c" 3 4
            ((void *)0)
# 223 "kernel/protocols/net/api/tcpip.c"
                ) {
    return ERR_MEM;
  }
...
# 250 "kernel/protocols/net/api/tcpip.c"
err_t
...
# 272 "kernel/protocols/net/api/tcpip.c"
err_t
tcpip_callback_with_block(tcpip_callback_fn function, void *ctx, u8_t block)
{
  ...
  if (msg == 
# 280 "kernel/protocols/net/api/tcpip.c" 3 4
            ((void *)0)
# 280 "kernel/protocols/net/api/tcpip.c"
                ) {
    return ERR_MEM;
  }
...
# 367 "kernel/protocols/net/api/tcpip.c"
err_t
tcpip_send_msg_wait_sem(tcpip_callback_fn fn, void *apimsg, sys_sem_t* sem)
{
  ...
  sys_mutex_unlock(&lock_tcpip_core);
  return ERR_OK;
# 391 "kernel/protocols/net/api/tcpip.c"
}
# 403 "kernel/protocols/net/api/tcpip.c"
err_t
tcpip_api_call(tcpip_api_call_fn fn, struct tcpip_api_call_data *call)
{
  ...
  sys_mutex_unlock(&lock_tcpip_core);
  return err;
# 443 "kernel/protocols/net/api/tcpip.c"
}
# 453 "kernel/protocols/net/api/tcpip.c"
struct tcpip_callback_msg*
tcpip_callbackmsg_new(tcpip_callback_fn function, void *ctx)
{
  struct tcpip_msg *msg = (struct tcpip_msg *)memp_malloc(MEMP_TCPIP_MSG_API);
  if (msg == 
# 457 "kernel/protocols/net/api/tcpip.c" 3 4
            ((void *)0)
# 457 "kernel/protocols/net/api/tcpip.c"
                ) {
    return 
# 458 "kernel/protocols/net/api/tcpip.c" 3 4
          ((void *)0)
# 458 "kernel/protocols/net/api/tcpip.c"
              ;
  }
...
# 484 "kernel/protocols/net/api/tcpip.c"
err_t
...
# 500 "kernel/protocols/net/api/tcpip.c"
void
tcpip_init(tcpip_init_done_fn initfunc, void *arg)
{
  ...
  if (sys_mbox_new(&mbox, 16) != ERR_OK) {
    ;
  }
...
# 516 "kernel/protocols/net/api/tcpip.c" 3 4
                                                 ((void *)0)
# 516 "kernel/protocols/net/api/tcpip.c"
                                                     , 3072, 7);
}
...
# 551 "kernel/protocols/net/api/tcpip.c"
err_t
