# 1 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
# 20 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
...
# 21 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 2
# 1 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.h" 1
# 22 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 2
...
char *LITE_format_string(const unsigned int len, const char *fmt, ...)
{
    ...
    char *tmp = 
# 27 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
                         ((void *)0)
# 27 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
                             ;
    char *module_name = 
# 28 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
                                 ((void *)0)
# 28 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
                                     ;
    unsigned int n;
    int magic = 0;
    va_list ap;
...
# 33 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
   __builtin_va_start(
# 33 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
   ap
# 33 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
   ,
# 33 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
...
# 33 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
                    ;
    magic = 
# 34 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
           __builtin_va_arg(
# 34 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
           ap
# 34 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
           ,
# 34 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
...
# 34 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
    ...
    if ((0x1234) == magic) {
        module_name = 
# 36 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
                     __builtin_va_arg(
# 36 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
                     ap
# 36 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
                     ,
# 36 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
...
# 39 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
       __builtin_va_start(
# 39 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
       ap
# 39 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
       ,
# 39 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
...
# 39 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
    ...
    n = (len != 0) ? len : (512);
    tmp = LITE_malloc_internal(__func__, 43, n + 1, magic, module_name);

    do { if (!(tmp)) { HAL_Printf("### %s | %s(%d): ASSERT FAILED ###: %s is FALSE\r\n", "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c", __func__, 45, "tmp"); } } while(0);
    if (
# 46 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
       ((void *)0) 
# 46 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
            == tmp) {
        return 
# 47 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
              ((void *)0)
# 47 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
                  ;
    }
    memset(tmp, 0, n + 1);
    HAL_Vsnprintf(tmp, n, fmt, ap);
    
# 51 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
   __builtin_va_end(
# 51 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
   ap
# 51 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
   )
# 51 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
...
{
    char *tmp = 
# 60 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
                         ((void *)0)
# 60 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
                             ;
    char *dst;
    char *module_name = 
# 62 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
                                 ((void *)0)
# 62 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
                                     ;
    int rc = -1;
    int magic = 0;
    va_list ap;
...
# 67 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
   __builtin_va_start(
# 67 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
   ap
# 67 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
   ,
# 67 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
...
# 67 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
                    ;
    magic = 
# 68 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
           __builtin_va_arg(
# 68 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
           ap
# 68 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
           ,
# 68 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
...
# 68 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
    ...
    if ((0x1234) == magic) {
        module_name = 
# 70 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
                     __builtin_va_arg(
# 70 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
                     ap
# 70 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
                     ,
# 70 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
...
# 73 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
       __builtin_va_start(
# 73 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
       ap
# 73 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
       ,
# 73 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
...
# 73 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
    ...
    tmp = LITE_malloc_internal(__func__, 76, len + 2, magic, module_name);

    if (
# 78 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
       ((void *)0) 
# 78 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
            == tmp) {
        return 
# 79 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
              ((void *)0)
# 79 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
                  ;
    }
    memset(tmp, 0, len + 2);
    rc = HAL_Vsnprintf(tmp, len + 1, fmt, ap);
    
# 83 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
   __builtin_va_end(
# 83 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
   ap
# 83 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
   )
# 83 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
             ;
    do { if (!(tmp)) { HAL_Printf("### %s | %s(%d): ASSERT FAILED ###: %s is FALSE\r\n", "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c", __func__, 84, "tmp"); } } while(0);
    do { if (!(rc < 1024)) { HAL_Printf("### %s | %s(%d): ASSERT FAILED ###: %s is FALSE\r\n", "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c", __func__, 85, "rc < 1024"); } } while(0);

    dst = LITE_malloc_internal(__func__, 87, len + 1, magic, module_name);
    snprintf(dst, (len + 1), "%s", tmp);
    do { if(!tmp) { LITE_syslog(__FUNCTION__, 89, LOG_ERR_LEVEL, "%s == NULL! LITE_free(%s) aborted.", "tmp", "tmp"); break; } LITE_free_internal((void *)tmp); tmp = 
# 89 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
   ((void *)0)
# 89 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
   ; } while(0);
    return dst;
...
char *LITE_strdup(const char *src, ...)
{
    int len = 0;
    char *dst = 
# 97 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
                         ((void *)0)
# 97 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
                             ;
    int magic = 0;
    char *module_name = 
# 99 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
                                 ((void *)0)
# 99 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
                                     ;

    if (!src) {
        return 
# 102 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
              ((void *)0)
# 102 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
                  ;
    }
    len = strlen(src) + 1;
    if (len > 1024) {
        LITE_syslog(__FUNCTION__, 106, LOG_ERR_LEVEL, "Too long string to duplicate, abort! len = %d", len);
        return 
# 107 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
              ((void *)0)
# 107 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
                  ;
    }
# 121 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
    dst = (char *)LITE_malloc_internal(__func__, 121, sizeof(char) * len, magic, module_name);

    if (!dst) {
        return 
# 124 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c" 3 4
              ((void *)0)
# 124 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/string_utils.c"
                  ;
    }
    strncpy(dst, src, len);
...
void LITE_hexstr_convert(char *hexstr, uint8_t *out_buf, int in_len)
{
    ...
    if (in_len % 2 != 0) {
        LITE_syslog(__FUNCTION__, 167, LOG_ERR_LEVEL, "hexstr length (%d) is not even", in_len);
        return;
    }
