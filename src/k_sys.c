...
# 6 "kernel/rhino/core/k_sys.c" 2

static inline void rhino_stack_check_init(void)
{
# 20 "kernel/rhino/core/k_sys.c"
}

kstat_t krhino_init(void)
{
    g_sys_stat = RHINO_STOPPED;
# 34 "kernel/rhino/core/k_sys.c"
...
# 59 "kernel/rhino/core/k_sys.c"
    krhino_task_create(&g_idle_task[0], "idle_task", 
# 59 "kernel/rhino/core/k_sys.c" 3 4
                                                    ((void *)0)
# 59 "kernel/rhino/core/k_sys.c"
                                                        , (62 - 1), 0,
                       &g_idle_task_stack[0][0], 200,
                       idle_task, 1u);
...
tick_t krhino_next_sleep_ticks_get(void)
{
    ...
    iter = tick_head->next;
    tcb = ((ktask_t *)((uint8_t *)(iter) - (size_t)(&((ktask_t *)0)->tick_list)));
