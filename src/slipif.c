# 1 "kernel/protocols/net/netif/slipif.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/netif/slipif.c"
# 62 "kernel/protocols/net/netif/slipif.c"
# 1 "./kernel/protocols/net/include/netif/slipif.h" 1
# 43 "./kernel/protocols/net/include/netif/slipif.h"
...
# 44 "./kernel/protocols/net/include/netif/slipif.h" 2
...
# 45 "./kernel/protocols/net/include/netif/slipif.h" 2
# 74 "./kernel/protocols/net/include/netif/slipif.h"
err_t slipif_init(struct netif * netif);
void slipif_poll(struct netif *netif);
# 63 "kernel/protocols/net/netif/slipif.c" 2
...
struct udp_pcb;
struct netif;
# 69 "kernel/protocols/net/netif/slipif.c" 2
...
# 70 "kernel/protocols/net/netif/slipif.c" 2
# 1 "./kernel/protocols/net/include/lwip/sio.h" 1
# 48 "./kernel/protocols/net/include/lwip/sio.h"
typedef void * sio_fd_t;
# 61 "./kernel/protocols/net/include/lwip/sio.h"
sio_fd_t sio_open(u8_t devnum);
# 73 "./kernel/protocols/net/include/lwip/sio.h"
void sio_send(u8_t c, sio_fd_t fd);
# 84 "./kernel/protocols/net/include/lwip/sio.h"
u8_t sio_recv(sio_fd_t fd);
# 99 "./kernel/protocols/net/include/lwip/sio.h"
u32_t sio_read(sio_fd_t fd, u8_t *data, u32_t len);
# 112 "./kernel/protocols/net/include/lwip/sio.h"
u32_t sio_tryread(sio_fd_t fd, u8_t *data, u32_t len);
# 126 "./kernel/protocols/net/include/lwip/sio.h"
u32_t sio_write(sio_fd_t fd, u8_t *data, u32_t len);
# 135 "./kernel/protocols/net/include/lwip/sio.h"
void sio_read_abort(sio_fd_t fd);
# 71 "kernel/protocols/net/netif/slipif.c" 2
# 90 "kernel/protocols/net/netif/slipif.c"
...
# 115 "kernel/protocols/net/netif/slipif.c"
static err_t
slipif_output(struct netif *netif, struct pbuf *p)
{
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("slipif_output(%""4d""): sending %""4d"" bytes\n", (u16_t)netif->num, p->tot_len) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  ...
  for (q = p; q != 
# 134 "kernel/protocols/net/netif/slipif.c" 3 4
                  ((void *)0)
# 134 "kernel/protocols/net/netif/slipif.c"
                      ; q = q->next) {
    for (i = 0; i < q->len; i++) {
      c = ((u8_t *)q->payload)[i];
      switch (c) {
...
# 171 "kernel/protocols/net/netif/slipif.c"
static err_t
...
# 206 "kernel/protocols/net/netif/slipif.c"
static struct pbuf*
  ...
  case SLIP_RECV_NORMAL:
    ...
    case 0xC0:
      if (priv->recved > 0) {
        ...
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("slipif: Got packet (%""4d"" bytes)\n", priv->recved) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        t = priv->q;
        priv->p = priv->q = 
# 230 "kernel/protocols/net/netif/slipif.c" 3 4
                           ((void *)0)
# 230 "kernel/protocols/net/netif/slipif.c"
                               ;
        priv->i = priv->recved = 0;
        return t;
      }
      return 
# 234 "kernel/protocols/net/netif/slipif.c" 3 4
            ((void *)0)
# 234 "kernel/protocols/net/netif/slipif.c"
                ;
    case 0xDB:
      priv->state = SLIP_RECV_ESCAPE;
      return 
# 237 "kernel/protocols/net/netif/slipif.c" 3 4
            ((void *)0)
# 237 "kernel/protocols/net/netif/slipif.c"
                ;
    default:
      break;
    }
  ...
  if (priv->p == 
# 262 "kernel/protocols/net/netif/slipif.c" 3 4
                ((void *)0)
# 262 "kernel/protocols/net/netif/slipif.c"
                    ) {

    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("slipif_input: alloc\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    priv->p = pbuf_alloc(PBUF_LINK, (1580 - (14 + 0) - 0), PBUF_POOL);

    if (priv->p == 
# 267 "kernel/protocols/net/netif/slipif.c" 3 4
                  ((void *)0)
# 267 "kernel/protocols/net/netif/slipif.c"
                      ) {
      ;
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("slipif_input: no new pbuf! (DROP)\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);

      return 
# 271 "kernel/protocols/net/netif/slipif.c" 3 4
            ((void *)0)
# 271 "kernel/protocols/net/netif/slipif.c"
                ;
    }

    if (priv->q != 
# 274 "kernel/protocols/net/netif/slipif.c" 3 4
                  ((void *)0)
# 274 "kernel/protocols/net/netif/slipif.c"
                      ) {
  ...
  if ((priv->p != 
# 284 "kernel/protocols/net/netif/slipif.c" 3 4
                 ((void *)0)
# 284 "kernel/protocols/net/netif/slipif.c"
                     ) && (priv->recved <= 1500)) {
    ...
    if (priv->i >= priv->p->len) {
      ...
      priv->i = 0;
      if (priv->p->next != 
# 291 "kernel/protocols/net/netif/slipif.c" 3 4
                          ((void *)0) 
# 291 "kernel/protocols/net/netif/slipif.c"
                               && priv->p->next->len > 0) {
          ...
          priv->p = 
# 297 "kernel/protocols/net/netif/slipif.c" 3 4
                   ((void *)0)
# 297 "kernel/protocols/net/netif/slipif.c"
                       ;
      }
    }
  }
  return 
# 301 "kernel/protocols/net/netif/slipif.c" 3 4
        ((void *)0)
# 301 "kernel/protocols/net/netif/slipif.c"
            ;
}
...
slipif_rxbyte_input(struct netif *netif, u8_t c)
{
  ...
  if (p != 
# 314 "kernel/protocols/net/netif/slipif.c" 3 4
          ((void *)0)
# 314 "kernel/protocols/net/netif/slipif.c"
              ) {
...
# 329 "kernel/protocols/net/netif/slipif.c"
static void
...
# 360 "kernel/protocols/net/netif/slipif.c"
err_t
slipif_init(struct netif *netif)
{
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("slipif_init: netif->num=%""4d""\n", (u16_t)netif->num) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  ...
  if (netif->state != 
# 385 "kernel/protocols/net/netif/slipif.c" 3 4
                     ((void *)0)
# 385 "kernel/protocols/net/netif/slipif.c"
                         ) {
  ...
  priv->p = 
# 399 "kernel/protocols/net/netif/slipif.c" 3 4
           ((void *)0)
# 399 "kernel/protocols/net/netif/slipif.c"
               ;
  priv->q = 
# 400 "kernel/protocols/net/netif/slipif.c" 3 4
           ((void *)0)
# 400 "kernel/protocols/net/netif/slipif.c"
               ;
  priv->state = SLIP_RECV_NORMAL;
  priv->i = 0;
  priv->recved = 0;
