...
# 10 "framework/netmgr/netmgr.c" 2
...
# 11 "framework/netmgr/netmgr.c" 2
# 1 "./include/hal/hal.h" 1
# 9 "./include/hal/hal.h"
# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/lib/gcc/arm-none-eabi/5.4.1/include/stddef.h" 1 3 4
# 10 "./include/hal/hal.h" 2

# 1 "./include/hal/base.h" 1
...
# 12 "./include/hal/hal.h" 2
# 1 "./include/hal/ota.h" 1
...
# 13 "./include/hal/hal.h" 2
# 1 "./include/hal/sensor.h" 1
# 12 "./include/hal/sensor.h"
...
# 13 "./include/hal/sensor.h" 2
# 22 "./include/hal/sensor.h"
typedef enum {
...
# 14 "./include/hal/hal.h" 2
# 1 "./include/hal/trace.h" 1
# 11 "./include/hal/trace.h"
void *trace_hal_init(void);
# 22 "./include/hal/trace.h"
ssize_t trace_hal_send(void *handle, void *buf, size_t len);
# 32 "./include/hal/trace.h"
...
# 15 "./include/hal/hal.h" 2
# 1 "./include/hal/wifi.h" 1
# 14 "./include/hal/wifi.h"
...
# 16 "./include/hal/hal.h" 2
# 1 "./include/hal/atcmd.h" 1
# 17 "./include/hal/hal.h" 2
# 12 "framework/netmgr/netmgr.c" 2
...
# 15 "framework/netmgr/netmgr.c" 2
...
# 16 "framework/netmgr/netmgr.c" 2


# 1 "./framework/netmgr/include/netmgr.h" 1
# 29 "./framework/netmgr/include/netmgr.h"
typedef struct {
    char ssid[32 + 1];
    uint8_t bssid[(6)];
    char pwd[64 + 1];
...
# 83 "./framework/netmgr/include/netmgr.h" 3 4
_Bool 
# 83 "./framework/netmgr/include/netmgr.h"
    netmgr_get_scan_cb_finished(void);

# 84 "./framework/netmgr/include/netmgr.h" 3 4
_Bool 
# 84 "./framework/netmgr/include/netmgr.h"
    netmgr_get_ip_state(void);
...
int netmgr_start(
# 90 "./framework/netmgr/include/netmgr.h" 3 4
                _Bool 
# 90 "./framework/netmgr/include/netmgr.h"
                     autoconfig);
# 19 "framework/netmgr/netmgr.c" 2
# 44 "framework/netmgr/netmgr.c"
typedef struct {
...
# 51 "framework/netmgr/netmgr.c" 3 4
   _Bool 
# 51 "framework/netmgr/netmgr.c"
                              doing_smartconfig;
    
# 52 "framework/netmgr/netmgr.c" 3 4
   _Bool 
# 52 "framework/netmgr/netmgr.c"
                              ip_available;
    netmgr_wifi_scan_result_cb_t cb;
    
# 54 "framework/netmgr/netmgr.c" 3 4
   _Bool 
# 54 "framework/netmgr/netmgr.c"
                              wifi_scan_complete_cb_finished;
} netmgr_cxt_t;
...
static 
# 66 "framework/netmgr/netmgr.c" 3 4
      _Bool 
# 66 "framework/netmgr/netmgr.c"
           g_station_is_up = 
# 66 "framework/netmgr/netmgr.c" 3 4
                             0
# 66 "framework/netmgr/netmgr.c"
...
# 103 "framework/netmgr/netmgr.c"
static void start_mesh(
# 103 "framework/netmgr/netmgr.c" 3 4
                      _Bool 
# 103 "framework/netmgr/netmgr.c"
                           is_leader)
{
# 115 "framework/netmgr/netmgr.c"
}
...
{
    do { if (aos_log_get_level() & (1 << AOS_LL_V_INFO_BIT)) { csp_printf("[%06d]<" "I" "> ", (unsigned)aos_now_ms(), "Got ip : %s, gw : %s, mask : %s", pnet->ip, pnet->gate, pnet->mask); csp_printf("Got ip : %s, gw : %s, mask : %s", pnet->ip, pnet->gate, pnet->mask); csp_printf("\r\n"); } } while (0);
    ...
    g_netmgr_cxt.ip_available = 
# 147 "framework/netmgr/netmgr.c" 3 4
                               1
# 147 "framework/netmgr/netmgr.c"
                                   ;
    aos_post_event(0x0002, 4, 0u);
    start_mesh(
# 149 "framework/netmgr/netmgr.c" 3 4
              1
# 149 "framework/netmgr/netmgr.c"
                  );
}
# 220 "framework/netmgr/netmgr.c"
static void ramdonize_tcp_local_port()
{
                                  ...
                                  void *arg)
{
    switch (stat) {
        case NOTIFY_STATION_UP:
            g_station_is_up = 
# 262 "framework/netmgr/netmgr.c" 3 4
                             1
# 262 "framework/netmgr/netmgr.c"
                                 ;
            aos_post_event(0x0002, 2,
                           (unsigned long)g_netmgr_cxt.ap_config.ssid);
            break;
        case NOTIFY_STATION_DOWN:
            g_station_is_up = 
# 267 "framework/netmgr/netmgr.c" 3 4
                             0
# 267 "framework/netmgr/netmgr.c"
                                  ;
            aos_post_event(0x0002, 3, 0u);
            break;
        case NOTIFY_AP_UP:
            break;
        case NOTIFY_AP_DOWN:
                                        ...
                                        void *arg)
{
    ...
    if (g_netmgr_cxt.cb) {
        ...
        g_netmgr_cxt.wifi_scan_complete_cb_finished = 
# 302 "framework/netmgr/netmgr.c" 3 4
                                                     1
# 302 "framework/netmgr/netmgr.c"
                                                         ;
    }
}
                                            ...
                                            void *arg)
{
    ...
    if (g_netmgr_cxt.cb) {
        ...
        g_netmgr_cxt.wifi_scan_complete_cb_finished = 
# 323 "framework/netmgr/netmgr.c" 3 4
                                                     1
# 323 "framework/netmgr/netmgr.c"
                                                         ;
    }
}
...
{
    g_netmgr_cxt.ip_available = 
# 365 "framework/netmgr/netmgr.c" 3 4
                               0
# 365 "framework/netmgr/netmgr.c"
                                    ;
    reconnect_wifi(
# 366 "framework/netmgr/netmgr.c" 3 4
                  ((void *)0)
# 366 "framework/netmgr/netmgr.c"
                      );
}
...
static int set_wifi_ssid(void)
{
    ...
    if (strcmp(g_netmgr_cxt.ap_config.ssid, "aha") == 0 ||
        strcmp(g_netmgr_cxt.ap_config.ssid, "adha") == 0) {
        return -1;
    }

    len = sizeof(netmgr_ap_config_t);
    ret = aos_kv_get("wifi", &tmp, &len);
    ...
    ret = aos_kv_set("wifi", &g_netmgr_cxt.saved_conf,
...
static void netmgr_events_executor(input_event_t *eventinfo, void *priv_data)
{
    ...
    switch (eventinfo->code) {
        case 2:
            if (g_station_is_up == 
# 459 "framework/netmgr/netmgr.c" 3 4
                                  1
# 459 "framework/netmgr/netmgr.c"
                                      ) {
        ...
        case 3:
            if (g_station_is_up == 
# 464 "framework/netmgr/netmgr.c" 3 4
                                  0
# 464 "framework/netmgr/netmgr.c"
                                       ) {
                handle_wifi_disconnect();
                g_netmgr_cxt.ip_available = 
# 466 "framework/netmgr/netmgr.c" 3 4
                                           0
# 466 "framework/netmgr/netmgr.c"
                                                ;
            }
            break;
        case 4:
            if (g_netmgr_cxt.doing_smartconfig) {
                if (strcmp(g_netmgr_cxt.ap_config.ssid, "aha") != 0 &&
                    strcmp(g_netmgr_cxt.ap_config.ssid, "adha") != 0) {
                    do { if (aos_log_get_level() & (1 << AOS_LL_V_INFO_BIT)) { csp_printf("[%06d]<" "I" "> ", (unsigned)aos_now_ms(), "Let's post GOT_IP event."); csp_printf("Let's post GOT_IP event."); csp_printf("\r\n"); } } while (0);
                    g_netmgr_cxt.autoconfig_chain->config_result_cb(
                        0, g_netmgr_cxt.ipv4_owned);
                    g_netmgr_cxt.autoconfig_chain->autoconfig_stop();
                } else {
                    do { if (aos_log_get_level() & (1 << AOS_LL_V_INFO_BIT)) { csp_printf("[%06d]<" "I" "> ", (unsigned)aos_now_ms(), "In hotspot/router mode, do not post GOT_IP event here."); csp_printf("In hotspot/router mode, do not post GOT_IP event here."); csp_printf("\r\n"); } } while (0);
                }
            } else {
                aos_post_event(0x0002, 5,
                               (unsigned long)(&g_netmgr_cxt.ipv4_owned));
            }
            break;
        case 5:
            if (g_netmgr_cxt.doing_smartconfig) {
                g_netmgr_cxt.doing_smartconfig = 
# 487 "framework/netmgr/netmgr.c" 3 4
                                                0
# 487 "framework/netmgr/netmgr.c"
                                                     ;
            }
            set_wifi_ssid();
            break;
        case 1:
            g_netmgr_cxt.disconnected_times = 0;
            g_netmgr_cxt.ip_available = 
# 493 "framework/netmgr/netmgr.c" 3 4
                                       0
# 493 "framework/netmgr/netmgr.c"
                                            ;
           
                                                                         ;
            reconnect_wifi(
# 496 "framework/netmgr/netmgr.c" 3 4
                          ((void *)0)
# 496 "framework/netmgr/netmgr.c"
                              );
            break;
        default :
            break;
...
void netmgr_register_wifi_scan_result_callback(netmgr_wifi_scan_result_cb_t cb)
{
    g_netmgr_cxt.cb = cb;
    g_netmgr_cxt.wifi_scan_complete_cb_finished = 
# 511 "framework/netmgr/netmgr.c" 3 4
                                                 0
# 511 "framework/netmgr/netmgr.c"
                                                      ;
}
...
static void netmgr_wifi_config_start(void)
{
    ...
    if (valid_plugin != 
# 518 "framework/netmgr/netmgr.c" 3 4
                       ((void *)0)
# 518 "framework/netmgr/netmgr.c"
                           ) {
        g_netmgr_cxt.doing_smartconfig = 
# 519 "framework/netmgr/netmgr.c" 3 4
                                        1
# 519 "framework/netmgr/netmgr.c"
                                            ;
        valid_plugin->autoconfig_start();
    } else {
        do { if (aos_log_get_level() & (1 << AOS_LL_V_WARN_BIT)) { csp_printf("[%06d]<" "W" "> ", (unsigned)aos_now_ms(), "net mgr none config policy"); csp_printf("net mgr none config policy"); csp_printf("\r\n"); } } while (0);
        start_mesh(
# 523 "framework/netmgr/netmgr.c" 3 4
                  0
# 523 "framework/netmgr/netmgr.c"
                       );
    }
}
...
int netmgr_get_ap_config(netmgr_ap_config_t *config)
{
    ...
    strncpy(config->ssid, g_netmgr_cxt.ap_config.ssid, 32);
    strncpy(config->pwd, g_netmgr_cxt.ap_config.pwd, 64);
...
static void handle_netmgr_cmd(char *pwbuf, int blen, int argc, char **argv)
{
    ...
    if (strcmp(rtype, "clear") == 0) {
        ...
        netmgr_start(
# 610 "framework/netmgr/netmgr.c" 3 4
                    0
# 610 "framework/netmgr/netmgr.c"
                         );
    } else {
        netmgr_start(
# 612 "framework/netmgr/netmgr.c" 3 4
                    1
# 612 "framework/netmgr/netmgr.c"
                        );
    }
}
...
int netmgr_init(void)
{
    ...
    aos_register_event_filter(0x0002, netmgr_events_executor, 
# 626 "framework/netmgr/netmgr.c" 3 4
                                                              ((void *)0)
# 626 "framework/netmgr/netmgr.c"
                                                                  );
    ...
    g_netmgr_cxt.ip_available = 
# 631 "framework/netmgr/netmgr.c" 3 4
                               0
# 631 "framework/netmgr/netmgr.c"
                                    ;
    g_netmgr_cxt.wifi_scan_complete_cb_finished = 
# 632 "framework/netmgr/netmgr.c" 3 4
                                                 0
# 632 "framework/netmgr/netmgr.c"
                                                      ;
...
int netmgr_start(
# 656 "framework/netmgr/netmgr.c" 3 4
                _Bool 
# 656 "framework/netmgr/netmgr.c"
                     autoconfig)
{
    stop_mesh();
...
# 673 "framework/netmgr/netmgr.c"
    ...
    start_mesh(
# 678 "framework/netmgr/netmgr.c" 3 4
              0
# 678 "framework/netmgr/netmgr.c"
                   );
    return -1;
}


# 682 "framework/netmgr/netmgr.c" 3 4
_Bool 
# 682 "framework/netmgr/netmgr.c"
    netmgr_get_ip_state()
{
...
# 687 "framework/netmgr/netmgr.c" 3 4
_Bool 
# 687 "framework/netmgr/netmgr.c"
...
{
    if (!ip) {
        do { if (aos_log_get_level() & (1 << AOS_LL_V_ERROR_BIT)) { csp_printf("[%06d]<" "E" "> ", (unsigned)aos_now_ms(), "Invalid argument in %s", __func__); csp_printf("Invalid argument in %s", __func__); csp_printf("\r\n"); } } while (0);
    } else {
...
static int def_smart_config_start(void)
{
    ...
    strncpy(config.ssid, "cisco-15A7", sizeof(config.ssid) - 1);
    strncpy(config.pwd, "12345678", sizeof(config.pwd) - 1);
    netmgr_set_ap_config(&config);
    aos_post_event(0x0002, 1, 0);
    return 0;
}
