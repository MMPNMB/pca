...
# 6 "framework/common/main.c" 2
# 1 "./kernel/vfs/include/vfs.h" 1
# 7 "framework/common/main.c" 2
...
{
    do { if (1) { csp_printf("[%06d]<" "V" "> ", (unsigned)aos_now_ms(), "aos framework init."); csp_printf("aos framework init."); csp_printf("\r\n"); } } while (0);

    version_init();
# 32 "framework/common/main.c"
    return 0;
}
