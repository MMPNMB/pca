...
# 20 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/sys/types.h" 3
...
# 21 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/sys/types.h" 2 3
...
# 22 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/sys/types.h" 2 3
...
const hal_logic_partition_t hal_partitions[] =
{
 [HAL_PARTITION_BOOTLOADER] =
 {
     ...
     .partition_options = ( 0x1u << ( 0 ) ) | ( 0x0u << ( 1 ) ),
 },
 [HAL_PARTITION_PARAMETER_1] =
    {
        .partition_owner = HAL_FLASH_EMBEDDED,
        ...
        .partition_options = ( 0x1u << ( 0 ) ) | ( 0x1u << ( 1 ) ),
    },
    [HAL_PARTITION_PARAMETER_2] =
    {
        .partition_owner = HAL_FLASH_EMBEDDED,
...
static void key_poll_func(void *arg)
{
    ...
    if (level == 0) {
        aos_post_delayed_action(10, key_poll_func, 
# 96 "board/mk3060/board.c" 3 4
                                                  ((void *)0)
# 96 "board/mk3060/board.c"
                                                      );
    } else {
        diff = aos_now_ms() - elink_time;
        if (diff > 6000) {
            elink_time = 0;
            aos_post_event(0x0201, 13, 4);
        } else if (diff > 2000) {
            elink_time = 0;
            aos_post_event(0x0201, 13, 3);
        } else if (diff > 40) {
            elink_time = 0;
            aos_post_event(0x0201, 13, 2);
        } else {
            aos_post_delayed_action(10, key_poll_func, 
# 109 "board/mk3060/board.c" 3 4
                                                      ((void *)0)
# 109 "board/mk3060/board.c"
                                                          );
        }
    }
}
...
{
    aos_schedule_call(key_poll_func, 
# 116 "board/mk3060/board.c" 3 4
                                    ((void *)0)
# 116 "board/mk3060/board.c"
                                        );
}
...
static void handle_elink_key(void *arg)
{
    ...
    if (gpio_value == 0 && elink_time == 0) {
        ...
        aos_loop_schedule_work(0, key_proc_work, 
# 126 "board/mk3060/board.c" 3 4
                                                ((void *)0)
# 126 "board/mk3060/board.c"
                                                    , 
# 126 "board/mk3060/board.c" 3 4
                                                      ((void *)0)
# 126 "board/mk3060/board.c"
...
void board_init(void)
{
    ...
    hal_gpio_enable_irq(&gpio_key_boot, IRQ_TRIGGER_FALLING_EDGE, handle_elink_key, 
# 165 "board/mk3060/board.c" 3 4
                                                                                   ((void *)0)
# 165 "board/mk3060/board.c"
                                                                                       );
}
