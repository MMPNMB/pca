# 1 "framework/protocol/linkkit/iotkit/iotkit-system/src/sdk-impl.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "framework/protocol/linkkit/iotkit/iotkit-system/src/sdk-impl.c"
# 19 "framework/protocol/linkkit/iotkit/iotkit-system/src/sdk-impl.c"
# 1 "./framework/protocol/linkkit/iotkit/iotkit-system/sdk-impl_internal.h" 1
# 27 "./framework/protocol/linkkit/iotkit/iotkit-system/sdk-impl_internal.h"
# 1 "./framework/protocol/linkkit/iotkit/sdk-encap/iot_import.h" 1
# 25 "./framework/protocol/linkkit/iotkit/sdk-encap/iot_import.h"
...
# 26 "./framework/protocol/linkkit/iotkit/sdk-encap/iot_import.h" 2
...
# 27 "./framework/protocol/linkkit/iotkit/sdk-encap/iot_import.h" 2
# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/lib/gcc/arm-none-eabi/5.4.1/include/stdarg.h" 1 3 4
# 28 "./framework/protocol/linkkit/iotkit/sdk-encap/iot_import.h" 2
# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/inttypes.h" 1 3
# 18 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/inttypes.h" 3
# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/sys/_intsup.h" 1 3
# 49 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/sys/_intsup.h" 3
...
# 201 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/sys/_intsup.h" 3
...
# 19 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/inttypes.h" 2 3
...
# 20 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/inttypes.h" 2 3
...
# 28 "./framework/protocol/linkkit/iotkit/iotkit-system/sdk-impl_internal.h" 2
...
# 29 "./framework/protocol/linkkit/iotkit/iotkit-system/sdk-impl_internal.h" 2

# 1 "./framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log.h" 1
# 28 "./framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log.h"
...
# 29 "./framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log.h" 2
...
# 31 "./framework/protocol/linkkit/iotkit/iotkit-system/sdk-impl_internal.h" 2
...
# 32 "./framework/protocol/linkkit/iotkit/iotkit-system/sdk-impl_internal.h" 2
# 1 "./framework/protocol/linkkit/iotkit/iotkit-system/lite-system.h" 1
# 33 "./framework/protocol/linkkit/iotkit/iotkit-system/lite-system.h"
int iotx_guider_authenticate(void);
# 46 "./framework/protocol/linkkit/iotkit/iotkit-system/lite-system.h"
...
# 63 "./framework/protocol/linkkit/iotkit/iotkit-system/lite-system.h"
...
# 33 "./framework/protocol/linkkit/iotkit/iotkit-system/sdk-impl_internal.h" 2
# 20 "framework/protocol/linkkit/iotkit/iotkit-system/src/sdk-impl.c" 2
...
void IOT_OpenLog(const char *ident)
{
    ...
    if (
# 28 "framework/protocol/linkkit/iotkit/iotkit-system/src/sdk-impl.c" 3 4
       ((void *)0) 
# 28 "framework/protocol/linkkit/iotkit/iotkit-system/src/sdk-impl.c"
            == mod) {
        mod = "---";
    }
...
void IOT_SetLogLevel(IOT_LogLevel level)
{
    ...
    if (lvl > LOG_DEBUG_LEVEL) {
        LITE_syslog(__FUNCTION__,

                               47
# 45 "framework/protocol/linkkit/iotkit/iotkit-system/src/sdk-impl.c"
        , LOG_ERR_LEVEL, "Invalid input level: %d out of [%d, %d]", level, LOG_EMERG_LEVEL, LOG_DEBUG_LEVEL)
...
void IOT_DumpMemoryStats(IOT_LogLevel level)
{
    ...
    if (lvl > LOG_DEBUG_LEVEL) {
        lvl = LOG_DEBUG_LEVEL;
        LITE_syslog(__FUNCTION__, 60, LOG_WARNING_LEVEL, "Invalid input level, using default: %d => %d", level, lvl);
    }
                      ...
                      void **info_ptr)
{
    ...
    if (!info_ptr) {
        LITE_syslog(__FUNCTION__, 75, LOG_ERR_LEVEL, "Invalid argument, info_ptr = %p", info_ptr);
        return -1;
    }

    do { if (
# 79 "framework/protocol/linkkit/iotkit/iotkit-system/src/sdk-impl.c" 3 4
   ((void *)0) 
# 79 "framework/protocol/linkkit/iotkit/iotkit-system/src/sdk-impl.c"
   == (product_key)) { LITE_syslog(__FUNCTION__, 79, LOG_ERR_LEVEL, "Invalid argument, %s = %p", "product_key", (product_key)); return (-1); } if (0 == strlen((product_key))) { LITE_syslog(__FUNCTION__, 79, LOG_ERR_LEVEL, "Invalid argument, %s = '%s'", "product_key", (product_key)); return (-1); } } while(0);
    do { if (
# 80 "framework/protocol/linkkit/iotkit/iotkit-system/src/sdk-impl.c" 3 4
   ((void *)0) 
# 80 "framework/protocol/linkkit/iotkit/iotkit-system/src/sdk-impl.c"
   == (device_name)) { LITE_syslog(__FUNCTION__, 80, LOG_ERR_LEVEL, "Invalid argument, %s = %p", "device_name", (device_name)); return (-1); } if (0 == strlen((device_name))) { LITE_syslog(__FUNCTION__, 80, LOG_ERR_LEVEL, "Invalid argument, %s = '%s'", "device_name", (device_name)); return (-1); } } while(0);
    do { if (
# 81 "framework/protocol/linkkit/iotkit/iotkit-system/src/sdk-impl.c" 3 4
   ((void *)0) 
# 81 "framework/protocol/linkkit/iotkit/iotkit-system/src/sdk-impl.c"
   == (device_secret)) { LITE_syslog(__FUNCTION__, 81, LOG_ERR_LEVEL, "Invalid argument, %s = %p", "device_secret", (device_secret)); return (-1); } if (0 == strlen((device_secret))) { LITE_syslog(__FUNCTION__, 81, LOG_ERR_LEVEL, "Invalid argument, %s = '%s'", "device_secret", (device_secret)); return (-1); } } while(0);
    ...
    if (rc == 0) {
        ...
        *info_ptr = 
# 91 "framework/protocol/linkkit/iotkit/iotkit-system/src/sdk-impl.c" 3 4
                   ((void *)0)
# 91 "framework/protocol/linkkit/iotkit/iotkit-system/src/sdk-impl.c"
                       ;
        return -1;
    }
}
