# 1 "kernel/protocols/net/core/sys.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/core/sys.c"
# 39 "kernel/protocols/net/core/sys.c"
...
# 40 "kernel/protocols/net/core/sys.c" 2
...
# 42 "kernel/protocols/net/core/sys.c" 2
# 54 "kernel/protocols/net/core/sys.c"
void
sys_msleep(u32_t ms)
{
  if (ms > 0) {
