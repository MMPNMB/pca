# 1 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_sha1.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_sha1.c"
# 21 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_sha1.c"
...
# 22 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_sha1.c" 2
...
# 23 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_sha1.c" 2
...
# 24 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_sha1.c" 2
...
# 25 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_sha1.c" 2
# 1 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_sha1.h" 1
# 29 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_sha1.h"
typedef struct {
    uint32_t total[2];
    uint32_t state[5];
...
# 72 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_sha1.h"
...
# 92 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_sha1.h"
void utils_sha1(const unsigned char *input, size_t ilen, unsigned char output[20]);
# 26 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_sha1.c" 2
...
# 59 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_sha1.c"
void utils_sha1_init(iot_sha1_context *ctx)
{
...
{
    if (ctx == 
# 66 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_sha1.c" 3 4
              ((void *)0)
# 66 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_sha1.c"
                  ) {
        return;
    }
...
# 129 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_sha1.c"
    A = ctx->state[0];
    B = ctx->state[1];
    C = ctx->state[2];
    D = ctx->state[3];
