# 1 "kernel/protocols/net/api/netdb.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/api/netdb.c"
# 38 "kernel/protocols/net/api/netdb.c"
# 1 "./kernel/protocols/net/include/lwip/netdb.h" 1
# 37 "./kernel/protocols/net/include/lwip/netdb.h"
...
# 38 "./kernel/protocols/net/include/lwip/netdb.h" 2
...
# 44 "./kernel/protocols/net/include/lwip/inet.h"
...
# 45 "./kernel/protocols/net/include/lwip/inet.h" 2
...
int lwip_getaddrinfo(const char *nodename,
       ...
       struct addrinfo **res);
# 39 "kernel/protocols/net/api/netdb.c" 2
...
# 44 "kernel/protocols/net/api/netdb.c" 2
...
# 45 "kernel/protocols/net/api/netdb.c" 2
...
# 47 "kernel/protocols/net/api/netdb.c" 2
...
err_t dns_gethostbyname_addrtype(const char *hostname, ip_addr_t *addr,
                                   dns_found_callback found, void *callback_arg,
                                   u8_t dns_addrtype);
# 48 "kernel/protocols/net/api/netdb.c" 2
...
# 50 "kernel/protocols/net/api/netdb.c" 2
...
# 51 "kernel/protocols/net/api/netdb.c" 2



# 53 "kernel/protocols/net/api/netdb.c"
...
int h_errno;
# 86 "kernel/protocols/net/api/netdb.c"
struct hostent*
lwip_gethostbyname(const char *name)
{
  ...
  if (err != ERR_OK) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("lwip_gethostbyname(%s) failed, err=%d\n", name, err) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    h_errno = 210;
    return 
# 104 "kernel/protocols/net/api/netdb.c" 3 4
          ((void *)0)
# 104 "kernel/protocols/net/api/netdb.c"
              ;
  }
  ...
  s_phostent_addr[1] = 
# 110 "kernel/protocols/net/api/netdb.c" 3 4
                      ((void *)0)
# 110 "kernel/protocols/net/api/netdb.c"
                          ;
  strncpy(s_hostname, name, 256);
  s_hostname[256] = 0;
  s_hostent.h_name = s_hostname;
  s_aliases = 
# 114 "kernel/protocols/net/api/netdb.c" 3 4
             ((void *)0)
# 114 "kernel/protocols/net/api/netdb.c"
                 ;
  s_hostent.h_aliases = &s_aliases;
  s_hostent.h_addrtype = 2;
  s_hostent.h_length = sizeof(ip_addr_t);
  s_hostent.h_addr_list = (char**)&s_phostent_addr;
# 141 "kernel/protocols/net/api/netdb.c"
  return &s_hostent;

}
# 161 "kernel/protocols/net/api/netdb.c"
int
                ...
                size_t buflen, struct hostent **result, int *h_errnop)
{
  ...
  if (h_errnop == 
# 171 "kernel/protocols/net/api/netdb.c" 3 4
                 ((void *)0)
# 171 "kernel/protocols/net/api/netdb.c"
                     ) {
  ...
  if (result == 
# 176 "kernel/protocols/net/api/netdb.c" 3 4
               ((void *)0)
# 176 "kernel/protocols/net/api/netdb.c"
                   ) {
  ...
  *result = 
# 182 "kernel/protocols/net/api/netdb.c" 3 4
           ((void *)0)
# 182 "kernel/protocols/net/api/netdb.c"
               ;
  if ((name == 
# 183 "kernel/protocols/net/api/netdb.c" 3 4
              ((void *)0)
# 183 "kernel/protocols/net/api/netdb.c"
                  ) || (ret == 
# 183 "kernel/protocols/net/api/netdb.c" 3 4
                               ((void *)0)
# 183 "kernel/protocols/net/api/netdb.c"
...
# 183 "kernel/protocols/net/api/netdb.c"
  ...
  h->addr_list[1] = 
# 213 "kernel/protocols/net/api/netdb.c" 3 4
                   ((void *)0)
# 213 "kernel/protocols/net/api/netdb.c"
                       ;
  h->aliases = 
# 214 "kernel/protocols/net/api/netdb.c" 3 4
              ((void *)0)
# 214 "kernel/protocols/net/api/netdb.c"
                  ;
  ret->h_name = hostname;
...
# 235 "kernel/protocols/net/api/netdb.c"
void
lwip_freeaddrinfo(struct addrinfo *ai)
{
  ...
  while (ai != 
# 240 "kernel/protocols/net/api/netdb.c" 3 4
              ((void *)0)
# 240 "kernel/protocols/net/api/netdb.c"
                  ) {
    next = ai->ai_next;
...
# 268 "kernel/protocols/net/api/netdb.c"
int
...
# 275 "kernel/protocols/net/api/netdb.c" 3 4
                               ((void *)0)
# 275 "kernel/protocols/net/api/netdb.c"
                                   ;
  int port_nr = 0;
  size_t total_size;
  size_t namelen = 0;
  ...
  if (res == 
# 281 "kernel/protocols/net/api/netdb.c" 3 4
            ((void *)0)
# 281 "kernel/protocols/net/api/netdb.c"
                ) {
    return 202;
  }
  *res = 
# 284 "kernel/protocols/net/api/netdb.c" 3 4
        ((void *)0)
# 284 "kernel/protocols/net/api/netdb.c"
            ;
  if ((nodename == 
# 285 "kernel/protocols/net/api/netdb.c" 3 4
                  ((void *)0)
# 285 "kernel/protocols/net/api/netdb.c"
                      ) && (servname == 
# 285 "kernel/protocols/net/api/netdb.c" 3 4
                                        ((void *)0)
# 285 "kernel/protocols/net/api/netdb.c"
  ...
  if (hints != 
# 289 "kernel/protocols/net/api/netdb.c" 3 4
              ((void *)0)
# 289 "kernel/protocols/net/api/netdb.c"
                  ) {
  ...
  if (servname != 
# 305 "kernel/protocols/net/api/netdb.c" 3 4
                 ((void *)0)
# 305 "kernel/protocols/net/api/netdb.c"
                     ) {
  ...
  if (nodename != 
# 314 "kernel/protocols/net/api/netdb.c" 3 4
                 ((void *)0)
# 314 "kernel/protocols/net/api/netdb.c"
                     ) {

    if ((hints != 
# 316 "kernel/protocols/net/api/netdb.c" 3 4
                 ((void *)0)
# 316 "kernel/protocols/net/api/netdb.c"
                     ) && (hints->ai_flags & 0x04)) {
...
# 337 "kernel/protocols/net/api/netdb.c"
    ...
    if ((hints != 
# 344 "kernel/protocols/net/api/netdb.c" 3 4
                 ((void *)0)
# 344 "kernel/protocols/net/api/netdb.c"
                     ) && (hints->ai_flags & 0x01)) {
  ...
  if (nodename != 
# 352 "kernel/protocols/net/api/netdb.c" 3 4
                 ((void *)0)
# 352 "kernel/protocols/net/api/netdb.c"
                     ) {
  ...
  if (ai == 
# 365 "kernel/protocols/net/api/netdb.c" 3 4
           ((void *)0)
# 365 "kernel/protocols/net/api/netdb.c"
               ) {
    return 203;
  }
  ...
  if (0) {
# 381 "kernel/protocols/net/api/netdb.c"
  } else {
  ...
  if (hints != 
# 394 "kernel/protocols/net/api/netdb.c" 3 4
              ((void *)0)
# 394 "kernel/protocols/net/api/netdb.c"
                  ) {
  ...
  if (nodename != 
# 399 "kernel/protocols/net/api/netdb.c" 3 4
                 ((void *)0)
# 399 "kernel/protocols/net/api/netdb.c"
                     ) {
