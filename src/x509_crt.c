# 1 "security/mbedtls/src/x509_crt.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "security/mbedtls/src/x509_crt.c"
# 33 "security/mbedtls/src/x509_crt.c"
...
# 34 "security/mbedtls/src/x509_crt.c" 2
...
# 27 "./security/mbedtls/include/mbedtls/x509_crt.h"
# 1 "./security/mbedtls/include/mbedtls/config.h" 1
# 28 "./security/mbedtls/include/mbedtls/x509_crt.h" 2
...
# 34 "./security/mbedtls/include/mbedtls/x509.h" 2
...
# 41 "security/mbedtls/src/x509_crt.c" 2
# 1 "./security/mbedtls/include/mbedtls/oid.h" 1
# 35 "./security/mbedtls/include/mbedtls/oid.h"
# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/lib/gcc/arm-none-eabi/5.4.1/include/stddef.h" 1 3 4
# 36 "./security/mbedtls/include/mbedtls/oid.h" 2
...
int mbedtls_cipher_crypt( mbedtls_cipher_context_t *ctx,
                  ...
                  const unsigned char *input, size_t ilen,
                  unsigned char *output, size_t *olen );
# 39 "./security/mbedtls/include/mbedtls/oid.h" 2
# 382 "./security/mbedtls/include/mbedtls/oid.h"
typedef struct {
    const char *asn1;
    size_t asn1_len;
    const char *name;
...
# 400 "./security/mbedtls/include/mbedtls/oid.h"
int mbedtls_oid_get_numeric_string( char *buf, size_t size, const mbedtls_asn1_buf *oid );
# 411 "./security/mbedtls/include/mbedtls/oid.h"
int mbedtls_oid_get_x509_ext_type( const mbedtls_asn1_buf *oid, int *ext_type );
# 423 "./security/mbedtls/include/mbedtls/oid.h"
int mbedtls_oid_get_attr_short_name( const mbedtls_asn1_buf *oid, const char **short_name );
# 433 "./security/mbedtls/include/mbedtls/oid.h"
int mbedtls_oid_get_pk_alg( const mbedtls_asn1_buf *oid, mbedtls_pk_type_t *pk_alg );
# 444 "./security/mbedtls/include/mbedtls/oid.h"
int mbedtls_oid_get_oid_by_pk_alg( mbedtls_pk_type_t pk_alg,
                           const char **oid, size_t *olen );
# 481 "./security/mbedtls/include/mbedtls/oid.h"
int mbedtls_oid_get_sig_alg( const mbedtls_asn1_buf *oid,
                     mbedtls_md_type_t *md_alg, mbedtls_pk_type_t *pk_alg );
# 492 "./security/mbedtls/include/mbedtls/oid.h"
int mbedtls_oid_get_sig_alg_desc( const mbedtls_asn1_buf *oid, const char **desc );
# 504 "./security/mbedtls/include/mbedtls/oid.h"
int mbedtls_oid_get_oid_by_sig_alg( mbedtls_pk_type_t pk_alg, mbedtls_md_type_t md_alg,
                            const char **oid, size_t *olen );
# 515 "./security/mbedtls/include/mbedtls/oid.h"
int mbedtls_oid_get_md_alg( const mbedtls_asn1_buf *oid, mbedtls_md_type_t *md_alg );
# 526 "./security/mbedtls/include/mbedtls/oid.h"
int mbedtls_oid_get_extended_key_usage( const mbedtls_asn1_buf *oid, const char **desc );
# 537 "./security/mbedtls/include/mbedtls/oid.h"
int mbedtls_oid_get_oid_by_md( mbedtls_md_type_t md_alg, const char **oid, size_t *olen );
# 548 "./security/mbedtls/include/mbedtls/oid.h"
int mbedtls_oid_get_cipher_alg( const mbedtls_asn1_buf *oid, mbedtls_cipher_type_t *cipher_alg );
# 42 "security/mbedtls/src/x509_crt.c" 2
...
# 45 "security/mbedtls/src/x509_crt.c" 2


# 1 "./security/mbedtls/include/mbedtls/pem.h" 1
# 26 "./security/mbedtls/include/mbedtls/pem.h"
# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/lib/gcc/arm-none-eabi/5.4.1/include/stddef.h" 1 3 4
# 27 "./security/mbedtls/include/mbedtls/pem.h" 2
# 53 "./security/mbedtls/include/mbedtls/pem.h"
...
# 90 "./security/mbedtls/include/mbedtls/pem.h"
...
# 48 "security/mbedtls/src/x509_crt.c" 2
...
# 52 "security/mbedtls/src/x509_crt.c" 2
# 62 "security/mbedtls/src/x509_crt.c"
...
# 63 "security/mbedtls/src/x509_crt.c" 2
# 81 "security/mbedtls/src/x509_crt.c"
...
const mbedtls_x509_crt_profile mbedtls_x509_crt_profile_default =
{
    ...
    0,
    2048,
# 113 "security/mbedtls/src/x509_crt.c"
};
...
const mbedtls_x509_crt_profile mbedtls_x509_crt_profile_next =
{
    ...
    0xFFFFFFF,
# 135 "security/mbedtls/src/x509_crt.c"
    0,
...
# 218 "security/mbedtls/src/x509_crt.c"
    return( -1 );
}
...
# 344 "security/mbedtls/src/x509_crt.c"
...
# 399 "security/mbedtls/src/x509_crt.c" 3 4
                                       ((void *)0) 
# 399 "security/mbedtls/src/x509_crt.c"
                                            };
                               ...
                               unsigned int *key_usage)
{
    ...
    size_t i;
    mbedtls_x509_bitstring bs = { 0, 0, 
# 419 "security/mbedtls/src/x509_crt.c" 3 4
                                       ((void *)0) 
# 419 "security/mbedtls/src/x509_crt.c"
                                            };
...
# 453 "security/mbedtls/src/x509_crt.c" 3 4
                               ((void *)0) 
# 453 "security/mbedtls/src/x509_crt.c"
                                    )
        return( -0x2500 +
                -0x0064 );
...
# 486 "security/mbedtls/src/x509_crt.c"
                                      ...
                                      mbedtls_x509_sequence *subject_alt_name )
{
    ...
    while( *p < end )
    {
        ...
        if( cur->buf.p != 
# 528 "security/mbedtls/src/x509_crt.c" 3 4
                         ((void *)0) 
# 528 "security/mbedtls/src/x509_crt.c"
                              )
        {
            if( cur->next != 
# 530 "security/mbedtls/src/x509_crt.c" 3 4
                            ((void *)0) 
# 530 "security/mbedtls/src/x509_crt.c"
                                 )
                return( -0x2500 );
            ...
            if( cur->next == 
# 535 "security/mbedtls/src/x509_crt.c" 3 4
                            ((void *)0) 
# 535 "security/mbedtls/src/x509_crt.c"
                                 )
                return( -0x2500 +
                        -0x006A );
    ...
    cur->next = 
# 550 "security/mbedtls/src/x509_crt.c" 3 4
               ((void *)0)
# 550 "security/mbedtls/src/x509_crt.c"
                   ;
...
# 587 "security/mbedtls/src/x509_crt.c" 3 4
                                          ((void *)0)
# 587 "security/mbedtls/src/x509_crt.c"
                                              };
        int is_critical = 0;
        int ext_type = 0;
        ...
        *p += extn_oid.len;
        ...
        if( ret != 0 )
        {
            ...
            *p = end_ext_octet;
# 646 "security/mbedtls/src/x509_crt.c"
            continue;
        }
                                    ...
                                    size_t buflen )
{
    ...
    if( crt == 
# 722 "security/mbedtls/src/x509_crt.c" 3 4
              ((void *)0) 
# 722 "security/mbedtls/src/x509_crt.c"
                   || buf == 
# 722 "security/mbedtls/src/x509_crt.c" 3 4
                             ((void *)0) 
# 722 "security/mbedtls/src/x509_crt.c"
    ...
    if( p == 
# 754 "security/mbedtls/src/x509_crt.c" 3 4
            ((void *)0) 
# 754 "security/mbedtls/src/x509_crt.c"
                 )
        return( -0x2880 );
...
# 785 "security/mbedtls/src/x509_crt.c"
...
# 840 "security/mbedtls/src/x509_crt.c"
...
# 885 "security/mbedtls/src/x509_crt.c"
...
# 944 "security/mbedtls/src/x509_crt.c"
...
# 984 "security/mbedtls/src/x509_crt.c" 3 4
                                          ((void *)0)
# 984 "security/mbedtls/src/x509_crt.c"
                                              ;
    ...
    if( crt == 
# 989 "security/mbedtls/src/x509_crt.c" 3 4
              ((void *)0) 
# 989 "security/mbedtls/src/x509_crt.c"
                   || buf == 
# 989 "security/mbedtls/src/x509_crt.c" 3 4
                             ((void *)0) 
# 989 "security/mbedtls/src/x509_crt.c"
...
# 992 "security/mbedtls/src/x509_crt.c" 3 4
                                            ((void *)0) 
# 992 "security/mbedtls/src/x509_crt.c"
                                                 )
    {
        prev = crt;
        crt = crt->next;
...
# 1001 "security/mbedtls/src/x509_crt.c" 3 4
                                         ((void *)0) 
# 1001 "security/mbedtls/src/x509_crt.c"
                                              )
    {
        crt->next = mbedtls_calloc( 1, sizeof( mbedtls_x509_crt ) );

        if( crt->next == 
# 1005 "security/mbedtls/src/x509_crt.c" 3 4
                        ((void *)0) 
# 1005 "security/mbedtls/src/x509_crt.c"
                             )
            return( -0x2880 );
    ...
    if( ( ret = x509_crt_parse_der_core( crt, buf, buflen ) ) != 0 )
    {
        if( prev )
            prev->next = 
# 1016 "security/mbedtls/src/x509_crt.c" 3 4
                        ((void *)0)
# 1016 "security/mbedtls/src/x509_crt.c"
                            ;
...
int mbedtls_x509_crt_parse( mbedtls_x509_crt *chain, const unsigned char *buf, size_t buflen )
{
    ...
    if( chain == 
# 1041 "security/mbedtls/src/x509_crt.c" 3 4
                ((void *)0) 
# 1041 "security/mbedtls/src/x509_crt.c"
                     || buf == 
# 1041 "security/mbedtls/src/x509_crt.c" 3 4
                               ((void *)0) 
# 1041 "security/mbedtls/src/x509_crt.c"
...
# 1050 "security/mbedtls/src/x509_crt.c" 3 4
                                                                      ((void *)0) 
# 1050 "security/mbedtls/src/x509_crt.c"
                                                                           )
    {
        buf_format = 2;
    }
    ...
    if( buf_format == 2 )
    {
        ...
        while( buflen > 1 )
        {
            ...
            ret = mbedtls_pem_read_buffer( &pem,
                           ...
                           "-----END CERTIFICATE-----",
                           buf, 
# 1077 "security/mbedtls/src/x509_crt.c" 3 4
                               ((void *)0)
# 1077 "security/mbedtls/src/x509_crt.c"
                                   , 0, &use_len );
...
# 1419 "security/mbedtls/src/x509_crt.c"
int mbedtls_x509_crt_info( char *buf, size_t size, const char *prefix,
                   const mbedtls_x509_crt *crt )
{
    int ret;
    ...
    if( 
# 1430 "security/mbedtls/src/x509_crt.c" 3 4
       ((void *)0) 
# 1430 "security/mbedtls/src/x509_crt.c"
            == crt )
    {
    ...
    do { if( ret < 0 || (size_t) ret >= n ) return( -0x2980 ); n -= (size_t) ret; p += (size_t) ret; } while( 0 );
# 1460 "security/mbedtls/src/x509_crt.c"
    ret = snprintf( p, n, "\n%sissued  on        : "
    ...
    do { if( ret < 0 || (size_t) ret >= n ) return( -0x2980 ); n -= (size_t) ret; p += (size_t) ret; } while( 0 );
# 1484 "security/mbedtls/src/x509_crt.c"
    ...
    do { if( ret < 0 || (size_t) ret >= n ) return( -0x2980 ); n -= (size_t) ret; p += (size_t) ret; } while( 0 );
# 1550 "security/mbedtls/src/x509_crt.c"
    ret = snprintf( p, n, "\n" );
    do { if( ret < 0 || (size_t) ret >= n ) return( -0x2980 ); n -= (size_t) ret; p += (size_t) ret; } while( 0 );
...
static const struct x509_crt_verify_string x509_crt_verify_strings[] = {
    ...
    { 0, 
# 1582 "security/mbedtls/src/x509_crt.c" 3 4
        ((void *)0) 
# 1582 "security/mbedtls/src/x509_crt.c"
             }
};
...
# 1593 "security/mbedtls/src/x509_crt.c" 3 4
                                                      ((void *)0) 
# 1593 "security/mbedtls/src/x509_crt.c"
                                                           ; cur++ )
    {
        if( ( flags & cur->code ) == 0 )
            continue;
...
# 1790 "security/mbedtls/src/x509_crt.c"
...
# 1884 "security/mbedtls/src/x509_crt.c"
static int x509_name_cmp( const mbedtls_x509_name *a, const mbedtls_x509_name *b )
{

    while( a != 
# 1887 "security/mbedtls/src/x509_crt.c" 3 4
               ((void *)0) 
# 1887 "security/mbedtls/src/x509_crt.c"
                    || b != 
# 1887 "security/mbedtls/src/x509_crt.c" 3 4
                            ((void *)0) 
# 1887 "security/mbedtls/src/x509_crt.c"
    ...
    {
        if( a == 
# 1889 "security/mbedtls/src/x509_crt.c" 3 4
                ((void *)0) 
# 1889 "security/mbedtls/src/x509_crt.c"
                     || b == 
# 1889 "security/mbedtls/src/x509_crt.c" 3 4
                             ((void *)0) 
# 1889 "security/mbedtls/src/x509_crt.c"
...
# 1923 "security/mbedtls/src/x509_crt.c"
                                  ...
                                  int top, int bottom )
{
    ...
    if( need_ca_bit && ! parent->ca_istrue )
        return( -1 );
# 1959 "security/mbedtls/src/x509_crt.c"
    return( 0 );
}
...
# 1975 "security/mbedtls/src/x509_crt.c" 3 4
                                      ((void *)0)
# 1975 "security/mbedtls/src/x509_crt.c"
                                          ;
    ...
    *flags |= 0x08;
    ...
    if( md_info == 
# 1992 "security/mbedtls/src/x509_crt.c" 3 4
                  ((void *)0) 
# 1992 "security/mbedtls/src/x509_crt.c"
                       )
    {
        ...
        trust_ca = 
# 1997 "security/mbedtls/src/x509_crt.c" 3 4
                  ((void *)0)
# 1997 "security/mbedtls/src/x509_crt.c"
                      ;
    }
    else
    ...
    for( ; trust_ca != 
# 2002 "security/mbedtls/src/x509_crt.c" 3 4
                                     ((void *)0)
# 2002 "security/mbedtls/src/x509_crt.c"
                                         ; trust_ca = trust_ca->next )
    {
        ...
        {
            if ( future_past_ca == 
# 2037 "security/mbedtls/src/x509_crt.c" 3 4
                                  ((void *)0) 
# 2037 "security/mbedtls/src/x509_crt.c"
                                       )
    ...
    if( trust_ca != 
# 2046 "security/mbedtls/src/x509_crt.c" 3 4
                   ((void *)0) 
# 2046 "security/mbedtls/src/x509_crt.c"
...
# 2046 "security/mbedtls/src/x509_crt.c"
    ...
    if( trust_ca != 
# 2062 "security/mbedtls/src/x509_crt.c" 3 4
                   ((void *)0) 
# 2062 "security/mbedtls/src/x509_crt.c"
                        &&
                            ...
                            child->issuer_raw.len ) != 0 ) )
    {
        ...
        if( 
# 2080 "security/mbedtls/src/x509_crt.c" 3 4
           ((void *)0) 
# 2080 "security/mbedtls/src/x509_crt.c"
                != f_vrfy )
        {
    ...
    if( 
# 2091 "security/mbedtls/src/x509_crt.c" 3 4
       ((void *)0) 
# 2091 "security/mbedtls/src/x509_crt.c"
            != f_vrfy )
    {
                ...
                void *p_vrfy )
{
    ...
    md_info = mbedtls_md_info_from_type( child->sig_md );
    if( md_info == 
# 2140 "security/mbedtls/src/x509_crt.c" 3 4
                  ((void *)0) 
# 2140 "security/mbedtls/src/x509_crt.c"
                       )
    {
    ...
    for( grandparent = trust_ca;
         grandparent != 
# 2169 "security/mbedtls/src/x509_crt.c" 3 4
                       ((void *)0)
# 2169 "security/mbedtls/src/x509_crt.c"
                           ;
    ...
    if( grandparent != 
# 2177 "security/mbedtls/src/x509_crt.c" 3 4
                      ((void *)0) 
# 2177 "security/mbedtls/src/x509_crt.c"
                           )
    {
    ...
    else
    {
        ...
        for( grandparent = parent->next;
             grandparent != 
# 2188 "security/mbedtls/src/x509_crt.c" 3 4
                           ((void *)0)
# 2188 "security/mbedtls/src/x509_crt.c"
                               ;
             grandparent = grandparent->next )
        {
        ...
        if( grandparent != 
# 2206 "security/mbedtls/src/x509_crt.c" 3 4
                          ((void *)0) 
# 2206 "security/mbedtls/src/x509_crt.c"
                               )
        {
    ...
    if( 
# 2225 "security/mbedtls/src/x509_crt.c" 3 4
       ((void *)0) 
# 2225 "security/mbedtls/src/x509_crt.c"
            != f_vrfy )
        if( ( ret = f_vrfy( p_vrfy, child, path_cnt, flags ) ) != 0 )
            return( ret );
...
# 2265 "security/mbedtls/src/x509_crt.c" 3 4
                                ((void *)0)
# 2265 "security/mbedtls/src/x509_crt.c"
                                    ;
    mbedtls_pk_type_t pk_type;

    if( profile == 
# 2268 "security/mbedtls/src/x509_crt.c" 3 4
                  ((void *)0) 
# 2268 "security/mbedtls/src/x509_crt.c"
                       )
        return( -0x2800 );
    ...
    *flags = 0;
    ...
    if( cn != 
# 2273 "security/mbedtls/src/x509_crt.c" 3 4
             ((void *)0) 
# 2273 "security/mbedtls/src/x509_crt.c"
                  )
    {
        name = &crt->subject;
        cn_len = strlen( cn );
        ...
        if( crt->ext_types & (1 << 5) )
        {
            ...
            while( cur != 
# 2282 "security/mbedtls/src/x509_crt.c" 3 4
                         ((void *)0) 
# 2282 "security/mbedtls/src/x509_crt.c"
                              )
            {
            ...
            if( cur == 
# 2298 "security/mbedtls/src/x509_crt.c" 3 4
                      ((void *)0) 
# 2298 "security/mbedtls/src/x509_crt.c"
                           )
                *flags |= 0x04;
        }
        else
        {
            while( name != 
# 2303 "security/mbedtls/src/x509_crt.c" 3 4
                          ((void *)0) 
# 2303 "security/mbedtls/src/x509_crt.c"
                               )
            {
            ...
            if( name == 
# 2320 "security/mbedtls/src/x509_crt.c" 3 4
                       ((void *)0) 
# 2320 "security/mbedtls/src/x509_crt.c"
                            )
                *flags |= 0x04;
        }
    }
...
# 2335 "security/mbedtls/src/x509_crt.c" 3 4
                                     ((void *)0)
# 2335 "security/mbedtls/src/x509_crt.c"
                                         ; parent = parent->next )
    {
    ...
    if( parent != 
# 2341 "security/mbedtls/src/x509_crt.c" 3 4
                 ((void *)0) 
# 2341 "security/mbedtls/src/x509_crt.c"
                      )
    {
...
# 2351 "security/mbedtls/src/x509_crt.c" 3 4
                                          ((void *)0)
# 2351 "security/mbedtls/src/x509_crt.c"
                                              ; parent = parent->next )
            if( x509_crt_check_parent( crt, parent, 0, pathlen == 0 ) == 0 )
                break;
        ...
        if( parent != 
# 2356 "security/mbedtls/src/x509_crt.c" 3 4
                     ((void *)0) 
# 2356 "security/mbedtls/src/x509_crt.c"
                          )
        {
...
void mbedtls_x509_crt_free( mbedtls_x509_crt *crt )
{
    ...
    if( crt == 
# 2398 "security/mbedtls/src/x509_crt.c" 3 4
              ((void *)0) 
# 2398 "security/mbedtls/src/x509_crt.c"
                   )
        return;
    ...
    do
    {
        ...
        while( name_cur != 
# 2410 "security/mbedtls/src/x509_crt.c" 3 4
                          ((void *)0) 
# 2410 "security/mbedtls/src/x509_crt.c"
                               )
        {
            name_prv = name_cur;
        ...
        while( name_cur != 
# 2419 "security/mbedtls/src/x509_crt.c" 3 4
                          ((void *)0) 
# 2419 "security/mbedtls/src/x509_crt.c"
                               )
        {
            name_prv = name_cur;
            name_cur = name_cur->next;
        ...
        while( seq_cur != 
# 2428 "security/mbedtls/src/x509_crt.c" 3 4
                         ((void *)0) 
# 2428 "security/mbedtls/src/x509_crt.c"
                              )
        {
            seq_prv = seq_cur;
        ...
        while( seq_cur != 
# 2437 "security/mbedtls/src/x509_crt.c" 3 4
                         ((void *)0) 
# 2437 "security/mbedtls/src/x509_crt.c"
                              )
        {
            seq_prv = seq_cur;
            seq_cur = seq_cur->next;
        ...
        if( cert_cur->raw.p != 
# 2445 "security/mbedtls/src/x509_crt.c" 3 4
                              ((void *)0) 
# 2445 "security/mbedtls/src/x509_crt.c"
                                   )
        {
    ...
    while( cert_cur != 
# 2453 "security/mbedtls/src/x509_crt.c" 3 4
                      ((void *)0) 
# 2453 "security/mbedtls/src/x509_crt.c"
                           );
    ...
    while( cert_cur != 
# 2465 "security/mbedtls/src/x509_crt.c" 3 4
                      ((void *)0) 
# 2465 "security/mbedtls/src/x509_crt.c"
                           );
}
