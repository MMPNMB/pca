# 1 "framework/fota/download/http/socket/stand/ota_socket.c"
...
# 5 "framework/fota/download/http/socket/stand/ota_socket.c" 2
...
# 6 "framework/fota/download/http/socket/stand/ota_socket.c" 2
...
# 7 "framework/fota/download/http/socket/stand/ota_socket.c" 2
...
# 8 "framework/fota/download/http/socket/stand/ota_socket.c" 2
...
# 9 "framework/fota/download/http/socket/stand/ota_socket.c" 2
...
# 11 "framework/fota/download/http/socket/stand/ota_socket.c" 2
# 1 "./framework/fota/download/http/socket/stand/../ota_socket.h" 1
# 10 "./framework/fota/download/http/socket/stand/../ota_socket.h"
...
# 12 "framework/fota/download/http/socket/stand/ota_socket.c" 2

int ota_socket_connect(int port, char *host_addr)
{
    if (host_addr == 
# 15 "framework/fota/download/http/socket/stand/ota_socket.c" 3 4
                    ((void *)0) 
# 15 "framework/fota/download/http/socket/stand/ota_socket.c"
                         || strlen(host_addr) == 0 || port <= 0) {
        do { if (aos_log_get_level() & (1 << AOS_LL_V_ERROR_BIT)) { csp_printf("[%06d]<" "E" "> ", (unsigned)aos_now_ms(), "ota_socket_connect parms   error\n ""\r\n"); csp_printf("ota_socket_connect parms   error\n ""\r\n"); csp_printf("\r\n"); } } while (0);
        return -1;
    }
    struct sockaddr_in server_addr;
    struct hostent *host;
    int sockfd;
    if ((host = lwip_gethostbyname(host_addr)) == 
# 22 "framework/fota/download/http/socket/stand/ota_socket.c" 3 4
                                            ((void *)0)
# 22 "framework/fota/download/http/socket/stand/ota_socket.c"
                                                ) {
        do { if (aos_log_get_level() & (1 << AOS_LL_V_ERROR_BIT)) { csp_printf("[%06d]<" "E" "> ", (unsigned)aos_now_ms(), "Gethostname   error,   %s\n ""\r\n", strerror(
# 23 "framework/fota/download/http/socket/stand/ota_socket.c" 3
       (*__errno())
# 23 "framework/fota/download/http/socket/stand/ota_socket.c"
       )); csp_printf("Gethostname   error,   %s\n ""\r\n", strerror(
# 23 "framework/fota/download/http/socket/stand/ota_socket.c" 3
       (*__errno())
# 23 "framework/fota/download/http/socket/stand/ota_socket.c"
       )); csp_printf("\r\n"); } } while (0);
    ...
    if ((sockfd = lwip_socket(2,1,0)) == -1) {
        do { if (aos_log_get_level() & (1 << AOS_LL_V_ERROR_BIT)) { csp_printf("[%06d]<" "E" "> ", (unsigned)aos_now_ms(), "Socket   Error:%s\a\n ""\r\n", strerror(
# 28 "framework/fota/download/http/socket/stand/ota_socket.c" 3
       (*__errno())
# 28 "framework/fota/download/http/socket/stand/ota_socket.c"
       )); csp_printf("Socket   Error:%s\a\n ""\r\n", strerror(
# 28 "framework/fota/download/http/socket/stand/ota_socket.c" 3
       (*__errno())
# 28 "framework/fota/download/http/socket/stand/ota_socket.c"
       )); csp_printf("\r\n"); } } while (0);
    ...
    if (lwip_setsockopt(sockfd,0xfff,0x1006,(char *)&timeout,sizeof(timeout))
                                     < 0) {
        do { if (aos_log_get_level() & (1 << AOS_LL_V_ERROR_BIT)) { csp_printf("[%06d]<" "E" "> ", (unsigned)aos_now_ms(), "setsockopt failed\n""\r\n"); csp_printf("setsockopt failed\n""\r\n"); csp_printf("\r\n"); } } while (0);
        goto err_out;
    }
    ...
    if (lwip_connect(sockfd,(struct sockaddr *) (&server_addr),sizeof(struct sockaddr)) == -1) {
        do { if (aos_log_get_level() & (1 << AOS_LL_V_ERROR_BIT)) { csp_printf("[%06d]<" "E" "> ", (unsigned)aos_now_ms(), "socket connecting %s failed!\n""\r\n", strerror(
# 48 "framework/fota/download/http/socket/stand/ota_socket.c" 3
       (*__errno())
# 48 "framework/fota/download/http/socket/stand/ota_socket.c"
       )); csp_printf("socket connecting %s failed!\n""\r\n", strerror(
# 48 "framework/fota/download/http/socket/stand/ota_socket.c" 3
       (*__errno())
# 48 "framework/fota/download/http/socket/stand/ota_socket.c"
       )); csp_printf("\r\n"); } } while (0);
        if (
# 49 "framework/fota/download/http/socket/stand/ota_socket.c" 3
           (*__errno()) 
# 49 "framework/fota/download/http/socket/stand/ota_socket.c"
                 != 4) {
            goto err_out;
        }
...
{
    if (socket < 0) {
        do { if (aos_log_get_level() & (1 << AOS_LL_V_ERROR_BIT)) { csp_printf("[%06d]<" "E" "> ", (unsigned)aos_now_ms(), "ota_socket_send: invalid socket fd\n""\r\n"); csp_printf("ota_socket_send: invalid socket fd\n""\r\n"); csp_printf("\r\n"); } } while (0);
        return -1;
    }
    if (buf == 
# 70 "framework/fota/download/http/socket/stand/ota_socket.c" 3 4
              ((void *)0)
# 70 "framework/fota/download/http/socket/stand/ota_socket.c"
                  ) {
        do { if (aos_log_get_level() & (1 << AOS_LL_V_ERROR_BIT)) { csp_printf("[%06d]<" "E" "> ", (unsigned)aos_now_ms(), "ota_socket_send: buf is NULL\n""\r\n"); csp_printf("ota_socket_send: buf is NULL\n""\r\n"); csp_printf("\r\n"); } } while (0);
        return -1;
    }

    return lwip_write(socket,buf,len);
}

int ota_socket_recv(int socket, char *buf, size_t len)
{
    if (socket < 0) {
        do { if (aos_log_get_level() & (1 << AOS_LL_V_ERROR_BIT)) { csp_printf("[%06d]<" "E" "> ", (unsigned)aos_now_ms(), "ota_socket_recv: invalid socket fd\n""\r\n"); csp_printf("ota_socket_recv: invalid socket fd\n""\r\n"); csp_printf("\r\n"); } } while (0);
        return -1;
    }
    if (buf == 
# 84 "framework/fota/download/http/socket/stand/ota_socket.c" 3 4
              ((void *)0)
# 84 "framework/fota/download/http/socket/stand/ota_socket.c"
                  ) {
        do { if (aos_log_get_level() & (1 << AOS_LL_V_ERROR_BIT)) { csp_printf("[%06d]<" "E" "> ", (unsigned)aos_now_ms(), "ota_socket_recv: buf is NULL\n""\r\n"); csp_printf("ota_socket_recv: buf is NULL\n""\r\n"); csp_printf("\r\n"); } } while (0);
        return -1;
    }

    return lwip_read(socket,buf,len);
}
...
{
    if (sock < 0) {
        do { if (aos_log_get_level() & (1 << AOS_LL_V_ERROR_BIT)) { csp_printf("[%06d]<" "E" "> ", (unsigned)aos_now_ms(), "ota_socket_check_conn: invalid socket fd\n""\r\n"); csp_printf("ota_socket_check_conn: invalid socket fd\n""\r\n"); csp_printf("\r\n"); } } while (0);
        return -1;
    }
# 121 "framework/fota/download/http/socket/stand/ota_socket.c"
    return 0;
}
