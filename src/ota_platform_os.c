# 1 "framework/fota/platform/ota_platform_os.c"
...
# 6 "framework/fota/platform/ota_platform_os.c" 2
# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/sys/time.h" 1 3
# 42 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/sys/time.h" 3
...
# 7 "framework/fota/platform/ota_platform_os.c" 2
...
# 9 "framework/fota/platform/ota_platform_os.c" 2
...
# 10 "framework/fota/platform/ota_platform_os.c" 2
...
void *ota_mutex_init(void)
{
    ...
    if (
# 27 "framework/fota/platform/ota_platform_os.c" 3 4
       ((void *)0) 
# 27 "framework/fota/platform/ota_platform_os.c"
            == mutex) {
        return 
# 28 "framework/fota/platform/ota_platform_os.c" 3 4
              ((void *)0)
# 28 "framework/fota/platform/ota_platform_os.c"
                  ;
    }
    ...
    if (0 != aos_mutex_new(mutex)) {
        aos_free(mutex);
        return 
# 33 "framework/fota/platform/ota_platform_os.c" 3 4
              ((void *)0)
# 33 "framework/fota/platform/ota_platform_os.c"
                  ;
    }
...
int ota_mutex_lock(void *mutex)
{
    return aos_mutex_lock((aos_mutex_t *)mutex, 0xffffffffu);
}
...
void *ota_semaphore_init(void)
{
    ...
    if (
# 59 "framework/fota/platform/ota_platform_os.c" 3 4
       ((void *)0) 
# 59 "framework/fota/platform/ota_platform_os.c"
            == sem) {
        return 
# 60 "framework/fota/platform/ota_platform_os.c" 3 4
              ((void *)0)
# 60 "framework/fota/platform/ota_platform_os.c"
                  ;
    }
    ...
    if (0 != aos_sem_new(sem, 0)) {
        aos_free(sem);
        return 
# 65 "framework/fota/platform/ota_platform_os.c" 3 4
              ((void *)0)
# 65 "framework/fota/platform/ota_platform_os.c"
                  ;
    }
...
uint32_t ota_get_time_ms(void)
{
    ...
    gettimeofday(&tv, 
# 92 "framework/fota/platform/ota_platform_os.c" 3 4
                     ((void *)0)
# 92 "framework/fota/platform/ota_platform_os.c"
                         );
