# 1 "security/mbedtls/src/cipher.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "security/mbedtls/src/cipher.c"
# 27 "security/mbedtls/src/cipher.c"
...
# 28 "security/mbedtls/src/cipher.c" 2
...
# 30 "./security/mbedtls/include/mbedtls/cipher.h"
# 1 "./security/mbedtls/include/mbedtls/config.h" 1
# 31 "./security/mbedtls/include/mbedtls/cipher.h" 2
...
int mbedtls_cipher_crypt( mbedtls_cipher_context_t *ctx,
                  ...
                  unsigned char *output, size_t *olen );
# 35 "security/mbedtls/src/cipher.c" 2
# 1 "./security/mbedtls/include/mbedtls/cipher_internal.h" 1
# 34 "./security/mbedtls/include/mbedtls/cipher_internal.h"
# 1 "./security/mbedtls/include/mbedtls/cipher.h" 1
...
# 36 "security/mbedtls/src/cipher.c" 2
...
# 38 "security/mbedtls/src/cipher.c" 2
...
# 39 "security/mbedtls/src/cipher.c" 2
...
# 42 "security/mbedtls/src/cipher.c" 2
# 57 "security/mbedtls/src/cipher.c"
...
# 58 "security/mbedtls/src/cipher.c" 2
# 68 "security/mbedtls/src/cipher.c"
...
# 99 "security/mbedtls/src/cipher.c" 3 4
                                                       ((void *)0)
# 99 "security/mbedtls/src/cipher.c"
                                                           ; def++ )
        if( def->type == cipher_type )
            return( def->info );

    return( 
# 103 "security/mbedtls/src/cipher.c" 3 4
           ((void *)0) 
# 103 "security/mbedtls/src/cipher.c"
                );
}
...
const mbedtls_cipher_info_t *mbedtls_cipher_info_from_string( const char *cipher_name )
{
    ...
    if( 
# 110 "security/mbedtls/src/cipher.c" 3 4
       ((void *)0) 
# 110 "security/mbedtls/src/cipher.c"
            == cipher_name )
        return( 
# 111 "security/mbedtls/src/cipher.c" 3 4
               ((void *)0) 
# 111 "security/mbedtls/src/cipher.c"
                    );

    for( def = mbedtls_cipher_definitions; def->info != 
# 113 "security/mbedtls/src/cipher.c" 3 4
                                                       ((void *)0)
# 113 "security/mbedtls/src/cipher.c"
                                                           ; def++ )
        if( ! strcmp( def->info->name, cipher_name ) )
            return( def->info );

    return( 
# 117 "security/mbedtls/src/cipher.c" 3 4
           ((void *)0) 
# 117 "security/mbedtls/src/cipher.c"
                );
}
                                              ...
                                              const mbedtls_cipher_mode_t mode )
{
    ...
    for( def = mbedtls_cipher_definitions; def->info != 
# 126 "security/mbedtls/src/cipher.c" 3 4
                                                       ((void *)0)
# 126 "security/mbedtls/src/cipher.c"
                                                           ; def++ )
    ...
    return( 
# 132 "security/mbedtls/src/cipher.c" 3 4
           ((void *)0) 
# 132 "security/mbedtls/src/cipher.c"
                );
}
...
{
    if( ctx == 
# 142 "security/mbedtls/src/cipher.c" 3 4
              ((void *)0) 
# 142 "security/mbedtls/src/cipher.c"
                   )
        return;
# 153 "security/mbedtls/src/cipher.c"
    if( ctx->cipher_ctx )
...
{
    if( 
# 161 "security/mbedtls/src/cipher.c" 3 4
       ((void *)0) 
# 161 "security/mbedtls/src/cipher.c"
            == cipher_info || 
# 161 "security/mbedtls/src/cipher.c" 3 4
                              ((void *)0) 
# 161 "security/mbedtls/src/cipher.c"
    ...
    if( 
# 166 "security/mbedtls/src/cipher.c" 3 4
       ((void *)0) 
# 166 "security/mbedtls/src/cipher.c"
            == ( ctx->cipher_ctx = cipher_info->base->ctx_alloc_func() ) )
        return( -0x6180 );

    ctx->cipher_info = cipher_info;
# 178 "security/mbedtls/src/cipher.c"
...
{
    if( 
# 188 "security/mbedtls/src/cipher.c" 3 4
       ((void *)0) 
# 188 "security/mbedtls/src/cipher.c"
            == ctx || 
# 188 "security/mbedtls/src/cipher.c" 3 4
                      ((void *)0) 
# 188 "security/mbedtls/src/cipher.c"
                   ...
                   const unsigned char *iv, size_t iv_len )
{
    ...
    if( 
# 223 "security/mbedtls/src/cipher.c" 3 4
       ((void *)0) 
# 223 "security/mbedtls/src/cipher.c"
            == ctx || 
# 223 "security/mbedtls/src/cipher.c" 3 4
                      ((void *)0) 
# 223 "security/mbedtls/src/cipher.c"
...
{
    if( 
# 249 "security/mbedtls/src/cipher.c" 3 4
       ((void *)0) 
# 249 "security/mbedtls/src/cipher.c"
            == ctx || 
# 249 "security/mbedtls/src/cipher.c" 3 4
                      ((void *)0) 
# 249 "security/mbedtls/src/cipher.c"
    ...
    ((mbedtls_aes_context *)(ctx->cipher_ctx))->status = 1;


    return( 0 );
}
# 278 "security/mbedtls/src/cipher.c"
int mbedtls_cipher_update( mbedtls_cipher_context_t *ctx, const unsigned char *input,
                   size_t ilen, unsigned char *output, size_t *olen )
{
    int ret;
    ...
    if( 
# 284 "security/mbedtls/src/cipher.c" 3 4
       ((void *)0) 
# 284 "security/mbedtls/src/cipher.c"
            == ctx || 
# 284 "security/mbedtls/src/cipher.c" 3 4
                      ((void *)0) 
# 284 "security/mbedtls/src/cipher.c"
...
# 317 "security/mbedtls/src/cipher.c"
    if ( 0 == block_size )
    {
        return -0x6380;
    }
...
# 459 "security/mbedtls/src/cipher.c"
    return( -0x6080 );
}
# 622 "security/mbedtls/src/cipher.c"
static int get_no_padding( unsigned char *input, size_t input_len,
                              size_t *data_len )
{
    if( 
# 625 "security/mbedtls/src/cipher.c" 3 4
       ((void *)0) 
# 625 "security/mbedtls/src/cipher.c"
            == input || 
# 625 "security/mbedtls/src/cipher.c" 3 4
                        ((void *)0) 
# 625 "security/mbedtls/src/cipher.c"
...
{
    if( 
# 637 "security/mbedtls/src/cipher.c" 3 4
       ((void *)0) 
# 637 "security/mbedtls/src/cipher.c"
            == ctx || 
# 637 "security/mbedtls/src/cipher.c" 3 4
                      ((void *)0) 
# 637 "security/mbedtls/src/cipher.c"
    ...
    *olen = 0;
    ...
    if( MBEDTLS_MODE_CBC == ctx->cipher_info->mode )
    {
        ...
        if( MBEDTLS_ENCRYPT == ctx->operation )
        {
            ...
            if( 
# 666 "security/mbedtls/src/cipher.c" 3 4
               ((void *)0) 
# 666 "security/mbedtls/src/cipher.c"
                    == ctx->add_padding )
            {
                if( 0 != ctx->unprocessed_len )
                    return( -0x6280 );
        ...
        else if( mbedtls_cipher_get_block_size( ctx ) != ctx->unprocessed_len )
        {
            ...
            if( 
# 683 "security/mbedtls/src/cipher.c" 3 4
               ((void *)0) 
# 683 "security/mbedtls/src/cipher.c"
...
{
    if( 
# 716 "security/mbedtls/src/cipher.c" 3 4
       ((void *)0) 
# 716 "security/mbedtls/src/cipher.c"
            == ctx ||
    ...
    switch( mode )
    {
# 748 "security/mbedtls/src/cipher.c"
    case MBEDTLS_PADDING_NONE:
        ctx->add_padding = 
# 749 "security/mbedtls/src/cipher.c" 3 4
                          ((void *)0)
# 749 "security/mbedtls/src/cipher.c"
                              ;
...
# 820 "security/mbedtls/src/cipher.c"
int mbedtls_cipher_crypt( mbedtls_cipher_context_t *ctx,
                  const unsigned char *iv, size_t iv_len,
                  const unsigned char *input, size_t ilen,
                  unsigned char *output, size_t *olen )
