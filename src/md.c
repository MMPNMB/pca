# 1 "security/mbedtls/src/md.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "security/mbedtls/src/md.c"
# 27 "security/mbedtls/src/md.c"
...
# 28 "security/mbedtls/src/md.c" 2
...
# 35 "security/mbedtls/src/md.c" 2
# 1 "./security/mbedtls/include/mbedtls/md_internal.h" 1
# 31 "./security/mbedtls/include/mbedtls/md_internal.h"
# 1 "./security/mbedtls/include/mbedtls/config.h" 1
# 32 "./security/mbedtls/include/mbedtls/md_internal.h" 2




# 1 "./security/mbedtls/include/mbedtls/md.h" 1
# 37 "./security/mbedtls/include/mbedtls/md_internal.h" 2
# 46 "./security/mbedtls/include/mbedtls/md_internal.h"
...
# 93 "./security/mbedtls/include/mbedtls/md_internal.h"
...
# 36 "security/mbedtls/src/md.c" 2
...
# 39 "security/mbedtls/src/md.c" 2
...
# 46 "security/mbedtls/src/md.c" 2
...
{
    if( 
# 101 "security/mbedtls/src/md.c" 3 4
       ((void *)0) 
# 101 "security/mbedtls/src/md.c"
            == md_name )
        return( 
# 102 "security/mbedtls/src/md.c" 3 4
               ((void *)0) 
# 102 "security/mbedtls/src/md.c"
                    );
# 114 "security/mbedtls/src/md.c"
    ...
    return( 
# 137 "security/mbedtls/src/md.c" 3 4
           ((void *)0) 
# 137 "security/mbedtls/src/md.c"
                );
}
...
# 153 "security/mbedtls/src/md.c"
        ...
        default:
            return( 
# 177 "security/mbedtls/src/md.c" 3 4
                   ((void *)0) 
# 177 "security/mbedtls/src/md.c"
                        );
    }
}
...
{
    if( ctx == 
# 188 "security/mbedtls/src/md.c" 3 4
              ((void *)0) 
# 188 "security/mbedtls/src/md.c"
                   || ctx->md_info == 
# 188 "security/mbedtls/src/md.c" 3 4
                                      ((void *)0) 
# 188 "security/mbedtls/src/md.c"
    ...
    if( ctx->md_ctx != 
# 191 "security/mbedtls/src/md.c" 3 4
                      ((void *)0) 
# 191 "security/mbedtls/src/md.c"
                           )
        ctx->md_info->ctx_free_func( ctx->md_ctx );

    if( ctx->hmac_ctx != 
# 194 "security/mbedtls/src/md.c" 3 4
                        ((void *)0) 
# 194 "security/mbedtls/src/md.c"
                             )
    {
...
{
    if( dst == 
# 206 "security/mbedtls/src/md.c" 3 4
              ((void *)0) 
# 206 "security/mbedtls/src/md.c"
                   || dst->md_info == 
# 206 "security/mbedtls/src/md.c" 3 4
                                      ((void *)0) 
# 206 "security/mbedtls/src/md.c"
                                           ||
        src == 
# 207 "security/mbedtls/src/md.c" 3 4
              ((void *)0) 
# 207 "security/mbedtls/src/md.c"
                   || src->md_info == 
# 207 "security/mbedtls/src/md.c" 3 4
                                      ((void *)0) 
# 207 "security/mbedtls/src/md.c"
...
{
    if( md_info == 
# 227 "security/mbedtls/src/md.c" 3 4
                  ((void *)0) 
# 227 "security/mbedtls/src/md.c"
                       || ctx == 
# 227 "security/mbedtls/src/md.c" 3 4
                                 ((void *)0) 
# 227 "security/mbedtls/src/md.c"
...
# 230 "security/mbedtls/src/md.c" 3 4
                                                      ((void *)0) 
# 230 "security/mbedtls/src/md.c"
                                                           )
        return( -0x5180 );
    ...
    if( hmac != 0 )
    {
        ...
        if( ctx->hmac_ctx == 
# 236 "security/mbedtls/src/md.c" 3 4
                            ((void *)0) 
# 236 "security/mbedtls/src/md.c"
                                 )
        {
...
{
    if( ctx == 
# 250 "security/mbedtls/src/md.c" 3 4
              ((void *)0) 
# 250 "security/mbedtls/src/md.c"
                   || ctx->md_info == 
# 250 "security/mbedtls/src/md.c" 3 4
                                      ((void *)0) 
# 250 "security/mbedtls/src/md.c"
...
{
    if( ctx == 
# 260 "security/mbedtls/src/md.c" 3 4
              ((void *)0) 
# 260 "security/mbedtls/src/md.c"
                   || ctx->md_info == 
# 260 "security/mbedtls/src/md.c" 3 4
                                      ((void *)0) 
# 260 "security/mbedtls/src/md.c"
...
{
    if( ctx == 
# 270 "security/mbedtls/src/md.c" 3 4
              ((void *)0) 
# 270 "security/mbedtls/src/md.c"
                   || ctx->md_info == 
# 270 "security/mbedtls/src/md.c" 3 4
                                      ((void *)0) 
# 270 "security/mbedtls/src/md.c"
...
{
    if( md_info == 
# 281 "security/mbedtls/src/md.c" 3 4
                  ((void *)0) 
# 281 "security/mbedtls/src/md.c"
                       )
        return( -0x5100 );
...
int mbedtls_md_hmac_starts( mbedtls_md_context_t *ctx, const unsigned char *key, size_t keylen )
{
    ...
    if( ctx == 
# 336 "security/mbedtls/src/md.c" 3 4
              ((void *)0) 
# 336 "security/mbedtls/src/md.c"
                   || ctx->md_info == 
# 336 "security/mbedtls/src/md.c" 3 4
                                      ((void *)0) 
# 336 "security/mbedtls/src/md.c"
...
{
    if( ctx == 
# 371 "security/mbedtls/src/md.c" 3 4
              ((void *)0) 
# 371 "security/mbedtls/src/md.c"
                   || ctx->md_info == 
# 371 "security/mbedtls/src/md.c" 3 4
                                      ((void *)0) 
# 371 "security/mbedtls/src/md.c"
...
int mbedtls_md_hmac_finish( mbedtls_md_context_t *ctx, unsigned char *output )
{
    ...
    if( ctx == 
# 384 "security/mbedtls/src/md.c" 3 4
              ((void *)0) 
# 384 "security/mbedtls/src/md.c"
                   || ctx->md_info == 
# 384 "security/mbedtls/src/md.c" 3 4
                                      ((void *)0) 
# 384 "security/mbedtls/src/md.c"
...
int mbedtls_md_hmac_reset( mbedtls_md_context_t *ctx )
{
    ...
    if( ctx == 
# 402 "security/mbedtls/src/md.c" 3 4
              ((void *)0) 
# 402 "security/mbedtls/src/md.c"
                   || ctx->md_info == 
# 402 "security/mbedtls/src/md.c" 3 4
                                      ((void *)0) 
# 402 "security/mbedtls/src/md.c"
                ...
                unsigned char *output )
{
    ...
    if( md_info == 
# 420 "security/mbedtls/src/md.c" 3 4
                  ((void *)0) 
# 420 "security/mbedtls/src/md.c"
                       )
        return( -0x5100 );
...
{
    if( ctx == 
# 439 "security/mbedtls/src/md.c" 3 4
              ((void *)0) 
# 439 "security/mbedtls/src/md.c"
                   || ctx->md_info == 
# 439 "security/mbedtls/src/md.c" 3 4
                                      ((void *)0) 
# 439 "security/mbedtls/src/md.c"
...
{
    if( md_info == 
# 449 "security/mbedtls/src/md.c" 3 4
                  ((void *)0) 
# 449 "security/mbedtls/src/md.c"
                       )
        return( 0 );
...
{
    if( md_info == 
# 457 "security/mbedtls/src/md.c" 3 4
                  ((void *)0) 
# 457 "security/mbedtls/src/md.c"
                       )
...
{
    if( md_info == 
# 465 "security/mbedtls/src/md.c" 3 4
                  ((void *)0) 
# 465 "security/mbedtls/src/md.c"
                       )
        return( 
# 466 "security/mbedtls/src/md.c" 3 4
               ((void *)0) 
# 466 "security/mbedtls/src/md.c"
                    );
