# 1 "framework/connectivity/mqtt/MQTTPacket/MQTTSerializePublish.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "framework/connectivity/mqtt/MQTTPacket/MQTTSerializePublish.c"
# 18 "framework/connectivity/mqtt/MQTTPacket/MQTTSerializePublish.c"
...
# 19 "framework/connectivity/mqtt/MQTTPacket/MQTTSerializePublish.c" 2
...
# 21 "framework/connectivity/mqtt/MQTTPacket/MQTTSerializePublish.c" 2
# 30 "framework/connectivity/mqtt/MQTTPacket/MQTTSerializePublish.c"
...
# 54 "framework/connectivity/mqtt/MQTTPacket/MQTTSerializePublish.c"
int MQTTSerialize_publish(unsigned char* buf, int buflen, unsigned char dup, int qos, unsigned char retained, unsigned short packetid,
  MQTTString topicName, unsigned char* payload, int payloadlen)
{
...
# 101 "framework/connectivity/mqtt/MQTTPacket/MQTTSerializePublish.c"
...
# 132 "framework/connectivity/mqtt/MQTTPacket/MQTTSerializePublish.c"
int MQTTSerialize_puback(unsigned char* buf, int buflen, unsigned short packetid)
{
 return MQTTSerialize_ack(buf, buflen, PUBACK, 0, packetid);
}
# 146 "framework/connectivity/mqtt/MQTTPacket/MQTTSerializePublish.c"
int MQTTSerialize_pubrel(unsigned char* buf, int buflen, unsigned char dup, unsigned short packetid)
{
 return MQTTSerialize_ack(buf, buflen, PUBREL, dup, packetid);
}
# 159 "framework/connectivity/mqtt/MQTTPacket/MQTTSerializePublish.c"
int MQTTSerialize_pubcomp(unsigned char* buf, int buflen, unsigned short packetid)
{
