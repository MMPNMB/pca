# 1 "kernel/protocols/net/core/def.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/core/def.c"
# 57 "kernel/protocols/net/core/def.c"
...
# 58 "kernel/protocols/net/core/def.c" 2
...
# 59 "kernel/protocols/net/core/def.c" 2
...
# 60 "kernel/protocols/net/core/def.c" 2
...
# 63 "kernel/protocols/net/core/def.c" 2
# 73 "kernel/protocols/net/core/def.c"
...
# 88 "kernel/protocols/net/core/def.c"
u32_t
lwip_htonl(u32_t n)
{
  return (u32_t)((((n) & 0xff) << 24) | (((n) & 0xff00) << 8) | (((n) & 0xff0000UL) >> 8) | (((n) & 0xff000000UL) >> 24));
}
# 104 "kernel/protocols/net/core/def.c"
char*
lwip_strnstr(const char* buffer, const char* token, size_t n)
{
  ...
  return 
# 117 "kernel/protocols/net/core/def.c" 3 4
        ((void *)0)
# 117 "kernel/protocols/net/core/def.c"
            ;
}
# 127 "kernel/protocols/net/core/def.c"
int
...
# 162 "kernel/protocols/net/core/def.c"
int
...
# 197 "kernel/protocols/net/core/def.c"
void
