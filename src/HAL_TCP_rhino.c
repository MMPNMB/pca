# 1 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c"
...
# 6 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c" 2
...
# 7 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c" 2

# 1 "./include/aos/network.h" 1
# 12 "./include/aos/network.h"
...
# 9 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c" 2
...
# 24 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c" 3 4
                                   ((void *)0)
# 24 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c"
                                       ;
    struct addrinfo *cur = 
# 25 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c" 3 4
                          ((void *)0)
# 25 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c"
                              ;
    int fd = 0;
    int rc = -1;
    char service[6];
    ...
    do { printf("RHINOSOCK %d %s() | ""establish tcp connection with server(host=%s port=%u)""\n", 32, __FUNCTION__, host, port); }while(0);;
    ...
    for (cur = addrInfoList; cur != 
# 44 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c" 3 4
                                   ((void *)0)
# 44 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c"
                                       ; cur = cur->ai_next) {
        if (cur->ai_family != 2) {
    ...
    if (-1 == rc){
        do { printf("RHINOSOCK %d %s() | ""fail to establish tcp""\n", 69, __FUNCTION__); }while(0);;
    } else {
        do { printf("RHINOSOCK %d %s() | ""success to establish tcp, fd=%d""\n", 71, __FUNCTION__, rc); }while(0);;
    }
...
# 105 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c" 3
   _types_fd_set 
# 105 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c"
          sets;
...
# 118 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c" 3
           (__extension__ (void)({ size_t __i; char *__tmp = (char *)
# 118 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c"
           &sets
# 118 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c" 3
...
# 119 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c" 3
           ((
# 119 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c"
           &sets
# 119 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c" 3
           )->fds_bits[(
# 119 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c"
...
# 119 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c"
            ...
            ret = lwip_select(fd + 1,
# 124 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c" 3 4
                 ((void *)0)
# 124 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c"
                 ,&sets,
# 124 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c" 3 4
                 ((void *)0)
# 124 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c"
            ...
            if (ret > 0) {
               if (0 == 
# 126 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c" 3
                       ((
# 126 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c"
                       &sets
# 126 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c" 3
                       )->fds_bits[(
# 126 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c"
...
# 126 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c"
                    ...
                    do { printf("RHINOSOCK %d %s() | ""Should NOT arrive""\n", 127, __FUNCTION__); }while(0);;
                ...
                if (4 == 
# 136 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c" 3
                            (*__errno())
# 136 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c"
                                 ) {
                    do { printf("RHINOSOCK %d %s() | ""EINTR be caught""\n", 137, __FUNCTION__); }while(0);;
                    continue;
                }
        ...
        if (ret > 0) {
            ...
            if (ret > 0) {
                ...
                do { printf("RHINOSOCK %d %s() | ""No data be sent""\n", 152, __FUNCTION__); }while(0);;
            } else {
                if (4 == 
# 154 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c" 3
                            (*__errno())
# 154 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c"
                                 ) {
                    do { printf("RHINOSOCK %d %s() | ""EINTR be caught""\n", 155, __FUNCTION__); }while(0);;
                    continue;
                }
...
# 175 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c" 3
   _types_fd_set 
# 175 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c"
          sets;
    struct timeval timeout;
...
# 187 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c" 3
       (__extension__ (void)({ size_t __i; char *__tmp = (char *)
# 187 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c"
       &sets
# 187 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c" 3
       ; for (__i = 0; __i < sizeof (*(
# 187 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c"
...
# 188 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c" 3
       ((
# 188 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c"
       &sets
# 188 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c" 3
       )->fds_bits[(
# 188 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c"
...
# 188 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c"
        ...
        ret = lwip_select(fd + 1,&sets,
# 193 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c" 3 4
             ((void *)0)
# 193 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c"
             ,
# 193 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c" 3 4
             ((void *)0)
# 193 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c"
             ,&timeout);
        if (ret > 0) {
            ret = lwip_recv(fd,buf + len_recv,len - len_recv,0);
            if (ret > 0) {
                len_recv += ret;
            } else if (0 == ret) {
                ...
                if (4 == 
# 203 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c" 3
                            (*__errno())
# 203 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_TCP_rhino.c"
                                 ) {
                    do { printf("RHINOSOCK %d %s() | ""EINTR be caught""\n", 204, __FUNCTION__); }while(0);;
                    continue;
                }
                perror("send fail");
                err_code = -2;
