...
# 6 "kernel/vfs/vfs.c" 2
# 1 "./kernel/vfs/include/vfs_conf.h" 1
# 7 "kernel/vfs/vfs.c" 2
# 1 "./kernel/vfs/include/vfs_err.h" 1
# 8 "kernel/vfs/vfs.c" 2
# 1 "./kernel/vfs/include/vfs_inode.h" 1
# 17 "./kernel/vfs/include/vfs_inode.h"
enum {
    VFS_TYPE_NOT_INIT,
    VFS_TYPE_CHAR_DEV,
    VFS_TYPE_BLOCK_DEV,
...
# 43 "./kernel/vfs/include/vfs_inode.h"
...
struct file_ops {
    ...
    int (*poll) (file_t *fp, 
# 77 "./kernel/vfs/include/vfs_inode.h" 3 4
                                 _Bool 
# 77 "./kernel/vfs/include/vfs_inode.h"
...
# 9 "kernel/vfs/vfs.c" 2
# 1 "./kernel/vfs/include/vfs.h" 1
# 10 "kernel/vfs/vfs.c" 2
...
# 14 "kernel/vfs/vfs.c" 2
# 1 "./kernel/vfs/include/vfs_file.h" 1
# 12 "./kernel/vfs/include/vfs_file.h"
...
int vfs_init(void)
{
    ...
    if ((ret = aos_mutex_new(&g_vfs_mutex)) != 0u) {
        return ret;
    }
...
int aos_open(const char *path, int flags)
{
    ...
    if (path == 
# 53 "kernel/vfs/vfs.c" 3 4
               ((void *)0)
# 53 "kernel/vfs/vfs.c"
                   ) {
        return -
# 54 "kernel/vfs/vfs.c" 3
               22
# 54 "kernel/vfs/vfs.c"
                     ;
    }
    ...
    len = strlen(path);
    if (len > 
# 58 "kernel/vfs/vfs.c" 3 4
             4096
# 58 "kernel/vfs/vfs.c"
                     ) {
        return -
# 59 "kernel/vfs/vfs.c" 3
               91
# 59 "kernel/vfs/vfs.c"
                           ;
    }

    if ((ret = aos_mutex_lock(&g_vfs_mutex, 0xffffffffu)) != 0) {
        return ret;
    }
...
# 74 "kernel/vfs/vfs.c"
    ...
    if (file == 
# 83 "kernel/vfs/vfs.c" 3 4
               ((void *)0)
# 83 "kernel/vfs/vfs.c"
                   ) {
        return -
# 84 "kernel/vfs/vfs.c" 3
               23
# 84 "kernel/vfs/vfs.c"
                     ;
    }
...
int aos_close(int fd)
{
    ...
    if (f == 
# 114 "kernel/vfs/vfs.c" 3 4
            ((void *)0)
# 114 "kernel/vfs/vfs.c"
                ) {



            return -
# 118 "kernel/vfs/vfs.c" 3
                   2
# 118 "kernel/vfs/vfs.c"
                         ;
...
# 125 "kernel/vfs/vfs.c" 3 4
                                        ((void *)0)
# 125 "kernel/vfs/vfs.c"
                                            ) {
...
# 131 "kernel/vfs/vfs.c" 3 4
                                       ((void *)0)
# 131 "kernel/vfs/vfs.c"
                                           ) {
...
ssize_t aos_read(int fd, void *buf, size_t nbytes)
{
    ...
    if (f == 
# 155 "kernel/vfs/vfs.c" 3 4
            ((void *)0)
# 155 "kernel/vfs/vfs.c"
                ) {



            return -
# 159 "kernel/vfs/vfs.c" 3
                   2
# 159 "kernel/vfs/vfs.c"
                         ;
...
# 166 "kernel/vfs/vfs.c" 3 4
                                       ((void *)0)
# 166 "kernel/vfs/vfs.c"
                                           ) {
            nread = (node->ops.i_fops->read)(f, buf, nbytes);
        }
    } else {
        if ((node->ops.i_ops->read) != 
# 170 "kernel/vfs/vfs.c" 3 4
                                      ((void *)0)
# 170 "kernel/vfs/vfs.c"
                                          ) {
...
ssize_t aos_write(int fd, const void *buf, size_t nbytes)
{
    ...
    if (f == 
# 186 "kernel/vfs/vfs.c" 3 4
            ((void *)0)
# 186 "kernel/vfs/vfs.c"
                ) {



            return -
# 190 "kernel/vfs/vfs.c" 3
                   2
# 190 "kernel/vfs/vfs.c"
                         ;
...
# 197 "kernel/vfs/vfs.c" 3 4
                                        ((void *)0)
# 197 "kernel/vfs/vfs.c"
                                            ) {
            nwrite = (node->ops.i_fops->write)(f, buf, nbytes);
        }
    } else {
        if ((node->ops.i_ops->write) != 
# 201 "kernel/vfs/vfs.c" 3 4
                                       ((void *)0)
# 201 "kernel/vfs/vfs.c"
                                           ) {
...
{
    int ret = -
# 211 "kernel/vfs/vfs.c" 3
              88
# 211 "kernel/vfs/vfs.c"
                    ;
    file_t *f;
    inode_t *node;
    ...
    if (fd < 0) {
        return -
# 216 "kernel/vfs/vfs.c" 3
               22
# 216 "kernel/vfs/vfs.c"
                     ;
    }
    ...
    if (f == 
# 221 "kernel/vfs/vfs.c" 3 4
            ((void *)0)
# 221 "kernel/vfs/vfs.c"
                ) {
        return -
# 222 "kernel/vfs/vfs.c" 3
               2
# 222 "kernel/vfs/vfs.c"
                     ;
    }
...
# 228 "kernel/vfs/vfs.c" 3 4
                                        ((void *)0)
# 228 "kernel/vfs/vfs.c"
                                            ) {
            ret = (node->ops.i_fops->ioctl)(f, cmd, arg);
        }
    } else {
        if ((node->ops.i_ops->ioctl) != 
# 232 "kernel/vfs/vfs.c" 3 4
                                       ((void *)0)
# 232 "kernel/vfs/vfs.c"
                                           ) {
...
off_t aos_lseek(int fd, off_t offset, int whence)
{
    ...
    inode_t *node;
    int ret = -
# 244 "kernel/vfs/vfs.c" 3
              88
# 244 "kernel/vfs/vfs.c"
                    ;

    f = get_file(fd);

    if (f == 
# 248 "kernel/vfs/vfs.c" 3 4
            ((void *)0)
# 248 "kernel/vfs/vfs.c"
                ) {
        return -
# 249 "kernel/vfs/vfs.c" 3
               2
# 249 "kernel/vfs/vfs.c"
                     ;
    }
...
# 255 "kernel/vfs/vfs.c" 3 4
                                        ((void *)0)
# 255 "kernel/vfs/vfs.c"
                                            ) {
...
int aos_sync(int fd)
{
    ...
    inode_t *node;
    int ret = -
# 267 "kernel/vfs/vfs.c" 3
              88
# 267 "kernel/vfs/vfs.c"
                    ;

    f = get_file(fd);

    if (f == 
# 271 "kernel/vfs/vfs.c" 3 4
            ((void *)0)
# 271 "kernel/vfs/vfs.c"
                ) {
        return -
# 272 "kernel/vfs/vfs.c" 3
               2
# 272 "kernel/vfs/vfs.c"
                     ;
    }
...
# 278 "kernel/vfs/vfs.c" 3 4
                                       ((void *)0)
# 278 "kernel/vfs/vfs.c"
                                           ) {
...
int aos_stat(const char *path, struct stat *st)
{
    ...
    inode_t *node;
    int err, ret = -
# 290 "kernel/vfs/vfs.c" 3
                   88
# 290 "kernel/vfs/vfs.c"
                         ;

    if (path == 
# 292 "kernel/vfs/vfs.c" 3 4
               ((void *)0)
# 292 "kernel/vfs/vfs.c"
                   ) {
        return -
# 293 "kernel/vfs/vfs.c" 3
               22
# 293 "kernel/vfs/vfs.c"
                     ;
    }

    if ((err = aos_mutex_lock(&g_vfs_mutex, 0xffffffffu)) != 0) {
        return err;
    }
    ...
    if (node == 
# 302 "kernel/vfs/vfs.c" 3 4
               ((void *)0)
# 302 "kernel/vfs/vfs.c"
                   ) {
        aos_mutex_unlock(&g_vfs_mutex);
        return -
# 304 "kernel/vfs/vfs.c" 3
               19
# 304 "kernel/vfs/vfs.c"
                     ;
    }
    ...
    if (file == 
# 311 "kernel/vfs/vfs.c" 3 4
               ((void *)0)
# 311 "kernel/vfs/vfs.c"
                   ) {
        return -
# 312 "kernel/vfs/vfs.c" 3
               2
# 312 "kernel/vfs/vfs.c"
                     ;
    }

    if (((node)->type == (VFS_TYPE_FS_DEV))) {
        if ((node->ops.i_fops->stat) != 
# 316 "kernel/vfs/vfs.c" 3 4
                                       ((void *)0)
# 316 "kernel/vfs/vfs.c"
                                           ) {
...
int aos_unlink(const char *path)
{
    ...
    inode_t *node;
    int err, ret = -
# 335 "kernel/vfs/vfs.c" 3
                   88
# 335 "kernel/vfs/vfs.c"
                         ;

    if (path == 
# 337 "kernel/vfs/vfs.c" 3 4
               ((void *)0)
# 337 "kernel/vfs/vfs.c"
                   ) {
        return -
# 338 "kernel/vfs/vfs.c" 3
               22
# 338 "kernel/vfs/vfs.c"
                     ;
    }
    ...
    if (node == 
# 347 "kernel/vfs/vfs.c" 3 4
               ((void *)0)
# 347 "kernel/vfs/vfs.c"
                   ) {
        aos_mutex_unlock(&g_vfs_mutex);
        return -
# 349 "kernel/vfs/vfs.c" 3
               19
# 349 "kernel/vfs/vfs.c"
                     ;
    }
    ...
    if (f == 
# 356 "kernel/vfs/vfs.c" 3 4
            ((void *)0)
# 356 "kernel/vfs/vfs.c"
                ) {
        return -
# 357 "kernel/vfs/vfs.c" 3
               2
# 357 "kernel/vfs/vfs.c"
                     ;
    }

    if (((node)->type == (VFS_TYPE_FS_DEV))) {
        if ((node->ops.i_fops->unlink) != 
# 361 "kernel/vfs/vfs.c" 3 4
                                         ((void *)0)
# 361 "kernel/vfs/vfs.c"
                                             ) {
...
int aos_rename(const char *oldpath, const char *newpath)
{
    ...
    inode_t *node;
    int err, ret = -
# 380 "kernel/vfs/vfs.c" 3
                   88
# 380 "kernel/vfs/vfs.c"
                         ;

    if (oldpath == 
# 382 "kernel/vfs/vfs.c" 3 4
                  ((void *)0) 
# 382 "kernel/vfs/vfs.c"
                       || newpath == 
# 382 "kernel/vfs/vfs.c" 3 4
                                     ((void *)0)
# 382 "kernel/vfs/vfs.c"
        ...
        return -
# 383 "kernel/vfs/vfs.c" 3
               22
# 383 "kernel/vfs/vfs.c"
                     ;
    }
    ...
    if (node == 
# 392 "kernel/vfs/vfs.c" 3 4
               ((void *)0)
# 392 "kernel/vfs/vfs.c"
                   ) {
        aos_mutex_unlock(&g_vfs_mutex);
        return -
# 394 "kernel/vfs/vfs.c" 3
               19
# 394 "kernel/vfs/vfs.c"
                     ;
    }
    ...
    if (f == 
# 401 "kernel/vfs/vfs.c" 3 4
            ((void *)0)
# 401 "kernel/vfs/vfs.c"
                ) {
        return -
# 402 "kernel/vfs/vfs.c" 3
               2
# 402 "kernel/vfs/vfs.c"
                     ;
    }

    if (((node)->type == (VFS_TYPE_FS_DEV))) {
        if ((node->ops.i_fops->rename) != 
# 406 "kernel/vfs/vfs.c" 3 4
                                         ((void *)0)
# 406 "kernel/vfs/vfs.c"
                                             ) {
...
aos_dir_t *aos_opendir(const char *path)
{
    ...
    inode_t *node;
    aos_dir_t *dp = 
# 425 "kernel/vfs/vfs.c" 3 4
                   ((void *)0)
# 425 "kernel/vfs/vfs.c"
                       ;

    if (path == 
# 427 "kernel/vfs/vfs.c" 3 4
               ((void *)0)
# 427 "kernel/vfs/vfs.c"
                   ) {
        return 
# 428 "kernel/vfs/vfs.c" 3 4
              ((void *)0)
# 428 "kernel/vfs/vfs.c"
                  ;
    }

    if (aos_mutex_lock(&g_vfs_mutex, 0xffffffffu) != 0) {
        return 
# 432 "kernel/vfs/vfs.c" 3 4
              ((void *)0)
# 432 "kernel/vfs/vfs.c"
                  ;
    }
    ...
    if (node == 
# 437 "kernel/vfs/vfs.c" 3 4
               ((void *)0)
# 437 "kernel/vfs/vfs.c"
                   ) {
        aos_mutex_unlock(&g_vfs_mutex);
        return 
# 439 "kernel/vfs/vfs.c" 3 4
              ((void *)0)
# 439 "kernel/vfs/vfs.c"
                  ;
    }
    ...
    if (file == 
# 446 "kernel/vfs/vfs.c" 3 4
               ((void *)0)
# 446 "kernel/vfs/vfs.c"
                   ) {
        return 
# 447 "kernel/vfs/vfs.c" 3 4
              ((void *)0)
# 447 "kernel/vfs/vfs.c"
                  ;
    }

    if (((node)->type == (VFS_TYPE_FS_DEV))) {
        if ((node->ops.i_fops->opendir) != 
# 451 "kernel/vfs/vfs.c" 3 4
                                          ((void *)0)
# 451 "kernel/vfs/vfs.c"
                                              ) {
    ...
    if (dp == 
# 456 "kernel/vfs/vfs.c" 3 4
             ((void *)0)
# 456 "kernel/vfs/vfs.c"
                 ) {
        if (aos_mutex_lock(&g_vfs_mutex, 0xffffffffu) != 0) {
            return 
# 458 "kernel/vfs/vfs.c" 3 4
                  ((void *)0)
# 458 "kernel/vfs/vfs.c"
                      ;
        }
        ...
        aos_mutex_unlock(&g_vfs_mutex);
        return 
# 464 "kernel/vfs/vfs.c" 3 4
              ((void *)0)
# 464 "kernel/vfs/vfs.c"
                  ;
    }
...
int aos_closedir(aos_dir_t *dir)
{
    ...
    inode_t *node;
    int err, ret = -
# 475 "kernel/vfs/vfs.c" 3
                   88
# 475 "kernel/vfs/vfs.c"
                         ;

    if (dir == 
# 477 "kernel/vfs/vfs.c" 3 4
              ((void *)0)
# 477 "kernel/vfs/vfs.c"
                  ) {
        return -
# 478 "kernel/vfs/vfs.c" 3
               22
# 478 "kernel/vfs/vfs.c"
                     ;
    }
    ...
    if (f == 
# 483 "kernel/vfs/vfs.c" 3 4
            ((void *)0)
# 483 "kernel/vfs/vfs.c"
                ) {
        return -
# 484 "kernel/vfs/vfs.c" 3
               2
# 484 "kernel/vfs/vfs.c"
                     ;
    }
...
# 490 "kernel/vfs/vfs.c" 3 4
                                           ((void *)0)
# 490 "kernel/vfs/vfs.c"
                                               ) {
...
aos_dirent_t *aos_readdir(aos_dir_t *dir)
{
    ...
    inode_t *node;
    aos_dirent_t *ret = 
# 510 "kernel/vfs/vfs.c" 3 4
                       ((void *)0)
# 510 "kernel/vfs/vfs.c"
                           ;

    if (dir == 
# 512 "kernel/vfs/vfs.c" 3 4
              ((void *)0)
# 512 "kernel/vfs/vfs.c"
                  ) {
        return 
# 513 "kernel/vfs/vfs.c" 3 4
              ((void *)0)
# 513 "kernel/vfs/vfs.c"
                  ;
    }

    f = get_file(dir->dd_vfs_fd);
    if (f == 
# 517 "kernel/vfs/vfs.c" 3 4
            ((void *)0)
# 517 "kernel/vfs/vfs.c"
                ) {
        return 
# 518 "kernel/vfs/vfs.c" 3 4
              ((void *)0)
# 518 "kernel/vfs/vfs.c"
                  ;
    }
...
# 524 "kernel/vfs/vfs.c" 3 4
                                          ((void *)0)
# 524 "kernel/vfs/vfs.c"
                                              ) {
    ...
    if (ret != 
# 529 "kernel/vfs/vfs.c" 3 4
              ((void *)0)
# 529 "kernel/vfs/vfs.c"
                  ) {
        return ret;
    }

    return 
# 533 "kernel/vfs/vfs.c" 3 4
          ((void *)0)
# 533 "kernel/vfs/vfs.c"
              ;
}
...
int aos_mkdir(const char *path)
{
    ...
    inode_t *node;
    int err, ret = -
# 540 "kernel/vfs/vfs.c" 3
                   88
# 540 "kernel/vfs/vfs.c"
                         ;

    if (path == 
# 542 "kernel/vfs/vfs.c" 3 4
               ((void *)0)
# 542 "kernel/vfs/vfs.c"
                   ) {
        return -
# 543 "kernel/vfs/vfs.c" 3
               22
# 543 "kernel/vfs/vfs.c"
                     ;
    }
    ...
    if (node == 
# 552 "kernel/vfs/vfs.c" 3 4
               ((void *)0)
# 552 "kernel/vfs/vfs.c"
                   ) {
        aos_mutex_unlock(&g_vfs_mutex);
        return -
# 554 "kernel/vfs/vfs.c" 3
               19
# 554 "kernel/vfs/vfs.c"
                     ;
    }
    ...
    if (file == 
# 561 "kernel/vfs/vfs.c" 3 4
               ((void *)0)
# 561 "kernel/vfs/vfs.c"
                   ) {
        return -
# 562 "kernel/vfs/vfs.c" 3
               2
# 562 "kernel/vfs/vfs.c"
                     ;
    }

    if (((node)->type == (VFS_TYPE_FS_DEV))) {
        if ((node->ops.i_fops->mkdir) != 
# 566 "kernel/vfs/vfs.c" 3 4
                                        ((void *)0)
# 566 "kernel/vfs/vfs.c"
                                            ) {
