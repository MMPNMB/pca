# 1 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_md5.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_md5.c"
# 22 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_md5.c"
...
# 20 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/stdlib.h" 2 3
...
# 23 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_md5.c" 2
...
# 24 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_md5.c" 2
...
# 25 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_md5.c" 2
...
# 26 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_md5.c" 2
...
# 27 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_md5.c" 2
# 1 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_md5.h" 1
# 28 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_md5.h"
typedef struct {
    uint32_t total[2];
    uint32_t state[4];
...
# 71 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_md5.h"
...
# 91 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_md5.h"
void utils_md5(const unsigned char *input, size_t ilen, unsigned char output[16]);


int8_t utils_hb2hex(uint8_t hb);
# 28 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_md5.c" 2
...
# 64 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_md5.c"
void utils_md5_init(iot_md5_context *ctx)
{
...
{
    if (ctx == 
# 71 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_md5.c" 3 4
              ((void *)0)
# 71 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_md5.c"
                  ) {
        return;
    }
...
# 126 "framework/protocol/linkkit/iotkit/base/utils//digest/utils_md5.c"
    A = ctx->state[0];
    B = ctx->state[1];
    C = ctx->state[2];
    D = ctx->state[3];
