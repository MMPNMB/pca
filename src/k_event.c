...
# 6 "kernel/rhino/core/k_event.c" 2
                            ...
                            uint8_t mm_alloc_flag)
{
    ...
    do { if (event == 
# 13 "kernel/rhino/core/k_event.c" 3 4
   ((void *)0)
# 13 "kernel/rhino/core/k_event.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    do { if (name == 
# 14 "kernel/rhino/core/k_event.c" 3 4
   ((void *)0)
# 14 "kernel/rhino/core/k_event.c"
   ) { return RHINO_NULL_PTR; } } while (0);
...
kstat_t krhino_event_create(kevent_t *event, const name_t *name, uint32_t flags)
{
    return event_create(event, name, flags, 1u);
}
...
kstat_t krhino_event_del(kevent_t *event)
{
    ...
    do { if (event == 
# 47 "kernel/rhino/core/k_event.c" 3 4
   ((void *)0)
# 47 "kernel/rhino/core/k_event.c"
   ) { return RHINO_NULL_PTR; } } while (0);
                                ...
                                uint32_t flags)
{
    ...
    if (event == 
# 91 "kernel/rhino/core/k_event.c" 3 4
                ((void *)0)
# 91 "kernel/rhino/core/k_event.c"
                    ) {
    ...
    if (event_obj == 
# 97 "kernel/rhino/core/k_event.c" 3 4
                    ((void *)0)
# 97 "kernel/rhino/core/k_event.c"
                        ) {
        return RHINO_NO_MEM;
    }

    stat = event_create(event_obj, name, flags, 2u);
...
kstat_t krhino_event_dyn_del(kevent_t *event)
{
    ...
    do { if (event == 
# 119 "kernel/rhino/core/k_event.c" 3 4
   ((void *)0)
# 119 "kernel/rhino/core/k_event.c"
   ) { return RHINO_NULL_PTR; } } while (0);
                         ...
                         uint32_t *actl_flags, tick_t ticks)
{
    ...
    do { if (event == 
# 166 "kernel/rhino/core/k_event.c" 3 4
   ((void *)0)
# 166 "kernel/rhino/core/k_event.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    do { if (actl_flags == 
# 167 "kernel/rhino/core/k_event.c" 3 4
   ((void *)0)
# 167 "kernel/rhino/core/k_event.c"
   ) { return RHINO_NULL_PTR; } } while (0);

    if ((opt != 0x02u) && (opt != 0x00u) && (opt != 0x03u) &&
        (opt != 0x01u)) {
...
static kstat_t event_set(kevent_t *event, uint32_t flags, uint8_t opt)
{
    ...
    while (iter != event_head) {
        task = ((ktask_t *)((uint8_t *)(iter) - (size_t)(&((ktask_t *)0)->task_list)));
        iter_temp = iter->next;

        if (task->pend_option & 0x2u) {
...
{
    do { if (event == 
# 329 "kernel/rhino/core/k_event.c" 3 4
   ((void *)0)
# 329 "kernel/rhino/core/k_event.c"
   ) { return RHINO_NULL_PTR; } } while (0);

    if ((opt != 0x02u) && (opt != 0x00u)) {
        return RHINO_NO_THIS_EVENT_OPT;
    }
