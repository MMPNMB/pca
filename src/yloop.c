...
# 40 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/sys/time.h" 3
...
# 41 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/sys/time.h" 2 3
...
# 42 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/sys/time.h" 2 3
# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/sys/_timeval.h" 1 3
# 32 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/sys/_timeval.h" 3
...
# 33 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/sys/_timeval.h" 2 3
...
# 43 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/sys/time.h" 2 3
...
# 44 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/sys/time.h" 2 3
...
# 13 "kernel/yloop/yloop.c" 2

# 1 "kernel/yloop/yloop.h" 1
...
# 21 "kernel/yloop/yloop.h" 3 4
   _Bool 
# 21 "kernel/yloop/yloop.h"
                    pending_terminate;
    
# 22 "kernel/yloop/yloop.h" 3 4
   _Bool 
# 22 "kernel/yloop/yloop.h"
                    terminate;
} yloop_ctx_t;
...
# 27 "kernel/yloop/yloop.c" 3 4
                            ((void *)0)
# 27 "kernel/yloop/yloop.c"
                                ;
...
aos_loop_t aos_loop_init(void)
{
    ...
    if (!g_main_ctx) {
        ...
        do { if (aos_log_get_level() & (1 << AOS_LL_V_ERROR_BIT)) { csp_printf("[%06d]<" "E" "> ", (unsigned)aos_now_ms(), "yloop already inited"); csp_printf("yloop already inited"); csp_printf("\r\n"); } } while (0);
        return ctx;
    }
...
int aos_poll_read_fd(int sock, aos_poll_call_t cb, void *private_data)
{
    ...
    if (new_sock == 
# 106 "kernel/yloop/yloop.c" 3 4
                   ((void *)0) 
# 106 "kernel/yloop/yloop.c"
                        || new_loop_pollfds == 
# 106 "kernel/yloop/yloop.c" 3 4
                                               ((void *)0)
# 106 "kernel/yloop/yloop.c"
                                                   ) {
        do { if (aos_log_get_level() & (1 << AOS_LL_V_ERROR_BIT)) { csp_printf("[%06d]<" "E" "> ", (unsigned)aos_now_ms(), "out of memory"); csp_printf("out of memory"); csp_printf("\r\n"); } } while (0);
        aos_free(new_sock);
...
# 113 "kernel/yloop/yloop.c" 3
                                3
# 113 "kernel/yloop/yloop.c"
                                       , 0);
    aos_fcntl(sock, 
# 114 "kernel/yloop/yloop.c" 3
                   4
# 114 "kernel/yloop/yloop.c"
                          , status | 
# 114 "kernel/yloop/yloop.c" 3
                                     0x4000
# 114 "kernel/yloop/yloop.c"
...
void aos_cancel_poll_read_fd(int sock, aos_poll_call_t action, void *param)
{
    yloop_ctx_t *ctx = get_context();
    if (ctx->readers == 
# 141 "kernel/yloop/yloop.c" 3 4
                       ((void *)0) 
# 141 "kernel/yloop/yloop.c"
                            || ctx->reader_count == 0) {
        return;
    }
...
{
    if (action == 
# 167 "kernel/yloop/yloop.c" 3 4
                 ((void *)0)
# 167 "kernel/yloop/yloop.c"
                     ) {
        return -22;
    }
    ...
    if (timeout == 
# 173 "kernel/yloop/yloop.c" 3 4
                  ((void *)0)
# 173 "kernel/yloop/yloop.c"
                      ) {
        return -12;
    }
...
void aos_loop_run(void)
{
    ...
    while (!ctx->terminate &&
        ...
        if (res < 0 && 
# 247 "kernel/yloop/yloop.c" 3
                      (*__errno()) 
# 247 "kernel/yloop/yloop.c"
                            != 4) {
            do { if (aos_log_get_level() & (1 << AOS_LL_V_ERROR_BIT)) { csp_printf("[%06d]<" "E" "> ", (unsigned)aos_now_ms(), "aos_poll"); csp_printf("aos_poll"); csp_printf("\r\n"); } } while (0);
            return;
        }
...
void aos_loop_destroy(void)
{
    ...
    if (ctx == 
# 290 "kernel/yloop/yloop.c" 3 4
              ((void *)0)
# 290 "kernel/yloop/yloop.c"
                  ) {
        return;
    }
    ...
    _set_context(
# 306 "kernel/yloop/yloop.c" 3 4
                ((void *)0)
# 306 "kernel/yloop/yloop.c"
                    );
    if (ctx == g_main_ctx) {
        g_main_ctx = 
# 308 "kernel/yloop/yloop.c" 3 4
                    ((void *)0)
# 308 "kernel/yloop/yloop.c"
                        ;
    }
    aos_free(ctx);
}
