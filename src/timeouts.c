# 1 "kernel/protocols/net/core/timeouts.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/core/timeouts.c"
# 42 "kernel/protocols/net/core/timeouts.c"
...
# 43 "kernel/protocols/net/core/timeouts.c" 2

# 1 "./kernel/protocols/net/include/lwip/timeouts.h" 1
# 42 "./kernel/protocols/net/include/lwip/timeouts.h"
...
# 43 "./kernel/protocols/net/include/lwip/timeouts.h" 2
...
# 45 "kernel/protocols/net/core/timeouts.c" 2
...
# 46 "kernel/protocols/net/core/timeouts.c" 2
...
# 50 "kernel/protocols/net/core/timeouts.c" 2

# 1 "./kernel/protocols/net/include/lwip/ip4_frag.h" 1
# 52 "kernel/protocols/net/core/timeouts.c" 2
...
# 53 "kernel/protocols/net/core/timeouts.c" 2
...
# 54 "kernel/protocols/net/core/timeouts.c" 2
# 1 "./kernel/protocols/net/include/lwip/autoip.h" 1
# 55 "kernel/protocols/net/core/timeouts.c" 2
...
void igmp_tmr(void);
# 56 "kernel/protocols/net/core/timeouts.c" 2
...
err_t dns_gethostbyname_addrtype(const char *hostname, ip_addr_t *addr,
                                   dns_found_callback found, void *callback_arg,
                                   u8_t dns_addrtype);
# 57 "kernel/protocols/net/core/timeouts.c" 2
# 1 "./kernel/protocols/net/include/lwip/nd6.h" 1
# 58 "kernel/protocols/net/core/timeouts.c" 2
# 1 "./kernel/protocols/net/include/lwip/ip6_frag.h" 1
# 59 "kernel/protocols/net/core/timeouts.c" 2
# 1 "./kernel/protocols/net/include/lwip/mld6.h" 1
# 60 "kernel/protocols/net/core/timeouts.c" 2
# 71 "kernel/protocols/net/core/timeouts.c"
const struct lwip_cyclic_timer lwip_cyclic_timers[] = {
  ...
  {1000, dns_tmr},
# 107 "kernel/protocols/net/core/timeouts.c"
};
...
# 134 "kernel/protocols/net/core/timeouts.c" 3 4
                                                  ((void *)0)
# 134 "kernel/protocols/net/core/timeouts.c"
                                                      );
  } else {
...
tcp_timer_needed(void)
{
  ...
  if (!tcpip_tcp_timer_active && (tcp_active_pcbs || tcp_tw_pcbs)) {
    ...
    sys_timeout(250, tcpip_tcp_timer, 
# 153 "kernel/protocols/net/core/timeouts.c" 3 4
                                                  ((void *)0)
# 153 "kernel/protocols/net/core/timeouts.c"
                                                      );
  }
}
...
# 203 "kernel/protocols/net/core/timeouts.c"
void
...

{
  ...
  if (timeout == 
# 211 "kernel/protocols/net/core/timeouts.c" 3 4
                ((void *)0)
# 211 "kernel/protocols/net/core/timeouts.c"
                    ) {
    ;
    return;
  }
  ...
  now = sys_now();
  if (next_timeout == 
# 217 "kernel/protocols/net/core/timeouts.c" 3 4
                     ((void *)0)
# 217 "kernel/protocols/net/core/timeouts.c"
                         ) {
    diff = 0;
  ...
  timeout->next = 
# 224 "kernel/protocols/net/core/timeouts.c" 3 4
                 ((void *)0)
# 224 "kernel/protocols/net/core/timeouts.c"
                     ;
  timeout->h = handler;
  timeout->arg = arg;
  ...
  if (next_timeout == 
# 234 "kernel/protocols/net/core/timeouts.c" 3 4
                     ((void *)0)
# 234 "kernel/protocols/net/core/timeouts.c"
                         ) {
...
# 244 "kernel/protocols/net/core/timeouts.c" 3 4
                               ((void *)0)
# 244 "kernel/protocols/net/core/timeouts.c"
                                   ; t = t->next) {
      timeout->time -= t->time;
      if (t->next == 
# 246 "kernel/protocols/net/core/timeouts.c" 3 4
                    ((void *)0) 
# 246 "kernel/protocols/net/core/timeouts.c"
                         || t->next->time > timeout->time) {
        if (t->next != 
# 247 "kernel/protocols/net/core/timeouts.c" 3 4
                      ((void *)0)
# 247 "kernel/protocols/net/core/timeouts.c"
                          ) {
          t->next->time -= timeout->time;
...
# 272 "kernel/protocols/net/core/timeouts.c"
void
sys_untimeout(sys_timeout_handler handler, void *arg)
{
  ...
  if (next_timeout == 
# 277 "kernel/protocols/net/core/timeouts.c" 3 4
                     ((void *)0)
# 277 "kernel/protocols/net/core/timeouts.c"
                         ) {
    return;
  }

  for (t = next_timeout, prev_t = 
# 281 "kernel/protocols/net/core/timeouts.c" 3 4
                                 ((void *)0)
# 281 "kernel/protocols/net/core/timeouts.c"
                                     ; t != 
# 281 "kernel/protocols/net/core/timeouts.c" 3 4
                                            ((void *)0)
# 281 "kernel/protocols/net/core/timeouts.c"
    ...
    if ((t->h == handler) && (t->arg == arg)) {
      ...
      if (prev_t == 
# 285 "kernel/protocols/net/core/timeouts.c" 3 4
                   ((void *)0)
# 285 "kernel/protocols/net/core/timeouts.c"
                       ) {
        next_timeout = t->next;
      } else {
        prev_t->next = t->next;
      ...
      if (t->next != 
# 291 "kernel/protocols/net/core/timeouts.c" 3 4
                    ((void *)0)
# 291 "kernel/protocols/net/core/timeouts.c"
                        ) {
        t->next->time += t->time;
      }
...
# 310 "kernel/protocols/net/core/timeouts.c"
static
  ...
  if (next_timeout) {
    ...
    do {
      ...
      if (tmptimeout && (tmptimeout->time <= diff)) {
        ...
        if (handler != 
# 345 "kernel/protocols/net/core/timeouts.c" 3 4
                      ((void *)0)
# 345 "kernel/protocols/net/core/timeouts.c"
                          ) {
...
sys_timeouts_sleeptime(void)
{
  u32_t diff;
  if (next_timeout == 
# 384 "kernel/protocols/net/core/timeouts.c" 3 4
                     ((void *)0)
# 384 "kernel/protocols/net/core/timeouts.c"
                         ) {
    return 0xffffffff;
  }
...
# 404 "kernel/protocols/net/core/timeouts.c"
void
