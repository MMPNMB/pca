...
# 1 "././kernel/vfs/device/../include/device/vfs_adc.h" 1
# 12 "././kernel/vfs/device/../include/device/vfs_adc.h"
...
# 13 "././kernel/vfs/device/../include/device/vfs_adc.h" 2


extern const struct file_ops adc_ops;
# 24 "././kernel/vfs/device/../include/device/vfs_adc.h"
int vfs_adc_open(inode_t *inode, file_t *fp);
# 33 "././kernel/vfs/device/../include/device/vfs_adc.h"
int vfs_adc_close(file_t *fp);
# 45 "././kernel/vfs/device/../include/device/vfs_adc.h"
ssize_t vfs_adc_read(file_t *fp, void *buf, size_t nbytes);
# 6 "kernel/vfs/device/vfs_adc.c" 2
...
# 7 "kernel/vfs/device/vfs_adc.c" 2
# 1 "././kernel/vfs/device/../include/vfs_err.h" 1
# 8 "kernel/vfs/device/vfs_adc.c" 2
...
int vfs_adc_open(inode_t *inode, file_t *fp)
{
    int ret = -1;
    adc_dev_t *adc_dev = 
# 20 "kernel/vfs/device/vfs_adc.c" 3 4
                        ((void *)0)
# 20 "kernel/vfs/device/vfs_adc.c"
                            ;


    if ((fp != 
# 23 "kernel/vfs/device/vfs_adc.c" 3 4
              ((void *)0)
# 23 "kernel/vfs/device/vfs_adc.c"
                  ) && (fp->node != 
# 23 "kernel/vfs/device/vfs_adc.c" 3 4
                                    ((void *)0)
# 23 "kernel/vfs/device/vfs_adc.c"
        ...
        ret = -
# 37 "kernel/vfs/device/vfs_adc.c" 3
              22
# 37 "kernel/vfs/device/vfs_adc.c"
                    ;
    }
...
int vfs_adc_close(file_t *fp)
{
    int ret = -1;
    adc_dev_t *adc_dev = 
# 46 "kernel/vfs/device/vfs_adc.c" 3 4
                        ((void *)0)
# 46 "kernel/vfs/device/vfs_adc.c"
                            ;


    if ((fp != 
# 49 "kernel/vfs/device/vfs_adc.c" 3 4
              ((void *)0)
# 49 "kernel/vfs/device/vfs_adc.c"
                  ) && (fp->node != 
# 49 "kernel/vfs/device/vfs_adc.c" 3 4
                                    ((void *)0)
# 49 "kernel/vfs/device/vfs_adc.c"
        ...
        ret = -
# 71 "kernel/vfs/device/vfs_adc.c" 3
              22
# 71 "kernel/vfs/device/vfs_adc.c"
                    ;
    }
...
ssize_t vfs_adc_read(file_t *fp, void *buf, size_t nbytes)
{
    int ret = -1;
    adc_dev_t *adc_dev = 
# 80 "kernel/vfs/device/vfs_adc.c" 3 4
                        ((void *)0)
# 80 "kernel/vfs/device/vfs_adc.c"
                            ;


    if ((fp != 
# 83 "kernel/vfs/device/vfs_adc.c" 3 4
              ((void *)0)
# 83 "kernel/vfs/device/vfs_adc.c"
                  ) && (fp->node != 
# 83 "kernel/vfs/device/vfs_adc.c" 3 4
                                    ((void *)0)
# 83 "kernel/vfs/device/vfs_adc.c"
        ...
        if (ret == 0) {
            ...
            ret = hal_adc_value_get(adc_dev, buf, 0xFFFFFFFFU);
        ...
        ret = -
# 105 "kernel/vfs/device/vfs_adc.c" 3
              22
# 105 "kernel/vfs/device/vfs_adc.c"
                    ;
    }
