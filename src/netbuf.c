# 1 "kernel/protocols/net/api/netbuf.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/api/netbuf.c"
# 45 "kernel/protocols/net/api/netbuf.c"
...
# 46 "kernel/protocols/net/api/netbuf.c" 2
...
# 50 "kernel/protocols/net/api/netbuf.c" 2
...
# 51 "kernel/protocols/net/api/netbuf.c" 2
...
# 53 "kernel/protocols/net/api/netbuf.c" 2
# 62 "kernel/protocols/net/api/netbuf.c"
...
netbuf *netbuf_new(void)
{
  ...
  if (buf != 
# 68 "kernel/protocols/net/api/netbuf.c" 3 4
            ((void *)0)
# 68 "kernel/protocols/net/api/netbuf.c"
                ) {
...
{
  if (buf != 
# 83 "kernel/protocols/net/api/netbuf.c" 3 4
            ((void *)0)
# 83 "kernel/protocols/net/api/netbuf.c"
                ) {
    if (buf->p != 
# 84 "kernel/protocols/net/api/netbuf.c" 3 4
                 ((void *)0)
# 84 "kernel/protocols/net/api/netbuf.c"
                     ) {
      pbuf_free(buf->p);
      buf->p = buf->ptr = 
# 86 "kernel/protocols/net/api/netbuf.c" 3 4
                         ((void *)0)
# 86 "kernel/protocols/net/api/netbuf.c"
                             ;
    }
    memp_free(MEMP_NETBUF, buf);
  }
}
# 101 "kernel/protocols/net/api/netbuf.c"
void *
netbuf_alloc(struct netbuf *buf, u16_t size)
{
  do { if (!((buf != 
# 104 "kernel/protocols/net/api/netbuf.c" 3 4
 ((void *)0)
# 104 "kernel/protocols/net/api/netbuf.c"
 ))) { do {bk_printf ("netbuf_alloc: invalid buf") ;} while(0); return 
# 104 "kernel/protocols/net/api/netbuf.c" 3 4
 ((void *)0)
# 104 "kernel/protocols/net/api/netbuf.c"
 ;;}} while(0);
  ...
  if (buf->p != 
# 107 "kernel/protocols/net/api/netbuf.c" 3 4
               ((void *)0)
# 107 "kernel/protocols/net/api/netbuf.c"
                   ) {
    pbuf_free(buf->p);
  }
  buf->p = pbuf_alloc(PBUF_TRANSPORT, size, PBUF_RAM);
  if (buf->p == 
# 111 "kernel/protocols/net/api/netbuf.c" 3 4
               ((void *)0)
# 111 "kernel/protocols/net/api/netbuf.c"
                   ) {
     return 
# 112 "kernel/protocols/net/api/netbuf.c" 3 4
           ((void *)0)
# 112 "kernel/protocols/net/api/netbuf.c"
               ;
  }
...
{
  do { if (!((buf != 
# 129 "kernel/protocols/net/api/netbuf.c" 3 4
 ((void *)0)
# 129 "kernel/protocols/net/api/netbuf.c"
 ))) { do {bk_printf ("netbuf_free: invalid buf") ;} while(0); return;;}} while(0);
  if (buf->p != 
# 130 "kernel/protocols/net/api/netbuf.c" 3 4
               ((void *)0)
# 130 "kernel/protocols/net/api/netbuf.c"
                   ) {
    pbuf_free(buf->p);
  }
  buf->p = buf->ptr = 
# 133 "kernel/protocols/net/api/netbuf.c" 3 4
                     ((void *)0)
# 133 "kernel/protocols/net/api/netbuf.c"
                         ;
}
# 146 "kernel/protocols/net/api/netbuf.c"
err_t
netbuf_ref(struct netbuf *buf, const void *dataptr, u16_t size)
{
  do { if (!((buf != 
# 149 "kernel/protocols/net/api/netbuf.c" 3 4
 ((void *)0)
# 149 "kernel/protocols/net/api/netbuf.c"
 ))) { do {bk_printf ("netbuf_ref: invalid buf") ;} while(0); return ERR_ARG;;}} while(0);
  if (buf->p != 
# 150 "kernel/protocols/net/api/netbuf.c" 3 4
               ((void *)0)
# 150 "kernel/protocols/net/api/netbuf.c"
                   ) {
    pbuf_free(buf->p);
  }
  buf->p = pbuf_alloc(PBUF_TRANSPORT, 0, PBUF_REF);
  if (buf->p == 
# 154 "kernel/protocols/net/api/netbuf.c" 3 4
               ((void *)0)
# 154 "kernel/protocols/net/api/netbuf.c"
                   ) {
    buf->ptr = 
# 155 "kernel/protocols/net/api/netbuf.c" 3 4
              ((void *)0)
# 155 "kernel/protocols/net/api/netbuf.c"
                  ;
    return ERR_MEM;
  }
...
# 171 "kernel/protocols/net/api/netbuf.c"
void
netbuf_chain(struct netbuf *head, struct netbuf *tail)
{
  do { if (!((head != 
# 174 "kernel/protocols/net/api/netbuf.c" 3 4
 ((void *)0)
# 174 "kernel/protocols/net/api/netbuf.c"
 ))) { do {bk_printf ("netbuf_chain: invalid head") ;} while(0); return;;}} while(0);
  do { if (!((tail != 
# 175 "kernel/protocols/net/api/netbuf.c" 3 4
 ((void *)0)
# 175 "kernel/protocols/net/api/netbuf.c"
 ))) { do {bk_printf ("netbuf_chain: invalid tail") ;} while(0); return;;}} while(0);
  pbuf_cat(head->p, tail->p);
  head->ptr = head->p;
  memp_free(MEMP_NETBUF, tail);
}
# 191 "kernel/protocols/net/api/netbuf.c"
err_t
netbuf_data(struct netbuf *buf, void **dataptr, u16_t *len)
{
  do { if (!((buf != 
# 194 "kernel/protocols/net/api/netbuf.c" 3 4
 ((void *)0)
# 194 "kernel/protocols/net/api/netbuf.c"
 ))) { do {bk_printf ("netbuf_data: invalid buf") ;} while(0); return ERR_ARG;;}} while(0);
  do { if (!((dataptr != 
# 195 "kernel/protocols/net/api/netbuf.c" 3 4
 ((void *)0)
# 195 "kernel/protocols/net/api/netbuf.c"
 ))) { do {bk_printf ("netbuf_data: invalid dataptr") ;} while(0); return ERR_ARG;;}} while(0);
  do { if (!((len != 
# 196 "kernel/protocols/net/api/netbuf.c" 3 4
 ((void *)0)
# 196 "kernel/protocols/net/api/netbuf.c"
 ))) { do {bk_printf ("netbuf_data: invalid len") ;} while(0); return ERR_ARG;;}} while(0);

  if (buf->ptr == 
# 198 "kernel/protocols/net/api/netbuf.c" 3 4
                 ((void *)0)
# 198 "kernel/protocols/net/api/netbuf.c"
                     ) {
    return ERR_BUF;
  }
...
# 217 "kernel/protocols/net/api/netbuf.c"
s8_t
netbuf_next(struct netbuf *buf)
{
  do { if (!((buf != 
# 220 "kernel/protocols/net/api/netbuf.c" 3 4
 ((void *)0)
# 220 "kernel/protocols/net/api/netbuf.c"
 ))) { do {bk_printf ("netbuf_next: invalid buf") ;} while(0); return -1;;}} while(0);
  if (buf->ptr->next == 
# 221 "kernel/protocols/net/api/netbuf.c" 3 4
                       ((void *)0)
# 221 "kernel/protocols/net/api/netbuf.c"
                           ) {
    return -1;
  }
  buf->ptr = buf->ptr->next;
  if (buf->ptr->next == 
# 225 "kernel/protocols/net/api/netbuf.c" 3 4
                       ((void *)0)
# 225 "kernel/protocols/net/api/netbuf.c"
                           ) {
    return 1;
  }
  return 0;
}
# 239 "kernel/protocols/net/api/netbuf.c"
void
netbuf_first(struct netbuf *buf)
{
  do { if (!((buf != 
# 242 "kernel/protocols/net/api/netbuf.c" 3 4
 ((void *)0)
# 242 "kernel/protocols/net/api/netbuf.c"
 ))) { do {bk_printf ("netbuf_first: invalid buf") ;} while(0); return;;}} while(0);
  buf->ptr = buf->p;
}
