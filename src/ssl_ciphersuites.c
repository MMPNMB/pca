# 1 "security/mbedtls/src/ssl_ciphersuites.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "security/mbedtls/src/ssl_ciphersuites.c"
# 25 "security/mbedtls/src/ssl_ciphersuites.c"
...
# 26 "security/mbedtls/src/ssl_ciphersuites.c" 2
...
# 34 "security/mbedtls/src/ssl_ciphersuites.c" 2
...
# 39 "security/mbedtls/src/ssl_ciphersuites.c" 2
...
# 40 "security/mbedtls/src/ssl_ciphersuites.c" 2
...
# 42 "security/mbedtls/src/ssl_ciphersuites.c" 2
# 55 "security/mbedtls/src/ssl_ciphersuites.c"

# 55 "security/mbedtls/src/ssl_ciphersuites.c"
static const int ciphersuite_preference[] =
{
# 150 "security/mbedtls/src/ssl_ciphersuites.c"
    0x3D,
    0x35,
# 178 "security/mbedtls/src/ssl_ciphersuites.c"
    0x3C,
    0x2F,
# 279 "security/mbedtls/src/ssl_ciphersuites.c"
    0
};

static const mbedtls_ssl_ciphersuite_t ciphersuite_definitions[] =
{
# 699 "security/mbedtls/src/ssl_ciphersuites.c"
    ...
    { 0x35, "TLS-RSA-WITH-AES-256-CBC-SHA",
      ...
      3, 3,
      0 },
# 1706 "security/mbedtls/src/ssl_ciphersuites.c"
    { 0, "",
      MBEDTLS_CIPHER_NONE, MBEDTLS_MD_NONE, MBEDTLS_KEY_EXCHANGE_NONE,
      0, 0, 0, 0, 0 }
};
# 1719 "security/mbedtls/src/ssl_ciphersuites.c"
...
# 1742 "security/mbedtls/src/ssl_ciphersuites.c" 3 4
                                                        ((void *)0) 
# 1742 "security/mbedtls/src/ssl_ciphersuites.c"
                                                             )
                                                ...
                                                const char *ciphersuite_name )
{
    ...
    if( 
# 1760 "security/mbedtls/src/ssl_ciphersuites.c" 3 4
       ((void *)0) 
# 1760 "security/mbedtls/src/ssl_ciphersuites.c"
            == ciphersuite_name )
        return( 
# 1761 "security/mbedtls/src/ssl_ciphersuites.c" 3 4
               ((void *)0) 
# 1761 "security/mbedtls/src/ssl_ciphersuites.c"
                    );
    ...
    return( 
# 1771 "security/mbedtls/src/ssl_ciphersuites.c" 3 4
           ((void *)0) 
# 1771 "security/mbedtls/src/ssl_ciphersuites.c"
                );
}
...
const mbedtls_ssl_ciphersuite_t *mbedtls_ssl_ciphersuite_from_id( int ciphersuite )
{
    ...
    return( 
# 1786 "security/mbedtls/src/ssl_ciphersuites.c" 3 4
           ((void *)0) 
# 1786 "security/mbedtls/src/ssl_ciphersuites.c"
                );
}
...
const char *mbedtls_ssl_get_ciphersuite_name( const int ciphersuite_id )
{
    ...
    if( cur == 
# 1795 "security/mbedtls/src/ssl_ciphersuites.c" 3 4
              ((void *)0) 
# 1795 "security/mbedtls/src/ssl_ciphersuites.c"
                   )
        return( "unknown" );
...
int mbedtls_ssl_get_ciphersuite_id( const char *ciphersuite_name )
{
    ...
    if( cur == 
# 1807 "security/mbedtls/src/ssl_ciphersuites.c" 3 4
              ((void *)0) 
# 1807 "security/mbedtls/src/ssl_ciphersuites.c"
                   )
        return( 0 );
