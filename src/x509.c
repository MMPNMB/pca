# 1 "security/mbedtls/src/x509.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "security/mbedtls/src/x509.c"
# 33 "security/mbedtls/src/x509.c"
...
# 34 "security/mbedtls/src/x509.c" 2
...
# 27 "./security/mbedtls/include/mbedtls/x509.h"
# 1 "./security/mbedtls/include/mbedtls/config.h" 1
# 28 "./security/mbedtls/include/mbedtls/x509.h" 2
...
# 41 "security/mbedtls/src/x509.c" 2
# 1 "./security/mbedtls/include/mbedtls/asn1.h" 1
# 42 "security/mbedtls/src/x509.c" 2
...
# 43 "security/mbedtls/src/x509.c" 2
...
# 44 "security/mbedtls/src/x509.c" 2
...
# 47 "security/mbedtls/src/x509.c" 2
...
# 50 "security/mbedtls/src/x509.c" 2
...
# 54 "security/mbedtls/src/x509.c" 2
# 86 "security/mbedtls/src/x509.c"
...
# 368 "security/mbedtls/src/x509.c"
                                     ...
                                     mbedtls_x509_name *cur )
{
    ...
    *p += val->len;
    ...
    cur->next = 
# 414 "security/mbedtls/src/x509.c" 3 4
               ((void *)0)
# 414 "security/mbedtls/src/x509.c"
                   ;

    return( 0 );
}
# 442 "security/mbedtls/src/x509.c"
int mbedtls_x509_get_name( unsigned char **p, const unsigned char *end,
                   mbedtls_x509_name *cur )
{
    int ret;
    ...
    while( 1 )
    {
        ...
        while( 1 )
        {
            ...
            if( cur->next == 
# 474 "security/mbedtls/src/x509.c" 3 4
                            ((void *)0) 
# 474 "security/mbedtls/src/x509.c"
                                 )
                return( -0x2880 );
        ...
        if( cur->next == 
# 488 "security/mbedtls/src/x509.c" 3 4
                        ((void *)0) 
# 488 "security/mbedtls/src/x509.c"
                             )
            return( -0x2880 );
                      ...
                      void **sig_opts )
{
    ...
    if( *sig_opts != 
# 672 "security/mbedtls/src/x509.c" 3 4
                    ((void *)0) 
# 672 "security/mbedtls/src/x509.c"
                         )
        return( -0x2800 );
    ...
    *pk_alg = MBEDTLS_PK_NONE;
    ...
    if( sig_oid->len == 0x09) {
        ...
        if (!memcmp(sig_oid->p, CRT_OID_PKCS1_MD5, 0x09)) {
        ...
        if (!memcmp(sig_oid->p, CRT_OID_PKCS1_SHA1, 0x09)) {
        ...
        if (!memcmp(sig_oid->p, CRT_OID_PKCS1_SHA256, 0x09)) {
    ...
    if (*md_alg == MBEDTLS_MD_NONE) {
        do { } while( 0 );
        return( -0x2600 + -0x002E );
    }
# 736 "security/mbedtls/src/x509.c"
    {
...
# 776 "security/mbedtls/src/x509.c"
    if( ( ret = mbedtls_asn1_get_tag( p, end, &len,
            0x20 | 0x10 ) ) != 0 )
        return( -0x2500 + ret );
...
# 855 "security/mbedtls/src/x509.c"
int mbedtls_x509_serial_gets( char *buf, size_t size, const mbedtls_x509_buf *serial )
{
    int ret;
    size_t i, n, nr;
...
# 936 "security/mbedtls/src/x509.c"
int mbedtls_x509_key_size_helper( char *buf, size_t buf_size, const char *name )
{
    char *p = buf;
    size_t n = buf_size;
...
# 1068 "security/mbedtls/src/x509.c"
