# 1 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c"
...
# 6 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c" 2
...
# 7 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c" 2
# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/lib/gcc/arm-none-eabi/5.4.1/include/stdarg.h" 1 3 4
# 8 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c" 2
...
# 9 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c" 2
...
# 10 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c" 2
...
# 11 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c" 2
...
# 13 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c" 2
# 1 "./framework/protocol/linkkit/iotkit/sdk-encap/imports/iot_import_product.h" 1
# 14 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c" 2
# 26 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c"
void *HAL_MutexCreate(void)
{
    aos_mutex_t mutex;
    ...
    if (0 != aos_mutex_new(&mutex)) {
        return 
# 31 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c" 3 4
              ((void *)0)
# 31 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c"
                  ;
    }
...
{
    if (
# 39 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c" 3 4
       ((void *)0) 
# 39 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c"
            != mutex) {
...
{
    if (
# 46 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c" 3 4
       ((void *)0) 
# 46 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c"
            != mutex) {
        aos_mutex_lock((aos_mutex_t *)&mutex, 0xffffffffu);
    }
}
...
{
    if (
# 53 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c" 3 4
       ((void *)0) 
# 53 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c"
            != mutex) {
...
# 115 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c" 3 4
   __builtin_va_start(
# 115 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c"
   args
# 115 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c" 3 4
   ,
# 115 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c"
...
# 117 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c" 3 4
   __builtin_va_end(
# 117 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c"
   args
# 117 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c" 3 4
   )
# 117 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c"
...
# 133 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c" 3 4
   __builtin_va_start(
# 133 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c"
   args
# 133 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c" 3 4
   ,
# 133 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c"
...
# 135 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c" 3 4
   __builtin_va_end(
# 135 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c"
   args
# 135 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c" 3 4
   )
# 135 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c"
    ...
    fflush(
# 137 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c" 3
          (_impure_ptr->_stdout)
# 137 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c"
                );
}
...
void *HAL_SemaphoreCreate(void)
{
    ...
    if (0 != aos_sem_new(&sem, 0)) {
        return 
# 160 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c" 3 4
              ((void *)0)
# 160 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c"
                  ;
    }
...
{
    if ((~0) == timeout_ms) {
        return aos_sem_wait((aos_sem_t *)&sem, 0xffffffffu);
    } else {
...
static void task_wrapper(void *arg)
{
    ...
    if (task != 
# 195 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c" 3 4
               ((void *)0)
# 195 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c"
                   ) {
        task->routine(task->arg);
        aos_free(task);
        task = 
# 198 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c" 3 4
              ((void *)0)
# 198 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c"
                  ;
    }
}
...
void HAL_ThreadDelete( void *thread_handle)
{
    if (thread_handle) {
        ...
        thread_handle = 
# 262 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c" 3 4
                       ((void *)0)
# 262 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_OS_rhino.c"
                           ;
    }
    aos_task_exit(0);
}
