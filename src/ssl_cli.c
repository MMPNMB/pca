# 1 "security/mbedtls/src/ssl_cli.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "security/mbedtls/src/ssl_cli.c"
# 23 "security/mbedtls/src/ssl_cli.c"
...
# 24 "security/mbedtls/src/ssl_cli.c" 2
...
# 32 "security/mbedtls/src/ssl_cli.c" 2
...
# 32 "./security/mbedtls/include/mbedtls/debug.h"
...
# 39 "security/mbedtls/src/ssl_cli.c" 2
# 1 "./security/mbedtls/include/mbedtls/ssl.h" 1
# 40 "security/mbedtls/src/ssl_cli.c" 2
...
# 41 "security/mbedtls/src/ssl_cli.c" 2
...
# 43 "security/mbedtls/src/ssl_cli.c" 2
# 161 "security/mbedtls/src/ssl_cli.c"
...
{
    unsigned char *p = buf;
    const unsigned char *end = ssl->out_msg + (4*1024);
...
# 230 "security/mbedtls/src/ssl_cli.c"
...
# 427 "security/mbedtls/src/ssl_cli.c"
...
# 667 "security/mbedtls/src/ssl_cli.c"
static int ssl_generate_random( mbedtls_ssl_context *ssl )
{
    int ret;
    unsigned char *p = ssl->handshake->randbytes;
# 679 "security/mbedtls/src/ssl_cli.c"
    if( ssl->conf->transport == 1 &&
        ssl->handshake->verify_cookie != 
# 680 "security/mbedtls/src/ssl_cli.c" 3 4
                                        ((void *)0) 
# 680 "security/mbedtls/src/ssl_cli.c"
                                             )
    {
        return( 0 );
    }
# 695 "security/mbedtls/src/ssl_cli.c"
...
static int ssl_write_client_hello( mbedtls_ssl_context *ssl )
{
    ...
    if( ssl->conf->f_rng == 
# 719 "security/mbedtls/src/ssl_cli.c" 3 4
                           ((void *)0) 
# 719 "security/mbedtls/src/ssl_cli.c"
                                )
    {
        do { } while( 0 );
        return( -0x7400 );
...
# 747 "security/mbedtls/src/ssl_cli.c"
    buf = ssl->out_msg;
    p = buf + 4;
    ...
    do { } while( 0 );
    p += 32;
# 779 "security/mbedtls/src/ssl_cli.c"
...
# 812 "security/mbedtls/src/ssl_cli.c"
    *p++ = (unsigned char) n;
...
# 826 "security/mbedtls/src/ssl_cli.c" 3 4
                                            ((void *)0) 
# 826 "security/mbedtls/src/ssl_cli.c"
                                                 )
        {
            do { } while( 0 );
            *p++ = 0;
    ...
    for( i = 0; ciphersuites[i] != 0; i++ )
    {
        ...
        if( ciphersuite_info == 
# 859 "security/mbedtls/src/ssl_cli.c" 3 4
                               ((void *)0) 
# 859 "security/mbedtls/src/ssl_cli.c"
                                    )
            continue;
        ...
        if( ssl->conf->transport == 1 &&
            ...
            continue;
# 884 "security/mbedtls/src/ssl_cli.c"
        do { } while( 0 )
                                                       ;
...
# 915 "security/mbedtls/src/ssl_cli.c"
    *q++ = (unsigned char)( n >> 7 );
    *q++ = (unsigned char)( n << 1 );
    ...
    offer_compress = 0;
# 933 "security/mbedtls/src/ssl_cli.c"
    if( ssl->conf->transport == 1 )
        offer_compress = 0;
...
# 971 "security/mbedtls/src/ssl_cli.c"
    ssl_write_signature_algorithms_ext( ssl, p + 2 + ext_len, &olen );
    ext_len += olen;
# 990 "security/mbedtls/src/ssl_cli.c"
    ssl_write_max_fragment_length_ext( ssl, p + 2 + ext_len, &olen );
    ext_len += olen;
# 1020 "security/mbedtls/src/ssl_cli.c"
    ((void) olen);
...
{
    int ret;
# 1081 "security/mbedtls/src/ssl_cli.c"
    {
        if( len != 1 || buf[0] != 0x00 )
        {
            do { } while( 0 );
...
# 1320 "security/mbedtls/src/ssl_cli.c"
static int ssl_parse_hello_verify_request( mbedtls_ssl_context *ssl )
{
    ...
    if( ssl->handshake->verify_cookie == 
# 1370 "security/mbedtls/src/ssl_cli.c" 3 4
                                         ((void *)0) 
# 1370 "security/mbedtls/src/ssl_cli.c"
                                              )
    {
        do { } while( 0 );
        return( -0x7F00 );
...
static int ssl_parse_server_hello( mbedtls_ssl_context *ssl )
{
    ...
    {
# 1440 "security/mbedtls/src/ssl_cli.c"
        do { } while( 0 );
        return( -0x7700 );
    }
    ...
    if( ssl->conf->transport == 1 )
    {
        ...
        else
        {
            ...
            mbedtls_free( ssl->handshake->verify_cookie );
            ssl->handshake->verify_cookie = 
# 1457 "security/mbedtls/src/ssl_cli.c" 3 4
                                           ((void *)0)
# 1457 "security/mbedtls/src/ssl_cli.c"
                                               ;
...
# 1481 "security/mbedtls/src/ssl_cli.c"
...
# 1512 "security/mbedtls/src/ssl_cli.c"
    ...
    comp = buf[37 + n];
# 1566 "security/mbedtls/src/ssl_cli.c"
    if( comp != 0 )
...
# 1578 "security/mbedtls/src/ssl_cli.c" 3 4
                                                     ((void *)0) 
# 1578 "security/mbedtls/src/ssl_cli.c"
                                                          )
    {
        do { } while( 0 );
        return( -0x7100 );
    ...
    if( suite_info == 
# 1629 "security/mbedtls/src/ssl_cli.c" 3 4
                     ((void *)0)
...
# 1634 "security/mbedtls/src/ssl_cli.c"
       )
    {
        do { } while( 0 );
        return( -0x7980 );
    ...
    while( ext_len )
    {
        ...
        case 1:
            ...
            break;
# 1803 "security/mbedtls/src/ssl_cli.c"
        default:
            do { } while( 0 )
                                     ;
        }
...
# 1851 "security/mbedtls/src/ssl_cli.c"
...
# 2015 "security/mbedtls/src/ssl_cli.c"
                                    ...
                                    size_t pms_offset )
{
    ...
    if( offset + len_bytes > (4*1024) )
    {
        do { } while( 0 );
        return( -0x6A00 );
    }
# 2036 "security/mbedtls/src/ssl_cli.c"
    mbedtls_ssl_write_version( ssl->conf->max_major_ver, ssl->conf->max_minor_ver,
                       ssl->conf->transport, p );
...
# 2047 "security/mbedtls/src/ssl_cli.c" 3 4
                                            ((void *)0) 
# 2047 "security/mbedtls/src/ssl_cli.c"
                                                 )
    {
        do { } while( 0 );
        return( -0x7700 );
...
# 2192 "security/mbedtls/src/ssl_cli.c"
static int ssl_parse_server_key_exchange( mbedtls_ssl_context *ssl )
{
    ...
    ((void) p);
    ((void) end);
# 2231 "security/mbedtls/src/ssl_cli.c"
    if( ( ret = mbedtls_ssl_read_record( ssl ) ) != 0 )
    {
        do { } while( 0 );
        return( ret );
    ...
    do { } while( 0 );
# 2330 "security/mbedtls/src/ssl_cli.c"
    {
        do { } while( 0 );
        return( -0x6C00 );
    }
# 2513 "security/mbedtls/src/ssl_cli.c"
exit:
    ssl->state++;
...
# 2548 "security/mbedtls/src/ssl_cli.c"
static int ssl_parse_certificate_request( mbedtls_ssl_context *ssl )
{
    ...
    ssl->record_read = 0;
# 2624 "security/mbedtls/src/ssl_cli.c"
    buf = ssl->in_msg;
...
# 2652 "security/mbedtls/src/ssl_cli.c"
        n += 2 + sig_alg_len;
...
static int ssl_write_client_key_exchange( mbedtls_ssl_context *ssl )
{
    ...
    do { } while( 0 );
# 2926 "security/mbedtls/src/ssl_cli.c"
    if( ciphersuite_info->key_exchange == MBEDTLS_KEY_EXCHANGE_RSA )
    {
        i = 4;
...
# 2959 "security/mbedtls/src/ssl_cli.c"
    {
...
# 3016 "security/mbedtls/src/ssl_cli.c"
...
# 3045 "security/mbedtls/src/ssl_cli.c" 3 4
                                                               ((void *)0) 
# 3045 "security/mbedtls/src/ssl_cli.c"
                                                                    )
    {
        do { } while( 0 );
        ssl->state++;
...
# 3052 "security/mbedtls/src/ssl_cli.c" 3 4
                                     ((void *)0) 
# 3052 "security/mbedtls/src/ssl_cli.c"
                                          )
    {
        do { } while( 0 );
        return( -0x7600 );
...
# 3096 "security/mbedtls/src/ssl_cli.c"
    if( ssl->minor_ver == 3 )
    {
# 3113 "security/mbedtls/src/ssl_cli.c"
...
# 3272 "security/mbedtls/src/ssl_cli.c"
int mbedtls_ssl_handshake_client_step( mbedtls_ssl_context *ssl )
{
    int ret = 0;

    if( ssl->state == MBEDTLS_SSL_HANDSHAKE_OVER || ssl->handshake == 
# 3276 "security/mbedtls/src/ssl_cli.c" 3 4
                                                                     ((void *)0) 
# 3276 "security/mbedtls/src/ssl_cli.c"
                                                                          )
        return( -0x7100 );
...
# 3303 "security/mbedtls/src/ssl_cli.c"
    switch( ssl->state )
    {
       ...
       case MBEDTLS_SSL_CLIENT_HELLO:
           ...
           break;
# 3323 "security/mbedtls/src/ssl_cli.c"
       ...
       case MBEDTLS_SSL_SERVER_HELLO_DONE:
           ...
           break;
# 3350 "security/mbedtls/src/ssl_cli.c"
       ...
       case MBEDTLS_SSL_CLIENT_FINISHED:
           ...
           break;
# 3381 "security/mbedtls/src/ssl_cli.c"
