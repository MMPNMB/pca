# 1 "security/alicrypto/./mbedtls/library/sha256.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "security/alicrypto/./mbedtls/library/sha256.c"
# 28 "security/alicrypto/./mbedtls/library/sha256.c"
...
# 29 "security/alicrypto/./mbedtls/library/sha256.c" 2
...
# 27 "./security/alicrypto/./mbedtls/include/mbedtls/sha256.h"
# 1 "./security/alicrypto/./mbedtls/include/mbedtls/config.h" 1
# 28 "./security/alicrypto/./mbedtls/include/mbedtls/sha256.h" 2
...
# 34 "./security/alicrypto/./mbedtls/include/mbedtls/sha256.h" 2
...
# 36 "security/alicrypto/./mbedtls/library/sha256.c" 2
...
# 38 "security/alicrypto/./mbedtls/library/sha256.c" 2
# 54 "security/alicrypto/./mbedtls/library/sha256.c"

# 54 "security/alicrypto/./mbedtls/library/sha256.c"
static void mbedtls_zeroize( void *v, size_t n ) {
    volatile unsigned char *p = v; while( n-- ) *p++ = 0;
}
# 81 "security/alicrypto/./mbedtls/library/sha256.c"
void mbedtls_sha256_init( mbedtls_sha256_context *ctx )
{
...
{
    if( ctx == 
# 88 "security/alicrypto/./mbedtls/library/sha256.c" 3 4
              ((void *)0) 
# 88 "security/alicrypto/./mbedtls/library/sha256.c"
                   )
        return;
...
# 182 "security/alicrypto/./mbedtls/library/sha256.c"
void mbedtls_sha256_process( mbedtls_sha256_context *ctx, const unsigned char data[64] )
{
    ...
    for( i = 0; i < 8; i++ )
        A[i] = ctx->state[i];
# 205 "security/alicrypto/./mbedtls/library/sha256.c"
    for( i = 0; i < 16; i++ )
