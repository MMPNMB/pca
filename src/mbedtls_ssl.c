# 1 "security/mbedtls/src/mbedtls_ssl.c"
...
# 2 "security/mbedtls/src/mbedtls_ssl.c" 2
...
# 3 "security/mbedtls/src/mbedtls_ssl.c" 2
...
# 4 "security/mbedtls/src/mbedtls_ssl.c" 2
...
# 5 "security/mbedtls/src/mbedtls_ssl.c" 2
...
# 6 "security/mbedtls/src/mbedtls_ssl.c" 2
...
# 7 "security/mbedtls/src/mbedtls_ssl.c" 2
...
# 9 "./security/alicrypto/./libalicrypto/inc/ali_crypto_types.h"
# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/lib/gcc/arm-none-eabi/5.4.1/include/stddef.h" 1 3 4
...
# 9 "security/mbedtls/src/mbedtls_ssl.c" 2
...
# 10 "security/mbedtls/src/mbedtls_ssl.c" 2
# 1 "./security/mbedtls/include/mbedtls/debug.h" 1
# 27 "./security/mbedtls/include/mbedtls/debug.h"
# 1 "./security/mbedtls/include/mbedtls/config.h" 1
# 28 "./security/mbedtls/include/mbedtls/debug.h" 2
...
# 33 "./security/mbedtls/include/mbedtls/debug.h" 2
...
# 11 "security/mbedtls/src/mbedtls_ssl.c" 2
# 1 "./security/mbedtls/include/mbedtls/ssl.h" 1
# 12 "security/mbedtls/src/mbedtls_ssl.c" 2
# 1 "./security/mbedtls/include/mbedtls/x509_crt.h" 1
# 13 "security/mbedtls/src/mbedtls_ssl.c" 2
# 1 "./security/mbedtls/include/mbedtls/net_sockets.h" 1
# 34 "./security/mbedtls/include/mbedtls/net_sockets.h"
# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/lib/gcc/arm-none-eabi/5.4.1/include/stddef.h" 1 3 4
...
# 14 "security/mbedtls/src/mbedtls_ssl.c" 2
...
# 11 "./security/mbedtls/include/mbedtls/threading_alt.h"
typedef struct
{
    aos_mutex_t mutex;
    char is_valid;
...
# 17 "security/mbedtls/src/mbedtls_ssl.c" 2
...
static int ssl_random(void *prng, unsigned char *output, size_t output_len)
{
    ...
    gettimeofday(&tv, 
# 38 "security/mbedtls/src/mbedtls_ssl.c" 3 4
                     ((void *)0)
# 38 "security/mbedtls/src/mbedtls_ssl.c"
                         );
...
# 58 "security/mbedtls/src/mbedtls_ssl.c"
void *mbedtls_ssl_connect(void *tcp_fd, const char *ca_cert, int ca_cert_len)
{
    int ret;
    unsigned int result;
    ssl_param_t *ssl_param = 
# 62 "security/mbedtls/src/mbedtls_ssl.c" 3 4
                            ((void *)0)
# 62 "security/mbedtls/src/mbedtls_ssl.c"
                                ;

    if (ca_cert == 
# 64 "security/mbedtls/src/mbedtls_ssl.c" 3 4
                  ((void *)0) 
# 64 "security/mbedtls/src/mbedtls_ssl.c"
                       || ca_cert_len <= 0) {
        printf("ssl_connect: invalid input args!\n");
        return 
# 66 "security/mbedtls/src/mbedtls_ssl.c" 3 4
              ((void *)0)
# 66 "security/mbedtls/src/mbedtls_ssl.c"
                  ;
    }
    ...
    if ((int)tcp_fd < 0) {
        ...
        return 
# 71 "security/mbedtls/src/mbedtls_ssl.c" 3 4
              ((void *)0)
# 71 "security/mbedtls/src/mbedtls_ssl.c"
                  ;
    }
    ...
    if (
# 86 "security/mbedtls/src/mbedtls_ssl.c" 3 4
       ((void *)0) 
# 86 "security/mbedtls/src/mbedtls_ssl.c"
            == ssl_param) {
        printf("ssl_connect: malloc(%d) fail\n", sizeof(ssl_param_t));
        return 
# 88 "security/mbedtls/src/mbedtls_ssl.c" 3 4
              ((void *)0)
# 88 "security/mbedtls/src/mbedtls_ssl.c"
                  ;
    } else {
...
# 119 "security/mbedtls/src/mbedtls_ssl.c"
...
# 137 "security/mbedtls/src/mbedtls_ssl.c"
...
# 152 "security/mbedtls/src/mbedtls_ssl.c" 3 4
                                                                    ((void *)0)
# 152 "security/mbedtls/src/mbedtls_ssl.c"
                                                                        );
    mbedtls_ssl_conf_rng(&ssl_param->conf, ssl_random, 
# 153 "security/mbedtls/src/mbedtls_ssl.c" 3 4
                                                      ((void *)0)
# 153 "security/mbedtls/src/mbedtls_ssl.c"
                                                          );
...
# 173 "security/mbedtls/src/mbedtls_ssl.c" 3 4
                                                                                             ((void *)0)
# 173 "security/mbedtls/src/mbedtls_ssl.c"
                                                                                                 );
# 182 "security/mbedtls/src/mbedtls_ssl.c"
...
# 200 "security/mbedtls/src/mbedtls_ssl.c"
...
_err:
    if (ssl_param != 
# 213 "security/mbedtls/src/mbedtls_ssl.c" 3 4
                    ((void *)0)
# 213 "security/mbedtls/src/mbedtls_ssl.c"
                        ) {
        ...
        free(ssl_param);
        ssl_param = 
# 220 "security/mbedtls/src/mbedtls_ssl.c" 3 4
                   ((void *)0)
# 220 "security/mbedtls/src/mbedtls_ssl.c"
                       ;
    }

    return 
# 223 "security/mbedtls/src/mbedtls_ssl.c" 3 4
          ((void *)0)
# 223 "security/mbedtls/src/mbedtls_ssl.c"
              ;
}
...
int mbedtls_ssl_send(void *ssl, const char *buffer, int length)
{
    ...
    if (ssl == 
# 233 "security/mbedtls/src/mbedtls_ssl.c" 3 4
              ((void *)0) 
# 233 "security/mbedtls/src/mbedtls_ssl.c"
                   || buffer == 
# 233 "security/mbedtls/src/mbedtls_ssl.c" 3 4
                                ((void *)0) 
# 233 "security/mbedtls/src/mbedtls_ssl.c"
...
# 293 "security/mbedtls/src/mbedtls_ssl.c"
...
int mbedtls_ssl_recv(void *ssl, char *buffer, int length)
{
    ...
    if (ssl == 
# 302 "security/mbedtls/src/mbedtls_ssl.c" 3 4
              ((void *)0) 
# 302 "security/mbedtls/src/mbedtls_ssl.c"
                   || buffer == 
# 302 "security/mbedtls/src/mbedtls_ssl.c" 3 4
                                ((void *)0) 
# 302 "security/mbedtls/src/mbedtls_ssl.c"
...
# 360 "security/mbedtls/src/mbedtls_ssl.c"
    return total_len;
}
...
int mbedtls_ssl_close(void *ssl)
{
    ...
    if (ssl == 
# 367 "security/mbedtls/src/mbedtls_ssl.c" 3 4
              ((void *)0)
# 367 "security/mbedtls/src/mbedtls_ssl.c"
                  ) {
        return 0;
    }
