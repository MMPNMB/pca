# 1 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
# 19 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
...
# 20 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 2
...
# 21 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 2
...
# 22 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 2


# 1 "./security/mbedtls/include/mbedtls/error.h" 1
# 26 "./security/mbedtls/include/mbedtls/error.h"
# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/lib/gcc/arm-none-eabi/5.4.1/include/stddef.h" 1 3 4
# 27 "./security/mbedtls/include/mbedtls/error.h" 2
# 101 "./security/mbedtls/include/mbedtls/error.h"

# 101 "./security/mbedtls/include/mbedtls/error.h"
void mbedtls_strerror( int errnum, char *buffer, size_t buflen );
# 25 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 2
# 1 "./security/mbedtls/include/mbedtls/ssl.h" 1
# 27 "./security/mbedtls/include/mbedtls/ssl.h"
...
# 28 "./security/mbedtls/include/mbedtls/ssl.h" 2
...
# 26 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 2
# 1 "./security/mbedtls/include/mbedtls/net.h" 1
# 27 "./security/mbedtls/include/mbedtls/net.h"
# 1 "./security/mbedtls/include/mbedtls/net_sockets.h" 1
# 32 "./security/mbedtls/include/mbedtls/net_sockets.h"
# 1 "./security/mbedtls/include/mbedtls/ssl.h" 1
# 33 "./security/mbedtls/include/mbedtls/net_sockets.h" 2

# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/lib/gcc/arm-none-eabi/5.4.1/include/stddef.h" 1 3 4
# 35 "./security/mbedtls/include/mbedtls/net_sockets.h" 2
# 65 "./security/mbedtls/include/mbedtls/net_sockets.h"
typedef struct
{
    int fd;
}
...
# 94 "./security/mbedtls/include/mbedtls/net_sockets.h"
int mbedtls_net_connect( mbedtls_net_context *ctx, const char *host, const char *port, int proto );
# 113 "./security/mbedtls/include/mbedtls/net_sockets.h"
int mbedtls_net_bind( mbedtls_net_context *ctx, const char *bind_ip, const char *port, int proto );
# 130 "./security/mbedtls/include/mbedtls/net_sockets.h"
int mbedtls_net_accept( mbedtls_net_context *bind_ctx,
                        mbedtls_net_context *client_ctx,
                        void *client_ip, size_t buf_size, size_t *ip_len );
# 141 "./security/mbedtls/include/mbedtls/net_sockets.h"
int mbedtls_net_set_block( mbedtls_net_context *ctx );
# 150 "./security/mbedtls/include/mbedtls/net_sockets.h"
int mbedtls_net_set_nonblock( mbedtls_net_context *ctx );
# 160 "./security/mbedtls/include/mbedtls/net_sockets.h"
void mbedtls_net_usleep( unsigned long usec );
# 174 "./security/mbedtls/include/mbedtls/net_sockets.h"
int mbedtls_net_recv( void *ctx, unsigned char *buf, size_t len );
# 188 "./security/mbedtls/include/mbedtls/net_sockets.h"
int mbedtls_net_send( void *ctx, const unsigned char *buf, size_t len );
# 211 "./security/mbedtls/include/mbedtls/net_sockets.h"
...
# 28 "./security/mbedtls/include/mbedtls/net.h" 2
# 27 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 2
# 1 "./security/mbedtls/include/mbedtls/x509_crt.h" 1
# 28 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 2
# 1 "./security/mbedtls/include/mbedtls/pk.h" 1
# 29 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 2
# 1 "./security/mbedtls/include/mbedtls/debug.h" 1
# 103 "./security/mbedtls/include/mbedtls/debug.h"
void mbedtls_debug_set_threshold( int threshold );
# 120 "./security/mbedtls/include/mbedtls/debug.h"
void mbedtls_debug_print_msg( const mbedtls_ssl_context *ssl, int level,
                              const char *file, int line,
                              const char *format, ... );
# 139 "./security/mbedtls/include/mbedtls/debug.h"
void mbedtls_debug_print_ret( const mbedtls_ssl_context *ssl, int level,
                      const char *file, int line,
                      const char *text, int ret );
# 160 "./security/mbedtls/include/mbedtls/debug.h"
void mbedtls_debug_print_buf( const mbedtls_ssl_context *ssl, int level,
                      const char *file, int line, const char *text,
                      const unsigned char *buf, size_t len );
# 224 "./security/mbedtls/include/mbedtls/debug.h"
...
# 30 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 2
...
# 9 "./security/mbedtls/include/mbedtls/platform_alt.h"
...
# 37 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/time.h" 3
struct tm
{
  int tm_sec;
  int tm_min;
...
# 31 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 2
# 1 "./framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/lite-utils.h" 1
# 27 "./framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/lite-utils.h"
# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/lib/gcc/arm-none-eabi/5.4.1/include/stdarg.h" 1 3 4
# 28 "./framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/lite-utils.h" 2
# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/lib/gcc/arm-none-eabi/5.4.1/include/stddef.h" 1 3 4
...
# 32 "./framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log.h"
...
# 35 "./framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/lite-utils.h" 2
...
# 32 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 2
...
# 34 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 2
...
# 55 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
static int ssl_fd = -1;
...
static void _ssl_debug(void *ctx, int level, const char *file, int line, const char *str)
{
    ((void) level);
    if (
# 85 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3 4
       ((void *)0) 
# 85 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
            != ctx) {
...
{
    do { HAL_Printf("[inf] %s(%d): ""certificate verification result: 0x%02x""\n", __FUNCTION__, 93, verify_result); fflush(
# 93 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
   (_impure_ptr->_stdout)
# 93 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
   ); }while(0);;
# 117 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
    return 0;
}
...
static int _ssl_parse_crt(mbedtls_x509_crt *crt)
{
    ...
    while (local_crt) {
        ...
        do { HAL_Printf("[inf] %s(%d): ""crt content:%u""\n", __FUNCTION__, 144, (uint32_t)strlen(buf)); fflush(
# 144 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
       (_impure_ptr->_stdout)
# 144 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
       ); }while(0);;
                           ...
                           )
{
    ...
    do { HAL_Printf("[inf] %s(%d): ""Loading the CA root certificate ...""\n", __FUNCTION__, 176); fflush(
# 176 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
   (_impure_ptr->_stdout)
# 176 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
   ); }while(0);;
    if (
# 177 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3 4
       ((void *)0) 
# 177 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
            != ca_crt) {
        if (0 != (ret = mbedtls_x509_crt_parse(crt509_ca, (const unsigned char *)ca_crt, ca_len))) {
            do { HAL_Printf("[inf] %s(%d): "" failed ! x509parse_crt returned -0x%04x""\n", __FUNCTION__, 179, -ret); fflush(
# 179 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
           (_impure_ptr->_stdout)
# 179 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
           ); }while(0);;
            return ret;
        }
    }
    _ssl_parse_crt(crt509_ca);
    do { HAL_Printf("[inf] %s(%d): "" ok (%d skipped)""\n", __FUNCTION__, 184, ret); fflush(
# 184 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
   (_impure_ptr->_stdout)
# 184 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
   ); }while(0);;
# 193 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
    if (cli_crt != 
# 193 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3 4
                  ((void *)0) 
# 193 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
                       && cli_key != 
# 193 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3 4
...
# 193 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
        ...
        {
            ret = 1;
            do { HAL_Printf("[inf] %s(%d): ""MBEDTLS_CERTS_C not defined.""\n", __FUNCTION__, 200); fflush(
# 200 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
           (_impure_ptr->_stdout)
# 200 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
           ); }while(0);;
        }

        if (ret != 0) {
            do { HAL_Printf("[inf] %s(%d): "" failed!  mbedtls_x509_crt_parse returned -0x%x\n""\n", __FUNCTION__, 204, -ret); fflush(
# 204 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
           (_impure_ptr->_stdout)
# 204 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
           ); }while(0);;
            return ret;
        }
        ...
        if (ret != 0) {
            do { HAL_Printf("[inf] %s(%d): "" failed\n  !  mbedtls_pk_parse_key returned -0x%x\n""\n", __FUNCTION__, 214, -ret); fflush(
# 214 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
           (_impure_ptr->_stdout)
# 214 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
           ); }while(0);;
            return ret;
        }
    }
...
# 319 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
                              ...
                              const char *client_pwd, size_t client_pwd_len)
{
    ...
    if (0 != (ret = _ssl_client_init(&(pTlsData->ssl), &(pTlsData->fd), &(pTlsData->conf),
        ...
        do { HAL_Printf("[inf] %s(%d): "" failed ! ssl_client_init returned -0x%04x""\n", __FUNCTION__, 333, -ret); fflush(
# 333 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
       (_impure_ptr->_stdout)
# 333 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
       ); }while(0);;
        return ret;
    }
    ...
    do { HAL_Printf("[inf] %s(%d): ""Connecting to /%s/%s...""\n", __FUNCTION__, 340, addr, port); fflush(
# 340 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
   (_impure_ptr->_stdout)
# 340 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
   ); }while(0);;
    ...
    if (0 != (ret = mbedtls_net_connect(&(pTlsData->fd), addr, port, 0))) {
        do { HAL_Printf("[inf] %s(%d): "" failed ! net_connect returned -0x%04x""\n", __FUNCTION__, 349, -ret); fflush(
# 349 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
       (_impure_ptr->_stdout)
# 349 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
       ); }while(0);;
        return ret;
    }
    ...
    do { HAL_Printf("[inf] %s(%d): ""  . Setting up the SSL/TLS structure...""\n", __FUNCTION__, 357); fflush(
# 357 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
   (_impure_ptr->_stdout)
# 357 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
   ); }while(0);;
    if ((ret = mbedtls_ssl_config_defaults(&(pTlsData->conf), 0, 0,
                                           0)) != 0) {
        do { HAL_Printf("[inf] %s(%d): "" failed! mbedtls_ssl_config_defaults returned %d""\n", __FUNCTION__, 360, ret); fflush(
# 360 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
       (_impure_ptr->_stdout)
# 360 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
       ); }while(0);;
        return ret;
    }

    mbedtls_ssl_conf_max_version(&pTlsData->conf, 3, 3);
    mbedtls_ssl_conf_min_version(&pTlsData->conf, 3, 3);

    do { HAL_Printf("[inf] %s(%d): "" ok""\n", __FUNCTION__, 367); fflush(
# 367 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
   (_impure_ptr->_stdout)
# 367 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
   ); }while(0);;


    if (ca_crt != 
# 370 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3 4
                 ((void *)0)
# 370 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
                     ) {



        mbedtls_ssl_conf_authmode(&(pTlsData->conf), 1);

    } else {
        mbedtls_ssl_conf_authmode(&(pTlsData->conf), 0);
    }


    mbedtls_ssl_conf_ca_chain(&(pTlsData->conf), &(pTlsData->cacertl), 
# 381 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3 4
                                                                      ((void *)0)
# 381 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
                                                                          );

    if ((ret = mbedtls_ssl_conf_own_cert(&(pTlsData->conf), &(pTlsData->clicert), &(pTlsData->pkey))) != 0) {
        do { HAL_Printf("[inf] %s(%d): "" failed\n  ! mbedtls_ssl_conf_own_cert returned %d\n""\n", __FUNCTION__, 384, ret); fflush(
# 384 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
       (_impure_ptr->_stdout)
# 384 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
       ); }while(0);;
        return ret;
    }

    mbedtls_ssl_conf_rng(&(pTlsData->conf), _ssl_random, 
# 388 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3 4
                                                        ((void *)0)
# 388 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
                                                            );
    mbedtls_ssl_conf_dbg(&(pTlsData->conf), _ssl_debug, 
# 389 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3 4
                                                       ((void *)0)
# 389 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
                                                           );


    if ((ret = mbedtls_ssl_setup(&(pTlsData->ssl), &(pTlsData->conf))) != 0) {
        do { HAL_Printf("[inf] %s(%d): ""failed! mbedtls_ssl_setup returned %d""\n", __FUNCTION__, 393, ret); fflush(
# 393 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
       (_impure_ptr->_stdout)
# 393 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
       ); }while(0);;
        return ret;
    }
    ...
    do { HAL_Printf("[inf] %s(%d): ""Performing the SSL/TLS handshake...""\n", __FUNCTION__, 402); fflush(
# 402 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
   (_impure_ptr->_stdout)
# 402 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
   ); }while(0);;

    while ((ret = mbedtls_ssl_handshake(&(pTlsData->ssl))) != 0) {
        if ((ret != -0x6900) && (ret != -0x6880)) {
            do { HAL_Printf("[inf] %s(%d): ""failed  ! mbedtls_ssl_handshake returned -0x%04x""\n", __FUNCTION__, 406, -ret); fflush(
# 406 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
           (_impure_ptr->_stdout)
# 406 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
           ); }while(0);;
            return ret;
        }
    }
    do { HAL_Printf("[inf] %s(%d): "" ok""\n", __FUNCTION__, 410); fflush(
# 410 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
   (_impure_ptr->_stdout)
# 410 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
   ); }while(0);;



    do { HAL_Printf("[inf] %s(%d): ""  . Verifying peer X.509 certificate..""\n", __FUNCTION__, 414); fflush(
# 414 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
   (_impure_ptr->_stdout)
# 414 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
   ); }while(0);;
    if (0 != (ret = _real_confirm(mbedtls_ssl_get_verify_result(&(pTlsData->ssl))))) {
        do { HAL_Printf("[inf] %s(%d): "" failed  ! verify result not confirmed.""\n", __FUNCTION__, 416); fflush(
# 416 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
       (_impure_ptr->_stdout)
# 416 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
       ); }while(0);;
        return ret;
    }
...
# 427 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 2

# 427 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
    ...
    while (readLen < len) {
        ...
        if (ret > 0) {
            ...
            if (-0x7880 == ret) {
                ...
                do { HAL_Printf("[inf] %s(%d): ""ssl recv error: code = %d, err_str = '%s'""\n", __FUNCTION__, 446, ret, err_str); fflush(
# 446 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
               (_impure_ptr->_stdout)
# 446 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
               ); }while(0);;
                net_status = -2;
                break;
            } else if ((-0x6800 == ret)
                ...
                do { HAL_Printf("[inf] %s(%d): ""ssl recv error: code = %d, err_str = '%s'""\n", __FUNCTION__, 459, ret, err_str); fflush(
# 459 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
               (_impure_ptr->_stdout)
# 459 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
               ); }while(0);;
...
static int _network_ssl_write(TLSDataParams_t *pTlsData, const char *buffer, int len, int timeout_ms)
{
    ...
    while (writtenLen < len) {
        ...
        if (ret > 0) {
            ...
            do { HAL_Printf("[inf] %s(%d): ""ssl write timeout""\n", __FUNCTION__, 486); fflush(
# 486 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
           (_impure_ptr->_stdout)
# 486 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
           ); }while(0);;
            return 0;
        } else {
            char err_str[33];

            do { HAL_Printf("[inf] %s(%d): ""ssl write fail, code=%d, str=%s""\n", __FUNCTION__, 491, ret, err_str); fflush(
# 491 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
           (_impure_ptr->_stdout)
# 491 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
           ); }while(0);;
            return -1;
        }
    }
...
static void _network_ssl_disconnect(TLSDataParams_t *pTlsData)
{
    ...
    if ((pTlsData->pkey).pk_info != 
# 505 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3 4
                                   ((void *)0)
# 505 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
                                       ) {
        do { HAL_Printf("[inf] %s(%d): ""need release client crt&key""\n", __FUNCTION__, 506); fflush(
# 506 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
       (_impure_ptr->_stdout)
# 506 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
       ); }while(0);;
    ...
    do { HAL_Printf("[inf] %s(%d): ""ssl_disconnect""\n", __FUNCTION__, 515); fflush(
# 515 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
   (_impure_ptr->_stdout)
# 515 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
   ); }while(0);;
}
...
int32_t HAL_SSL_GetFd(uintptr_t handle)
{
    int32_t fd = -1;
    if ((uintptr_t)
# 521 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3 4
                  ((void *)0) 
# 521 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
                       == handle) {
        do { HAL_Printf("[inf] %s(%d): ""handle is NULL""\n", __FUNCTION__, 522); fflush(
# 522 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
       (_impure_ptr->_stdout)
# 522 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
       ); }while(0);;
        return fd;
    }
...
int32_t HAL_SSL_Destroy(uintptr_t handle)
{
    ...
    if ((uintptr_t)
# 544 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3 4
                  ((void *)0) 
# 544 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
                       == handle) {
        do { HAL_Printf("[inf] %s(%d): ""handle is NULL""\n", __FUNCTION__, 545); fflush(
# 545 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3
       (_impure_ptr->_stdout)
# 545 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
       ); }while(0);;
        return 0;
    }
    ...
    ptr = (void *)handle;
    do { if(!ptr) { LITE_syslog(__FUNCTION__, 551, LOG_ERR_LEVEL, "%s == NULL! LITE_free(%s) aborted.", "ptr", "ptr"); break; } LITE_free_internal((void *)ptr); ptr = 
# 551 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3 4
   ((void *)0)
# 551 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
   ; } while(0);
                            ...
                            size_t ca_crt_len)
{
    ...
    pTlsData = LITE_malloc_internal(__func__, 566, sizeof(TLSDataParams_t), (0x1234), "HAL");
    if (
# 567 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3 4
       ((void *)0) 
# 567 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
            == pTlsData) {
        return (uintptr_t)
# 568 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3 4
                         ((void *)0)
# 568 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
                             ;
    }
...
# 573 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3 4
                                                                             ((void *)0)
# 573 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
                                                                                 , 0, 
# 573 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3 4
                                                                                      ((void *)0)
# 573 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
...
# 573 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
        ...
        if (pTlsData->ssl.hostname) {
            ...
            pTlsData->ssl.hostname = 
# 578 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3 4
                                    ((void *)0)
# 578 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
                                        ;
        }
        do { if(!pTlsData) { LITE_syslog(__FUNCTION__, 580, LOG_ERR_LEVEL, "%s == NULL! LITE_free(%s) aborted.", "pTlsData", "pTlsData"); break; } LITE_free_internal((void *)pTlsData); pTlsData = 
# 580 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c" 3 4
       ((void *)0)
# 580 "framework/protocol/linkkit/iotkit/hal-impl/tls/mbedtls/HAL_TLS_mbedtls.c"
       ; } while(0);
        return 0;
    }
