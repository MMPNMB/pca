# 1 "kernel/protocols/net/core/mem.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/core/mem.c"
# 56 "kernel/protocols/net/core/mem.c"
...
# 57 "kernel/protocols/net/core/mem.c" 2
...
# 58 "kernel/protocols/net/core/mem.c" 2
...
# 59 "kernel/protocols/net/core/mem.c" 2
...
# 60 "kernel/protocols/net/core/mem.c" 2
...
# 61 "kernel/protocols/net/core/mem.c" 2
...
# 64 "kernel/protocols/net/core/mem.c" 2
...
# 65 "kernel/protocols/net/core/mem.c" 2
...
# 70 "kernel/protocols/net/core/mem.c"
void
mem_init(void)
{
}
...
# 117 "kernel/protocols/net/core/mem.c"
void *
mem_malloc(mem_size_t size)
{
  void* ret = malloc(size + 0);
  if (ret == 
# 121 "kernel/protocols/net/core/mem.c" 3 4
            ((void *)0)
# 121 "kernel/protocols/net/core/mem.c"
                ) {
    ;
  } else {
    ;
...
# 743 "kernel/protocols/net/core/mem.c"
void *
