# 1 "framework/fota/download/http/ota_download.c"
...
# 9 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/sys/unistd.h" 2 3
...
# 12 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/sys/unistd.h" 2 3
# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/sys/types.h" 1 3
# 22 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/sys/types.h" 3
# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/machine/_types.h" 1 3
# 23 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/sys/types.h" 2 3
...
# 25 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/sys/_types.h" 3
...
# 64 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/sys/types.h" 2 3
...
# 6 "framework/fota/download/http/ota_download.c" 2
...
# 7 "framework/fota/download/http/ota_download.c" 2
...
# 8 "framework/fota/download/http/ota_download.c" 2
...
# 9 "framework/fota/download/http/ota_download.c" 2
...
# 10 "framework/fota/download/http/ota_download.c" 2

# 1 "./utility/digest_algorithm/./md5.h" 1
# 12 "./utility/digest_algorithm/./md5.h"
typedef struct {
    uint32_t state[4];
    uint32_t count[2];
    uint8_t buffer[64];
...
# 12 "framework/fota/download/http/ota_download.c" 2
# 1 "./framework/fota/download/http/../ota_download.h" 1
...
# 1 "./framework/fota/platform/./ota_transport.h" 1
# 16 "./framework/fota/platform/./ota_transport.h"
typedef struct {
...
typedef struct {
    char primary_version[64];
    char secondary_version[64];
    const char *product_type;
...
# 8 "./framework/fota/download/http/../ota_download.h" 2
# 1 "./framework/fota/./ota_update_manifest.h" 1
...
# 9 "./framework/fota/./ota_update_manifest.h" 2
...
# 9 "./framework/fota/download/http/../ota_download.h" 2
...
# 13 "framework/fota/download/http/ota_download.c" 2
# 1 "./framework/fota/./ota_util.h" 1
# 17 "./framework/fota/./ota_util.h"
typedef enum {
    OTA_REBOOT_FAILED = -6,
...
# 14 "framework/fota/download/http/ota_download.c" 2
# 1 "./framework/fota/./ota_log.h" 1
...
# 11 "./framework/fota/./ota_log.h" 2
# 15 "framework/fota/download/http/ota_download.c" 2

# 1 "./framework/fota/download/http/./socket/ota_socket.h" 1
# 10 "./framework/fota/download/http/./socket/ota_socket.h"
...
# 17 "framework/fota/download/http/ota_download.c" 2
# 35 "framework/fota/download/http/ota_download.c"
MD5_CTX g_ctx;
# 44 "framework/fota/download/http/ota_download.c"
void http_gethost_info(char *src, char **web, char **file, int *port)
{
    ...
    if (!src || strlen(src) == 0) {
        do { if (aos_log_get_level() & (1 << AOS_LL_V_ERROR_BIT)) { csp_printf("[%06d]<" "E" "> ", (unsigned)aos_now_ms(), "http_gethost_info parms error!\n""\r\n"); csp_printf("http_gethost_info parms error!\n""\r\n"); csp_printf("\r\n"); } } while (0);
        return;
    }
    *port = 0;
    if (!(*src)) {
...
int ota_download(char *url, write_flash_cb_t func, char *md5)
{
    if (!url || strlen(url) == 0 || func == 
# 99 "framework/fota/download/http/ota_download.c" 3 4
                                           ((void *)0) 
# 99 "framework/fota/download/http/ota_download.c"
                                                || md5 == 
# 99 "framework/fota/download/http/ota_download.c" 3 4
                                                          ((void *)0)
# 99 "framework/fota/download/http/ota_download.c"
                                                              ) {
        do { if (aos_log_get_level() & (1 << AOS_LL_V_ERROR_BIT)) { csp_printf("[%06d]<" "E" "> ", (unsigned)aos_now_ms(), "ota_download parms error!\n""\r\n"); csp_printf("ota_download parms error!\n""\r\n"); csp_printf("\r\n"); } } while (0);
    ...
    char last_md5[33] = {0};
    char *host_file = 
# 115 "framework/fota/download/http/ota_download.c" 3 4
                     ((void *)0)
# 115 "framework/fota/download/http/ota_download.c"
                         ;
    char *host_addr = 
# 116 "framework/fota/download/http/ota_download.c" 3 4
                     ((void *)0)
# 116 "framework/fota/download/http/ota_download.c"
                         ;
    char http_buffer[1461] = {0};
    http_gethost_info(url, &host_addr, &host_file, &port);

    if (host_file == 
# 120 "framework/fota/download/http/ota_download.c" 3 4
                    ((void *)0) 
# 120 "framework/fota/download/http/ota_download.c"
                         || host_addr == 
# 120 "framework/fota/download/http/ota_download.c" 3 4
                                         ((void *)0)
# 120 "framework/fota/download/http/ota_download.c"
    ...
    if (sockfd < 0 ) {
        do { if (aos_log_get_level() & (1 << AOS_LL_V_ERROR_BIT)) { csp_printf("[%06d]<" "E" "> ", (unsigned)aos_now_ms(), "ota_socket_connect error\n ""\r\n"); csp_printf("ota_socket_connect error\n ""\r\n"); csp_printf("\r\n"); } } while (0);
    ...
    if (breakpoint && !strncmp(last_md5, md5, 32)) {
        do { if (aos_log_get_level() & (1 << AOS_LL_V_INFO_BIT)) { csp_printf("[%06d]<" "I" "> ", (unsigned)aos_now_ms(), "----resume download,breakpoint=%d------""\r\n", breakpoint); csp_printf("----resume download,breakpoint=%d------""\r\n", breakpoint); csp_printf("\r\n"); } } while (0);
        sprintf(http_buffer, "GET /%s HTTP/1.1\r\nAccept:*/*\r\nUser-Agent: Mozilla/5.0\r\nCache-Control: no-cache\r\nConnection: close\r\nRange: bytes=%d-\r\nHost:%s:%d\r\n\r\n", host_file, breakpoint, host_addr, port);
    ...
    do { if (aos_log_get_level() & (1 << AOS_LL_V_INFO_BIT)) { csp_printf("[%06d]<" "I" "> ", (unsigned)aos_now_ms(), "send %s""\r\n", http_buffer); csp_printf("send %s""\r\n", http_buffer); csp_printf("\r\n"); } } while (0);
    while (totalsend < nbytes) {
        send = ota_socket_send(sockfd, http_buffer + totalsend, nbytes - totalsend);
        if (send == -1) {
            do { if (aos_log_get_level() & (1 << AOS_LL_V_ERROR_BIT)) { csp_printf("[%06d]<" "E" "> ", (unsigned)aos_now_ms(), "send error!%s\n ""\r\n", strerror(
# 151 "framework/fota/download/http/ota_download.c" 3
           (*__errno())
# 151 "framework/fota/download/http/ota_download.c"
           )); csp_printf("send error!%s\n ""\r\n", strerror(
# 151 "framework/fota/download/http/ota_download.c" 3
           (*__errno())
# 151 "framework/fota/download/http/ota_download.c"
           )); csp_printf("\r\n"); } } while (0);
        ...
        totalsend += send;
        do { if (aos_log_get_level() & (1 << AOS_LL_V_INFO_BIT)) { csp_printf("[%06d]<" "I" "> ", (unsigned)aos_now_ms(), "%d bytes send OK!\n ""\r\n", totalsend); csp_printf("%d bytes send OK!\n ""\r\n", totalsend); csp_printf("\r\n"); } } while (0);
    }

    memset(http_buffer, 0, 1461);
    while ((nbytes = ota_socket_recv(sockfd, http_buffer, 1461 - 1)) != 0) {

        if (nbytes < 0) {
            do { if (aos_log_get_level() & (1 << AOS_LL_V_INFO_BIT)) { csp_printf("[%06d]<" "I" "> ", (unsigned)aos_now_ms(), "ota_socket_recv nbytes < 0""\r\n"); csp_printf("ota_socket_recv nbytes < 0""\r\n"); csp_printf("\r\n"); } } while (0);
            if (
# 164 "framework/fota/download/http/ota_download.c" 3
               (*__errno()) 
# 164 "framework/fota/download/http/ota_download.c"
                     != 4) {
                break;
            }
            if (ota_socket_check_conn(sockfd) < 0) {
                do { if (aos_log_get_level() & (1 << AOS_LL_V_ERROR_BIT)) { csp_printf("[%06d]<" "E" "> ", (unsigned)aos_now_ms(), "download system error %s""\r\n", strerror(
# 168 "framework/fota/download/http/ota_download.c" 3
               (*__errno())
# 168 "framework/fota/download/http/ota_download.c"
               )); csp_printf("download system error %s""\r\n", strerror(
# 168 "framework/fota/download/http/ota_download.c" 3
               (*__errno())
# 168 "framework/fota/download/http/ota_download.c"
               )); csp_printf("\r\n"); } } while (0);
        ...
        if (!header_found) {
            ...
            if (pos != 
# 185 "framework/fota/download/http/ota_download.c" 3 4
                      ((void *)0)
# 185 "framework/fota/download/http/ota_download.c"
                          ) {
                pos += 4;
        ...
        func(1461, (uint8_t *) http_buffer, nbytes, 0);
    ...
    if (nbytes < 0) {
        do { if (aos_log_get_level() & (1 << AOS_LL_V_ERROR_BIT)) { csp_printf("[%06d]<" "E" "> ", (unsigned)aos_now_ms(), "download read error %s""\r\n", strerror(
# 216 "framework/fota/download/http/ota_download.c" 3
       (*__errno())
# 216 "framework/fota/download/http/ota_download.c"
       )); csp_printf("download read error %s""\r\n", strerror(
# 216 "framework/fota/download/http/ota_download.c" 3
       (*__errno())
# 216 "framework/fota/download/http/ota_download.c"
       )); csp_printf("\r\n"); } } while (0);
...
int check_md5(const char *buffer, const int32_t len)
{
    ...
    do { if (aos_log_get_level() & (1 << AOS_LL_V_INFO_BIT)) { csp_printf("[%06d]<" "I" "> ", (unsigned)aos_now_ms(), "url md5=%s""\r\n", buffer); csp_printf("url md5=%s""\r\n", buffer); csp_printf("\r\n"); } } while (0);
    do { if (aos_log_get_level() & (1 << AOS_LL_V_INFO_BIT)) { csp_printf("[%06d]<" "I" "> ", (unsigned)aos_now_ms(), "digestMD5=%s""\r\n", digest_str); csp_printf("digestMD5=%s""\r\n", digest_str); csp_printf("\r\n"); } } while (0);
    if (strncmp(digest_str, buffer, 32)) {
        do { if (aos_log_get_level() & (1 << AOS_LL_V_ERROR_BIT)) { csp_printf("[%06d]<" "E" "> ", (unsigned)aos_now_ms(), "update_packet md5 check FAIL!""\r\n"); csp_printf("update_packet md5 check FAIL!""\r\n"); csp_printf("\r\n"); } } while (0);
        return -1;
    }
    return 0;
}
