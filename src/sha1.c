# 1 "security/alicrypto/./mbedtls/library/sha1.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "security/alicrypto/./mbedtls/library/sha1.c"
# 28 "security/alicrypto/./mbedtls/library/sha1.c"
...
# 29 "security/alicrypto/./mbedtls/library/sha1.c" 2
...
# 27 "./security/alicrypto/./mbedtls/include/mbedtls/sha1.h"
# 1 "./security/alicrypto/./mbedtls/include/mbedtls/config.h" 1
# 28 "./security/alicrypto/./mbedtls/include/mbedtls/sha1.h" 2
...
# 34 "./security/alicrypto/./mbedtls/include/mbedtls/sha1.h" 2
...
# 36 "security/alicrypto/./mbedtls/library/sha1.c" 2
...
# 38 "security/alicrypto/./mbedtls/library/sha1.c" 2
# 51 "security/alicrypto/./mbedtls/library/sha1.c"

# 51 "security/alicrypto/./mbedtls/library/sha1.c"
static void mbedtls_zeroize( void *v, size_t n ) {
    volatile unsigned char *p = (unsigned char*)v; while( n-- ) *p++ = 0;
}
# 78 "security/alicrypto/./mbedtls/library/sha1.c"
void mbedtls_sha1_init( mbedtls_sha1_context *ctx )
{
...
{
    if( ctx == 
# 85 "security/alicrypto/./mbedtls/library/sha1.c" 3 4
              ((void *)0) 
# 85 "security/alicrypto/./mbedtls/library/sha1.c"
                   )
        return;
...
# 148 "security/alicrypto/./mbedtls/library/sha1.c"
    A = ctx->state[0];
    B = ctx->state[1];
    C = ctx->state[2];
    D = ctx->state[3];
