# 1 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c"
...
# 6 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 2
...
# 7 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 2
...
# 8 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 2
...
# 9 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 2
...
# 51 "./include/aos/internal/log_impl.h"
...
void aos_start(void);
# 52 "./include/aos/internal/log_impl.h" 2
...
# 10 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 2
# 1 "./include/aos/network.h" 1
# 13 "./include/aos/network.h"
...
# 14 "./include/aos/network.h" 2



# 1 "./kernel/protocols/net/include/lwip/def.h" 1
# 41 "./kernel/protocols/net/include/lwip/def.h"
...
# 42 "./kernel/protocols/net/include/lwip/def.h" 2
...
# 18 "./include/aos/network.h" 2
# 1 "./kernel/protocols/net/include/lwip/netdb.h" 1
# 41 "./kernel/protocols/net/include/lwip/netdb.h"
# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/lib/gcc/arm-none-eabi/5.4.1/include/stddef.h" 1 3 4
# 42 "./kernel/protocols/net/include/lwip/netdb.h" 2

# 1 "./kernel/protocols/net/include/lwip/inet.h" 1
# 45 "./kernel/protocols/net/include/lwip/inet.h"
...
# 46 "./kernel/protocols/net/include/lwip/inet.h" 2
...
# 44 "./kernel/protocols/net/include/lwip/netdb.h" 2
...
# 45 "./kernel/protocols/net/include/lwip/netdb.h" 2
# 93 "./kernel/protocols/net/include/lwip/netdb.h"
struct hostent {
    char *h_name;
    char **h_aliases;
...
int lwip_getaddrinfo(const char *nodename,
       ...
       struct addrinfo **res);
# 19 "./include/aos/network.h" 2
# 11 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 2
# 1 "./framework/protocol/linkkit/iotkit/sdk-encap/iot_import.h" 1
# 27 "./framework/protocol/linkkit/iotkit/sdk-encap/iot_import.h"
# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/lib/gcc/arm-none-eabi/5.4.1/include/stdarg.h" 1 3 4
...
# 12 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 2
# 33 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c"
intptr_t HAL_UDP_create(const char *host, unsigned short port)
{
    int flag = 1;
    int ret = -1;
    ...
    if((socket_id = lwip_socket(2,2,0)) < 0)
    {
        fprintf(
# 42 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 3
               (_impure_ptr->_stderr)
# 42 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c"
                     ,"socket create failed\r\n");
        return (intptr_t)-1;
    }

    ret = lwip_setsockopt(socket_id,0xfff,0x0004,&flag,sizeof(flag));
    if(ret < 0)
    {
        lwip_close(socket_id);
        fprintf(
# 50 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 3
               (_impure_ptr->_stderr)
# 50 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c"
    ...
    if((ret = lwip_setsockopt(socket_id,0,6,&flag,sizeof(flag))) < 0)

        if (ret < 0)
        {
            lwip_close(socket_id);
            fprintf(
# 63 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 3
                   (_impure_ptr->_stderr)
# 63 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c"
    ...
    if(
# 70 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 3 4
      ((void *)0) 
# 70 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c"
           != host){
        ip4addr_aton(host, (ip4_addr_t*)&local_addr.sin_addr);
    }else{
        local_addr.sin_addr.s_addr = lwip_htonl(((u32_t)0x00000000UL));
    }
    local_addr.sin_port = lwip_htons(port);
    ret = lwip_bind(socket_id,(struct sockaddr *)&local_addr,sizeof(local_addr));
...
# 101 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 3
   _types_fd_set 
# 101 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c"
                       read_fds;

    if(
# 103 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 3 4
      ((void *)0) 
# 103 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c"
           == p_remote || 
# 103 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 3 4
                           ((void *)0) 
# 103 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c"
...
# 109 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 3
   (__extension__ (void)({ size_t __i; char *__tmp = (char *)
# 109 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c"
   &read_fds
# 109 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 3
...
# 110 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 3
   ((
# 110 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c"
   &read_fds
# 110 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 3
   )->fds_bits[(
# 110 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c"
...
# 110 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c"
    ...
    ret = lwip_select(socket_id + 1,&read_fds,
# 115 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 3 4
         ((void *)0)
# 115 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c"
         ,
# 115 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 3 4
         ((void *)0)
# 115 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c"
...
# 115 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c"
    ...
    if (ret < 0) {
        if (
# 123 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 3
           (*__errno()) 
# 123 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c"
                 == 4) {
            return -3;
        }
    ...
    count = lwip_recvfrom(socket_id,p_data,(size_t)datalen,0,&from,&addrlen);
    if(-1 == count)
    {
        return -1;
    }
    if (from.sa_family == 2)
    {
        ...
        (((2) == 2) ? ip4addr_ntoa_r((const ip4_addr_t*)(&sin->sin_addr),(p_remote->addr),((16))) : 
# 139 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 3 4
       ((void *)0)
# 139 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c"
       );
        p_remote->port = lwip_htons(sin->sin_port);
    }
    return count;
}
                 ...
                 unsigned int timeout_ms)
{
    ...
    if(
# 164 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 3 4
      ((void *)0) 
# 164 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c"
           == p_remote || 
# 164 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 3 4
                          ((void *)0) 
# 164 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c"
    ...
    if(1 != (rc = (((remote_addr.sin_family) == 2) ? ip4addr_aton((p_remote->addr),(ip4_addr_t*)(&remote_addr.sin_addr.s_addr)) : 0)))
    {
        return -1;
    }
    remote_addr.sin_port = lwip_htons(p_remote->port);
    rc = lwip_sendto(socket_id,p_data,(size_t)datalen,0,(const struct sockaddr *)&remote_addr,sizeof(remote_addr))
                                                                         ;
    if(-1 == rc)
    {
        return -1;
                           ...
                           char *p_group)
{
    ...
    if(
# 199 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 3 4
      ((void *)0) 
# 199 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c"
           == p_group) {
        return -1;
    }
    ...
    int loop = 1;
    socket_id = (int)sockfd;
    err = lwip_setsockopt(socket_id,0,7,&loop,sizeof(loop));
    if(err < 0)
    {
         fprintf(
# 209 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 3
                (_impure_ptr->_stderr)
# 209 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c"
                      ,"setsockopt():IP_MULTICAST_LOOP failed\r\n");
         return err;
    }

    struct ip_mreq mreq;
    mreq.imr_multiaddr.s_addr = ipaddr_addr(p_group);
    mreq.imr_interface.s_addr = lwip_htonl(((u32_t)0x00000000UL));


    err = lwip_setsockopt(socket_id,0,3,&mreq,sizeof(mreq));
    if (err < 0)
    {
         fprintf(
# 221 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c" 3
                (_impure_ptr->_stderr)
# 221 "framework/protocol/linkkit/iotkit/hal-impl/rhino/HAL_UDP_rhino.c"
