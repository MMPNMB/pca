# 1 "kernel/protocols/net/core/memp.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/core/memp.c"
# 46 "kernel/protocols/net/core/memp.c"
...
# 47 "kernel/protocols/net/core/memp.c" 2
...
# 49 "kernel/protocols/net/core/memp.c" 2
# 1 "./kernel/protocols/net/include/lwip/sys.h" 1
# 132 "./kernel/protocols/net/include/lwip/sys.h"
...
# 133 "./kernel/protocols/net/include/lwip/sys.h" 2
...
# 50 "kernel/protocols/net/core/memp.c" 2
...
# 53 "kernel/protocols/net/core/memp.c" 2
...
# 56 "kernel/protocols/net/core/memp.c" 2
# 1 "./kernel/protocols/net/include/lwip/raw.h" 1
# 46 "./kernel/protocols/net/include/lwip/raw.h"
...
# 47 "./kernel/protocols/net/include/lwip/raw.h" 2
...
# 48 "./kernel/protocols/net/include/lwip/raw.h" 2
...
# 57 "kernel/protocols/net/core/memp.c" 2
...
# 58 "kernel/protocols/net/core/memp.c" 2
...
# 59 "kernel/protocols/net/core/memp.c" 2
...
# 60 "kernel/protocols/net/core/memp.c" 2
# 1 "./kernel/protocols/net/include/lwip/ip4_frag.h" 1
# 61 "kernel/protocols/net/core/memp.c" 2
...
# 62 "kernel/protocols/net/core/memp.c" 2
...
# 63 "kernel/protocols/net/core/memp.c" 2
...
# 64 "kernel/protocols/net/core/memp.c" 2
...
# 65 "kernel/protocols/net/core/memp.c" 2
...
# 66 "kernel/protocols/net/core/memp.c" 2
# 1 "./kernel/protocols/net/include/lwip/netifapi.h" 1
# 41 "./kernel/protocols/net/include/lwip/netifapi.h"
...
# 42 "./kernel/protocols/net/include/lwip/netifapi.h" 2
# 1 "./kernel/protocols/net/include/lwip/autoip.h" 1
# 43 "./kernel/protocols/net/include/lwip/netifapi.h" 2
# 55 "./kernel/protocols/net/include/lwip/netifapi.h"
...
err_t netifapi_netif_common(struct netif *netif, netifapi_void_fn voidfunc,
                            netifapi_errt_fn errtfunc);
# 67 "kernel/protocols/net/core/memp.c" 2
...
# 68 "kernel/protocols/net/core/memp.c" 2



# 1 "./kernel/protocols/net/include/netif/ppp/ppp_opts.h" 1
# 72 "kernel/protocols/net/core/memp.c" 2
...
int lwip_getaddrinfo(const char *nodename,
       ...
       struct addrinfo **res);
# 73 "kernel/protocols/net/core/memp.c" 2
...
err_t dns_gethostbyname_addrtype(const char *hostname, ip_addr_t *addr,
                                   dns_found_callback found, void *callback_arg,
                                   u8_t dns_addrtype);
# 74 "kernel/protocols/net/core/memp.c" 2
# 1 "./kernel/protocols/net/include/lwip/nd6.h" 1
# 75 "kernel/protocols/net/core/memp.c" 2
# 1 "./kernel/protocols/net/include/lwip/ip6_frag.h" 1
# 76 "kernel/protocols/net/core/memp.c" 2
# 1 "./kernel/protocols/net/include/lwip/mld6.h" 1
# 77 "kernel/protocols/net/core/memp.c" 2



# 1 "./kernel/protocols/net/include/lwip/priv/memp_std.h" 1
# 42 "./kernel/protocols/net/include/lwip/priv/memp_std.h"
 const struct memp_desc memp_RAW_PCB = { ("RAW_PCB"), (((sizeof(struct raw_pcb)) + 4 - 1U) & ~(4 -1U)) };



 const struct memp_desc memp_UDP_PCB = { ("UDP_PCB"), (((sizeof(struct udp_pcb)) + 4 - 1U) & ~(4 -1U)) };



 const struct memp_desc memp_TCP_PCB = { ("TCP_PCB"), (((sizeof(struct tcp_pcb)) + 4 - 1U) & ~(4 -1U)) };
 const struct memp_desc memp_TCP_PCB_LISTEN = { ("TCP_PCB_LISTEN"), (((sizeof(struct tcp_pcb_listen)) + 4 - 1U) & ~(4 -1U)) };
 const struct memp_desc memp_TCP_SEG = { ("TCP_SEG"), (((sizeof(struct tcp_seg)) + 4 - 1U) & ~(4 -1U)) };
# 63 "./kernel/protocols/net/include/lwip/priv/memp_std.h"
 const struct memp_desc memp_NETBUF = { ("NETBUF"), (((sizeof(struct netbuf)) + 4 - 1U) & ~(4 -1U)) };
 const struct memp_desc memp_NETCONN = { ("NETCONN"), (((sizeof(struct netconn)) + 4 - 1U) & ~(4 -1U)) };



 const struct memp_desc memp_TCPIP_MSG_API = { ("TCPIP_MSG_API"), (((sizeof(struct tcpip_msg)) + 4 - 1U) & ~(4 -1U)) };
# 82 "./kernel/protocols/net/include/lwip/priv/memp_std.h"
 const struct memp_desc memp_TCPIP_MSG_INPKT = { ("TCPIP_MSG_INPKT"), (((sizeof(struct tcpip_msg)) + 4 - 1U) & ~(4 -1U)) };
# 95 "./kernel/protocols/net/include/lwip/priv/memp_std.h"
 const struct memp_desc memp_IGMP_GROUP = { ("IGMP_GROUP"), (((sizeof(struct igmp_group)) + 4 - 1U) & ~(4 -1U)) };



 const struct memp_desc memp_SYS_TIMEOUT = { ("SYS_TIMEOUT"), (((sizeof(struct sys_timeo)) + 4 - 1U) & ~(4 -1U)) };



 const struct memp_desc memp_NETDB = { ("NETDB"), ((((sizeof(struct addrinfo) + sizeof(struct sockaddr_storage) + 256 + 1)) + 4 - 1U) & ~(4 -1U)) };
# 130 "./kernel/protocols/net/include/lwip/priv/memp_std.h"
 const struct memp_desc memp_PBUF = { ("PBUF_REF/ROM"), ((((((((sizeof(struct pbuf)) + 4 - 1U) & ~(4 -1U))) + ((((0) + 4 - 1U) & ~(4 -1U))))) + 4 - 1U) & ~(4 -1U)) };
 ...
 const struct memp_desc memp_PBUF_POOL = { ("PBUF_POOL"), ((((((((sizeof(struct pbuf)) + 4 - 1U) & ~(4 -1U))) + ((((1580) + 4 - 1U) & ~(4 -1U))))) + 4 - 1U) & ~(4 -1U)) };
# 81 "kernel/protocols/net/core/memp.c" 2
...
&memp_PBUF_POOL,
# 85 "kernel/protocols/net/core/memp.c" 2
};
# 226 "kernel/protocols/net/core/memp.c"
void
memp_init_pool(const struct memp_desc *desc)
{

  (void)desc;
# 259 "kernel/protocols/net/core/memp.c"
}
...
# 311 "kernel/protocols/net/core/memp.c"
  if (memp != 
# 311 "kernel/protocols/net/core/memp.c" 3 4
             ((void *)0)
# 311 "kernel/protocols/net/core/memp.c"
                 ) {
# 325 "kernel/protocols/net/core/memp.c"
    ...
    do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("memp_malloc: out of memory in pool %s\n", desc->desc) ;} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0);
  ...
  sys_arch_unprotect(old_level);
  return 
# 344 "kernel/protocols/net/core/memp.c" 3 4
        ((void *)0)
# 344 "kernel/protocols/net/core/memp.c"
            ;
}
# 354 "kernel/protocols/net/core/memp.c"
void *
...

{
  ;
  if (desc == 
# 362 "kernel/protocols/net/core/memp.c" 3 4
             ((void *)0)
# 362 "kernel/protocols/net/core/memp.c"
                 ) {
    return 
# 363 "kernel/protocols/net/core/memp.c" 3 4
          ((void *)0)
# 363 "kernel/protocols/net/core/memp.c"
              ;
  }
...
# 380 "kernel/protocols/net/core/memp.c"
void *
...
{
  void *memp;
  do { if (!((type < MEMP_MAX))) { do {bk_printf ("memp_malloc: type < MEMP_MAX") ;} while(0); return 
# 388 "kernel/protocols/net/core/memp.c" 3 4
 ((void *)0)
# 388 "kernel/protocols/net/core/memp.c"
 ;;}} while(0);
...
do_memp_free_pool(const struct memp_desc* desc, void *mem)
{
  ...
  old_level = sys_arch_protect();
# 427 "kernel/protocols/net/core/memp.c"
  (void)desc;
  sys_arch_unprotect(old_level);
  mem_free(memp);
# 440 "kernel/protocols/net/core/memp.c"
}
...
memp_free_pool(const struct memp_desc* desc, void *mem)
{
  ;
  if ((desc == 
# 452 "kernel/protocols/net/core/memp.c" 3 4
              ((void *)0)
# 452 "kernel/protocols/net/core/memp.c"
                  ) || (mem == 
# 452 "kernel/protocols/net/core/memp.c" 3 4
                               ((void *)0)
# 452 "kernel/protocols/net/core/memp.c"
...
memp_free(memp_t type, void *mem)
{
  ...
  do { if (!((type < MEMP_MAX))) { do {bk_printf ("memp_free: type < MEMP_MAX") ;} while(0); return;;}} while(0);
# 482 "kernel/protocols/net/core/memp.c"
