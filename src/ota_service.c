# 1 "framework/fota/ota_service.c"
...
# 5 "framework/fota/ota_service.c" 2
...
# 6 "framework/fota/ota_service.c" 2
...
# 8 "framework/fota/ota_service.c" 2
# 1 "framework/fota/ota_update_manifest.h" 1
# 12 "framework/fota/ota_update_manifest.h"
...
# 9 "framework/fota/ota_service.c" 2
# 1 "framework/fota/ota_version.h" 1
# 15 "framework/fota/ota_version.h"
...
# 10 "framework/fota/ota_service.c" 2
...
# 11 "framework/fota/ota_service.c" 2
...
{
    return hal_ota_write(hal_ota_get_default_module(), 
# 34 "framework/fota/ota_service.c" 3 4
                                                      ((void *)0)
# 34 "framework/fota/ota_service.c"
                                                          , buf, buf_len);
}
...
# 55 "framework/fota/ota_service.c"
static void update_action(void *buf)
{
    ;
    if (!buf) {
        do { if (aos_log_get_level() & (1 << AOS_LL_V_ERROR_BIT)) { csp_printf("[%06d]<" "E" "> ", (unsigned)aos_now_ms(), "do update buf is null"); csp_printf("do update buf is null"); csp_printf("\r\n"); } } while (0);
        return;
    }
...
void cancel_update(int len, const char *buf)
{
    ;
    if (!buf) {
        do { if (aos_log_get_level() & (1 << AOS_LL_V_ERROR_BIT)) { csp_printf("[%06d]<" "E" "> ", (unsigned)aos_now_ms(), "cancel update buf is null"); csp_printf("cancel update buf is null"); csp_printf("\r\n"); } } while (0);
        return;
    }
...
{
    if (event->type == 0x0001 && event->code == 5) {
        if (ota_init) {
            return;
        }
        ota_init = 1;
...
{
    aos_register_event_filter(0x0001, ota_service_event, 
# 138 "framework/fota/ota_service.c" 3 4
                                                        ((void *)0)
# 138 "framework/fota/ota_service.c"
                                                            );
}
