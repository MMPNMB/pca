# 1 "kernel/protocols/net/core/pbuf.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/core/pbuf.c"
# 112 "kernel/protocols/net/core/pbuf.c"
...
# 113 "kernel/protocols/net/core/pbuf.c" 2
...
# 115 "kernel/protocols/net/core/pbuf.c" 2
...
# 116 "kernel/protocols/net/core/pbuf.c" 2
...
# 119 "kernel/protocols/net/core/pbuf.c" 2
...
# 36 "./kernel/protocols/net/port/include/arch/sys_arch.h"
...
# 37 "./kernel/protocols/net/port/include/arch/sys_arch.h" 2
...
# 120 "kernel/protocols/net/core/pbuf.c" 2
...
# 122 "kernel/protocols/net/core/pbuf.c" 2
...
# 128 "kernel/protocols/net/core/pbuf.c" 2
# 148 "kernel/protocols/net/core/pbuf.c"
...
# 149 "kernel/protocols/net/core/pbuf.c" 2
# 158 "kernel/protocols/net/core/pbuf.c"
volatile u8_t pbuf_free_ooseq_pending;
# 170 "kernel/protocols/net/core/pbuf.c"
static
...
# 178 "kernel/protocols/net/core/pbuf.c" 3 4
                             ((void *)0) 
# 178 "kernel/protocols/net/core/pbuf.c"
                                  != pcb; pcb = pcb->next) {
    if (
# 179 "kernel/protocols/net/core/pbuf.c" 3 4
       ((void *)0) 
# 179 "kernel/protocols/net/core/pbuf.c"
            != pcb->ooseq) {

      do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("pbuf_free_ooseq: freeing out-of-sequence pbufs\n") ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
      tcp_segs_free(pcb->ooseq);
      pcb->ooseq = 
# 183 "kernel/protocols/net/core/pbuf.c" 3 4
                  ((void *)0)
# 183 "kernel/protocols/net/core/pbuf.c"
                      ;
      return;
    }
  }
...
# 217 "kernel/protocols/net/core/pbuf.c" 3 4
   ((void *)0)
# 217 "kernel/protocols/net/core/pbuf.c"
   , 0) != ERR_OK) { old_level = sys_arch_protect(); pbuf_free_ooseq_pending = 0; sys_arch_unprotect(old_level); } } while(0);
  }

}
# 259 "kernel/protocols/net/core/pbuf.c"
struct pbuf *
...

{
  ...
  s32_t rem_len;
  do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("pbuf_alloc(length=%""4d"")\n", length) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
  ...
  default:
    ;
    return 
# 301 "kernel/protocols/net/core/pbuf.c" 3 4
          ((void *)0)
# 301 "kernel/protocols/net/core/pbuf.c"
              ;
  }
# 317 "kernel/protocols/net/core/pbuf.c"
  switch (type) {
  case PBUF_POOL:
    ...
    do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("pbuf_alloc: allocated pbuf %p\n", (void *)p) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
    if (p == 
# 326 "kernel/protocols/net/core/pbuf.c" 3 4
            ((void *)0)
# 326 "kernel/protocols/net/core/pbuf.c"
                ) {
      pbuf_pool_is_empty();
      return 
# 328 "kernel/protocols/net/core/pbuf.c" 3 4
            ((void *)0)
# 328 "kernel/protocols/net/core/pbuf.c"
                ;
    }
    p->type = type;
    p->next = 
# 331 "kernel/protocols/net/core/pbuf.c" 3 4
             ((void *)0)
# 331 "kernel/protocols/net/core/pbuf.c"
                 ;
    ...
    p->tot_len = length;
# 366 "kernel/protocols/net/core/pbuf.c"
    p->len = (((length) < ((((1580) + 4 - 1U) & ~(4 -1U)) - (((offset) + 4 - 1U) & ~(4 -1U)))) ? (length) : ((((1580) + 4 - 1U) & ~(4 -1U)) - (((offset) + 4 - 1U) & ~(4 -1U))));
    ...
    while (rem_len > 0) {
      ...
      if (q == 
# 385 "kernel/protocols/net/core/pbuf.c" 3 4
              ((void *)0)
# 385 "kernel/protocols/net/core/pbuf.c"
                  ) {
        pbuf_pool_is_empty();
        ...
        return 
# 390 "kernel/protocols/net/core/pbuf.c" 3 4
              ((void *)0)
# 390 "kernel/protocols/net/core/pbuf.c"
                  ;
      }
      q->type = type;
      q->flags = 0;
      q->next = 
# 394 "kernel/protocols/net/core/pbuf.c" 3 4
               ((void *)0)
# 394 "kernel/protocols/net/core/pbuf.c"
                   ;
      ...
      q->len = ((((u16_t)rem_len) < ((((1580) + 4 - 1U) & ~(4 -1U)))) ? ((u16_t)rem_len) : ((((1580) + 4 - 1U) & ~(4 -1U))));
  ...
  case PBUF_RAM:
    ...
    if (p == 
# 425 "kernel/protocols/net/core/pbuf.c" 3 4
            ((void *)0)
# 425 "kernel/protocols/net/core/pbuf.c"
                ) {
      return 
# 426 "kernel/protocols/net/core/pbuf.c" 3 4
            ((void *)0)
# 426 "kernel/protocols/net/core/pbuf.c"
                ;
    }
    ...
    p->next = 
# 431 "kernel/protocols/net/core/pbuf.c" 3 4
             ((void *)0)
# 431 "kernel/protocols/net/core/pbuf.c"
                 ;
    p->type = type;
  ...
  case PBUF_REF:
    ...
    if (p == 
# 443 "kernel/protocols/net/core/pbuf.c" 3 4
            ((void *)0)
# 443 "kernel/protocols/net/core/pbuf.c"
                ) {
      do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("pbuf_alloc: Could not allocate MEMP_PBUF for PBUF_%s.\n", (type == PBUF_ROM) ? "ROM" : "REF") ;} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0)

                                                      ;
      return 
# 447 "kernel/protocols/net/core/pbuf.c" 3 4
            ((void *)0)
# 447 "kernel/protocols/net/core/pbuf.c"
                ;
    }

    p->payload = 
# 450 "kernel/protocols/net/core/pbuf.c" 3 4
                ((void *)0)
# 450 "kernel/protocols/net/core/pbuf.c"
                    ;
    p->len = p->tot_len = length;
    p->next = 
# 452 "kernel/protocols/net/core/pbuf.c" 3 4
             ((void *)0)
# 452 "kernel/protocols/net/core/pbuf.c"
                 ;
    p->type = type;
    break;
  default:
    ;
    return 
# 457 "kernel/protocols/net/core/pbuf.c" 3 4
          ((void *)0)
# 457 "kernel/protocols/net/core/pbuf.c"
              ;
  }
  ...
  do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("pbuf_alloc(length=%""4d"") == %p\n", length, (void *)p) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
  return p;
}
# 559 "kernel/protocols/net/core/pbuf.c"
void
pbuf_realloc(struct pbuf *p, u16_t new_len)
{
  ...
  if (q->next != 
# 621 "kernel/protocols/net/core/pbuf.c" 3 4
                ((void *)0)
# 621 "kernel/protocols/net/core/pbuf.c"
                    ) {
  ...
  q->next = 
# 626 "kernel/protocols/net/core/pbuf.c" 3 4
           ((void *)0)
# 626 "kernel/protocols/net/core/pbuf.c"
               ;

}
# 661 "kernel/protocols/net/core/pbuf.c"
static u8_t
...
# 669 "kernel/protocols/net/core/pbuf.c" 3 4
                                           ((void *)0)
# 669 "kernel/protocols/net/core/pbuf.c"
                                               )) {
    return 0;
  }
  ...
  if (header_size_increment < 0) {
    ...
    do { if (!((increment_magnitude <= p->len))) { do {bk_printf ("increment_magnitude <= p->len") ;} while(0); return 1;;}} while(0);
  } else {
    increment_magnitude = header_size_increment;
# 689 "kernel/protocols/net/core/pbuf.c"
  }
  ...
  if (type == PBUF_RAM || type == PBUF_POOL) {
    ...
    if ((u8_t *)p->payload < (u8_t *)p + (((sizeof(struct pbuf)) + 4 - 1U) & ~(4 -1U))) {
      do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("pbuf_header: failed as %p < %p (not enough space for new header size)\n", (void *)p->payload, (void *)((u8_t *)p + (((sizeof(struct pbuf)) + 4 - 1U) & ~(4 -1U)))) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0)
  ...
  do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("pbuf_header: old %p new %p (%""4d"")\n", (void *)payload, (void *)p->payload, header_size_increment) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0)
                                                                ;

  return 0;
}
# 757 "kernel/protocols/net/core/pbuf.c"
u8_t
...
# 807 "kernel/protocols/net/core/pbuf.c"
u8_t
pbuf_free(struct pbuf *p)
{
  ...
  if (p == 
# 814 "kernel/protocols/net/core/pbuf.c" 3 4
          ((void *)0)
# 814 "kernel/protocols/net/core/pbuf.c"
              ) {
    ;

    do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("pbuf_free(p == NULL) was called.\n") ;} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0)
                                             ;
    return 0;
  }
  do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("pbuf_free(%p)\n", (void *)p) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
  ...
  while (p != 
# 832 "kernel/protocols/net/core/pbuf.c" 3 4
             ((void *)0)
# 832 "kernel/protocols/net/core/pbuf.c"
                 ) {
    u16_t ref;
    sys_prot_t old_level;
    ...
    if (ref == 0) {
      ...
      q = p->next;
      do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("pbuf_free: deallocating %p\n", (void *)p) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
      type = p->type;
# 858 "kernel/protocols/net/core/pbuf.c"
      {
      ...
      do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("pbuf_free: %p has ref %""4d"", ending here.\n", (void *)p, ref) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);

      p = 
# 882 "kernel/protocols/net/core/pbuf.c" 3 4
         ((void *)0)
# 882 "kernel/protocols/net/core/pbuf.c"
             ;
    }
  }
  ;
...
pbuf_clen(const struct pbuf *p)
{
  ...
  len = 0;
  while (p != 
# 902 "kernel/protocols/net/core/pbuf.c" 3 4
             ((void *)0)
# 902 "kernel/protocols/net/core/pbuf.c"
                 ) {
    ++len;
    p = p->next;
  }
...
# 916 "kernel/protocols/net/core/pbuf.c"
void
pbuf_ref(struct pbuf *p)
{

  if (p != 
# 920 "kernel/protocols/net/core/pbuf.c" 3 4
          ((void *)0)
# 920 "kernel/protocols/net/core/pbuf.c"
              ) {
    do { sys_prot_t old_level; old_level = sys_arch_protect(); p->ref += 1; sys_arch_unprotect(old_level); } while(0);
  }
}
# 935 "kernel/protocols/net/core/pbuf.c"
void
pbuf_cat(struct pbuf *h, struct pbuf *t)
{
  ...
  do { if (!(((h != 
# 940 "kernel/protocols/net/core/pbuf.c" 3 4
 ((void *)0)
# 940 "kernel/protocols/net/core/pbuf.c"
 ) && (t != 
# 940 "kernel/protocols/net/core/pbuf.c" 3 4
 ((void *)0)
# 940 "kernel/protocols/net/core/pbuf.c"
 )))) { do {bk_printf ("(h != NULL) && (t != NULL) (programmer violates API)") ;} while(0); return;;}} while(0)
                                                   ;


  for (p = h; p->next != 
# 944 "kernel/protocols/net/core/pbuf.c" 3 4
                        ((void *)0)
# 944 "kernel/protocols/net/core/pbuf.c"
                            ; p = p->next) {
...
# 977 "kernel/protocols/net/core/pbuf.c"
void
pbuf_chain(struct pbuf *h, struct pbuf *t)
{
  ...
  pbuf_ref(t);
  do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("pbuf_chain: %p references %p\n", (void *)h, (void *)t) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
}
# 994 "kernel/protocols/net/core/pbuf.c"
struct pbuf *
pbuf_dechain(struct pbuf *p)
{
  ...
  if (q != 
# 1002 "kernel/protocols/net/core/pbuf.c" 3 4
          ((void *)0)
# 1002 "kernel/protocols/net/core/pbuf.c"
              ) {
    ...
    p->next = 
# 1008 "kernel/protocols/net/core/pbuf.c" 3 4
             ((void *)0)
# 1008 "kernel/protocols/net/core/pbuf.c"
                 ;

    p->tot_len = p->len;

    do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("pbuf_dechain: unreferencing %p\n", (void *)q) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
    tail_gone = pbuf_free(q);
    if (tail_gone > 0) {
      do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("pbuf_dechain: deallocated %p (as it is no longer referenced)\n", (void *)q) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0)
                                                                                                ;
    }
  ...
  ;
  return ((tail_gone > 0) ? 
# 1022 "kernel/protocols/net/core/pbuf.c" 3 4
                           ((void *)0) 
# 1022 "kernel/protocols/net/core/pbuf.c"
                                : q);
}
# 1043 "kernel/protocols/net/core/pbuf.c"
err_t
pbuf_copy(struct pbuf *p_to, const struct pbuf *p_from)
{
  u16_t offset_to=0, offset_from=0, len;

  do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("pbuf_copy(%p, %p)\n", (const void*)p_to, (const void*)p_from) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0)
                                            ;


  do { if (!(((p_to != 
# 1052 "kernel/protocols/net/core/pbuf.c" 3 4
 ((void *)0)
# 1052 "kernel/protocols/net/core/pbuf.c"
 ) && (p_from != 
# 1052 "kernel/protocols/net/core/pbuf.c" 3 4
 ((void *)0)
# 1052 "kernel/protocols/net/core/pbuf.c"
 ) && (p_to->tot_len >= p_from->tot_len)))) { do {bk_printf ("pbuf_copy: target not big enough to hold source") ;} while(0); return ERR_ARG;;}} while(0)
                                                                                      ;
  ...
  do
  {
    ...
    if (offset_to == p_to->len) {
      ...
      p_to = p_to->next;
      do { if (!((p_to != 
# 1080 "kernel/protocols/net/core/pbuf.c" 3 4
     ((void *)0)
# 1080 "kernel/protocols/net/core/pbuf.c"
     ) || (p_from == 
# 1080 "kernel/protocols/net/core/pbuf.c" 3 4
     ((void *)0)
# 1080 "kernel/protocols/net/core/pbuf.c"
     ))) { do {bk_printf ("p_to != NULL") ;} while(0); return ERR_ARG;;}} while(0);
    }

    if ((p_from != 
# 1083 "kernel/protocols/net/core/pbuf.c" 3 4
                  ((void *)0)
# 1083 "kernel/protocols/net/core/pbuf.c"
                      ) && (p_from->len == p_from->tot_len)) {

      do { if (!((p_from->next == 
# 1085 "kernel/protocols/net/core/pbuf.c" 3 4
     ((void *)0)
# 1085 "kernel/protocols/net/core/pbuf.c"
     ))) { do {bk_printf ("pbuf_copy() does not allow packet queues!") ;} while(0); return ERR_VAL;;}} while(0)
                                                         ;
    }
    if ((p_to != 
# 1088 "kernel/protocols/net/core/pbuf.c" 3 4
                ((void *)0)
# 1088 "kernel/protocols/net/core/pbuf.c"
                    ) && (p_to->len == p_to->tot_len)) {

      do { if (!((p_to->next == 
# 1090 "kernel/protocols/net/core/pbuf.c" 3 4
     ((void *)0)
# 1090 "kernel/protocols/net/core/pbuf.c"
     ))) { do {bk_printf ("pbuf_copy() does not allow packet queues!") ;} while(0); return ERR_VAL;;}} while(0)
                                                        ;
    }
  } while (p_from);
  do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("pbuf_copy: end of chain reached.\n") ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
  return ERR_OK;
}
# 1110 "kernel/protocols/net/core/pbuf.c"
u16_t
pbuf_copy_partial(const struct pbuf *buf, void *dataptr, u16_t len, u16_t offset)
{
  ...
  do { if (!((buf != 
# 1118 "kernel/protocols/net/core/pbuf.c" 3 4
 ((void *)0)
# 1118 "kernel/protocols/net/core/pbuf.c"
 ))) { do {bk_printf ("pbuf_copy_partial: invalid buf") ;} while(0); return 0;;}} while(0);
  do { if (!((dataptr != 
# 1119 "kernel/protocols/net/core/pbuf.c" 3 4
 ((void *)0)
# 1119 "kernel/protocols/net/core/pbuf.c"
 ))) { do {bk_printf ("pbuf_copy_partial: invalid dataptr") ;} while(0); return 0;;}} while(0);

  left = 0;


  for (p = buf; len != 0 && p != 
# 1124 "kernel/protocols/net/core/pbuf.c" 3 4
                                ((void *)0)
# 1124 "kernel/protocols/net/core/pbuf.c"
                                    ; p = p->next) {
...
# 1196 "kernel/protocols/net/core/pbuf.c"
...
pbuf_skip_const(const struct pbuf* in, u16_t in_offset, u16_t* out_offset)
{
  ...
  while ((q != 
# 1203 "kernel/protocols/net/core/pbuf.c" 3 4
              ((void *)0)
# 1203 "kernel/protocols/net/core/pbuf.c"
                  ) && (q->len <= offset_left)) {
    offset_left -= q->len;
    q = q->next;
  }
  if (out_offset != 
# 1207 "kernel/protocols/net/core/pbuf.c" 3 4
                   ((void *)0)
# 1207 "kernel/protocols/net/core/pbuf.c"
                       ) {
    *out_offset = offset_left;
  }
  return q;
}
# 1222 "kernel/protocols/net/core/pbuf.c"
struct pbuf*
pbuf_skip(struct pbuf* in, u16_t in_offset, u16_t* out_offset)
{
  return (struct pbuf*)(size_t)pbuf_skip_const(in, in_offset, out_offset);
}
# 1239 "kernel/protocols/net/core/pbuf.c"
err_t
pbuf_take(struct pbuf *buf, const void *dataptr, u16_t len)
{
  ...
  do { if (!((buf != 
# 1247 "kernel/protocols/net/core/pbuf.c" 3 4
 ((void *)0)
# 1247 "kernel/protocols/net/core/pbuf.c"
 ))) { do {bk_printf ("pbuf_take: invalid buf") ;} while(0); return ERR_ARG;;}} while(0);
  do { if (!((dataptr != 
# 1248 "kernel/protocols/net/core/pbuf.c" 3 4
 ((void *)0)
# 1248 "kernel/protocols/net/core/pbuf.c"
 ))) { do {bk_printf ("pbuf_take: invalid dataptr") ;} while(0); return ERR_ARG;;}} while(0);
  do { if (!((buf->tot_len >= len))) { do {bk_printf ("pbuf_take: buf not large enough") ;} while(0); return ERR_MEM;;}} while(0);

  if ((buf == 
# 1251 "kernel/protocols/net/core/pbuf.c" 3 4
             ((void *)0)
# 1251 "kernel/protocols/net/core/pbuf.c"
                 ) || (dataptr == 
# 1251 "kernel/protocols/net/core/pbuf.c" 3 4
                                  ((void *)0)
# 1251 "kernel/protocols/net/core/pbuf.c"
...
# 1283 "kernel/protocols/net/core/pbuf.c"
err_t
pbuf_take_at(struct pbuf *buf, const void *dataptr, u16_t len, u16_t offset)
{
  ...
  if ((q != 
# 1290 "kernel/protocols/net/core/pbuf.c" 3 4
           ((void *)0)
# 1290 "kernel/protocols/net/core/pbuf.c"
...
# 1319 "kernel/protocols/net/core/pbuf.c"
struct pbuf*
pbuf_coalesce(struct pbuf *p, pbuf_layer layer)
{
  ...
  err_t err;
  if (p->next == 
# 1324 "kernel/protocols/net/core/pbuf.c" 3 4
                ((void *)0)
# 1324 "kernel/protocols/net/core/pbuf.c"
                    ) {
    return p;
  }
  q = pbuf_alloc(layer, p->tot_len, PBUF_RAM);
  if (q == 
# 1328 "kernel/protocols/net/core/pbuf.c" 3 4
          ((void *)0)
# 1328 "kernel/protocols/net/core/pbuf.c"
              ) {
...
# 1388 "kernel/protocols/net/core/pbuf.c"
u8_t
...
# 1406 "kernel/protocols/net/core/pbuf.c"
int
pbuf_try_get_at(const struct pbuf* p, u16_t offset)
{
  ...
  if ((q != 
# 1413 "kernel/protocols/net/core/pbuf.c" 3 4
           ((void *)0)
# 1413 "kernel/protocols/net/core/pbuf.c"
               ) && (q->len > q_idx)) {
    return ((u8_t*)q->payload)[q_idx];
  }
  return -1;
}
# 1428 "kernel/protocols/net/core/pbuf.c"
void
pbuf_put_at(struct pbuf* p, u16_t offset, u8_t data)
{
  ...
  if ((q != 
# 1435 "kernel/protocols/net/core/pbuf.c" 3 4
           ((void *)0)
# 1435 "kernel/protocols/net/core/pbuf.c"
               ) && (q->len > q_idx)) {
    ((u8_t*)q->payload)[q_idx] = data;
  }
}
# 1451 "kernel/protocols/net/core/pbuf.c"
u16_t
pbuf_memcmp(const struct pbuf* p, u16_t offset, const void* s2, u16_t n)
{
  ...
  while ((q != 
# 1464 "kernel/protocols/net/core/pbuf.c" 3 4
              ((void *)0)
# 1464 "kernel/protocols/net/core/pbuf.c"
                  ) && (q->len <= start)) {
    start -= q->len;
    q = q->next;
  }
...
# 1493 "kernel/protocols/net/core/pbuf.c"
u16_t
...
# 1520 "kernel/protocols/net/core/pbuf.c"
u16_t
pbuf_strstr(const struct pbuf* p, const char* substr)
{
  size_t substr_len;
  if ((substr == 
# 1524 "kernel/protocols/net/core/pbuf.c" 3 4
                ((void *)0)
# 1524 "kernel/protocols/net/core/pbuf.c"
