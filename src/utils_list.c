# 1 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
# 21 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
...
# 22 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 2
...
# 23 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 2
# 1 "./framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/lite-utils_internal.h" 1
# 35 "./framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/lite-utils_internal.h"
...
# 24 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 2
# 1 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.h" 1
# 28 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.h"
typedef enum {
    LIST_HEAD,
    LIST_TAIL
} list_direction_t;
...
# 25 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 2
...
{
    list_t *self;
    self = LITE_malloc_internal(__func__, 34, sizeof(list_t));
    if (!self) {
        return 
# 36 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
              ((void *)0)
# 36 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                  ;
    }
    self->head = 
# 38 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
                ((void *)0)
# 38 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                    ;
    self->tail = 
# 39 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
                ((void *)0)
# 39 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                    ;
    self->free = 
# 40 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
                ((void *)0)
# 40 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                    ;
    self->match = 
# 41 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
                 ((void *)0)
# 41 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                     ;
    self->len = 0;
    return self;
}
...
void list_destroy(list_t *self)
{
    ...
    while (len--) {
        ...
        do { if(!curr) { LITE_syslog(__FUNCTION__, 60, LOG_ERR_LEVEL, "%s == NULL! LITE_free(%s) aborted.", "curr", "curr"); break; } LITE_free_internal((void *)curr); curr = 
# 60 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
       ((void *)0)
# 60 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
       ; } while(0);
        curr = next;
    }

    do { if(!self) { LITE_syslog(__FUNCTION__, 64, LOG_ERR_LEVEL, "%s == NULL! LITE_free(%s) aborted.", "self", "self"); break; } LITE_free_internal((void *)self); self = 
# 64 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
   ((void *)0)
# 64 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
   ; } while(0);
}
...
list_node_t *list_rpush(list_t *self, list_node_t *node)
{
    if (!node) {
        return 
# 74 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
              ((void *)0)
# 74 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                  ;
    }
    ...
    if (self->len) {
        node->prev = self->tail;
        node->next = 
# 79 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
                    ((void *)0)
# 79 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                        ;
        self->tail->next = node;
        self->tail = node;
    } else {
        ...
        node->prev = node->next = 
# 84 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
                                 ((void *)0)
# 84 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                                     ;
    }
...
{
    list_node_t *node = 
# 96 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
                       ((void *)0)
# 96 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                           ;
    if (!self->len) {
        return 
# 98 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
              ((void *)0)
# 98 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                  ;
    }
...
# 104 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
                                         ((void *)0)
# 104 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                                             ;
    } else {
        self->tail = self->head = 
# 106 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
                                 ((void *)0)
# 106 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                                     ;
    }

    node->next = node->prev = 
# 109 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
                             ((void *)0)
# 109 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                                 ;
    return node;
}
...
{
    list_node_t *node = 
# 118 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
                       ((void *)0)
# 118 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                           ;
    if (!self->len) {
        return 
# 120 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
              ((void *)0)
# 120 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                  ;
    }
    ...
    if (--self->len) {
        (self->head = node->next)->prev = 
# 126 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
                                         ((void *)0)
# 126 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                                             ;
    } else {
        self->head = self->tail = 
# 128 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
                                 ((void *)0)
# 128 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                                     ;
    }

    node->next = node->prev = 
# 131 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
                             ((void *)0)
# 131 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                                 ;
    return node;
}
...
list_node_t *list_lpush(list_t *self, list_node_t *node)
{
    if (!node) {
        return 
# 142 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
              ((void *)0)
# 142 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                  ;
    }
    ...
    if (self->len) {
        node->next = self->head;
        node->prev = 
# 147 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
                    ((void *)0)
# 147 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                        ;
        self->head->prev = node;
        self->head = node;
    } else {
        self->head = self->tail = node;
        node->prev = node->next = 
# 152 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
                                 ((void *)0)
# 152 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                                     ;
    }
...
list_node_t *list_find(list_t *self, void *val)
{
    ...
    if (
# 167 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
       ((void *)0) 
# 167 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
            == (it = list_iterator_new(self, LIST_HEAD))) {
        return 
# 168 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
              ((void *)0)
# 168 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                  ;
    }
    ...
    list_iterator_destroy(it);
    return 
# 187 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
          ((void *)0)
# 187 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
              ;
}
...
list_node_t *list_at(list_t *self, int index)
{
    ...
    if ((unsigned) index < self->len) {
        ...
        if (
# 206 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
           ((void *)0) 
# 206 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                == (it = list_iterator_new(self, direction))) {
            return 
# 207 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
                  ((void *)0)
# 207 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                      ;
        }
        node = list_iterator_next(it);
    ...
    return 
# 218 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
          ((void *)0)
# 218 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
              ;
}
...
void list_remove(list_t *self, list_node_t *node)
{
    ...
    do { if(!node) { LITE_syslog(__FUNCTION__, 234, LOG_ERR_LEVEL, "%s == NULL! LITE_free(%s) aborted.", "node", "node"); break; } LITE_free_internal((void *)node); node = 
# 234 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
   ((void *)0)
# 234 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
   ; } while(0);
    --self->len;
}
...
list_iterator_t *list_iterator_new_from_node(list_node_t *node, list_direction_t direction)
{
    ...
    self = LITE_malloc_internal(__func__, 255, sizeof(list_iterator_t));
    if (!self) {
        return 
# 257 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
              ((void *)0)
# 257 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                  ;
    }
    self->next = node;
...
void list_iterator_destroy(list_iterator_t *self)
{
    do { if(!self) { LITE_syslog(__FUNCTION__, 282, LOG_ERR_LEVEL, "%s == NULL! LITE_free(%s) aborted.", "self", "self"); break; } LITE_free_internal((void *)self); self = 
# 282 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
   ((void *)0)
# 282 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
   ; } while(0);
    self = 
# 283 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
          ((void *)0)
# 283 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
              ;
}
...
{
    list_node_t *self;
    self = LITE_malloc_internal(__func__, 292, sizeof(list_node_t));
    if (!self) {
        return 
# 294 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
              ((void *)0)
# 294 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                  ;
    }

    self->prev = 
# 297 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
                ((void *)0)
# 297 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                    ;
    self->next = 
# 298 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c" 3 4
                ((void *)0)
# 298 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_list.c"
                    ;
    self->val = val;
    return self;
}
