# 1 "security/alicrypto/./mbedtls/library/md5.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "security/alicrypto/./mbedtls/library/md5.c"
# 28 "security/alicrypto/./mbedtls/library/md5.c"
...
# 29 "security/alicrypto/./mbedtls/library/md5.c" 2
...
# 27 "./security/alicrypto/./mbedtls/include/mbedtls/md5.h"
# 1 "./security/alicrypto/./mbedtls/include/mbedtls/config.h" 1
# 28 "./security/alicrypto/./mbedtls/include/mbedtls/md5.h" 2
...
# 34 "./security/alicrypto/./mbedtls/include/mbedtls/md5.h" 2
...
# 36 "security/alicrypto/./mbedtls/library/md5.c" 2
...
# 38 "security/alicrypto/./mbedtls/library/md5.c" 2
# 51 "security/alicrypto/./mbedtls/library/md5.c"

# 51 "security/alicrypto/./mbedtls/library/md5.c"
static void mbedtls_zeroize( void *v, size_t n ) {
    volatile unsigned char *p = v; while( n-- ) *p++ = 0;
}
# 78 "security/alicrypto/./mbedtls/library/md5.c"
void mbedtls_md5_init( mbedtls_md5_context *ctx )
{
...
{
    if( ctx == 
# 85 "security/alicrypto/./mbedtls/library/md5.c" 3 4
              ((void *)0) 
# 85 "security/alicrypto/./mbedtls/library/md5.c"
                   )
        return;
...
# 140 "security/alicrypto/./mbedtls/library/md5.c"
    A = ctx->state[0];
    B = ctx->state[1];
    C = ctx->state[2];
    D = ctx->state[3];
