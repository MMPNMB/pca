# 1 "framework/connectivity/mqtt/MQTTPacket/MQTTConnectClient.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "framework/connectivity/mqtt/MQTTPacket/MQTTConnectClient.c"
# 17 "framework/connectivity/mqtt/MQTTPacket/MQTTConnectClient.c"
...
# 18 "framework/connectivity/mqtt/MQTTPacket/MQTTConnectClient.c" 2
...
# 20 "framework/connectivity/mqtt/MQTTPacket/MQTTConnectClient.c" 2
...
# 26 "framework/connectivity/mqtt/MQTTPacket/MQTTConnectClient.c"
...
# 55 "framework/connectivity/mqtt/MQTTPacket/MQTTConnectClient.c"
int MQTTSerialize_connect(unsigned char* buf, int buflen, MQTTPacket_connectData* options)
{
...
# 128 "framework/connectivity/mqtt/MQTTPacket/MQTTConnectClient.c"
int MQTTDeserialize_connack(unsigned char* sessionPresent, unsigned char* connack_rc, unsigned char* buf, int buflen)
{
 MQTTHeader header = {0};
 unsigned char* curdata = buf;
 unsigned char* enddata = 
# 132 "framework/connectivity/mqtt/MQTTPacket/MQTTConnectClient.c" 3 4
                         ((void *)0)
# 132 "framework/connectivity/mqtt/MQTTPacket/MQTTConnectClient.c"
                             ;
 int rc = 0;
 int mylen;
...
# 163 "framework/connectivity/mqtt/MQTTPacket/MQTTConnectClient.c"
...
# 191 "framework/connectivity/mqtt/MQTTPacket/MQTTConnectClient.c"
int MQTTSerialize_disconnect(unsigned char* buf, int buflen)
{
 return MQTTSerialize_zero(buf, buflen, DISCONNECT);
}
# 203 "framework/connectivity/mqtt/MQTTPacket/MQTTConnectClient.c"
int MQTTSerialize_pingreq(unsigned char* buf, int buflen)
{
