# 1 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.c"
# 20 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.c"
# 1 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.h" 1
# 23 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.h"
...
# 24 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.h" 2
...
# 21 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.c" 2

struct list_head mem_recs = { &(mem_recs), &(mem_recs) };
# 93 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.c"
void LITE_track_malloc_callstack(int state)
{
...
void *LITE_realloc_internal(const char *f, const int l, void *ptr, int size, ...)
{
# 140 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.c"
    return realloc(ptr, size);

}
# 296 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.c"
void *LITE_malloc_internal(const char *f, const int l, int size, ...)
{
    void *ptr = 
# 298 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.c" 3 4
                                 ((void *)0)
# 298 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.c"
                                     ;
# 382 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.c"
    ptr = HAL_Malloc(size);
    if (
# 383 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.c" 3 4
       ((void *)0) 
# 383 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.c"
            == ptr) {
        return 
# 384 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.c" 3 4
              ((void *)0)
# 384 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.c"
                  ;
    }
    memset(ptr, 0, size);
    return ptr;
...
void LITE_free_internal(void *ptr)
{
# 437 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.c"
    HAL_Free(ptr);
}
...
void *LITE_malloc_routine(int size, ...)
{
    int magic = 0;
    char *module_name = 
# 443 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.c" 3 4
                       ((void *)0)
# 443 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.c"
                           ;
# 456 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.c"
    return LITE_malloc_internal(__func__, 456, size, magic, module_name);
}
...
void *LITE_calloc_routine(size_t n, size_t s, ...)
{
    int magic = 0;
    char *module_name = 
# 462 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.c" 3 4
                       ((void *)0)
# 462 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.c"
                           ;
# 475 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.c"
    return LITE_malloc_internal(__func__, 475, n * s, magic, module_name);;
}

void LITE_free_routine(void *ptr)
{
    do { if(!ptr) { LITE_syslog(__FUNCTION__, 480, LOG_ERR_LEVEL, "%s == NULL! LITE_free(%s) aborted.", "ptr", "ptr"); break; } LITE_free_internal((void *)ptr); ptr = 
# 480 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.c" 3 4
   ((void *)0)
# 480 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.c"
   ; } while(0);
}

void LITE_dump_malloc_free_stats(int level)
{
# 594 "framework/protocol/linkkit/iotkit/base/utils/LITE-utils/src/mem_stats.c"
    LITE_syslog(__FUNCTION__, 594, LOG_ERR_LEVEL, "WITH_MEM_STATS = %d", 0);
