...
# 6 "kernel/rhino/core/k_mutex.c" 2
...
kstat_t mutex_create(kmutex_t *mutex, const name_t *name, uint8_t mm_alloc_flag)
{
    ...
    do { if (mutex == 
# 11 "kernel/rhino/core/k_mutex.c" 3 4
   ((void *)0)
# 11 "kernel/rhino/core/k_mutex.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    do { if (name == 
# 12 "kernel/rhino/core/k_mutex.c" 3 4
   ((void *)0)
# 12 "kernel/rhino/core/k_mutex.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    ...
    mutex->mutex_task = 
# 18 "kernel/rhino/core/k_mutex.c" 3 4
                               ((void *)0)
# 18 "kernel/rhino/core/k_mutex.c"
                                   ;
    mutex->mutex_list = 
# 19 "kernel/rhino/core/k_mutex.c" 3 4
                               ((void *)0)
# 19 "kernel/rhino/core/k_mutex.c"
                                   ;
...
kstat_t krhino_mutex_create(kmutex_t *mutex, const name_t *name)
{
    return mutex_create(mutex, name, 1u);
}
...
kstat_t krhino_mutex_del(kmutex_t *mutex)
{
    ...
    if (mutex == 
# 61 "kernel/rhino/core/k_mutex.c" 3 4
                ((void *)0)
# 61 "kernel/rhino/core/k_mutex.c"
                    ) {
        return RHINO_NULL_PTR;
    }

    do { if (mutex == 
# 65 "kernel/rhino/core/k_mutex.c" 3 4
   ((void *)0)
# 65 "kernel/rhino/core/k_mutex.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    ...
    if (mutex->mutex_task != 
# 85 "kernel/rhino/core/k_mutex.c" 3 4
                            ((void *)0)
# 85 "kernel/rhino/core/k_mutex.c"
                                ) {
...
kstat_t krhino_mutex_dyn_create(kmutex_t **mutex, const name_t *name)
{
    ...
    if (mutex == 
# 111 "kernel/rhino/core/k_mutex.c" 3 4
                ((void *)0)
# 111 "kernel/rhino/core/k_mutex.c"
                    ) {
        return RHINO_NULL_PTR;
    }

    do { if (mutex == 
# 115 "kernel/rhino/core/k_mutex.c" 3 4
   ((void *)0)
# 115 "kernel/rhino/core/k_mutex.c"
   ) { return RHINO_NULL_PTR; } } while (0);

    mutex_obj = krhino_mm_alloc(sizeof(kmutex_t));
    if (mutex_obj == 
# 118 "kernel/rhino/core/k_mutex.c" 3 4
                    ((void *)0)
# 118 "kernel/rhino/core/k_mutex.c"
                        ) {
        return RHINO_NO_MEM;
    }

    stat = mutex_create(mutex_obj, name, 2u);
...
kstat_t krhino_mutex_dyn_del(kmutex_t *mutex)
{
    ...
    if (mutex == 
# 139 "kernel/rhino/core/k_mutex.c" 3 4
                ((void *)0)
# 139 "kernel/rhino/core/k_mutex.c"
                    ) {
        return RHINO_NULL_PTR;
    }

    do { if (mutex == 
# 143 "kernel/rhino/core/k_mutex.c" 3 4
   ((void *)0)
# 143 "kernel/rhino/core/k_mutex.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    ...
    if (mutex->mutex_task != 
# 163 "kernel/rhino/core/k_mutex.c" 3 4
                            ((void *)0)
# 163 "kernel/rhino/core/k_mutex.c"
                                ) {
        mutex_release(mutex->mutex_task, mutex);
    }
...
uint8_t mutex_pri_limit(ktask_t *task, uint8_t pri)
{
    ...
    for (mutex_tmp = task->mutex_list; mutex_tmp != 
# 195 "kernel/rhino/core/k_mutex.c" 3 4
                                                   ((void *)0)
# 195 "kernel/rhino/core/k_mutex.c"
                                                       ;
         mutex_tmp = mutex_tmp->mutex_list) {
        blk_list_head = &mutex_tmp->blk_obj.blk_list;

        if (!is_klist_empty(blk_list_head)) {
            first_blk_task = ((ktask_t *)((uint8_t *)(blk_list_head->next) - (size_t)(&((ktask_t *)0)->task_list)));
...
uint8_t mutex_pri_look(ktask_t *task, kmutex_t *mutex_rel)
{
    ...
    while ((mutex_tmp = *prev) != 
# 229 "kernel/rhino/core/k_mutex.c" 3 4
                                 ((void *)0)
# 229 "kernel/rhino/core/k_mutex.c"
                                     ) {
...
void mutex_task_pri_reset(ktask_t *task)
{
    ...
    if (task->blk_obj->obj_type == RHINO_MUTEX_OBJ_TYPE) {
        ...
        if (mutex_task->prio == task->prio) {
            mutex_release(mutex_task, 
# 263 "kernel/rhino/core/k_mutex.c" 3 4
                                     ((void *)0)
# 263 "kernel/rhino/core/k_mutex.c"
                                         );
        }
    }
}
...
kstat_t krhino_mutex_lock(kmutex_t *mutex, tick_t ticks)
{
    ...
    do { if (mutex == 
# 276 "kernel/rhino/core/k_mutex.c" 3 4
   ((void *)0)
# 276 "kernel/rhino/core/k_mutex.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    ...
    if (mutex_task == 
# 310 "kernel/rhino/core/k_mutex.c" 3 4
                     ((void *)0)
# 310 "kernel/rhino/core/k_mutex.c"
                         ) {
...
kstat_t krhino_mutex_unlock(kmutex_t *mutex)
{
    ...
    do { if (mutex == 
# 370 "kernel/rhino/core/k_mutex.c" 3 4
   ((void *)0)
# 370 "kernel/rhino/core/k_mutex.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    ...
    if (is_klist_empty(blk_list_head)) {
        ...
        mutex->mutex_task = 
# 407 "kernel/rhino/core/k_mutex.c" 3 4
                           ((void *)0)
# 407 "kernel/rhino/core/k_mutex.c"
                               ;
