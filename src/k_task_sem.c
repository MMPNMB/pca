# 1 "kernel/rhino/core/k_task_sem.c"
...
# 6 "kernel/rhino/core/k_task_sem.c" 2
                               ...
                               size_t count)
{
    ...
    if (task == 
# 13 "kernel/rhino/core/k_task_sem.c" 3 4
               ((void *)0)
# 13 "kernel/rhino/core/k_task_sem.c"
                   ) {
        return RHINO_NULL_PTR;
    }

    do { if (task == 
# 17 "kernel/rhino/core/k_task_sem.c" 3 4
   ((void *)0)
# 17 "kernel/rhino/core/k_task_sem.c"
    ...
    if (ret == RHINO_SUCCESS) {
        ...
        task->task_sem_obj = 
# 23 "kernel/rhino/core/k_task_sem.c" 3 4
                            ((void *)0)
# 23 "kernel/rhino/core/k_task_sem.c"
                                ;
    }
...
{
    do { if (task == 
# 31 "kernel/rhino/core/k_task_sem.c" 3 4
   ((void *)0)
# 31 "kernel/rhino/core/k_task_sem.c"
   ) { return RHINO_NULL_PTR; } } while (0);
...
{
    do { if (task == 
# 38 "kernel/rhino/core/k_task_sem.c" 3 4
   ((void *)0)
# 38 "kernel/rhino/core/k_task_sem.c"
   ) { return RHINO_NULL_PTR; } } while (0);
...
{
    do { if (task == 
# 50 "kernel/rhino/core/k_task_sem.c" 3 4
   ((void *)0)
# 50 "kernel/rhino/core/k_task_sem.c"
   ) { return RHINO_NULL_PTR; } } while (0);
...
{
    do { if (task == 
# 57 "kernel/rhino/core/k_task_sem.c" 3 4
   ((void *)0)
# 57 "kernel/rhino/core/k_task_sem.c"
   ) { return RHINO_NULL_PTR; } } while (0);
