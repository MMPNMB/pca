# 1 "utility/digest_algorithm/CheckSumUtils.c"
...
# 1 "utility/digest_algorithm/CheckSumUtils.h" 1
...
# 9 "utility/digest_algorithm/CheckSumUtils.h" 2
...
# 10 "utility/digest_algorithm/CheckSumUtils.h" 2
...
# 11 "utility/digest_algorithm/CheckSumUtils.h" 2
...
# 12 "utility/digest_algorithm/CheckSumUtils.h" 2
...
# 17 "utility/digest_algorithm/CheckSumUtils.h"
typedef struct {
    uint8_t crc;
} CRC8_Context;
# 28 "utility/digest_algorithm/CheckSumUtils.h"
void CRC8_Init( CRC8_Context *inContext );
# 40 "utility/digest_algorithm/CheckSumUtils.h"
void CRC8_Update( CRC8_Context *inContext, const void *inSrc, size_t inLen );
# 51 "utility/digest_algorithm/CheckSumUtils.h"
void CRC8_Final( CRC8_Context *inContext, uint8_t *outResult );
# 72 "utility/digest_algorithm/CheckSumUtils.h"
typedef struct {
    uint16_t crc;
} CRC16_Context;
# 83 "utility/digest_algorithm/CheckSumUtils.h"
void CRC16_Init( CRC16_Context *inContext );
# 95 "utility/digest_algorithm/CheckSumUtils.h"
void CRC16_Update( CRC16_Context *inContext, const void *inSrc, size_t inLen );
# 106 "utility/digest_algorithm/CheckSumUtils.h"
void CRC16_Final( CRC16_Context *inContext, uint16_t *outResult );
# 6 "utility/digest_algorithm/CheckSumUtils.c" 2
