...
# 6 "kernel/rhino/core/k_time.c" 2

void krhino_tick_proc(void)
{
# 17 "kernel/rhino/core/k_time.c"
    tick_list_update(1);
...
sys_time_t krhino_sys_time_get(void)
{
    return (sys_time_t)(krhino_sys_tick_get() * 1000 / 500);
}
...
tick_t krhino_ms_to_ticks(sys_time_t ms)
{
    ...
    ticks += ((surplus + padding) * 500) / 1000;
