# 1 "framework/connectivity/mqtt/MQTTPacket/MQTTSubscribeClient.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "framework/connectivity/mqtt/MQTTPacket/MQTTSubscribeClient.c"
# 17 "framework/connectivity/mqtt/MQTTPacket/MQTTSubscribeClient.c"
...
# 18 "framework/connectivity/mqtt/MQTTPacket/MQTTSubscribeClient.c" 2
...
# 20 "framework/connectivity/mqtt/MQTTPacket/MQTTSubscribeClient.c" 2
...
# 27 "framework/connectivity/mqtt/MQTTPacket/MQTTSubscribeClient.c"
...
# 49 "framework/connectivity/mqtt/MQTTPacket/MQTTSubscribeClient.c"
...
# 97 "framework/connectivity/mqtt/MQTTPacket/MQTTSubscribeClient.c"
int MQTTDeserialize_suback(unsigned short* packetid, int maxcount, int* count, int grantedQoSs[], unsigned char* buf, int buflen)
{
 MQTTHeader header = {0};
 unsigned char* curdata = buf;
 unsigned char* enddata = 
# 101 "framework/connectivity/mqtt/MQTTPacket/MQTTSubscribeClient.c" 3 4
                         ((void *)0)
# 101 "framework/connectivity/mqtt/MQTTPacket/MQTTSubscribeClient.c"
                             ;
 int rc = 0;
 int mylen;
