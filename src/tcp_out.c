# 1 "kernel/protocols/net/core/tcp_out.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/core/tcp_out.c"
# 41 "kernel/protocols/net/core/tcp_out.c"
...
# 42 "kernel/protocols/net/core/tcp_out.c" 2
...
# 46 "kernel/protocols/net/core/tcp_out.c" 2
...
# 52 "kernel/protocols/net/core/tcp_out.c" 2
...
# 60 "kernel/protocols/net/core/tcp_out.c" 2
# 95 "kernel/protocols/net/core/tcp_out.c"

# 95 "kernel/protocols/net/core/tcp_out.c"
static err_t tcp_output_segment(struct tcp_seg *seg, struct tcp_pcb *pcb, struct netif *netif);
# 107 "kernel/protocols/net/core/tcp_out.c"
static struct pbuf *
                      ...
                      u32_t seqno_be )
{
  ...
  if (p != 
# 113 "kernel/protocols/net/core/tcp_out.c" 3 4
          ((void *)0)
# 113 "kernel/protocols/net/core/tcp_out.c"
              ) {
...
tcp_send_fin(struct tcp_pcb *pcb)
{
  ...
  if (pcb->unsent != 
# 142 "kernel/protocols/net/core/tcp_out.c" 3 4
                    ((void *)0)
# 142 "kernel/protocols/net/core/tcp_out.c"
                        ) {
    struct tcp_seg *last_unsent;
    for (last_unsent = pcb->unsent; last_unsent->next != 
# 144 "kernel/protocols/net/core/tcp_out.c" 3 4
                                                        ((void *)0)
# 144 "kernel/protocols/net/core/tcp_out.c"
                                                            ;
...
# 172 "kernel/protocols/net/core/tcp_out.c"
...
# 178 "kernel/protocols/net/core/tcp_out.c" 3 4
                                                            ((void *)0)
# 178 "kernel/protocols/net/core/tcp_out.c"
                                                                ) {
    do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("tcp_create_segment: no memory.\n") ;} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0);
    pbuf_free(p);
    return 
# 181 "kernel/protocols/net/core/tcp_out.c" 3 4
          ((void *)0)
# 181 "kernel/protocols/net/core/tcp_out.c"
              ;
  }
  seg->flags = optflags;
  seg->next = 
# 184 "kernel/protocols/net/core/tcp_out.c" 3 4
             ((void *)0)
# 184 "kernel/protocols/net/core/tcp_out.c"
                 ;
  seg->p = p;
  ;
  ...
  seg->oversize_left = 0;
# 200 "kernel/protocols/net/core/tcp_out.c"
  if (pbuf_header(p, 20)) {
    do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("tcp_create_segment: no room for TCP header in pbuf.\n") ;} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0);
    ;
    tcp_seg_free(seg);
    return 
# 204 "kernel/protocols/net/core/tcp_out.c" 3 4
          ((void *)0)
# 204 "kernel/protocols/net/core/tcp_out.c"
              ;
  }
...
# 232 "kernel/protocols/net/core/tcp_out.c"
static struct pbuf *
                  ...
                  u8_t first_seg)
{
  struct pbuf *p;
  u16_t alloc = length;
# 247 "kernel/protocols/net/core/tcp_out.c"
  if (length < max_length) {
# 259 "kernel/protocols/net/core/tcp_out.c"
    if ((apiflags & 0x02) ||
        (!(pcb->flags & 0x40U) &&
         (!first_seg ||
          pcb->unsent != 
# 262 "kernel/protocols/net/core/tcp_out.c" 3 4
                        ((void *)0) 
# 262 "kernel/protocols/net/core/tcp_out.c"
                             ||
          pcb->unacked != 
# 263 "kernel/protocols/net/core/tcp_out.c" 3 4
                         ((void *)0)
# 263 "kernel/protocols/net/core/tcp_out.c"
                             ))) {
  ...
  if (p == 
# 269 "kernel/protocols/net/core/tcp_out.c" 3 4
          ((void *)0)
# 269 "kernel/protocols/net/core/tcp_out.c"
              ) {
    return 
# 270 "kernel/protocols/net/core/tcp_out.c" 3 4
          ((void *)0)
# 270 "kernel/protocols/net/core/tcp_out.c"
              ;
  }
  ;
...
# 306 "kernel/protocols/net/core/tcp_out.c"
static err_t
tcp_write_checks(struct tcp_pcb *pcb, u16_t len)
{
  ...
  if ((pcb->state != ESTABLISHED) &&
      ...
      (pcb->state != SYN_SENT) &&
      (pcb->state != SYN_RCVD)) {
    do { if ( ((0x00U | 0x20U | 0x03) & 0x80U) && ((0x00U | 0x20U | 0x03) & 0x80U) && ((s16_t)((0x00U | 0x20U | 0x03) & 0x03) >= 0x00)) { do {bk_printf ("tcp_write() called in invalid state\n") ;} while(0); if ((0x00U | 0x20U | 0x03) & 0x08U) { while(1); } } } while(0);
    return ERR_CONN;
  } else if (len == 0) {
    return ERR_OK;
  }
  ...
  if (len > pcb->snd_buf) {
    do { if ( ((0x00U | 0x03) & 0x80U) && ((0x00U | 0x03) & 0x80U) && ((s16_t)((0x00U | 0x03) & 0x03) >= 0x00)) { do {bk_printf ("tcp_write: too much data (len=%""4d"" > snd_buf=%""4d"")\n", len, pcb->snd_buf) ;} while(0); if ((0x00U | 0x03) & 0x08U) { while(1); } } } while(0)
                         ;
    pcb->flags |= 0x80U;
    return ERR_MEM;
  }

  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_write: queuelen: %""4d""\n", (tcpwnd_size_t)pcb->snd_queuelen) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);




  if ((pcb->snd_queuelen >= (20)) || (pcb->snd_queuelen > (0xffffU-3))) {
    do { if ( ((0x00U | 0x03) & 0x80U) && ((0x00U | 0x03) & 0x80U) && ((s16_t)((0x00U | 0x03) & 0x03) >= 0x00)) { do {bk_printf ("tcp_write: too long queue %""4d"" (max %""4d"")\n", pcb->snd_queuelen, (u16_t)(20)) ;} while(0); if ((0x00U | 0x03) & 0x08U) { while(1); } } } while(0)
                                                  ;
    ;
    pcb->flags |= 0x80U;
    return ERR_MEM;
...
# 367 "kernel/protocols/net/core/tcp_out.c"
err_t
tcp_write(struct tcp_pcb *pcb, const void *arg, u16_t len, u8_t apiflags)
{
  struct pbuf *concat_p = 
# 370 "kernel/protocols/net/core/tcp_out.c" 3 4
                         ((void *)0)
# 370 "kernel/protocols/net/core/tcp_out.c"
                             ;
  struct tcp_seg *last_unsent = 
# 371 "kernel/protocols/net/core/tcp_out.c" 3 4
                               ((void *)0)
# 371 "kernel/protocols/net/core/tcp_out.c"
                                   , *seg = 
# 371 "kernel/protocols/net/core/tcp_out.c" 3 4
                                            ((void *)0)
# 371 "kernel/protocols/net/core/tcp_out.c"
...
# 371 "kernel/protocols/net/core/tcp_out.c"
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_write(pcb=%p, data=%p, len=%""4d"", apiflags=%""4d"")\n", (void *)pcb, arg, len, (u16_t)apiflags) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
                                            ;
  do { if (!(arg != 
# 397 "kernel/protocols/net/core/tcp_out.c" 3 4
 ((void *)0)
# 397 "kernel/protocols/net/core/tcp_out.c"
 )) { do {bk_printf ("tcp_write: arg == NULL (programmer violates API)") ;} while(0); return ERR_ARG;;}} while(0)
                                          ;
...
# 441 "kernel/protocols/net/core/tcp_out.c"
  if (pcb->unsent != 
# 441 "kernel/protocols/net/core/tcp_out.c" 3 4
                    ((void *)0)
# 441 "kernel/protocols/net/core/tcp_out.c"
                        ) {
    u16_t space;
    ...
    for (last_unsent = pcb->unsent; last_unsent->next != 
# 446 "kernel/protocols/net/core/tcp_out.c" 3 4
                                                        ((void *)0)
# 446 "kernel/protocols/net/core/tcp_out.c"
                                                            ;
         last_unsent = last_unsent->next);
...
# 464 "kernel/protocols/net/core/tcp_out.c"
    ...
    ;
# 487 "kernel/protocols/net/core/tcp_out.c"
...
# 496 "kernel/protocols/net/core/tcp_out.c" 3 4
                                                                                                   ((void *)0)
# 496 "kernel/protocols/net/core/tcp_out.c"
                                                                                                       ) {
          do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("tcp_write : could not allocate memory for pbuf copy size %""4d""\n", seglen) ;} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0)
...
# 511 "kernel/protocols/net/core/tcp_out.c" 3 4
                                                                  ((void *)0)
# 511 "kernel/protocols/net/core/tcp_out.c"
                                                                      ) {
          do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("tcp_write: could not allocate memory for zero-copy pbuf\n") ;} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0)
                                                                                    ;
          goto memerr;
        }
...
# 555 "kernel/protocols/net/core/tcp_out.c" 3 4
                                                                                                               ((void *)0)
# 555 "kernel/protocols/net/core/tcp_out.c"
                                                                                                                   )) == 
# 555 "kernel/protocols/net/core/tcp_out.c" 3 4
                                                                                                                         ((void *)0)
# 555 "kernel/protocols/net/core/tcp_out.c"
...
# 572 "kernel/protocols/net/core/tcp_out.c" 3 4
                                                                ((void *)0)
# 572 "kernel/protocols/net/core/tcp_out.c"
                                                                    ) {
        do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("tcp_write: could not allocate memory for zero-copy pbuf\n") ;} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0);
        goto memerr;
      }
# 585 "kernel/protocols/net/core/tcp_out.c"
      ((struct pbuf_rom*)p2)->payload = (const u8_t*)arg + pos;


      if ((p = pbuf_alloc(PBUF_TRANSPORT, optlen, PBUF_RAM)) == 
# 588 "kernel/protocols/net/core/tcp_out.c" 3 4
                                                               ((void *)0)
# 588 "kernel/protocols/net/core/tcp_out.c"
                                                                   ) {


        pbuf_free(p2);
        do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("tcp_write: could not allocate memory for header pbuf\n") ;} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0);
        goto memerr;
      }
    ...
    if ((queuelen > (20)) || (queuelen > (0xffffU-3))) {
      do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("tcp_write: queue too long %""4d"" (%d)\n", queuelen, (int)(20)) ;} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0)
                                         ;
      pbuf_free(p);
      goto memerr;
    }
...
# 611 "kernel/protocols/net/core/tcp_out.c" 3 4
                                                                              ((void *)0)
# 611 "kernel/protocols/net/core/tcp_out.c"
                                                                                  ) {
      goto memerr;
    }

    seg->oversize_left = oversize;
# 624 "kernel/protocols/net/core/tcp_out.c"
    if (queue == 
# 624 "kernel/protocols/net/core/tcp_out.c" 3 4
                ((void *)0)
# 624 "kernel/protocols/net/core/tcp_out.c"
                    ) {
      queue = seg;
    ...
    do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_write: queueing %""8ld"":%""8ld""\n", lwip_htonl(seg->tcphdr->seqno), lwip_htonl(seg->tcphdr->seqno) + ((seg)->len + (((((u16_t)(lwip_htons(((seg)->tcphdr)->_hdrlen_rsvd_flags) & 0x3fU)) & (0x01U | 0x02U)) != 0) ? 1U : 0U))) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0)

                                                        ;

    pos += seglen;
  }
# 651 "kernel/protocols/net/core/tcp_out.c"
  if (oversize_used > 0) {
    struct pbuf *p;
    ...
    for (p = last_unsent->p; p; p = p->next) {
      ...
      if (p->next == 
# 656 "kernel/protocols/net/core/tcp_out.c" 3 4
                    ((void *)0)
# 656 "kernel/protocols/net/core/tcp_out.c"
                        ) {
  ...
  if (concat_p != 
# 674 "kernel/protocols/net/core/tcp_out.c" 3 4
                 ((void *)0)
# 674 "kernel/protocols/net/core/tcp_out.c"
                     ) {
   
                            ;
    pbuf_cat(last_unsent->p, concat_p);
    last_unsent->len += concat_p->tot_len;
# 690 "kernel/protocols/net/core/tcp_out.c"
  }
  ...
  if (last_unsent == 
# 696 "kernel/protocols/net/core/tcp_out.c" 3 4
                    ((void *)0)
# 696 "kernel/protocols/net/core/tcp_out.c"
                        ) {
    pcb->unsent = queue;
  } else {
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_write: %""4d"" (after enqueued)\n", pcb->snd_queuelen) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
                       ;
  if (pcb->snd_queuelen != 0) {
  ...
  if (seg != 
# 717 "kernel/protocols/net/core/tcp_out.c" 3 4
            ((void *)0) 
# 717 "kernel/protocols/net/core/tcp_out.c"
                 && seg->tcphdr != 
# 717 "kernel/protocols/net/core/tcp_out.c" 3 4
                                   ((void *)0) 
# 717 "kernel/protocols/net/core/tcp_out.c"
...
memerr:
  ...
  if (concat_p != 
# 726 "kernel/protocols/net/core/tcp_out.c" 3 4
                 ((void *)0)
# 726 "kernel/protocols/net/core/tcp_out.c"
                     ) {
    pbuf_free(concat_p);
  }
  if (queue != 
# 729 "kernel/protocols/net/core/tcp_out.c" 3 4
              ((void *)0)
# 729 "kernel/protocols/net/core/tcp_out.c"
                  ) {
    tcp_segs_free(queue);
  }
  if (pcb->snd_queuelen != 0) {
  ...
  do { if ( ((0x00U | 0x20U) & 0x80U) && ((0x00U | 0x20U) & 0x80U) && ((s16_t)((0x00U | 0x20U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_write: %""4d"" (with mem err)\n", pcb->snd_queuelen) ;} while(0); if ((0x00U | 0x20U) & 0x08U) { while(1); } } } while(0);
  return ERR_MEM;
}
# 748 "kernel/protocols/net/core/tcp_out.c"
err_t
tcp_enqueue_flags(struct tcp_pcb *pcb, u8_t flags)
{
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_enqueue_flags: queuelen: %""4d""\n", (u16_t)pcb->snd_queuelen) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  ...
  if (((pcb->snd_queuelen >= (20)) || (pcb->snd_queuelen > (0xffffU-3))) &&
      ((flags & 0x01U) == 0)) {
    do { if ( ((0x00U | 0x03) & 0x80U) && ((0x00U | 0x03) & 0x80U) && ((s16_t)((0x00U | 0x03) & 0x03) >= 0x00)) { do {bk_printf ("tcp_enqueue_flags: too long queue %""4d"" (max %""4d"")\n", pcb->snd_queuelen, (u16_t)(20)) ;} while(0); if ((0x00U | 0x03) & 0x08U) { while(1); } } } while(0)
                                                                                   ;
    ;
    pcb->flags |= 0x80U;
    return ERR_MEM;
  ...
  if ((p = pbuf_alloc(PBUF_TRANSPORT, optlen, PBUF_RAM)) == 
# 791 "kernel/protocols/net/core/tcp_out.c" 3 4
                                                           ((void *)0)
# 791 "kernel/protocols/net/core/tcp_out.c"
                                                               ) {
    pcb->flags |= 0x80U;
    ;
    return ERR_MEM;
...
# 800 "kernel/protocols/net/core/tcp_out.c" 3 4
                                                                          ((void *)0)
# 800 "kernel/protocols/net/core/tcp_out.c"
                                                                              ) {
    pcb->flags |= 0x80U;
    ;
    return ERR_MEM;
  ...
  do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_enqueue_flags: queueing %""8ld"":%""8ld"" (0x%""4x"")\n", lwip_htonl(seg->tcphdr->seqno), lwip_htonl(seg->tcphdr->seqno) + ((seg)->len + (((((u16_t)(lwip_htons(((seg)->tcphdr)->_hdrlen_rsvd_flags) & 0x3fU)) & (0x01U | 0x02U)) != 0) ? 1U : 0U)), (u16_t)flags) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0)
  ...
  if (pcb->unsent == 
# 815 "kernel/protocols/net/core/tcp_out.c" 3 4
                    ((void *)0)
# 815 "kernel/protocols/net/core/tcp_out.c"
                        ) {
    pcb->unsent = seg;
  } else {
    struct tcp_seg *useg;
    for (useg = pcb->unsent; useg->next != 
# 819 "kernel/protocols/net/core/tcp_out.c" 3 4
                                          ((void *)0)
# 819 "kernel/protocols/net/core/tcp_out.c"
                                              ; useg = useg->next);
    useg->next = seg;
  }
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_enqueue_flags: %""4d"" (after enqueued)\n", pcb->snd_queuelen) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  if (pcb->snd_queuelen != 0) {
...
# 881 "kernel/protocols/net/core/tcp_out.c"
err_t
tcp_send_empty_ack(struct tcp_pcb *pcb)
{
  ...
  struct tcp_hdr *tcphdr;
# 898 "kernel/protocols/net/core/tcp_out.c"
  p = tcp_output_alloc_header(pcb, optlen, 0, lwip_htonl(pcb->snd_nxt));
  if (p == 
# 899 "kernel/protocols/net/core/tcp_out.c" 3 4
          ((void *)0)
# 899 "kernel/protocols/net/core/tcp_out.c"
              ) {

    pcb->flags |= (0x01U | 0x02U);
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_output: (ACK) could not allocate pbuf\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    return ERR_BUF;
  }

  tcphdr = (struct tcp_hdr *)p->payload;

  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_output: sending ACK for %""8ld""\n", pcb->rcv_nxt) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
                                                                       ;
# 920 "kernel/protocols/net/core/tcp_out.c"
  netif = ip4_route(&pcb->remote_ip);
  if (netif == 
# 921 "kernel/protocols/net/core/tcp_out.c" 3 4
              ((void *)0)
# 921 "kernel/protocols/net/core/tcp_out.c"
                  ) {
    err = ERR_RTE;
  } else {
...
# 956 "kernel/protocols/net/core/tcp_out.c"
err_t
tcp_output(struct tcp_pcb *pcb)
{
  ...
  if (pcb->flags & 0x02U &&
     (seg == 
# 990 "kernel/protocols/net/core/tcp_out.c" 3 4
            ((void *)0) 
# 990 "kernel/protocols/net/core/tcp_out.c"
                 ||
  ...
  useg = pcb->unacked;
  if (useg != 
# 997 "kernel/protocols/net/core/tcp_out.c" 3 4
             ((void *)0)
# 997 "kernel/protocols/net/core/tcp_out.c"
                 ) {
    for (; useg->next != 
# 998 "kernel/protocols/net/core/tcp_out.c" 3 4
                        ((void *)0)
# 998 "kernel/protocols/net/core/tcp_out.c"
                            ; useg = useg->next);
  }

  netif = ip4_route(&pcb->remote_ip);
  if (netif == 
# 1002 "kernel/protocols/net/core/tcp_out.c" 3 4
              ((void *)0)
# 1002 "kernel/protocols/net/core/tcp_out.c"
                  ) {
    return ERR_RTE;
  }
  ...
  if (((&pcb->local_ip) == 
# 1007 "kernel/protocols/net/core/tcp_out.c" 3 4
     ((void *)0) 
# 1007 "kernel/protocols/net/core/tcp_out.c"
     || ((*(&pcb->local_ip)).addr == ((u32_t)0x00000000UL)))) {
    const ip_addr_t *local_ip = (((netif) != 
# 1008 "kernel/protocols/net/core/tcp_out.c" 3 4
                               ((void *)0)
# 1008 "kernel/protocols/net/core/tcp_out.c"
...
# 1008 "kernel/protocols/net/core/tcp_out.c"
    ...
    if (local_ip == 
# 1009 "kernel/protocols/net/core/tcp_out.c" 3 4
                   ((void *)0)
# 1009 "kernel/protocols/net/core/tcp_out.c"
                       ) {
      return ERR_RTE;
    }
    ((pcb->local_ip).addr = (*local_ip).addr);
  }
# 1037 "kernel/protocols/net/core/tcp_out.c"
  while (seg != 
# 1037 "kernel/protocols/net/core/tcp_out.c" 3 4
               ((void *)0) 
# 1037 "kernel/protocols/net/core/tcp_out.c"
                    &&
         lwip_htonl(seg->tcphdr->seqno) - pcb->lastack + seg->len <= wnd) {
    ...
    if ((((((pcb)->unacked == 
# 1048 "kernel/protocols/net/core/tcp_out.c" 3 4
        ((void *)0)
# 1048 "kernel/protocols/net/core/tcp_out.c"
...
# 1048 "kernel/protocols/net/core/tcp_out.c" 3 4
        ((void *)0)
# 1048 "kernel/protocols/net/core/tcp_out.c"
        ) || ((pcb)->unsent->len >= (pcb)->mss))) || (((((pcb)->snd_buf)) == 0) || (((pcb)->snd_queuelen) >= (20))) ) ? 1 : 0) == 0) &&
      ((pcb->flags & (0x80U | 0x20U)) == 0)) {
      break;
    }
# 1061 "kernel/protocols/net/core/tcp_out.c"
    ...
    if (((seg)->len + (((((u16_t)(lwip_htons(((seg)->tcphdr)->_hdrlen_rsvd_flags) & 0x3fU)) & (0x01U | 0x02U)) != 0) ? 1U : 0U)) > 0) {
      seg->next = 
# 1084 "kernel/protocols/net/core/tcp_out.c" 3 4
                 ((void *)0)
# 1084 "kernel/protocols/net/core/tcp_out.c"
                     ;

      if (pcb->unacked == 
# 1086 "kernel/protocols/net/core/tcp_out.c" 3 4
                         ((void *)0)
# 1086 "kernel/protocols/net/core/tcp_out.c"
                             ) {
        pcb->unacked = seg;
        useg = seg;
  ...
  if (pcb->unsent == 
# 1116 "kernel/protocols/net/core/tcp_out.c" 3 4
                    ((void *)0)
# 1116 "kernel/protocols/net/core/tcp_out.c"
                        ) {
...
# 1133 "kernel/protocols/net/core/tcp_out.c"
static err_t
...
# 1159 "kernel/protocols/net/core/tcp_out.c"
  {
...
# 1196 "kernel/protocols/net/core/tcp_out.c"
  if (pcb->rtime < 0) {
    pcb->rtime = 0;
  }
  ...
  if (pcb->rttest == 0) {
    ...
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_output_segment: rtseq %""8ld""\n", pcb->rtseq) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  }
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_output_segment: %""8ld"":%""8ld""\n", lwip_htonl(seg->tcphdr->seqno), lwip_htonl(seg->tcphdr->seqno) + seg->len) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
  ...
  {
# 1254 "kernel/protocols/net/core/tcp_out.c"
...
# 1288 "kernel/protocols/net/core/tcp_out.c"
void
  ...
  u16_t local_port, u16_t remote_port)
{
  ...
  if (p == 
# 1297 "kernel/protocols/net/core/tcp_out.c" 3 4
          ((void *)0)
# 1297 "kernel/protocols/net/core/tcp_out.c"
              ) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_rst: could not allocate memory for pbuf\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    return;
  }
  ...
  tcphdr->wnd = (((((3*(1500 - 40))) & 0xff) << 8) | ((((3*(1500 - 40))) & 0xff00) >> 8));
  ...
  if (netif != 
# 1322 "kernel/protocols/net/core/tcp_out.c" 3 4
              ((void *)0)
# 1322 "kernel/protocols/net/core/tcp_out.c"
                  ) {
  ...
  pbuf_free(p);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_rst: seqno %""8ld"" ackno %""8ld"".\n", seqno, ackno) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
}
# 1343 "kernel/protocols/net/core/tcp_out.c"
void
tcp_rexmit_rto(struct tcp_pcb *pcb)
{
  ...
  if (pcb->unacked == 
# 1348 "kernel/protocols/net/core/tcp_out.c" 3 4
                     ((void *)0)
# 1348 "kernel/protocols/net/core/tcp_out.c"
                         ) {
    return;
  }
...
# 1353 "kernel/protocols/net/core/tcp_out.c" 3 4
                                       ((void *)0)
# 1353 "kernel/protocols/net/core/tcp_out.c"
                                           ; seg = seg->next);
  ...
  if (pcb->unsent == 
# 1358 "kernel/protocols/net/core/tcp_out.c" 3 4
                    ((void *)0)
# 1358 "kernel/protocols/net/core/tcp_out.c"
                        ) {
  ...
  pcb->unacked = 
# 1365 "kernel/protocols/net/core/tcp_out.c" 3 4
                ((void *)0)
# 1365 "kernel/protocols/net/core/tcp_out.c"
                    ;
...
# 1384 "kernel/protocols/net/core/tcp_out.c"
void
tcp_rexmit(struct tcp_pcb *pcb)
{
  ...
  if (pcb->unacked == 
# 1390 "kernel/protocols/net/core/tcp_out.c" 3 4
                     ((void *)0)
# 1390 "kernel/protocols/net/core/tcp_out.c"
                         ) {
    return;
  }
  ...
  *cur_seg = seg;
  ...
  if (seg->next == 
# 1407 "kernel/protocols/net/core/tcp_out.c" 3 4
                  ((void *)0)
# 1407 "kernel/protocols/net/core/tcp_out.c"
                      ) {
...
{
  if (pcb->unacked != 
# 1433 "kernel/protocols/net/core/tcp_out.c" 3 4
                     ((void *)0) 
# 1433 "kernel/protocols/net/core/tcp_out.c"
                          && !(pcb->flags & 0x04U)) {

    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_receive: dupacks %""4d"" (%""8ld" "), fast retransmit %""8ld""\n", (u16_t)pcb->dupacks, pcb->lastack, lwip_htonl(pcb->unacked->tcphdr->seqno)) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
    ...
    if (pcb->ssthresh < (2U * pcb->mss)) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_receive: The minimum value for ssthresh %""4d" " should be min 2 mss %""4d""...\n", pcb->ssthresh, (u16_t)(2*pcb->mss)) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
...
# 1476 "kernel/protocols/net/core/tcp_out.c"
err_t
tcp_keepalive(struct tcp_pcb *pcb)
{
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_keepalive: sending KEEPALIVE probe to ") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)((&pcb->remote_ip) != 
# 1484 "kernel/protocols/net/core/tcp_out.c" 3 4
 ((void *)0) 
# 1484 "kernel/protocols/net/core/tcp_out.c"
...
# 1484 "kernel/protocols/net/core/tcp_out.c"
 ? ((u16_t)(((const u8_t*)(&(&pcb->remote_ip)->addr))[3])) : 0)) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_keepalive: tcp_ticks %""8ld""   pcb->tmr %""8ld"" pcb->keep_cnt_sent %""4d""\n", tcp_ticks, pcb->tmr, (u16_t)pcb->keep_cnt_sent) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
                                                                          ;

  p = tcp_output_alloc_header(pcb, 0, 0, lwip_htonl(pcb->snd_nxt - 1));
  if (p == 
# 1491 "kernel/protocols/net/core/tcp_out.c" 3 4
          ((void *)0)
# 1491 "kernel/protocols/net/core/tcp_out.c"
              ) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_keepalive: could not allocate memory for pbuf\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
                                                                        ;
    return ERR_MEM;
  }
  netif = ip4_route(&pcb->remote_ip);
  if (netif == 
# 1497 "kernel/protocols/net/core/tcp_out.c" 3 4
              ((void *)0)
# 1497 "kernel/protocols/net/core/tcp_out.c"
                  ) {
    err = ERR_RTE;
  } else {
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_keepalive: seqno %""8ld"" ackno %""8ld"" err %d.\n", pcb->snd_nxt - 1, pcb->rcv_nxt, (int)err) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
                                                                    ;
  return err;
}
# 1530 "kernel/protocols/net/core/tcp_out.c"
err_t
tcp_zero_window_probe(struct tcp_pcb *pcb)
{
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_zero_window_probe: sending ZERO WINDOW probe to ") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)((&pcb->remote_ip) != 
# 1543 "kernel/protocols/net/core/tcp_out.c" 3 4
 ((void *)0) 
# 1543 "kernel/protocols/net/core/tcp_out.c"
 ? ((u16_t)(((const u8_t*)(&(&pcb->remote_ip)->addr))[0])) : 0), (u16_t)((&pcb->remote_ip) != 
# 1543 "kernel/protocols/net/core/tcp_out.c" 3 4
 ((void *)0) 
# 1543 "kernel/protocols/net/core/tcp_out.c"
...
# 1543 "kernel/protocols/net/core/tcp_out.c"
 ? ((u16_t)(((const u8_t*)(&(&pcb->remote_ip)->addr))[3])) : 0)) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_zero_window_probe: tcp_ticks %""8ld" "   pcb->tmr %""8ld"" pcb->keep_cnt_sent %""4d""\n", tcp_ticks, pcb->tmr, (u16_t)pcb->keep_cnt_sent) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
  ...
  if (seg == 
# 1553 "kernel/protocols/net/core/tcp_out.c" 3 4
            ((void *)0)
# 1553 "kernel/protocols/net/core/tcp_out.c"
                ) {
    seg = pcb->unsent;
  }
  if (seg == 
# 1556 "kernel/protocols/net/core/tcp_out.c" 3 4
            ((void *)0)
# 1556 "kernel/protocols/net/core/tcp_out.c"
                ) {
  ...
  if (p == 
# 1566 "kernel/protocols/net/core/tcp_out.c" 3 4
          ((void *)0)
# 1566 "kernel/protocols/net/core/tcp_out.c"
              ) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_zero_window_probe: no memory for pbuf\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    return ERR_MEM;
  }
  tcphdr = (struct tcp_hdr *)p->payload;
  ...
  netif = ip4_route(&pcb->remote_ip);
  if (netif == 
# 1591 "kernel/protocols/net/core/tcp_out.c" 3 4
              ((void *)0)
# 1591 "kernel/protocols/net/core/tcp_out.c"
                  ) {
    err = ERR_RTE;
  } else {
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_zero_window_probe: seqno %""8ld" " ackno %""8ld"" err %d.\n", pcb->snd_nxt - 1, pcb->rcv_nxt, (int)err) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
