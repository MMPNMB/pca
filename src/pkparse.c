# 1 "security/mbedtls/src/pkparse.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "security/mbedtls/src/pkparse.c"
# 23 "security/mbedtls/src/pkparse.c"
...
# 24 "security/mbedtls/src/pkparse.c" 2
...
# 31 "security/mbedtls/src/pkparse.c" 2
...
# 32 "security/mbedtls/src/pkparse.c" 2
# 1 "./security/mbedtls/include/mbedtls/oid.h" 1
# 32 "./security/mbedtls/include/mbedtls/oid.h"
# 1 "./security/mbedtls/include/mbedtls/asn1.h" 1
# 33 "./security/mbedtls/include/mbedtls/oid.h" 2
# 1 "./security/mbedtls/include/mbedtls/pk.h" 1
# 34 "./security/mbedtls/include/mbedtls/oid.h" 2
...
# 47 "./security/mbedtls/include/mbedtls/oid.h" 2
...
# 33 "security/mbedtls/src/pkparse.c" 2
...
# 33 "./security/mbedtls/include/mbedtls/x509_crt.h"
...
# 34 "security/mbedtls/src/pkparse.c" 2
...
# 36 "security/mbedtls/src/pkparse.c" 2


# 1 "./security/mbedtls/include/mbedtls/rsa.h" 1
# 39 "security/mbedtls/src/pkparse.c" 2
# 47 "security/mbedtls/src/pkparse.c"
...
# 48 "security/mbedtls/src/pkparse.c" 2
# 57 "security/mbedtls/src/pkparse.c"
...
# 58 "security/mbedtls/src/pkparse.c" 2
...
# 515 "security/mbedtls/src/pkparse.c"
                             ...
                             mbedtls_rsa_context *rsa )
{
    ...
    *p += len;
    ...
    do { } while( 0 );
    do { } while( 0 );
# 580 "security/mbedtls/src/pkparse.c"
    return( 0 );
}
# 590 "security/mbedtls/src/pkparse.c"
                          ...
                          mbedtls_pk_type_t *pk_alg, mbedtls_asn1_buf *params )
{
    ...
    if( alg_oid.len != 0x09 ||
        memcmp(alg_oid.p, CRT_OID_PKCS1_RSA, 0x09 ) ) {
        do { } while( 0 );
        return( -0x2600 );
    } else {
        *pk_alg = MBEDTLS_PK_RSA;
    }
# 619 "security/mbedtls/src/pkparse.c"
...
# 661 "security/mbedtls/src/pkparse.c" 3 4
                                                            ((void *)0) 
# 661 "security/mbedtls/src/pkparse.c"
                                                                 )
        return( -0x3C80 );
...
# 681 "security/mbedtls/src/pkparse.c"
        ret = -0x3C80;
...
# 905 "security/mbedtls/src/pkparse.c"
                                    ...
                                    size_t keylen )
{
    ...
    mbedtls_pk_type_t pk_alg = MBEDTLS_PK_NONE;
    const mbedtls_pk_info_t *pk_info;
# 934 "security/mbedtls/src/pkparse.c"
    if( ( ret = mbedtls_asn1_get_tag( &p, end, &len,
            0x20 | 0x10 ) ) != 0 )
    {
        return( -0x3D00 + ret );
    ...
    if( ( pk_info = mbedtls_pk_info_from_type( pk_alg ) ) == 
# 958 "security/mbedtls/src/pkparse.c" 3 4
                                                            ((void *)0) 
# 958 "security/mbedtls/src/pkparse.c"
                                                                 )
        return( -0x3C80 );

    if( ( ret = mbedtls_pk_setup( pk, pk_info ) ) != 0 )
        return( ret );
# 987 "security/mbedtls/src/pkparse.c"
        return( -0x3C80 );

    return( 0 );
}
# 1118 "security/mbedtls/src/pkparse.c"
...
# 1164 "security/mbedtls/src/pkparse.c"
    (void)pwd;
    (void)pwdlen;
    (void)pk_info;
# 1203 "security/mbedtls/src/pkparse.c"
    if( keylen == 0 || key[keylen - 1] != '\0' )
        ...
        ret = mbedtls_pem_read_buffer( &pem,
                               ...
                               "-----END PRIVATE KEY-----",
                               key, 
# 1209 "security/mbedtls/src/pkparse.c" 3 4
                                   ((void *)0)
# 1209 "security/mbedtls/src/pkparse.c"
                                       , 0, &len );
    if( ret == 0 )
    {
        ...
        return( ret );
# 1276 "security/mbedtls/src/pkparse.c"
    if( ( ret = pk_parse_key_pkcs8_unencrypted_der( pk, key, keylen ) ) == 0 )
        return( 0 );

    mbedtls_pk_free( pk );
# 1309 "security/mbedtls/src/pkparse.c"
    return( -0x3D00 );
}
                         ...
                         const unsigned char *key, size_t keylen )
{
    ...
    if( keylen == 0 || key[keylen - 1] != '\0' )
        ...
        ret = mbedtls_pem_read_buffer( &pem,
                ...
                "-----END PUBLIC KEY-----",
                key, 
# 1333 "security/mbedtls/src/pkparse.c" 3 4
                    ((void *)0)
# 1333 "security/mbedtls/src/pkparse.c"
                        , 0, &len );
