# 1 "framework/connectivity/mqtt/mqtt_instance.c"
...
# 2 "framework/connectivity/mqtt/mqtt_instance.c" 2
...
# 3 "framework/connectivity/mqtt/mqtt_instance.c" 2
...
# 4 "framework/connectivity/mqtt/mqtt_instance.c" 2
...
# 5 "framework/connectivity/mqtt/mqtt_instance.c" 2
# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/assert.h" 1 3
# 39 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/arm-none-eabi/include/assert.h" 3
void __assert (const char *, int, const char *) __attribute__ ((__noreturn__))
                                 ;
void __assert_func (const char *, int, const char *, const char *) __attribute__ ((__noreturn__))
                                 ;
# 6 "framework/connectivity/mqtt/mqtt_instance.c" 2
...
# 8 "framework/connectivity/mqtt/mqtt_instance.c" 2
...
# 9 "framework/connectivity/mqtt/mqtt_instance.c" 2
# 1 "./framework/protocol/linkkit/iotkit/base/utils/iot_export.h" 1
# 29 "./framework/protocol/linkkit/iotkit/base/utils/iot_export.h"
...
# 54 "./framework/protocol/linkkit/iotkit/base/utils/iot_export.h"
typedef struct {
    char product_key[(20) + 1];
    char device_name[(32) + 1];
    char device_id[(64) + 1];
    char device_secret[(64) + 1];
    char module_vendor_id[(32) + 1];
} iotx_device_info_t, *iotx_device_info_pt;

typedef struct {
    uint16_t port;
    char host_name[(128) + 1];
    char client_id[(256) + 1];
    char username[(512) + 1];
    char password[(256) + 1];
    const char *pub_key;
...
# 92 "./framework/protocol/linkkit/iotkit/base/utils/iot_export.h"
...
# 110 "./framework/protocol/linkkit/iotkit/base/utils/iot_export.h"
void IOT_SetLogLevel(IOT_LogLevel level);
# 120 "./framework/protocol/linkkit/iotkit/base/utils/iot_export.h"
void IOT_DumpMemoryStats(IOT_LogLevel level);
# 141 "./framework/protocol/linkkit/iotkit/base/utils/iot_export.h"
int IOT_SetupConnInfo(const char *product_key,
                          const char *device_name,
                          const char *device_secret,
                          void **info_ptr);
# 158 "./framework/protocol/linkkit/iotkit/base/utils/iot_export.h"
...
# 1 "./framework/protocol/linkkit/iotkit/base/utils/exports/iot_export_errno.h" 1
# 23 "./framework/protocol/linkkit/iotkit/base/utils/exports/iot_export_errno.h"
typedef enum IOT_RETURN_CODES {
    ...
    NETWORK_RECONNECT_TIMED_OUT_ERROR = -40,
    MQTT_CONNACK_UNKNOWN_ERROR = -39,
    MQTT_CONANCK_UNACCEPTABLE_PROTOCOL_VERSION_ERROR = -38,
    MQTT_CONNACK_IDENTIFIER_REJECTED_ERROR = -37,
    MQTT_CONNACK_SERVER_UNAVAILABLE_ERROR = -36,
    MQTT_CONNACK_BAD_USERDATA_ERROR = -35,
    MQTT_CONNACK_NOT_AUTHORIZED_ERROR = -34,
    ...
    ERROR_SHADOW_UPDATE_NACK = -2005,
    ERROR_SHADOW_NO_ATTRIBUTE = -2004,
    ERROR_SHADOW_ATTR_NO_EXIST = -2003,
    ERROR_SHADOW_ATTR_EXIST = -2002,
    ERROR_SHADOW_WAIT_LIST_OVERFLOW = -2001,
    ERROR_SHADOW_INVALID_STATE = -2000,

 ERROR_SUBDEV_NULL_VALUE = -1501,
 ERROR_SUBDEV_NOT_NULL_VALUE = -1500,
 ERROR_SUBDEV_STRING_NULL_VALUE = -1499,
 ERROR_SUBDEV_INVALID_GATEWAY_HANDLE = -1498,
 ERROR_SUBDEV_SESSION_NOT_FOUND = -1497,
 ERROR_SUBDEV_RRPC_CB_NOT_NULL = -1496,
 ERROR_SUBDEV_REPLY_TYPE_NOT_DEF = -1495,
 ERROR_SUBDEV_GET_JSON_VAL = -1494,
 ERROR_SUBDEV_DATA_LEN_OVERFLOW = -1493,
 ERROR_SUBDEV_MSG_LEN = -1492,
 ERROR_SUBDEV_REPLY_PROC = -1491,
 ERROR_SUBDEV_REPLY_TOPIC_NOT_MATCH = -1490,
 ERROR_SUBDEV_REPLY_VAL_CHECK = -1489,
 ERROR_SUBDEV_REGISTER_TYPE_NOT_DEF = -1488,
 ERROR_SUBDEV_PACKET_SPLICE_FAIL = -1487,
 ERROR_SUBDEV_MQTT_PUBLISH_FAIL = -1486,
 ERROR_SUBDEV_REPLY_PARSE_FAIL = -1485,
 ERROR_SUBDEV_CREATE_SESSION_FAIL = -1484,
 ERROR_SUBDEV_INVALID_CLEAN_SESSION_TYPE = -1483,
 ERROR_SUBDEV_HAS_BEEN_LOGIN = -1482,
 ERROR_SUBDEV_SUB_UNSUB_FAIL = -1481,
 ERROR_SUBDEV_SESSION_STATE_FAIL = -1480,
 ERROR_SUBDEV_MEMORY_NOT_ENOUGH = -1479,

 ERROR_REPLY_TIMEOUT = -6099,
 ERROR_DEVICE_NOT_FOUND = -6100,
 ERROR_TOO_LARGE_PAGE_SIZE = -6101,
 ERROR_DEVICE_COUNT_FAULT = -6102,
 ERROR_DEVICE_DETAIL_FAULT = -6103,
 ERROR_TOO_LARGE_LIST_SIZE = -6104,
 ERROR_LIST_SIZE_CANNOT_BE_ZERO = -6105,
 ERROR_TOO_LARGE_MAP_SIZE = -6106,
 ERROR_MAP_SIZE_CANNOT_BE_ZERO = -6107,
 ERROR_DEVICE_STATUS_FAULT = -6108,
 ERROR_DEVICE_INFO_FAULT = -6109,
 ERROR_SET_THING_PROPERTIES_ERROR = -6150,
 ERROR_INVOKE_THING_SERVICE_ERROR = -6151,
 ERROR_SCRIPT_REL_NOT_EXIST = -6200,
 ERROR_SCRIPT_CONVERT_DATA_IS_NULL = -6201,
 ERROR_DEVICE_PRODUCT_NOT_EXIST = -6202,
 ERROR_TOPIC_NOT_EXIST = -6203,
 ERROR_DEVICE_IS_DISABLED = -6204,
 ERROR_IOT_MESSAGE_ERROR = -6205,
 ERROR_PRODUCT_PROPERTY_NOT_EXIST = -6206,
 ERROR_DATA_FORMAT_ERROR = -6207,
 ERROR_THING_STATUS_PROHIBITED = -6208,
 ERROR_THING_STATUS_NOT_ACTIVE = -6209,




 ERROR_PRODUCT_NOT_FOUND = -6250,
 ERROR_DEVICE_EXISTS = -6251,
 ERROR_JUDGE_DEVICE_EXISTS_ERROR = -6252,
 ERROR_ADD_DEVICE_FAILED = -6253,
 ERROR_UPDATE_DEVICE_FAILED = -6254,
 ERROR_INSERT_DGR_FAILED = -6255,
 ERROR_SYN_DEVICE_FAILED = -6256,
 ERROR_PRODUCT_DOMAIN_ILLEGAL = -6257,
 ERROR_TENANID_ILLEGAL = -6258,
 ERROR_PRODUCT_REGION_ILLEGAL = -6259,
 ERROR_PRODUCT_NETTYPE_ILLEGAL = -6260,
 ERROR_INSERT_DEVICE_APPLY_DETAIL_FAILED = -6261,
 ERROR_UPDATE_DEVICE_APPLY_STATUS_FAILED = -6262,
 ERROR_DELERE_DGR_FAILED = -6263,
 ERROR_DELETE_DEVICE_FAILED = -6264,
 ERROR_QUERY_DEVICE_DETAIL_FAILED = -6265,
 ERROR_QUERY_DEVICE_COUNT_FAILED = -6266,
 ERROR_QUERY_ACTIVE_DEVICE_COUNT_FAILED = -6267,
 ERROR_INSERT_AGR_FAILED = -6268,
 ERROR_QUERY_DEVICE_APPLY_FAILED = -6269,
 ERROR_QUERY_PRODUCT_FAILED = -6270,
 ERROR_DEVICE_APPLY_NOT_FOUND = -6271,
 ERROR_RELEASE_TRIAD_FAILED = -6272,
 ERROR_UPDATE_DAD_STATUS_FAILED = -6273,
 ERROR_REG_LORA_DEVICE_FAILED = -6274,
 ERROR_SYN_APPLY_DEVICE_FAILED = -6275,
 ERROR_QUERY_DGR_FAILED = -6276,
 ERROR_JUDGE_DGR_FAILED = -6277,
 ERROR_QUERY_AGR_FAILED = -6278,
 ERROR_JUDGE_AGR_FAILED = -6279,
 ERROR_DEVICENAME_NOT_MEET_SPECS = -6280,
 ERROR_DELETE_APPLY_DEVICE_FAILED = -6281,
 ERROR_GEN_DEVICEID_FAILED = -6282,
 ERROR_APPLY_ILLEGAL = -6283,
 ERROR_LORA_DEVICE_METHOD_ERROR = -6284,
 ERROR_APPLY_NOT_READY = -6285,
 ...
 ERROR_DSL_PARSE_METHOD_NOT_EXIST = -6300,
 ERROR_DSL_PARSE_PARAMS_FORMAT_ERROR = -6301,
 ERROR_DSL_PARSE_PARAMS_VALUE_EMPTY = -6302,
 ERROR_DSL_PARSE_PARAMS_NUMBER_ERROR = -6303,
 ERROR_DSL_PARSE_PARAMS_NOT_EXIST = -6304,
 ERROR_DSL_PARSE_PARAMS_TYPE_ERROR = -6305,
 ERROR_DSL_PARSE_INT_SPECS_ERROR = -6306,
 ERROR_DSL_PARSE_FLOAT_SPECS_ERROR = -6307,
 ERROR_DSL_PARSE_BOOL_SPECS_ERROR = -6308,
 ERROR_DSL_PARSE_ENUM_SPECS_ERROR = -6309,
 ERROR_DSL_PARSE_STRING_SPECS_ERROR = -6310,
 ERROR_DSL_PARSE_DATE_SPECS_ERROR = -6311,
 ERROR_DSL_PARSE_STRUCT_SPECS_ERROR = -6312,
 ERROR_DSL_SERVICE_NOT_AVAILABLE = -6313,
 ERROR_DSL_PARSE_DATA_TYPE_PARSE_ERROR = -6314,
 ERROR_DATA_NOT_SATISFY_DSL = -6315,
 ERROR_DSL_PARSE_SPECS_NUMBER_FORMAT_ERROR = -6316,
 ERROR_DSL_PARSE_TEMPLATE_ERROR = -6317,
 ERROR_DSL_EXCEPTION = -6318,
 ERROR_DSL_PARSE_EVENT_CALL_TYPE_ERROR = -6319,
 ERROR_DSL_PARSE_NO_PROPERTY = -6320,
 ERROR_DSL_PARSE_IDENTIFIER_IS_NULL = -6321,
 ERROR_DSL_DEVICE_NOT_EXIST_IN_PRODUCT = -6321,
 ERROR_DSL_PARSE_DOUBLE_SPECS_ERROR = -6322,





 ERROR_EVENT_PUT_ERROR = -6350,
 ERROR_SERVICE_PUT_ERROR = -6351,
 ERROR_DEVICE_GET_EVENT_FAULT = -6352,
 ERROR_PRODUCT_KEY_ELEMENT_ALREADY_EXIST = -6353,





 ERROR_TOPO_RELATION_COUNT_EXCEED = -6400,
 ERROR_TOPO_RELATION_NOT_EXIST = -6401,
 ERROR_TOPO_RELATION_CANNOT_ADD_BYSELF = -6402,





 ERROR_ALINK_METHOD_NOT_EXIST = -6450,





 ERROR_DEVICE_GROUP_NOT_FOUND = -6550,


    ERROR_NO_MEM = -1016,
    ERROR_CERTIFICATE_EXPIRED = -1015,
    ERROR_MALLOC = -1014,
    ERROR_NO_ENOUGH_MEM = -1013,
...
# 167 "./framework/protocol/linkkit/iotkit/base/utils/iot_export.h" 2
# 10 "framework/connectivity/mqtt/mqtt_instance.c" 2
# 1 "framework/connectivity/mqtt/iot_export_mqtt.h" 1
# 24 "framework/connectivity/mqtt/iot_export_mqtt.h"
typedef enum {
    IOTX_MQTT_QOS0 = 0,
    IOTX_MQTT_QOS1,
    IOTX_MQTT_QOS2
...
# 115 "framework/connectivity/mqtt/iot_export_mqtt.h"
    void *msg;
} iotx_mqtt_event_msg_t, *iotx_mqtt_event_msg_pt;
# 129 "framework/connectivity/mqtt/iot_export_mqtt.h"
...
# 185 "framework/connectivity/mqtt/iot_export_mqtt.h"
void *IOT_MQTT_Construct(iotx_mqtt_param_t *pInitParams);
# 198 "framework/connectivity/mqtt/iot_export_mqtt.h"
void *IOT_MQTT_ConstructSecure(iotx_mqtt_param_t *pInitParams);
# 210 "framework/connectivity/mqtt/iot_export_mqtt.h"
int IOT_MQTT_Destroy(void **phandle);
# 223 "framework/connectivity/mqtt/iot_export_mqtt.h"
int IOT_MQTT_Yield(void *handle, int timeout_ms);
# 235 "framework/connectivity/mqtt/iot_export_mqtt.h"
int IOT_MQTT_CheckStateNormal(void *handle);
# 253 "framework/connectivity/mqtt/iot_export_mqtt.h"
int IOT_MQTT_Subscribe(void *handle,
                       const char *topic_filter,
                       iotx_mqtt_qos_t qos,
                       iotx_mqtt_event_handle_func_fpt topic_handle_func,
                       void *pcontext);
# 272 "framework/connectivity/mqtt/iot_export_mqtt.h"
int IOT_MQTT_Unsubscribe(void *handle, const char *topic_filter);
# 289 "framework/connectivity/mqtt/iot_export_mqtt.h"
int IOT_MQTT_Publish(void *handle, const char *topic_name, iotx_mqtt_topic_info_pt topic_msg);
# 11 "framework/connectivity/mqtt/mqtt_instance.c" 2

# 1 "framework/connectivity/mqtt/mqtt_instance.h" 1
...
# 19 "framework/connectivity/mqtt/mqtt_instance.h"
void *mqtt_get_instance();
# 30 "framework/connectivity/mqtt/mqtt_instance.h"
void mqtt_remove_instance();
# 42 "framework/connectivity/mqtt/mqtt_instance.h"
int mqtt_set_instance(void* mqtt_t);
# 60 "framework/connectivity/mqtt/mqtt_instance.h"
int mqtt_init_instance(char *productKey, char *deviceName, char *deviceSecret, int maxMsgSize);
# 71 "framework/connectivity/mqtt/mqtt_instance.h"
int mqtt_deinit_instance();
# 84 "framework/connectivity/mqtt/mqtt_instance.h"
int mqtt_set_event_cb(void (*event)(int event, void *ctx), void *ctx);
# 98 "framework/connectivity/mqtt/mqtt_instance.h"
int mqtt_subscribe(char *topic, void (*cb)(char *topic, int topic_len, void *payload, int payload_len, void *ctx), void *ctx);
# 110 "framework/connectivity/mqtt/mqtt_instance.h"
int mqtt_unsubscribe(char *topic);
# 125 "framework/connectivity/mqtt/mqtt_instance.h"
int mqtt_publish(char *topic, int qos, void *data, int len);
# 13 "framework/connectivity/mqtt/mqtt_instance.c" 2
# 21 "framework/connectivity/mqtt/mqtt_instance.c"
static void *mqtt_client = 
# 21 "framework/connectivity/mqtt/mqtt_instance.c" 3 4
                          ((void *)0)
# 21 "framework/connectivity/mqtt/mqtt_instance.c"
                              ;

static void *mqtt_rbuf = 
# 23 "framework/connectivity/mqtt/mqtt_instance.c" 3 4
                        ((void *)0)
# 23 "framework/connectivity/mqtt/mqtt_instance.c"
                            ;
static void *mqtt_wbuf = 
# 24 "framework/connectivity/mqtt/mqtt_instance.c" 3 4
                        ((void *)0)
# 24 "framework/connectivity/mqtt/mqtt_instance.c"
                            ;
...
static mqtt_instance_event_t *first_event = 
# 35 "framework/connectivity/mqtt/mqtt_instance.c" 3 4
                                           ((void *)0)
# 35 "framework/connectivity/mqtt/mqtt_instance.c"
                                               ;
...
static void event_list_remove(mqtt_instance_event_t *ev)
{
    ...
    ep = &first_event;
    while ((*ep) != 
# 49 "framework/connectivity/mqtt/mqtt_instance.c" 3 4
                   ((void *)0)
# 49 "framework/connectivity/mqtt/mqtt_instance.c"
                       ) {
        e1 = *ep;
        if (e1 == ev)
            *ep = ev->next;
...
{
    mqtt_client = 
# 88 "framework/connectivity/mqtt/mqtt_instance.c" 3 4
                 ((void *)0)
# 88 "framework/connectivity/mqtt/mqtt_instance.c"
                     ;
}

int mqtt_set_instance(void* mqtt_t)
{
    if (mqtt_client || mqtt_t == 
# 93 "framework/connectivity/mqtt/mqtt_instance.c" 3 4
                                ((void *)0)
# 93 "framework/connectivity/mqtt/mqtt_instance.c"
                                    )
        return FAIL_RETURN;
...
int mqtt_init_instance(char *productKey, char *deviceName, char *deviceSecret, int maxMsgSize)
{
    ...
    mqtt_rbuf = LITE_malloc_internal(__func__, 121, maxMsgSize);
    if (!mqtt_rbuf)
        return -1;

    mqtt_wbuf = LITE_malloc_internal(__func__, 125, maxMsgSize);
    if (!mqtt_wbuf)
        goto fail;
...
# 148 "framework/connectivity/mqtt/mqtt_instance.c" 3 4
                                       ((void *)0)
# 148 "framework/connectivity/mqtt/mqtt_instance.c"
                                           ;
...
int mqtt_deinit_instance(void)
{
    ...
    if (mqtt_rbuf) {
        do { if(!mqtt_rbuf) { LITE_syslog(__FUNCTION__, 167, LOG_ERR_LEVEL, "%s == NULL! LITE_free(%s) aborted.", "mqtt_rbuf", "mqtt_rbuf"); break; } LITE_free_internal((void *)mqtt_rbuf); mqtt_rbuf = 
# 167 "framework/connectivity/mqtt/mqtt_instance.c" 3 4
       ((void *)0)
# 167 "framework/connectivity/mqtt/mqtt_instance.c"
       ; } while(0);
        mqtt_rbuf = 
# 168 "framework/connectivity/mqtt/mqtt_instance.c" 3 4
                   ((void *)0)
# 168 "framework/connectivity/mqtt/mqtt_instance.c"
                       ;
    }

    if (mqtt_wbuf) {
        do { if(!mqtt_wbuf) { LITE_syslog(__FUNCTION__, 172, LOG_ERR_LEVEL, "%s == NULL! LITE_free(%s) aborted.", "mqtt_wbuf", "mqtt_wbuf"); break; } LITE_free_internal((void *)mqtt_wbuf); mqtt_wbuf = 
# 172 "framework/connectivity/mqtt/mqtt_instance.c" 3 4
       ((void *)0)
# 172 "framework/connectivity/mqtt/mqtt_instance.c"
       ; } while(0);
        mqtt_wbuf = 
# 173 "framework/connectivity/mqtt/mqtt_instance.c" 3 4
                   ((void *)0)
# 173 "framework/connectivity/mqtt/mqtt_instance.c"
                       ;
    }
    ...
    if (mqtt_client) {
        ...
        mqtt_client = 
# 178 "framework/connectivity/mqtt/mqtt_instance.c" 3 4
                     ((void *)0)
# 178 "framework/connectivity/mqtt/mqtt_instance.c"
                         ;
    }
    ...
    for (ev = first_event; ev; ev = ev_next) {
        ...
        do { if(!ev) { LITE_syslog(__FUNCTION__, 185, LOG_ERR_LEVEL, "%s == NULL! LITE_free(%s) aborted.", "ev", "ev"); break; } LITE_free_internal((void *)ev); ev = 
# 185 "framework/connectivity/mqtt/mqtt_instance.c" 3 4
       ((void *)0)
# 185 "framework/connectivity/mqtt/mqtt_instance.c"
       ; } while(0);
    }

    first_event = 
# 188 "framework/connectivity/mqtt/mqtt_instance.c" 3 4
                 ((void *)0)
# 188 "framework/connectivity/mqtt/mqtt_instance.c"
                     ;
...
int mqtt_set_event_cb(void (*event_cb)(int event, void *ctx), void *ctx)
{
    ...
    mqtt_instance_event_t *ev = LITE_malloc_internal(__func__, 203, sizeof(mqtt_instance_event_t));
    if (!ev)
        return -1;
...
static mqtt_instance_topic_t *first_topic = 
# 225 "framework/connectivity/mqtt/mqtt_instance.c" 3 4
                                           ((void *)0)
# 225 "framework/connectivity/mqtt/mqtt_instance.c"
                                               ;
...
static void topic_list_remove(mqtt_instance_topic_t *t)
{
    ...
    tp = &first_topic;
    while ((*tp) != 
# 239 "framework/connectivity/mqtt/mqtt_instance.c" 3 4
                   ((void *)0)
# 239 "framework/connectivity/mqtt/mqtt_instance.c"
                       ) {
        t1 = *tp;
        if (t1 == t)
            *tp = t->next;
...
int mqtt_subscribe(char *topic, void (*cb)(char *topic, int topic_len, void *payload, int len, void *ctx), void *ctx)
{
    ...
    mqtt_instance_topic_t *t = LITE_malloc_internal(__func__, 267, sizeof(mqtt_instance_topic_t));
    if (!t)
        return -1;
    memset(t, 0, sizeof(mqtt_instance_topic_t));

    t->topic = LITE_malloc_internal(__func__, 272, strlen(topic) + 1);
    if (!t->topic) {
        do { if(!t) { LITE_syslog(__FUNCTION__, 274, LOG_ERR_LEVEL, "%s == NULL! LITE_free(%s) aborted.", "t", "t"); break; } LITE_free_internal((void *)t); t = 
# 274 "framework/connectivity/mqtt/mqtt_instance.c" 3 4
       ((void *)0)
# 274 "framework/connectivity/mqtt/mqtt_instance.c"
       ; } while(0);
        return -1;
    }
    ...
    if (ret < 0) {
        do { if(!t->topic) { LITE_syslog(__FUNCTION__, 284, LOG_ERR_LEVEL, "%s == NULL! LITE_free(%s) aborted.", "t->topic", "t->topic"); break; } LITE_free_internal((void *)t->topic); t->topic = 
# 284 "framework/connectivity/mqtt/mqtt_instance.c" 3 4
       ((void *)0)
# 284 "framework/connectivity/mqtt/mqtt_instance.c"
       ; } while(0);
        do { if(!t) { LITE_syslog(__FUNCTION__, 285, LOG_ERR_LEVEL, "%s == NULL! LITE_free(%s) aborted.", "t", "t"); break; } LITE_free_internal((void *)t); t = 
# 285 "framework/connectivity/mqtt/mqtt_instance.c" 3 4
       ((void *)0)
# 285 "framework/connectivity/mqtt/mqtt_instance.c"
       ; } while(0);
        return -1;
    }
...
int mqtt_unsubscribe(char *topic)
{
    ...
    for (t = first_topic; t; t = t_next) {
        ...
        if (strcmp(t->topic, topic) == 0) {
            ...
            topic_list_remove(t);
            do { if(!t->topic) { LITE_syslog(__FUNCTION__, 307, LOG_ERR_LEVEL, "%s == NULL! LITE_free(%s) aborted.", "t->topic", "t->topic"); break; } LITE_free_internal((void *)t->topic); t->topic = 
# 307 "framework/connectivity/mqtt/mqtt_instance.c" 3 4
           ((void *)0)
# 307 "framework/connectivity/mqtt/mqtt_instance.c"
           ; } while(0);
            do { if(!t) { LITE_syslog(__FUNCTION__, 308, LOG_ERR_LEVEL, "%s == NULL! LITE_free(%s) aborted.", "t", "t"); break; } LITE_free_internal((void *)t); t = 
# 308 "framework/connectivity/mqtt/mqtt_instance.c" 3 4
           ((void *)0)
# 308 "framework/connectivity/mqtt/mqtt_instance.c"
           ; } while(0);
            t = 
# 309 "framework/connectivity/mqtt/mqtt_instance.c" 3 4
               ((void *)0)
# 309 "framework/connectivity/mqtt/mqtt_instance.c"
                   ;
        }
    }
...
int mqtt_publish(char *topic, int qos, void *data, int len)
{
    ...
    if (IOT_MQTT_Publish(mqtt_client, topic, &mqtt_msg) < 0) {
        do { printf("\033[1;31;40m%s.%d: ", __func__, 331); printf("IOT_MQTT_Publish failed\n"); printf("\033[0m"); } while (0);
        return -1;
    }
