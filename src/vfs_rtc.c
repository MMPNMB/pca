...
# 1 "././kernel/vfs/device/../include/device/vfs_rtc.h" 1
# 12 "././kernel/vfs/device/../include/device/vfs_rtc.h"
...
# 13 "././kernel/vfs/device/../include/device/vfs_rtc.h" 2


extern const struct file_ops rtc_ops;
# 24 "././kernel/vfs/device/../include/device/vfs_rtc.h"
int vfs_rtc_open(inode_t *inode, file_t *fp);
# 33 "././kernel/vfs/device/../include/device/vfs_rtc.h"
int vfs_rtc_close(file_t *fp);
# 45 "././kernel/vfs/device/../include/device/vfs_rtc.h"
ssize_t vfs_rtc_read(file_t *fp, void *buf, size_t nbytes);
# 57 "././kernel/vfs/device/../include/device/vfs_rtc.h"
ssize_t vfs_rtc_write(file_t *fp, const void *buf, size_t nbytes);
# 6 "kernel/vfs/device/vfs_rtc.c" 2
...
# 7 "kernel/vfs/device/vfs_rtc.c" 2
# 1 "././kernel/vfs/device/../include/vfs_err.h" 1
# 8 "kernel/vfs/device/vfs_rtc.c" 2
...
int vfs_rtc_open(inode_t *inode, file_t *fp)
{
    int ret = -1;
    rtc_dev_t *rtc_dev = 
# 21 "kernel/vfs/device/vfs_rtc.c" 3 4
                        ((void *)0)
# 21 "kernel/vfs/device/vfs_rtc.c"
                            ;


    if ((fp != 
# 24 "kernel/vfs/device/vfs_rtc.c" 3 4
              ((void *)0)
# 24 "kernel/vfs/device/vfs_rtc.c"
                  ) && (fp->node != 
# 24 "kernel/vfs/device/vfs_rtc.c" 3 4
                                    ((void *)0)
# 24 "kernel/vfs/device/vfs_rtc.c"
        ...
        ret = -
# 38 "kernel/vfs/device/vfs_rtc.c" 3
              22
# 38 "kernel/vfs/device/vfs_rtc.c"
                    ;
    }
...
int vfs_rtc_close(file_t *fp)
{
    int ret = -1;
    rtc_dev_t *rtc_dev = 
# 47 "kernel/vfs/device/vfs_rtc.c" 3 4
                        ((void *)0)
# 47 "kernel/vfs/device/vfs_rtc.c"
                            ;


    if ((fp != 
# 50 "kernel/vfs/device/vfs_rtc.c" 3 4
              ((void *)0)
# 50 "kernel/vfs/device/vfs_rtc.c"
                  ) && (fp->node != 
# 50 "kernel/vfs/device/vfs_rtc.c" 3 4
                                    ((void *)0)
# 50 "kernel/vfs/device/vfs_rtc.c"
        ...
        ret = -
# 72 "kernel/vfs/device/vfs_rtc.c" 3
              22
# 72 "kernel/vfs/device/vfs_rtc.c"
                    ;
    }
...
ssize_t vfs_rtc_read(file_t *fp, void *buf, size_t nbytes)
{
    int ret = -1;
    rtc_dev_t *rtc_dev = 
# 81 "kernel/vfs/device/vfs_rtc.c" 3 4
                        ((void *)0)
# 81 "kernel/vfs/device/vfs_rtc.c"
                            ;


    if ((fp != 
# 84 "kernel/vfs/device/vfs_rtc.c" 3 4
              ((void *)0)
# 84 "kernel/vfs/device/vfs_rtc.c"
                  ) && (fp->node != 
# 84 "kernel/vfs/device/vfs_rtc.c" 3 4
                                    ((void *)0)
# 84 "kernel/vfs/device/vfs_rtc.c"
                                        ) && (nbytes >= sizeof(rtc_time_t))) {
        ...
        ret = -
# 105 "kernel/vfs/device/vfs_rtc.c" 3
              22
# 105 "kernel/vfs/device/vfs_rtc.c"
                    ;
    }
...
ssize_t vfs_rtc_write(file_t *fp, const void *buf, size_t nbytes)
{
    int ret = -1;
    rtc_dev_t *rtc_dev = 
# 114 "kernel/vfs/device/vfs_rtc.c" 3 4
                        ((void *)0)
# 114 "kernel/vfs/device/vfs_rtc.c"
                            ;


    if ((fp != 
# 117 "kernel/vfs/device/vfs_rtc.c" 3 4
              ((void *)0)
# 117 "kernel/vfs/device/vfs_rtc.c"
                  ) && (fp->node != 
# 117 "kernel/vfs/device/vfs_rtc.c" 3 4
                                    ((void *)0)
# 117 "kernel/vfs/device/vfs_rtc.c"
        ...
        ret = -
# 139 "kernel/vfs/device/vfs_rtc.c" 3
              22
# 139 "kernel/vfs/device/vfs_rtc.c"
                    ;
    }
