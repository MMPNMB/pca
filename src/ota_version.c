# 1 "framework/fota/ota_version.c"
...
# 6 "framework/fota/ota_version.c" 2
...
# 7 "framework/fota/ota_version.c" 2
...
# 9 "framework/fota/ota_version.c" 2
...
# 10 "framework/fota/ota_version.c" 2
...
# 11 "framework/fota/ota_version.c" 2
...
# 12 "framework/fota/ota_version.c" 2
...
{
    int len = (64);
    memset(version_config.ota_version, 0, (64));
    aos_kv_get("ota_ota_version", version_config.ota_version, &len);
...
{
    if (str == 
# 30 "framework/fota/ota_version.c" 3 4
              ((void *)0)
# 30 "framework/fota/ota_version.c"
                  ) {
        return ;
    }
    aos_kv_set("ota_ota_version", str, (64), 1);
}

const char *ota_get_dev_version(void)
{
    int len = (64);
    memset(version_config.dev_version, 0, (64));
    aos_kv_get("ota_dev_version", version_config.dev_version, &len);
...
{
    if (str == 
# 46 "framework/fota/ota_version.c" 3 4
              ((void *)0)
# 46 "framework/fota/ota_version.c"
                  ) {
        return ;
    }
    aos_kv_set("ota_dev_version", str, (64), 1);
}
...
# 74 "framework/fota/ota_version.c"
const char *aos_get_os_version(void)
{
