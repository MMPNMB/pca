# 1 "kernel/protocols/net/core/inet_chksum.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/core/inet_chksum.c"
# 48 "kernel/protocols/net/core/inet_chksum.c"
...
# 49 "kernel/protocols/net/core/inet_chksum.c" 2

# 1 "./kernel/protocols/net/include/lwip/inet_chksum.h" 1
# 42 "./kernel/protocols/net/include/lwip/inet_chksum.h"
...
# 43 "./kernel/protocols/net/include/lwip/inet_chksum.h" 2
...
# 44 "./kernel/protocols/net/include/lwip/inet_chksum.h" 2
...
# 51 "kernel/protocols/net/core/inet_chksum.c" 2



# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/lib/gcc/arm-none-eabi/5.4.1/include/stddef.h" 1 3 4
# 55 "kernel/protocols/net/core/inet_chksum.c" 2
...
# 56 "kernel/protocols/net/core/inet_chksum.c" 2
...
# 62 "kernel/protocols/net/core/inet_chksum.c"
u16_t lwip_standard_chksum(const void *dataptr, int len);
# 133 "kernel/protocols/net/core/inet_chksum.c"
u16_t
...
# 260 "kernel/protocols/net/core/inet_chksum.c"
static u16_t
inet_cksum_pseudo_base(struct pbuf *p, u8_t proto, u16_t proto_len, u32_t acc)
{
  ...
  for (q = p; q != 
# 267 "kernel/protocols/net/core/inet_chksum.c" 3 4
                  ((void *)0)
# 267 "kernel/protocols/net/core/inet_chksum.c"
                      ; q = q->next) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("inet_chksum_pseudo(): checksumming pbuf %p (has next %p) \n", (void *)q, (void *)q->next) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
                                  ;
  ...
  acc = (((acc) >> 16) + ((acc) & 0x0000ffffUL));
  acc = (((acc) >> 16) + ((acc) & 0x0000ffffUL));
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("inet_chksum_pseudo(): pbuf chain lwip_chksum()=%""8lx""\n", acc) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  return (u16_t)~(acc & 0xffffUL);
}
# 310 "kernel/protocols/net/core/inet_chksum.c"
u16_t
...
# 379 "kernel/protocols/net/core/inet_chksum.c"
u16_t
ip_chksum_pseudo(struct pbuf *p, u8_t proto, u16_t proto_len,
       const ip_addr_t *src, const ip_addr_t *dest)
{
# 392 "kernel/protocols/net/core/inet_chksum.c"
  {
       ...
       u16_t chksum_len, u32_t acc)
{
  ...
  for (q = p; (q != 
# 408 "kernel/protocols/net/core/inet_chksum.c" 3 4
                   ((void *)0)
# 408 "kernel/protocols/net/core/inet_chksum.c"
...
# 456 "kernel/protocols/net/core/inet_chksum.c"
u16_t
...
# 526 "kernel/protocols/net/core/inet_chksum.c"
u16_t
ip_chksum_pseudo_partial(struct pbuf *p, u8_t proto, u16_t proto_len,
       u16_t chksum_len, const ip_addr_t *src, const ip_addr_t *dest)
{
# 539 "kernel/protocols/net/core/inet_chksum.c"
  {
    return inet_chksum_pseudo_partial(p, proto, proto_len, chksum_len, (src), (dest));
  }

}
# 555 "kernel/protocols/net/core/inet_chksum.c"
u16_t
inet_chksum(const void *dataptr, u16_t len)
{
  return (u16_t)~(unsigned int)lwip_standard_chksum(dataptr, len);
}
# 568 "kernel/protocols/net/core/inet_chksum.c"
u16_t
inet_chksum_pbuf(struct pbuf *p)
{
  ...
  swapped = 0;
  for (q = p; q != 
# 577 "kernel/protocols/net/core/inet_chksum.c" 3 4
                  ((void *)0)
# 577 "kernel/protocols/net/core/inet_chksum.c"
                      ; q = q->next) {
    acc += lwip_standard_chksum(q->payload, q->len);
    acc = (((acc) >> 16) + ((acc) & 0x0000ffffUL));
    if (q->len % 2 != 0) {
