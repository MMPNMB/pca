# 1 "kernel/protocols/net/core/ipv4/ip4_addr.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/core/ipv4/ip4_addr.c"
# 39 "kernel/protocols/net/core/ipv4/ip4_addr.c"
...
# 40 "kernel/protocols/net/core/ipv4/ip4_addr.c" 2
...
# 44 "kernel/protocols/net/core/ipv4/ip4_addr.c" 2
...
# 132 "kernel/protocols/net/core/ipv4/ip4_addr.c"
u32_t
...
# 154 "kernel/protocols/net/core/ipv4/ip4_addr.c"
int
...
# 276 "kernel/protocols/net/core/ipv4/ip4_addr.c"
char*
...
# 292 "kernel/protocols/net/core/ipv4/ip4_addr.c"
char*
ip4addr_ntoa_r(const ip4_addr_t *addr, char *buf, int buflen)
{
  ...
  for (n = 0; n < 4; n++) {
    ...
    while (i--) {
      if (len++ >= buflen) {
        return 
# 317 "kernel/protocols/net/core/ipv4/ip4_addr.c" 3 4
              ((void *)0)
# 317 "kernel/protocols/net/core/ipv4/ip4_addr.c"
                  ;
      }
      *rp++ = inv[i];
    }
    if (len++ >= buflen) {
      return 
# 322 "kernel/protocols/net/core/ipv4/ip4_addr.c" 3 4
            ((void *)0)
# 322 "kernel/protocols/net/core/ipv4/ip4_addr.c"
                ;
    }
    *rp++ = '.';
    ap++;
