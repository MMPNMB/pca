# 1 "framework/connectivity/mqtt/MQTTPacket/MQTTDeserializePublish.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "framework/connectivity/mqtt/MQTTPacket/MQTTDeserializePublish.c"
# 17 "framework/connectivity/mqtt/MQTTPacket/MQTTDeserializePublish.c"
...
# 18 "framework/connectivity/mqtt/MQTTPacket/MQTTDeserializePublish.c" 2
...
# 19 "framework/connectivity/mqtt/MQTTPacket/MQTTDeserializePublish.c" 2
# 35 "framework/connectivity/mqtt/MQTTPacket/MQTTDeserializePublish.c"
...
# 40 "framework/connectivity/mqtt/MQTTPacket/MQTTDeserializePublish.c" 3 4
                         ((void *)0)
# 40 "framework/connectivity/mqtt/MQTTPacket/MQTTDeserializePublish.c"
                             ;
 int rc = 0;
 int mylen = 0;
...
# 79 "framework/connectivity/mqtt/MQTTPacket/MQTTDeserializePublish.c"
int MQTTDeserialize_ack(unsigned char* packettype, unsigned char* dup, unsigned short* packetid, unsigned char* buf, int buflen)
{
 MQTTHeader header = {0};
 unsigned char* curdata = buf;
 unsigned char* enddata = 
# 83 "framework/connectivity/mqtt/MQTTPacket/MQTTDeserializePublish.c" 3 4
                         ((void *)0)
# 83 "framework/connectivity/mqtt/MQTTPacket/MQTTDeserializePublish.c"
                             ;
 int rc = 0;
 int mylen;
