# 1 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c"
# 19 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c"
...
# 20 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c" 2
...
# 22 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c" 2
# 1 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.h" 1
# 32 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.h"
...
# 23 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c" 2
...
# 24 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c" 2
...
{
    if (
# 69 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c" 3 4
       ((void *)0) 
# 69 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c"
            == pNetwork) {
        LITE_syslog(__FUNCTION__, 70, LOG_ERR_LEVEL, "network is null");
        return 1;
    }

    intptr_t sockfd = HAL_TCP_Establish(pNetwork->pHostAddress, pNetwork->port);
    LITE_syslog(__FUNCTION__, 75, LOG_DEBUG_LEVEL, "sockfd: %d", sockfd);
    if (sockfd < 0) {
        LITE_syslog(__FUNCTION__, 77, LOG_DEBUG_LEVEL, "establish tcp fail, sockfd: %d", sockfd);
        pNetwork->handle = 0;
        return -1;
    }
    tcp_fd = sockfd;
...
{
    if (
# 90 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c" 3 4
       ((void *)0) 
# 90 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c"
            == pNetwork) {
        LITE_syslog(__FUNCTION__, 91, LOG_ERR_LEVEL, "network is null");
        return -1;
    }
...
{
    if (
# 100 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c" 3 4
       ((void *)0) 
# 100 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c"
            == pNetwork) {
        LITE_syslog(__FUNCTION__, 101, LOG_ERR_LEVEL, "network is null");
        return -1;
    }
...
{
    if (
# 110 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c" 3 4
       ((void *)0) 
# 110 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c"
            == pNetwork) {
        LITE_syslog(__FUNCTION__, 111, LOG_ERR_LEVEL, "network is null");
        return -1;
    }
...
{
    if (
# 123 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c" 3 4
       ((void *)0) 
# 123 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c"
            == pNetwork) {
        LITE_syslog(__FUNCTION__, 124, LOG_ERR_LEVEL, "network is null");
        return 1;
    }
...
int utils_net_read(utils_network_pt pNetwork, char *buffer, uint32_t len, uint32_t timeout_ms)
{
    ...
    if (
# 148 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c" 3 4
       ((void *)0) 
# 148 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c"
            == pNetwork->ca_crt) {
...
int utils_net_write(utils_network_pt pNetwork, const char *buffer, uint32_t len, uint32_t timeout_ms)
{
    ...
    if (
# 163 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c" 3 4
       ((void *)0) 
# 163 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c"
            == pNetwork->ca_crt) {
...
int iotx_net_disconnect(utils_network_pt pNetwork)
{
    ...
    if (
# 178 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c" 3 4
       ((void *)0) 
# 178 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c"
            == pNetwork->ca_crt) {
...
int iotx_net_connect(utils_network_pt pNetwork)
{
    ...
    if (
# 193 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c" 3 4
       ((void *)0) 
# 193 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c"
            == pNetwork->ca_crt) {
...
{
    if (!pNetwork || !host) {
        LITE_syslog(__FUNCTION__, 213, LOG_ERR_LEVEL, "parameter error! pNetwork=%p, host = %p", pNetwork, host);
        return -1;
    }
    ...
    if (
# 220 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c" 3 4
       ((void *)0) 
# 220 "framework/protocol/linkkit/iotkit/base/utils//misc/utils_net.c"
            == ca_crt) {
