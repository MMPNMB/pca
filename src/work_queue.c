# 1 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
# 27 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
# 1 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.h" 1
# 36 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.h"
# 1 "./framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log.h" 1
# 26 "./framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log.h"
...
# 27 "./framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log.h" 2
...
# 28 "./framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log.h" 2
...
# 30 "./framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log.h" 2
# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/lib/gcc/arm-none-eabi/5.4.1/include/stdarg.h" 1 3 4
...
# 37 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.h" 2
...
# 38 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.h" 2
...
# 63 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.h"
int work_queue_init(void);
int work_queue_exit(void);
# 73 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.h"
int queue_work(struct work_struct *work);
# 83 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.h"
int queue_delayed_work(struct work_struct *dwork, unsigned int delayed_ms);
# 94 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.h"
int cancel_work(struct work_struct *work);
# 28 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c" 2
...
# 29 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c" 2
...
# 30 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c" 2


static struct list_head g_wq_list = { &(g_wq_list), &(g_wq_list) };
...
static int g_wq_state = (-1);
static void *g_wq_sem;
static void *g_wq_thread;
static void *g_wq_mutex;
static unsigned int g_wq_timestamp;
static volatile struct work_struct *g_wq_current;

static inline int wq_is_running(void) { return g_wq_state == (1); }
static inline int wq_is_stopping(void) { return g_wq_state == (0); }
static inline int wq_is_stopped(void) { return g_wq_state == (-1); }
static inline void wq_set_running(void) { g_wq_state = (1); }
static inline void wq_set_stopping(void) { g_wq_state = (0); }
static inline void wq_set_stopped(void) { g_wq_state = (-1); }
# 72 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
...
# 102 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
int queue_work(struct work_struct *work)
{
    int newitem = 1;
    ...
    if (g_wq_current && time_elapsed_ms_since(g_wq_timestamp) > (10 * 1000))
        LITE_syslog(__FUNCTION__,
                                                       115
# 114 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
        , LOG_ERR_LEVEL, "work %s block > %d ms!!!", g_wq_current->name, (10 * 1000))
                                                        ;


    HAL_MutexLock(g_wq_mutex);

    for (item = ((work_struct_t *) ((char *) ((&g_wq_list)->next) - 
# 120 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c" 3 4
   __builtin_offsetof (
# 120 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
   work_struct_t
# 120 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c" 3 4
   , 
# 120 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
...
# 120 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
   )); &item->entry != (&g_wq_list); item = ((work_struct_t *) ((char *) (item->entry.next) - 
# 120 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c" 3 4
   __builtin_offsetof (
# 120 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
   work_struct_t
...
# 150 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
int queue_delayed_work(struct work_struct *dwork, unsigned int delay_ms)
{
    do{ if (!(!(delay_ms & (0x80000000)))) { LITE_syslog(__FUNCTION__,

                                 154
# 152 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
    , LOG_ERR_LEVEL, "delay work %s time %d over range", dwork->name, delay_ms); do{ while(1){ LITE_syslog(__FUNCTION__,

                                 154
# 152 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
    , LOG_ERR_LEVEL, "#####assert failed!######\r\n"); HAL_SleepMs(1000); }}while(0); } }while(0)
...
# 173 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
int cancel_work(struct work_struct *work)
{
    struct work_struct *item;
    int cancel = 3;
...
retry:
    ...
    HAL_MutexLock(g_wq_mutex);
    for (item = ((work_struct_t *) ((char *) ((&g_wq_list)->next) - 
# 184 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c" 3 4
   __builtin_offsetof (
# 184 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
   work_struct_t
# 184 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c" 3 4
   , 
# 184 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
...
# 184 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
    ...
    if (work == g_wq_current) {
        LITE_syslog(__FUNCTION__, 194, LOG_INFO_LEVEL, "work %s is working, wait it exit", work->name);
...
static void *worker_thread(void *arg)
{
    ...
    struct work_struct *item, *work = 
# 207 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c" 3 4
                                     ((void *)0)
# 207 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
                                         ;
    uint64_t start, time_elpased, min_time_left = (~0);
    int prio;

    LITE_syslog(__FUNCTION__, 211, LOG_DEBUG_LEVEL, "");
    ...
    while (wq_is_running()) {
        ...
        work = 
# 220 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c" 3 4
              ((void *)0)
# 220 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
                  ;
        prio = (127);
        min_time_left = (~0);
        ...
        HAL_MutexLock(g_wq_mutex);
        for (item = ((work_struct_t *) ((char *) ((&g_wq_list)->next) - 
# 225 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c" 3 4
       __builtin_offsetof (
# 225 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
       work_struct_t
# 225 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c" 3 4
       , 
# 225 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
...
# 225 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
        ...
        if (work) {
            ...
            g_wq_current = 
# 260 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c" 3 4
                          ((void *)0)
# 260 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
                              ;
            min_time_left = 0;
        } else if (min_time_left != (~0)) {

        } else {

            LITE_syslog(__FUNCTION__, 266, LOG_INFO_LEVEL, "work queue: idle...");
        }
    }

    LITE_syslog(__FUNCTION__, 270, LOG_DEBUG_LEVEL, "");

    HAL_ThreadDetach(g_wq_thread);
    return 
# 273 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c" 3 4
          ((void *)0)
# 273 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
              ;
}
...
int work_queue_init(void)
{
    ...
    int stack_used = 0;
    ret = HAL_ThreadCreate(&g_wq_thread, worker_thread, 
# 297 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c" 3 4
                                                       ((void *)0)
# 297 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
                                                           , &threadParams, &stack_used);
    do{ if (!(ret == 0)) { LITE_syslog(__FUNCTION__, 298, LOG_ERR_LEVEL, "thread create failed!"); do{ while(1){ LITE_syslog(__FUNCTION__, 298, LOG_ERR_LEVEL, "#####assert failed!######\r\n"); HAL_SleepMs(1000); }}while(0); } }while(0);
...
int work_queue_stop(void)
{
    ...
    HAL_SemaphorePost(g_wq_sem);
    LITE_syslog(__FUNCTION__, 308, LOG_DEBUG_LEVEL, "");
...
int work_queue_exit(void)
{
    ...
    if (g_wq_thread) {
        HAL_ThreadDetach(g_wq_thread);
        g_wq_thread = 
# 322 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c" 3 4
                     ((void *)0)
# 322 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
                         ;
    }
    LITE_syslog(__FUNCTION__, 324, LOG_DEBUG_LEVEL, "");

    HAL_MutexLock(g_wq_mutex);
    if (!list_empty(&g_wq_list)) {
        struct work_struct *item;
        LITE_syslog(__FUNCTION__, 329, LOG_ERR_LEVEL, "dump unfinished work in queue");
        for (item = ((work_struct_t *) ((char *) ((&g_wq_list)->next) - 
# 330 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c" 3 4
       __builtin_offsetof (
# 330 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
       work_struct_t
# 330 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c" 3 4
       , 
# 330 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
...
# 330 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
            ...
            LITE_syslog(__FUNCTION__, 331, LOG_ERR_LEVEL, "\t\twork: %s", item->name);
        }
        do{ if (!(0)) { LITE_syslog(__FUNCTION__, 333, LOG_ERR_LEVEL, "unfinished work in queue!!!"); do{ while(1){ LITE_syslog(__FUNCTION__, 333, LOG_ERR_LEVEL, "#####assert failed!######\r\n"); HAL_SleepMs(1000); }}while(0); } }while(0);
    }
    HAL_MutexUnlock(g_wq_mutex);
    ...
    if (g_wq_sem) {
        ...
        g_wq_sem = 
# 339 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c" 3 4
                  ((void *)0)
# 339 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
                      ;
    }
    if (g_wq_mutex) {
        HAL_MutexDestroy(g_wq_mutex);
        g_wq_mutex = 
# 343 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c" 3 4
                    ((void *)0)
# 343 "framework/protocol/linkkit/iotkit/base/utils//misc/work_queue.c"
                        ;
    }

    wq_set_stopped();
    LITE_syslog(__FUNCTION__, 347, LOG_DEBUG_LEVEL, "");
