...
# 6 "kernel/rhino/core/k_queue.c" 2


static inline void task_msg_recv(ktask_t *task, void *msg)
{
    task->msg = msg;
                            ...
                            size_t msg_num, uint8_t mm_alloc_flag)
{
    ...
    do { if (queue == 
# 19 "kernel/rhino/core/k_queue.c" 3 4
   ((void *)0)
# 19 "kernel/rhino/core/k_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    do { if (start == 
# 20 "kernel/rhino/core/k_queue.c" 3 4
   ((void *)0)
# 20 "kernel/rhino/core/k_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    do { if (name == 
# 21 "kernel/rhino/core/k_queue.c" 3 4
   ((void *)0)
# 21 "kernel/rhino/core/k_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
...
kstat_t krhino_queue_create(kqueue_t *queue, const name_t *name, void **start,
                            size_t msg_num)
{
    return queue_create(queue, name, start, msg_num, 1u);
}
...
kstat_t krhino_queue_del(kqueue_t *queue)
{
    ...
    do { if (queue == 
# 65 "kernel/rhino/core/k_queue.c" 3 4
   ((void *)0)
# 65 "kernel/rhino/core/k_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    ...
    while (!is_klist_empty(blk_list_head)) {
        pend_task_rm(((ktask_t *)((uint8_t *)(blk_list_head->next) - (size_t)(&((ktask_t *)0)->task_list))));
    }
                                ...
                                size_t msg_num)
{
    ...
    do { if (queue == 
# 109 "kernel/rhino/core/k_queue.c" 3 4
   ((void *)0)
# 109 "kernel/rhino/core/k_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);

    queue_obj = krhino_mm_alloc(sizeof(kqueue_t));
    if (queue_obj == 
# 112 "kernel/rhino/core/k_queue.c" 3 4
                    ((void *)0)
# 112 "kernel/rhino/core/k_queue.c"
                        ) {
        return RHINO_NO_MEM;
    }
    ...
    if (msg_start == 
# 117 "kernel/rhino/core/k_queue.c" 3 4
                    ((void *)0)
# 117 "kernel/rhino/core/k_queue.c"
                        ) {
...
kstat_t krhino_queue_dyn_del(kqueue_t *queue)
{
    ...
    do { if (queue == 
# 141 "kernel/rhino/core/k_queue.c" 3 4
   ((void *)0)
# 141 "kernel/rhino/core/k_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
...
static kstat_t msg_send(kqueue_t *p_q, void *p_void, uint8_t opt_wake_all)
{
    ...
    do { if (p_q == 
# 187 "kernel/rhino/core/k_queue.c" 3 4
   ((void *)0)
# 187 "kernel/rhino/core/k_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    ...
    if (opt_wake_all) {
        while (!is_klist_empty(blk_list_head)) {
            task_msg_recv(((ktask_t *)((uint8_t *)(blk_list_head->next) - (size_t)(&((ktask_t *)0)->task_list))),
                          p_void);
        }
    } else {
        task_msg_recv(((ktask_t *)((uint8_t *)(blk_list_head->next) - (size_t)(&((ktask_t *)0)->task_list))),
...
kstat_t krhino_queue_back_send(kqueue_t *queue, void *msg)
{
    return msg_send(queue, msg, 0u);
}

kstat_t krhino_queue_all_send(kqueue_t *queue, void *msg)
{
    return msg_send(queue, msg, 1u);
}
...
kstat_t krhino_queue_recv(kqueue_t *queue, tick_t ticks, void **msg)
{
    ...
    do { if (queue == 
# 256 "kernel/rhino/core/k_queue.c" 3 4
   ((void *)0)
# 256 "kernel/rhino/core/k_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    do { if (msg == 
# 257 "kernel/rhino/core/k_queue.c" 3 4
   ((void *)0)
# 257 "kernel/rhino/core/k_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    ...
    if ((g_intrpt_nested_level[cur_cpu_num] > 0u) && (ticks != 0u)) {
        do { { cpu_intrpt_restore(cpsr); }; } while (0);
    ...
    if (queue->msg_q.cur_num > 0u) {
        ...
        ringbuf_pop(&queue->ringbuf, msg, 
# 276 "kernel/rhino/core/k_queue.c" 3 4
                                         ((void *)0)
# 276 "kernel/rhino/core/k_queue.c"
                                             );
    ...
    if (ticks == 0u) {
        *msg = 
# 286 "kernel/rhino/core/k_queue.c" 3 4
              ((void *)0)
# 286 "kernel/rhino/core/k_queue.c"
                  ;
        do { { cpu_intrpt_restore(cpsr); }; } while (0);
    ...
    if (g_sched_lock[cur_cpu_num] > 0u) {
        *msg = 
# 294 "kernel/rhino/core/k_queue.c" 3 4
              ((void *)0)
# 294 "kernel/rhino/core/k_queue.c"
                  ;
        do { { cpu_intrpt_restore(cpsr); }; } while (0);
    ...
    switch (ret) {
        ...
        default:
            *msg = 
# 314 "kernel/rhino/core/k_queue.c" 3 4
                  ((void *)0)
# 314 "kernel/rhino/core/k_queue.c"
                      ;
            break;
    }
...
kstat_t krhino_queue_is_full(kqueue_t *queue)
{
    ...
    do { if (queue == 
# 329 "kernel/rhino/core/k_queue.c" 3 4
   ((void *)0)
# 329 "kernel/rhino/core/k_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
...
kstat_t krhino_queue_flush(kqueue_t *queue)
{
    ...
    do { if (queue == 
# 353 "kernel/rhino/core/k_queue.c" 3 4
   ((void *)0)
# 353 "kernel/rhino/core/k_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
...
kstat_t krhino_queue_info_get(kqueue_t *queue, msg_info_t *info)
{
    ...
    if (queue == 
# 378 "kernel/rhino/core/k_queue.c" 3 4
                ((void *)0)
# 378 "kernel/rhino/core/k_queue.c"
                    ) {
        return RHINO_NULL_PTR;
    }

    if (info == 
# 382 "kernel/rhino/core/k_queue.c" 3 4
               ((void *)0)
# 382 "kernel/rhino/core/k_queue.c"
                   ) {
        return RHINO_NULL_PTR;
    }

    do { if (queue == 
# 386 "kernel/rhino/core/k_queue.c" 3 4
   ((void *)0)
# 386 "kernel/rhino/core/k_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    do { if (info == 
# 387 "kernel/rhino/core/k_queue.c" 3 4
   ((void *)0)
# 387 "kernel/rhino/core/k_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
