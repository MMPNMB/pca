# 1 "kernel/rhino/core/k_workqueue.c"
...
# 6 "kernel/rhino/core/k_workqueue.c" 2
...
static kstat_t workqueue_is_exist(kworkqueue_t *workqueue)
{
    ...
    for (pos = ((kworkqueue_t *)((uint8_t *)(g_workqueue_list_head.next) - (size_t)(&((kworkqueue_t *)0)->workqueue_node)));
        &pos->workqueue_node != &g_workqueue_list_head;
         pos = ((kworkqueue_t *)((uint8_t *)(pos->workqueue_node.next) - (size_t)(&((kworkqueue_t *)0)->workqueue_node)))) {
        if (pos == workqueue) {
...
static void worker_task(void *arg)
{
    ...
    kstat_t ret;
    kwork_t *work = 
# 33 "kernel/rhino/core/k_workqueue.c" 3 4
                        ((void *)0)
# 33 "kernel/rhino/core/k_workqueue.c"
                            ;
    kworkqueue_t *queue = (kworkqueue_t *)arg;

    while (1) {

        ret = krhino_sem_take(&(queue->sem), ((uint64_t)-1));
        ...
        work = ((kwork_t *)((uint8_t *)(queue->work_list.next) - (size_t)(&((kwork_t *)0)->work_node)));
        ...
        queue->work_current = 
# 56 "kernel/rhino/core/k_workqueue.c" 3 4
                             ((void *)0)
# 56 "kernel/rhino/core/k_workqueue.c"
                                 ;
                                ...
                                uint8_t pri, cpu_stack_t *stack_buf, size_t stack_size)
{
    ...
    do { if (workqueue == 
# 69 "kernel/rhino/core/k_workqueue.c" 3 4
   ((void *)0)
# 69 "kernel/rhino/core/k_workqueue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    do { if (name == 
# 70 "kernel/rhino/core/k_workqueue.c" 3 4
   ((void *)0)
# 70 "kernel/rhino/core/k_workqueue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    do { if (stack_buf == 
# 71 "kernel/rhino/core/k_workqueue.c" 3 4
   ((void *)0)
# 71 "kernel/rhino/core/k_workqueue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    ...
    workqueue->work_current = 
# 88 "kernel/rhino/core/k_workqueue.c" 3 4
                             ((void *)0)
# 88 "kernel/rhino/core/k_workqueue.c"
                                 ;
    workqueue->name = name;
                         ...
                         tick_t dly)
{
    ...
    if (work == 
# 155 "kernel/rhino/core/k_workqueue.c" 3 4
               ((void *)0)
# 155 "kernel/rhino/core/k_workqueue.c"
                   ) {
        return RHINO_NULL_PTR;
    }

    if (handle == 
# 159 "kernel/rhino/core/k_workqueue.c" 3 4
                 ((void *)0)
# 159 "kernel/rhino/core/k_workqueue.c"
                     ) {
        return RHINO_NULL_PTR;
    }

    do { if (work == 
# 163 "kernel/rhino/core/k_workqueue.c" 3 4
   ((void *)0)
# 163 "kernel/rhino/core/k_workqueue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    do { if (handle == 
# 164 "kernel/rhino/core/k_workqueue.c" 3 4
   ((void *)0)
# 164 "kernel/rhino/core/k_workqueue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    ...
    work->dly = dly;
    work->wq = 
# 172 "kernel/rhino/core/k_workqueue.c" 3 4
                   ((void *)0)
# 172 "kernel/rhino/core/k_workqueue.c"
                       ;
...
kstat_t krhino_work_run(kworkqueue_t *workqueue, kwork_t *work)
{
    ...
    do { if (workqueue == 
# 193 "kernel/rhino/core/k_workqueue.c" 3 4
   ((void *)0)
# 193 "kernel/rhino/core/k_workqueue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    do { if (work == 
# 194 "kernel/rhino/core/k_workqueue.c" 3 4
   ((void *)0)
# 194 "kernel/rhino/core/k_workqueue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
...
kstat_t krhino_work_cancel(kwork_t *work)
{
    ...
    do { if (work == 
# 244 "kernel/rhino/core/k_workqueue.c" 3 4
   ((void *)0)
# 244 "kernel/rhino/core/k_workqueue.c"
   ) { return RHINO_NULL_PTR; } } while (0);

    wq = (kworkqueue_t *)work->wq;

    if (wq == 
# 248 "kernel/rhino/core/k_workqueue.c" 3 4
             ((void *)0)
# 248 "kernel/rhino/core/k_workqueue.c"
                 ) {
        if (work->dly > 0) {
    ...
    klist_rm_init(&(work->work_node));
    work->wq = 
# 267 "kernel/rhino/core/k_workqueue.c" 3 4
                   ((void *)0)
# 267 "kernel/rhino/core/k_workqueue.c"
                       ;
    do { { cpu_intrpt_restore(cpsr); }; } while (0);
