# 1 "security/mbedtls/src/mbedtls_net.c"
...
# 2 "security/mbedtls/src/mbedtls_net.c" 2
...
# 3 "security/mbedtls/src/mbedtls_net.c" 2
...
# 4 "security/mbedtls/src/mbedtls_net.c" 2
...
# 5 "security/mbedtls/src/mbedtls_net.c" 2
...
# 7 "security/mbedtls/src/mbedtls_net.c" 2
...
# 8 "security/mbedtls/src/mbedtls_net.c" 2
# 190 "security/mbedtls/src/mbedtls_net.c"
...
# 191 "security/mbedtls/src/mbedtls_net.c" 2
...
# 192 "security/mbedtls/src/mbedtls_net.c" 2
...
# 193 "security/mbedtls/src/mbedtls_net.c" 2
...
# 195 "security/mbedtls/src/mbedtls_net.c" 2
...
static int net_would_block(const mbedtls_net_context *ctx)
{
    ...
    if((lwip_fcntl(ctx->fd,
# 201 "security/mbedtls/src/mbedtls_net.c" 3
       3
# 201 "security/mbedtls/src/mbedtls_net.c"
       ,0) & 
# 201 "security/mbedtls/src/mbedtls_net.c" 3
                                    0x4000
# 201 "security/mbedtls/src/mbedtls_net.c"
...
# 201 "security/mbedtls/src/mbedtls_net.c"
    ...
    switch(
# 204 "security/mbedtls/src/mbedtls_net.c" 3
          (*__errno())
# 204 "security/mbedtls/src/mbedtls_net.c"
               )
    {
...
# 234 "security/mbedtls/src/mbedtls_net.c" 3
       (*__errno())
# 234 "security/mbedtls/src/mbedtls_net.c"
       );
        return -0x0052;
    }
...
# 240 "security/mbedtls/src/mbedtls_net.c" 3 4
                                ((void *)0)
# 240 "security/mbedtls/src/mbedtls_net.c"
                                    ; cur = cur->ai_next) {
        ...
        do {
            ...
            if (ret == 0) {
                ...
                if (
# 253 "security/mbedtls/src/mbedtls_net.c" 3
                   (*__errno()) 
# 253 "security/mbedtls/src/mbedtls_net.c"
                         == 4) {
                    continue;
                }
...
int mbedtls_net_set_block(mbedtls_net_context *ctx)
{
    ...
    flags = lwip_fcntl(ctx->fd,
# 275 "security/mbedtls/src/mbedtls_net.c" 3
           3
# 275 "security/mbedtls/src/mbedtls_net.c"
           ,0);
    flags &= ~
# 276 "security/mbedtls/src/mbedtls_net.c" 3
             0x4000
# 276 "security/mbedtls/src/mbedtls_net.c"
                       ;

    return lwip_fcntl(ctx->fd,
# 278 "security/mbedtls/src/mbedtls_net.c" 3
          4
# 278 "security/mbedtls/src/mbedtls_net.c"
          ,flags);
}
...
int mbedtls_net_set_nonblock(mbedtls_net_context *ctx)
{
    ...
    flags = lwip_fcntl(ctx->fd,
# 285 "security/mbedtls/src/mbedtls_net.c" 3
           3
# 285 "security/mbedtls/src/mbedtls_net.c"
           ,0);
    flags |= 
# 286 "security/mbedtls/src/mbedtls_net.c" 3
            0x4000
# 286 "security/mbedtls/src/mbedtls_net.c"
                      ;

    return lwip_fcntl(ctx->fd,
# 288 "security/mbedtls/src/mbedtls_net.c" 3
          4
# 288 "security/mbedtls/src/mbedtls_net.c"
          ,flags);
}
...
int mbedtls_net_recv(void *ctx, unsigned char *buf, size_t len)
{
    ...
    if (ret < 0) {
        ...
        if (
# 307 "security/mbedtls/src/mbedtls_net.c" 3
           (*__errno()) 
# 307 "security/mbedtls/src/mbedtls_net.c"
                 == 32 || 
# 307 "security/mbedtls/src/mbedtls_net.c" 3
                             (*__errno()) 
# 307 "security/mbedtls/src/mbedtls_net.c"
...
# 308 "security/mbedtls/src/mbedtls_net.c" 3
           (*__errno())
# 308 "security/mbedtls/src/mbedtls_net.c"
           );
            return(-0x0050);
        }

        if (
# 312 "security/mbedtls/src/mbedtls_net.c" 3
           (*__errno()) 
# 312 "security/mbedtls/src/mbedtls_net.c"
                 == 4)
            return(-0x6900);

        printf("%s %d: ""net recv failed - errno: %d\n", __FUNCTION__, 315, 
# 315 "security/mbedtls/src/mbedtls_net.c" 3
       (*__errno())
# 315 "security/mbedtls/src/mbedtls_net.c"
       );
        return(-0x004C);
    }
...
int mbedtls_net_send(void *ctx, const unsigned char *buf, size_t len)
{
    ...
    if (ret < 0) {
        ...
        if (
# 336 "security/mbedtls/src/mbedtls_net.c" 3
           (*__errno()) 
# 336 "security/mbedtls/src/mbedtls_net.c"
                 == 32 || 
# 336 "security/mbedtls/src/mbedtls_net.c" 3
                             (*__errno()) 
# 336 "security/mbedtls/src/mbedtls_net.c"
                                   == 104) {
            printf("%s %d: ""net reset - errno: %d\n", __FUNCTION__, 337, 
# 337 "security/mbedtls/src/mbedtls_net.c" 3
           (*__errno())
# 337 "security/mbedtls/src/mbedtls_net.c"
           );
            return(-0x0050);
        }

        if (
# 341 "security/mbedtls/src/mbedtls_net.c" 3
           (*__errno()) 
# 341 "security/mbedtls/src/mbedtls_net.c"
                 == 4)
            return(-0x6880);

        printf("%s %d: ""net send failed - errno: %d\n", __FUNCTION__, 344, 
# 344 "security/mbedtls/src/mbedtls_net.c" 3
       (*__errno())
# 344 "security/mbedtls/src/mbedtls_net.c"
       );
        return(-0x004E);
    }
...
# 356 "security/mbedtls/src/mbedtls_net.c" 3
   _types_fd_set 
# 356 "security/mbedtls/src/mbedtls_net.c"
          read_fds;
    int fd = ((mbedtls_net_context *) ctx)->fd;
...
# 363 "security/mbedtls/src/mbedtls_net.c" 3
   (__extension__ (void)({ size_t __i; char *__tmp = (char *)
# 363 "security/mbedtls/src/mbedtls_net.c"
   &read_fds
# 363 "security/mbedtls/src/mbedtls_net.c" 3
...
# 364 "security/mbedtls/src/mbedtls_net.c" 3
   ((
# 364 "security/mbedtls/src/mbedtls_net.c"
   &read_fds
# 364 "security/mbedtls/src/mbedtls_net.c" 3
   )->fds_bits[(
# 364 "security/mbedtls/src/mbedtls_net.c"
...
# 369 "security/mbedtls/src/mbedtls_net.c" 3 4
         ((void *)0)
# 369 "security/mbedtls/src/mbedtls_net.c"
         ,
# 369 "security/mbedtls/src/mbedtls_net.c" 3 4
         ((void *)0)
# 369 "security/mbedtls/src/mbedtls_net.c"
...
# 369 "security/mbedtls/src/mbedtls_net.c"
    ...
    if (ret < 0) {
        if (
# 375 "security/mbedtls/src/mbedtls_net.c" 3
           (*__errno()) 
# 375 "security/mbedtls/src/mbedtls_net.c"
                 == 4) {
            return -0x6900;
        }
