# 1 "kernel/protocols/net/api/api_lib.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/api/api_lib.c"
# 58 "kernel/protocols/net/api/api_lib.c"
...
# 59 "kernel/protocols/net/api/api_lib.c" 2
...
# 48 "./kernel/protocols/net/include/lwip/netbuf.h" 2
...
# 63 "kernel/protocols/net/api/api_lib.c" 2
...
# 47 "./kernel/protocols/net/include/lwip/priv/memp_priv.h"
...
# 48 "./kernel/protocols/net/include/lwip/priv/memp_priv.h" 2
...
# 64 "kernel/protocols/net/api/api_lib.c" 2

# 1 "./kernel/protocols/net/include/lwip/ip.h" 1
# 46 "./kernel/protocols/net/include/lwip/ip.h"
...
# 66 "kernel/protocols/net/api/api_lib.c" 2
...
# 67 "kernel/protocols/net/api/api_lib.c" 2
...
# 68 "kernel/protocols/net/api/api_lib.c" 2
...
# 69 "kernel/protocols/net/api/api_lib.c" 2
...
# 70 "kernel/protocols/net/api/api_lib.c" 2
...
# 73 "kernel/protocols/net/api/api_lib.c" 2
...
# 80 "kernel/protocols/net/api/api_lib.c"
static err_t netconn_close_shutdown(struct netconn *conn, u8_t how);
# 91 "kernel/protocols/net/api/api_lib.c"
static err_t
...
# 122 "kernel/protocols/net/api/api_lib.c"
struct netconn*
netconn_new_with_proto_and_callback(enum netconn_type t, u8_t proto, netconn_callback callback)
{
  ...
  if (conn != 
# 130 "kernel/protocols/net/api/api_lib.c" 3 4
             ((void *)0)
# 130 "kernel/protocols/net/api/api_lib.c"
                 ) {
    err_t err;
    ...
    if (err != ERR_OK) {
      ...
      ;
      return 
# 149 "kernel/protocols/net/api/api_lib.c" 3 4
            ((void *)0)
# 149 "kernel/protocols/net/api/api_lib.c"
                ;
    }
  }
  ;
...
# 165 "kernel/protocols/net/api/api_lib.c"
err_t
netconn_delete(struct netconn *conn)
{
  ...
  if (conn == 
# 172 "kernel/protocols/net/api/api_lib.c" 3 4
             ((void *)0)
# 172 "kernel/protocols/net/api/api_lib.c"
                 ) {
    return ERR_OK;
  }
...
# 213 "kernel/protocols/net/api/api_lib.c"
err_t
netconn_getaddr(struct netconn *conn, ip_addr_t *addr, u16_t *port, u8_t local)
{
  ...
  do { if (!((conn != 
# 219 "kernel/protocols/net/api/api_lib.c" 3 4
 ((void *)0)
# 219 "kernel/protocols/net/api/api_lib.c"
 ))) { do {bk_printf ("netconn_getaddr: invalid conn") ;} while(0); return ERR_ARG;;}} while(0);
  do { if (!((addr != 
# 220 "kernel/protocols/net/api/api_lib.c" 3 4
 ((void *)0)
# 220 "kernel/protocols/net/api/api_lib.c"
 ))) { do {bk_printf ("netconn_getaddr: invalid addr") ;} while(0); return ERR_ARG;;}} while(0);
  do { if (!((port != 
# 221 "kernel/protocols/net/api/api_lib.c" 3 4
 ((void *)0)
# 221 "kernel/protocols/net/api/api_lib.c"
 ))) { do {bk_printf ("netconn_getaddr: invalid port") ;} while(0); return ERR_ARG;;}} while(0);
...
# 251 "kernel/protocols/net/api/api_lib.c"
err_t
netconn_bind(struct netconn *conn, const ip_addr_t *addr, u16_t port)
{
  ...
  do { if (!((conn != 
# 257 "kernel/protocols/net/api/api_lib.c" 3 4
 ((void *)0)
# 257 "kernel/protocols/net/api/api_lib.c"
 ))) { do {bk_printf ("netconn_bind: invalid conn") ;} while(0); return ERR_ARG;;}} while(0);


  if (addr == 
# 260 "kernel/protocols/net/api/api_lib.c" 3 4
             ((void *)0)
# 260 "kernel/protocols/net/api/api_lib.c"
                 ) {
    addr = (&ip_addr_any);
  }
...
# 283 "kernel/protocols/net/api/api_lib.c"
err_t
netconn_connect(struct netconn *conn, const ip_addr_t *addr, u16_t port)
{
  ...
  do { if (!((conn != 
# 289 "kernel/protocols/net/api/api_lib.c" 3 4
 ((void *)0)
# 289 "kernel/protocols/net/api/api_lib.c"
 ))) { do {bk_printf ("netconn_connect: invalid conn") ;} while(0); return ERR_ARG;;}} while(0);


  if (addr == 
# 292 "kernel/protocols/net/api/api_lib.c" 3 4
             ((void *)0)
# 292 "kernel/protocols/net/api/api_lib.c"
                 ) {
    addr = (&ip_addr_any);
  }
...
# 313 "kernel/protocols/net/api/api_lib.c"
err_t
netconn_disconnect(struct netconn *conn)
{
  ...
  do { if (!((conn != 
# 319 "kernel/protocols/net/api/api_lib.c" 3 4
 ((void *)0)
# 319 "kernel/protocols/net/api/api_lib.c"
 ))) { do {bk_printf ("netconn_disconnect: invalid conn") ;} while(0); return ERR_ARG;;}} while(0);
...
# 338 "kernel/protocols/net/api/api_lib.c"
err_t
netconn_listen_with_backlog(struct netconn *conn, u8_t backlog)
{
  ...
  do { if (!((conn != 
# 348 "kernel/protocols/net/api/api_lib.c" 3 4
 ((void *)0)
# 348 "kernel/protocols/net/api/api_lib.c"
 ))) { do {bk_printf ("netconn_listen: invalid conn") ;} while(0); return ERR_ARG;;}} while(0);
...
# 375 "kernel/protocols/net/api/api_lib.c"
err_t
netconn_accept(struct netconn *conn, struct netconn **new_conn)
{
  ...
  do { if (!((new_conn != 
# 386 "kernel/protocols/net/api/api_lib.c" 3 4
 ((void *)0)
# 386 "kernel/protocols/net/api/api_lib.c"
 ))) { do {bk_printf ("netconn_accept: invalid pointer") ;} while(0); return ERR_ARG;;}} while(0);
  *new_conn = 
# 387 "kernel/protocols/net/api/api_lib.c" 3 4
             ((void *)0)
# 387 "kernel/protocols/net/api/api_lib.c"
                 ;
  do { if (!((conn != 
# 388 "kernel/protocols/net/api/api_lib.c" 3 4
 ((void *)0)
# 388 "kernel/protocols/net/api/api_lib.c"
 ))) { do {bk_printf ("netconn_accept: invalid conn") ;} while(0); return ERR_ARG;;}} while(0);
  ...
  if (newconn == 
# 426 "kernel/protocols/net/api/api_lib.c" 3 4
                ((void *)0)
# 426 "kernel/protocols/net/api/api_lib.c"
                    ) {
    ...
    do { if ((conn) != 
# 431 "kernel/protocols/net/api/api_lib.c" 3 4
   ((void *)0)
# 431 "kernel/protocols/net/api/api_lib.c"
   ) { sys_prot_t netconn_set_safe_err_lev; netconn_set_safe_err_lev = sys_arch_protect(); if (!(((conn)->last_err) <= ERR_ABRT)) { (conn)->last_err = ERR_CLSD; } sys_arch_unprotect(netconn_set_safe_err_lev); }} while(0);;
...
# 465 "kernel/protocols/net/api/api_lib.c"
static err_t
netconn_recv_data(struct netconn *conn, void **new_buf)
{
  void *buf = 
# 468 "kernel/protocols/net/api/api_lib.c" 3 4
             ((void *)0)
# 468 "kernel/protocols/net/api/api_lib.c"
                 ;
  u16_t len;
  err_t err;
  ...
  do { if (!((new_buf != 
# 478 "kernel/protocols/net/api/api_lib.c" 3 4
 ((void *)0)
# 478 "kernel/protocols/net/api/api_lib.c"
 ))) { do {bk_printf ("netconn_recv: invalid pointer") ;} while(0); return ERR_ARG;;}} while(0);
  *new_buf = 
# 479 "kernel/protocols/net/api/api_lib.c" 3 4
            ((void *)0)
# 479 "kernel/protocols/net/api/api_lib.c"
                ;
  do { if (!((conn != 
# 480 "kernel/protocols/net/api/api_lib.c" 3 4
 ((void *)0)
# 480 "kernel/protocols/net/api/api_lib.c"
 ))) { do {bk_printf ("netconn_recv: invalid conn") ;} while(0); return ERR_ARG;;}} while(0);
...

  {
    if (!aos_queue_is_valid(&conn->recvmbox)) {
      ...
      return aos_queue_is_valid(&conn->acceptmbox) ? ERR_CONN : ERR_CLSD;
    }
  }

  do { if (!(aos_queue_is_valid(&conn->recvmbox))) { do {bk_printf ("netconn_recv: invalid recvmbox") ;} while(0); return ERR_CONN;;}} while(0);
...

  {
    ...
    msg.conn = conn;
    if (buf != 
# 536 "kernel/protocols/net/api/api_lib.c" 3 4
              ((void *)0)
# 536 "kernel/protocols/net/api/api_lib.c"
                  ) {
    ...
    if (buf == 
# 547 "kernel/protocols/net/api/api_lib.c" 3 4
              ((void *)0)
# 547 "kernel/protocols/net/api/api_lib.c"
                  ) {
      if (conn->callback) { (*conn->callback)(conn, NETCONN_EVT_RCVMINUS, 0); };
      if (conn->pcb.ip == 
# 549 "kernel/protocols/net/api/api_lib.c" 3 4
                         ((void *)0)
# 549 "kernel/protocols/net/api/api_lib.c"
                             ) {
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("netconn_recv_data: received %p, len=%""4d""\n", buf, len) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);

  *new_buf = buf;

  return ERR_OK;
}
# 594 "kernel/protocols/net/api/api_lib.c"
err_t
netconn_recv_tcp_pbuf(struct netconn *conn, struct pbuf **new_buf)
{
  do { if (!((conn != 
# 597 "kernel/protocols/net/api/api_lib.c" 3 4
 ((void *)0)
# 597 "kernel/protocols/net/api/api_lib.c"
 ) && (((conn->type))&0xF0) == NETCONN_TCP)) { do {bk_printf ("netconn_recv: invalid conn") ;} while(0); return ERR_ARG;;}} while(0)
                                                                                   ;

  return netconn_recv_data(conn, (void **)new_buf);
}
# 612 "kernel/protocols/net/api/api_lib.c"
err_t
netconn_recv(struct netconn *conn, struct netbuf **new_buf)
{

  struct netbuf *buf = 
# 616 "kernel/protocols/net/api/api_lib.c" 3 4
                      ((void *)0)
# 616 "kernel/protocols/net/api/api_lib.c"
                          ;
  err_t err;


  do { if (!((new_buf != 
# 620 "kernel/protocols/net/api/api_lib.c" 3 4
 ((void *)0)
# 620 "kernel/protocols/net/api/api_lib.c"
 ))) { do {bk_printf ("netconn_recv: invalid pointer") ;} while(0); return ERR_ARG;;}} while(0);
  *new_buf = 
# 621 "kernel/protocols/net/api/api_lib.c" 3 4
            ((void *)0)
# 621 "kernel/protocols/net/api/api_lib.c"
                ;
  do { if (!((conn != 
# 622 "kernel/protocols/net/api/api_lib.c" 3 4
 ((void *)0)
# 622 "kernel/protocols/net/api/api_lib.c"
 ))) { do {bk_printf ("netconn_recv: invalid conn") ;} while(0); return ERR_ARG;;}} while(0);
  ...
  {
    struct pbuf *p = 
# 629 "kernel/protocols/net/api/api_lib.c" 3 4
                    ((void *)0)
# 629 "kernel/protocols/net/api/api_lib.c"
                        ;


    buf = (struct netbuf *)memp_malloc(MEMP_NETBUF);
    if (buf == 
# 633 "kernel/protocols/net/api/api_lib.c" 3 4
              ((void *)0)
# 633 "kernel/protocols/net/api/api_lib.c"
                  ) {
      return ERR_MEM;
    }
...
# 674 "kernel/protocols/net/api/api_lib.c"
err_t
netconn_sendto(struct netconn *conn, struct netbuf *buf, const ip_addr_t *addr, u16_t port)
{
  if (buf != 
# 677 "kernel/protocols/net/api/api_lib.c" 3 4
            ((void *)0)
# 677 "kernel/protocols/net/api/api_lib.c"
                ) {
    ((&buf->addr)->addr = ((addr) == 
# 678 "kernel/protocols/net/api/api_lib.c" 3 4
   ((void *)0) 
# 678 "kernel/protocols/net/api/api_lib.c"
   ? 0 : (addr)->addr));
    buf->port = port;
...
# 693 "kernel/protocols/net/api/api_lib.c"
err_t
netconn_send(struct netconn *conn, struct netbuf *buf)
{
  ...
  do { if (!((conn != 
# 699 "kernel/protocols/net/api/api_lib.c" 3 4
 ((void *)0)
# 699 "kernel/protocols/net/api/api_lib.c"
 ))) { do {bk_printf ("netconn_send: invalid conn") ;} while(0); return ERR_ARG;;}} while(0);

  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("netconn_send: sending %""4d"" bytes\n", buf->p->tot_len) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  ;
  msg.conn = conn;
  msg.msg.b = buf;
...
# 725 "kernel/protocols/net/api/api_lib.c"
err_t
                     ...
                     u8_t apiflags, size_t *bytes_written)
{
  ...
  do { if (!((conn != 
# 733 "kernel/protocols/net/api/api_lib.c" 3 4
 ((void *)0)
# 733 "kernel/protocols/net/api/api_lib.c"
 ))) { do {bk_printf ("netconn_write: invalid conn") ;} while(0); return ERR_ARG;;}} while(0);
  do { if (!((((conn->type)&0xF0)== NETCONN_TCP))) { do {bk_printf ("netconn_write: invalid conn->type") ;} while(0); return ERR_VAL;;}} while(0);
  if (size == 0) {
    return ERR_OK;
  }
...
# 765 "kernel/protocols/net/api/api_lib.c" 3 4
                                          ((void *)0)
# 765 "kernel/protocols/net/api/api_lib.c"
                                              )) {
    if (dontblock
...
# 791 "kernel/protocols/net/api/api_lib.c"
static err_t
netconn_close_shutdown(struct netconn *conn, u8_t how)
{
  ...
  do { if (!((conn != 
# 798 "kernel/protocols/net/api/api_lib.c" 3 4
 ((void *)0)
# 798 "kernel/protocols/net/api/api_lib.c"
 ))) { do {bk_printf ("netconn_close: invalid conn") ;} while(0); return ERR_ARG;;}} while(0);
...
# 827 "kernel/protocols/net/api/api_lib.c"
err_t
...
# 843 "kernel/protocols/net/api/api_lib.c"
err_t
netconn_shutdown(struct netconn *conn, u8_t shut_rx, u8_t shut_tx)
{
  return netconn_close_shutdown(conn, (shut_rx ? 1 : 0) | (shut_tx ? 2 : 0));
}
# 861 "kernel/protocols/net/api/api_lib.c"
err_t
                         ...
                         enum netconn_igmp join_or_leave)
{
  ...
  do { if (!((conn != 
# 870 "kernel/protocols/net/api/api_lib.c" 3 4
 ((void *)0)
# 870 "kernel/protocols/net/api/api_lib.c"
 ))) { do {bk_printf ("netconn_join_leave_group: invalid conn") ;} while(0); return ERR_ARG;;}} while(0);

  ;


  if (multiaddr == 
# 875 "kernel/protocols/net/api/api_lib.c" 3 4
                  ((void *)0)
# 875 "kernel/protocols/net/api/api_lib.c"
                      ) {
    multiaddr = (&ip_addr_any);
  }
  if (netif_addr == 
# 878 "kernel/protocols/net/api/api_lib.c" 3 4
                   ((void *)0)
# 878 "kernel/protocols/net/api/api_lib.c"
                       ) {
...
# 910 "kernel/protocols/net/api/api_lib.c"
err_t
...

{
  ...
  do { if (!((name != 
# 920 "kernel/protocols/net/api/api_lib.c" 3 4
 ((void *)0)
# 920 "kernel/protocols/net/api/api_lib.c"
 ))) { do {bk_printf ("netconn_gethostbyname: invalid name") ;} while(0); return ERR_ARG;;}} while(0);
  do { if (!((addr != 
# 921 "kernel/protocols/net/api/api_lib.c" 3 4
 ((void *)0)
# 921 "kernel/protocols/net/api/api_lib.c"
 ))) { do {bk_printf ("netconn_gethostbyname: invalid addr") ;} while(0); return ERR_ARG;;}} while(0);
  ...
  err = tcpip_callback_with_block(lwip_netconn_do_gethostbyname, &msg, 1);
  if (err != ERR_OK) {
