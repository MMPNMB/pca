# 1 "kernel/protocols/net/apps/tftp/tftp_server.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/apps/tftp/tftp_server.c"
# 50 "kernel/protocols/net/apps/tftp/tftp_server.c"
# 1 "./kernel/protocols/net/include/lwip/udp.h" 1
# 41 "./kernel/protocols/net/include/lwip/udp.h"
...
# 42 "./kernel/protocols/net/include/lwip/udp.h" 2
...
# 51 "kernel/protocols/net/apps/tftp/tftp_server.c" 2
# 1 "./kernel/protocols/net/include/lwip/timeouts.h" 1
# 44 "./kernel/protocols/net/include/lwip/timeouts.h"
...
# 45 "./kernel/protocols/net/include/lwip/timeouts.h" 2
...
# 52 "kernel/protocols/net/apps/tftp/tftp_server.c" 2

# 1 "./kernel/protocols/net/include/lwip/apps/tftp.h" 1
# 44 "./kernel/protocols/net/include/lwip/apps/tftp.h"
# 1 "./kernel/protocols/net/include/lwip/apps/tftp_opts.h" 1
# 45 "./kernel/protocols/net/include/lwip/apps/tftp.h" 2
# 65 "./kernel/protocols/net/include/lwip/apps/tftp.h"
...
# 105 "./kernel/protocols/net/include/lwip/apps/tftp.h"
...
# 54 "kernel/protocols/net/apps/tftp/tftp_server.c" 2
...
# 56 "kernel/protocols/net/apps/tftp/tftp_server.c" 2



# 58 "kernel/protocols/net/apps/tftp/tftp_server.c"
struct tftp_state {
...
close_handle(void)
{
  ...
  if(tftp_state.last_data != 
# 85 "kernel/protocols/net/apps/tftp/tftp_server.c" 3 4
                            ((void *)0)
# 85 "kernel/protocols/net/apps/tftp/tftp_server.c"
                                ) {
    pbuf_free(tftp_state.last_data);
    tftp_state.last_data = 
# 87 "kernel/protocols/net/apps/tftp/tftp_server.c" 3 4
                          ((void *)0)
# 87 "kernel/protocols/net/apps/tftp/tftp_server.c"
                              ;
  }

  sys_untimeout(tftp_tmr, 
# 90 "kernel/protocols/net/apps/tftp/tftp_server.c" 3 4
                         ((void *)0)
# 90 "kernel/protocols/net/apps/tftp/tftp_server.c"
                             );

  if (tftp_state.handle) {
    tftp_state.ctx->close(tftp_state.handle);
    tftp_state.handle = 
# 94 "kernel/protocols/net/apps/tftp/tftp_server.c" 3 4
                       ((void *)0)
# 94 "kernel/protocols/net/apps/tftp/tftp_server.c"
                           ;
    do { if ( ((0x80U | 0x20U) & 0x80U) && ((0x80U | 0x20U) & 0x80U) && ((s16_t)((0x80U | 0x20U) & 0x03) >= 0x00)) { do {bk_printf ("tftp: closing\n") ;} while(0); if ((0x80U | 0x20U) & 0x08U) { while(1); } } } while(0);
  }
}
...
resend_data(void)
{
  ...
  if(p == 
# 103 "kernel/protocols/net/apps/tftp/tftp_server.c" 3 4
         ((void *)0)
# 103 "kernel/protocols/net/apps/tftp/tftp_server.c"
             ) {
    return;
  }
...
send_data(void)
{
  ...
  if(tftp_state.last_data != 
# 122 "kernel/protocols/net/apps/tftp/tftp_server.c" 3 4
                            ((void *)0)
# 122 "kernel/protocols/net/apps/tftp/tftp_server.c"
                                ) {
    pbuf_free(tftp_state.last_data);
  }
  ...
  if(tftp_state.last_data == 
# 127 "kernel/protocols/net/apps/tftp/tftp_server.c" 3 4
                            ((void *)0)
# 127 "kernel/protocols/net/apps/tftp/tftp_server.c"
                                ) {
    return;
  }
...
recv(void *arg, struct udp_pcb *upcb, struct pbuf *p, const ip_addr_t *addr, u16_t port)
{
  ...
  switch (opcode) {
    ...
    case ((((2) & 0xff) << 8) | (((2) & 0xff00) >> 8)):
    {
      ...
      if(tftp_state.handle != 
# 178 "kernel/protocols/net/apps/tftp/tftp_server.c" 3 4
                             ((void *)0)
# 178 "kernel/protocols/net/apps/tftp/tftp_server.c"
                                 ) {
        tftp_send_error(tftp_state.upcb, addr, port,
                TFTP_ERROR_ACCESS_VIOLATION, "Only one connection at a time is supported");
        break;
      ...
      sys_timeout(50, tftp_tmr, 
# 184 "kernel/protocols/net/apps/tftp/tftp_server.c" 3 4
                                             ((void *)0)
# 184 "kernel/protocols/net/apps/tftp/tftp_server.c"
                                                 );
      ...
      do { if ( ((0x80U | 0x20U) & 0x80U) && ((0x80U | 0x20U) & 0x80U) && ((s16_t)((0x80U | 0x20U) & 0x03) >= 0x00)) { do {bk_printf ("tftp: %s request from ", (opcode == ((((2) & 0xff) << 8) | (((2) & 0xff00) >> 8))) ? "write" : "read") ;} while(0); if ((0x80U | 0x20U) & 0x08U) { while(1); } } } while(0)
                                                                     ;
      do { if ( ((0x80U | 0x20U) & 0x80U) && ((0x80U | 0x20U) & 0x80U) && ((s16_t)((0x80U | 0x20U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)((addr) != 
# 215 "kernel/protocols/net/apps/tftp/tftp_server.c" 3 4
     ((void *)0) 
# 215 "kernel/protocols/net/apps/tftp/tftp_server.c"
...
# 215 "kernel/protocols/net/apps/tftp/tftp_server.c" 3 4
     ((void *)0) 
# 215 "kernel/protocols/net/apps/tftp/tftp_server.c"
     ? ((u16_t)(((const u8_t*)(&(addr)->addr))[3])) : 0)) ;} while(0); if ((0x80U | 0x20U) & 0x08U) { while(1); } } } while(0);
      do { if ( ((0x80U | 0x20U) & 0x80U) && ((0x80U | 0x20U) & 0x80U) && ((s16_t)((0x80U | 0x20U) & 0x03) >= 0x00)) { do {bk_printf (" for '%s' mode '%s'\n", filename, mode) ;} while(0); if ((0x80U | 0x20U) & 0x08U) { while(1); } } } while(0);
    ...
    case ((((3) & 0xff) << 8) | (((3) & 0xff00) >> 8)):
    {
      ...
      if (tftp_state.handle == 
# 237 "kernel/protocols/net/apps/tftp/tftp_server.c" 3 4
                              ((void *)0)
# 237 "kernel/protocols/net/apps/tftp/tftp_server.c"
                                  ) {
        tftp_send_error(tftp_state.upcb, addr, port,
    ...
    case ((((4) & 0xff) << 8) | (((4) & 0xff00) >> 8)):
    {
      ...
      if (tftp_state.handle == 
# 272 "kernel/protocols/net/apps/tftp/tftp_server.c" 3 4
                              ((void *)0)
# 272 "kernel/protocols/net/apps/tftp/tftp_server.c"
                                  ) {
        tftp_send_error(tftp_state.upcb, addr, port,
                TFTP_ERROR_ACCESS_VIOLATION, "No connection");
        break;
      ...
      if (tftp_state.last_data != 
# 293 "kernel/protocols/net/apps/tftp/tftp_server.c" 3 4
                                 ((void *)0)
# 293 "kernel/protocols/net/apps/tftp/tftp_server.c"
                                     ) {
...
tftp_tmr(void* arg)
{
  ...
  if (tftp_state.handle == 
# 323 "kernel/protocols/net/apps/tftp/tftp_server.c" 3 4
                          ((void *)0)
# 323 "kernel/protocols/net/apps/tftp/tftp_server.c"
                              ) {
    return;
  }

  sys_timeout(50, tftp_tmr, 
# 327 "kernel/protocols/net/apps/tftp/tftp_server.c" 3 4
                                         ((void *)0)
# 327 "kernel/protocols/net/apps/tftp/tftp_server.c"
                                             );

  if ((tftp_state.timer - tftp_state.last_pkt) > (1000 / 50)) {
    if ((tftp_state.last_data != 
# 330 "kernel/protocols/net/apps/tftp/tftp_server.c" 3 4
                                ((void *)0)
# 330 "kernel/protocols/net/apps/tftp/tftp_server.c"
                                    ) && (tftp_state.retries < 5)) {
      do { if ( ((0x80U | 0x20U) & 0x80U) && ((0x80U | 0x20U) & 0x80U) && ((s16_t)((0x80U | 0x20U) & 0x03) >= 0x00)) { do {bk_printf ("tftp: timeout, retrying\n") ;} while(0); if ((0x80U | 0x20U) & 0x08U) { while(1); } } } while(0);
      resend_data();
      tftp_state.retries++;
    } else {
      do { if ( ((0x80U | 0x20U) & 0x80U) && ((0x80U | 0x20U) & 0x80U) && ((s16_t)((0x80U | 0x20U) & 0x03) >= 0x00)) { do {bk_printf ("tftp: timeout\n") ;} while(0); if ((0x80U | 0x20U) & 0x08U) { while(1); } } } while(0);
      close_handle();
    }
  }
}
...
{
    FILE *fp = 
# 343 "kernel/protocols/net/apps/tftp/tftp_server.c" 3 4
              ((void *)0)
# 343 "kernel/protocols/net/apps/tftp/tftp_server.c"
                  ;
...
tftp_server_start(void)
{
  ...
  if (tftp_state.upcb != 
# 390 "kernel/protocols/net/apps/tftp/tftp_server.c" 3 4
                        ((void *)0)
# 390 "kernel/protocols/net/apps/tftp/tftp_server.c"
                            )
      return ERR_OK;

  struct udp_pcb *pcb = udp_new_ip_type(IPADDR_TYPE_ANY);
  if (pcb == 
# 394 "kernel/protocols/net/apps/tftp/tftp_server.c" 3 4
            ((void *)0)
# 394 "kernel/protocols/net/apps/tftp/tftp_server.c"
                ) {
    return ERR_MEM;
  }
  ...
  tftp_state.handle = 
# 404 "kernel/protocols/net/apps/tftp/tftp_server.c" 3 4
                        ((void *)0)
# 404 "kernel/protocols/net/apps/tftp/tftp_server.c"
                            ;
  tftp_state.port = 0;
  tftp_state.ctx = &server_ctx;
  tftp_state.timer = 0;
  tftp_state.last_data = 
# 408 "kernel/protocols/net/apps/tftp/tftp_server.c" 3 4
                        ((void *)0)
# 408 "kernel/protocols/net/apps/tftp/tftp_server.c"
                            ;
  tftp_state.upcb = pcb;
  udp_recv(pcb, recv, 
# 410 "kernel/protocols/net/apps/tftp/tftp_server.c" 3 4
                     ((void *)0)
# 410 "kernel/protocols/net/apps/tftp/tftp_server.c"
                         );
...
tftp_server_stop(void)
{
    ...
    if (tftp_state.upcb != 
# 421 "kernel/protocols/net/apps/tftp/tftp_server.c" 3 4
                          ((void *)0)
# 421 "kernel/protocols/net/apps/tftp/tftp_server.c"
                              ) {
