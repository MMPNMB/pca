# 1 "kernel/vfs/device/vfs_gpio.c"
...
# 1 "././kernel/vfs/device/../include/device/vfs_gpio.h" 1
# 12 "././kernel/vfs/device/../include/device/vfs_gpio.h"
...
# 13 "././kernel/vfs/device/../include/device/vfs_gpio.h" 2
...
# 29 "././kernel/vfs/device/../include/device/vfs_gpio.h"
int vfs_gpio_open(inode_t *inode, file_t *fp);
# 38 "././kernel/vfs/device/../include/device/vfs_gpio.h"
int vfs_gpio_close(file_t *fp);
# 50 "././kernel/vfs/device/../include/device/vfs_gpio.h"
ssize_t vfs_gpio_read(file_t *fp, void *buf, size_t nbytes);
# 61 "././kernel/vfs/device/../include/device/vfs_gpio.h"
int vfs_gpio_ioctl(file_t *fp, int cmd, unsigned long arg);
# 6 "kernel/vfs/device/vfs_gpio.c" 2
...
# 7 "kernel/vfs/device/vfs_gpio.c" 2
# 1 "././kernel/vfs/device/../include/vfs_err.h" 1
# 8 "kernel/vfs/device/vfs_gpio.c" 2
...
int vfs_gpio_open(inode_t *inode, file_t *fp)
{
    int ret = -1;
    gpio_dev_t *gpio_dev = 
# 21 "kernel/vfs/device/vfs_gpio.c" 3 4
                          ((void *)0)
# 21 "kernel/vfs/device/vfs_gpio.c"
                              ;


    if ((fp != 
# 24 "kernel/vfs/device/vfs_gpio.c" 3 4
              ((void *)0)
# 24 "kernel/vfs/device/vfs_gpio.c"
                  ) && (fp->node != 
# 24 "kernel/vfs/device/vfs_gpio.c" 3 4
                                    ((void *)0)
# 24 "kernel/vfs/device/vfs_gpio.c"
        ...
        ret = -
# 38 "kernel/vfs/device/vfs_gpio.c" 3
              22
# 38 "kernel/vfs/device/vfs_gpio.c"
                    ;
    }
...
int vfs_gpio_close(file_t *fp)
{
    int ret = -1;
    gpio_dev_t *gpio_dev = 
# 47 "kernel/vfs/device/vfs_gpio.c" 3 4
                          ((void *)0)
# 47 "kernel/vfs/device/vfs_gpio.c"
                              ;


    if ((fp != 
# 50 "kernel/vfs/device/vfs_gpio.c" 3 4
              ((void *)0)
# 50 "kernel/vfs/device/vfs_gpio.c"
                  ) && (fp->node != 
# 50 "kernel/vfs/device/vfs_gpio.c" 3 4
                                    ((void *)0)
# 50 "kernel/vfs/device/vfs_gpio.c"
        ...
        ret = -
# 72 "kernel/vfs/device/vfs_gpio.c" 3
              22
# 72 "kernel/vfs/device/vfs_gpio.c"
                    ;
    }
...
ssize_t vfs_gpio_read(file_t *fp, void *buf, size_t nbytes)
{
    int ret = -1;
    gpio_dev_t *gpio_dev = 
# 81 "kernel/vfs/device/vfs_gpio.c" 3 4
                          ((void *)0)
# 81 "kernel/vfs/device/vfs_gpio.c"
                              ;


    if ((fp != 
# 84 "kernel/vfs/device/vfs_gpio.c" 3 4
              ((void *)0)
# 84 "kernel/vfs/device/vfs_gpio.c"
                  ) && (fp->node != 
# 84 "kernel/vfs/device/vfs_gpio.c" 3 4
                                    ((void *)0)
# 84 "kernel/vfs/device/vfs_gpio.c"
        ...
        ret = -
# 106 "kernel/vfs/device/vfs_gpio.c" 3
              22
# 106 "kernel/vfs/device/vfs_gpio.c"
                    ;
    }
...
int vfs_gpio_ioctl(file_t *fp, int cmd, unsigned long arg)
{
    int ret = -1;
    gpio_dev_t *gpio_dev = 
# 115 "kernel/vfs/device/vfs_gpio.c" 3 4
                          ((void *)0)
# 115 "kernel/vfs/device/vfs_gpio.c"
                              ;


    if ((fp == 
# 118 "kernel/vfs/device/vfs_gpio.c" 3 4
              ((void *)0)
# 118 "kernel/vfs/device/vfs_gpio.c"
                  ) || (fp->node == 
# 118 "kernel/vfs/device/vfs_gpio.c" 3 4
                                    ((void *)0)
# 118 "kernel/vfs/device/vfs_gpio.c"
        ...
        return -
# 119 "kernel/vfs/device/vfs_gpio.c" 3
               22
# 119 "kernel/vfs/device/vfs_gpio.c"
                     ;
    }
    ...
    switch(cmd) {
        ...
        default:
            ret = -
# 142 "kernel/vfs/device/vfs_gpio.c" 3
                  22
# 142 "kernel/vfs/device/vfs_gpio.c"
                        ;
            break;
    }
