...
# 6 "kernel/vfs/vfs_file.c" 2
# 1 "./kernel/vfs/include/vfs_conf.h" 1
# 7 "kernel/vfs/vfs_file.c" 2
# 1 "./kernel/vfs/include/vfs_err.h" 1
# 8 "kernel/vfs/vfs_file.c" 2
...
# 10 "kernel/vfs/vfs_file.c" 2



# 12 "kernel/vfs/vfs_file.c"
static file_t files[(25 * 2)];
...
file_t *new_file(inode_t *node)
{
    ...
    for (idx = 0; idx < (25 * 2); idx++) {
        f = &files[idx];

        if (f->node == 
# 22 "kernel/vfs/vfs_file.c" 3 4
                      ((void *)0)
# 22 "kernel/vfs/vfs_file.c"
                          ) {
            goto got_file;
        }
    }
    ...
    return 
# 27 "kernel/vfs/vfs_file.c" 3 4
          ((void *)0)
# 27 "kernel/vfs/vfs_file.c"
              ;

got_file:
    f->node = node;
    f->f_arg = 
# 31 "kernel/vfs/vfs_file.c" 3 4
              ((void *)0)
# 31 "kernel/vfs/vfs_file.c"
                  ;
    f->offset = 0;
    inode_ref(node);
    return f;
...
void del_file(file_t *file)
{
    ...
    file->node = 
# 40 "kernel/vfs/vfs_file.c" 3 4
                ((void *)0)
# 40 "kernel/vfs/vfs_file.c"
                    ;
}

int get_fd(file_t *file)
{
    return (file - files) + 64;
}
...
file_t *get_file(int fd)
{
    ...
    if (fd < 0) {
        return 
# 55 "kernel/vfs/vfs_file.c" 3 4
              ((void *)0)
# 55 "kernel/vfs/vfs_file.c"
                  ;
    }

    if (fd >= (25 * 2)) {
        return 
# 59 "kernel/vfs/vfs_file.c" 3 4
              ((void *)0)
# 59 "kernel/vfs/vfs_file.c"
                  ;
    }

    f = &files[fd];
    return f->node ? f : 
# 63 "kernel/vfs/vfs_file.c" 3 4
                        ((void *)0)
# 63 "kernel/vfs/vfs_file.c"
                            ;
}
