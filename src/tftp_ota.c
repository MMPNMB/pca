# 1 "kernel/protocols/net/apps/tftp/tftp_ota.c"
...
# 5 "kernel/protocols/net/apps/tftp/tftp_ota.c" 2
...
# 6 "kernel/protocols/net/apps/tftp/tftp_ota.c" 2
...
# 7 "kernel/protocols/net/apps/tftp/tftp_ota.c" 2
...
# 9 "kernel/protocols/net/apps/tftp/tftp_ota.c" 2
# 1 "./kernel/protocols/net/include/lwip/ip_addr.h" 1
# 40 "./kernel/protocols/net/include/lwip/ip_addr.h"
...
# 41 "./kernel/protocols/net/include/lwip/ip_addr.h" 2
...
# 10 "kernel/protocols/net/apps/tftp/tftp_ota.c" 2
...
# 46 "./kernel/protocols/net/include/lwip/apps/tftp.h" 2
...
# 12 "kernel/protocols/net/apps/tftp/tftp_ota.c" 2

static void* tftp_fopen(const char* fname, const char* mode, u8_t write)
{
    void *fp = 
# 15 "kernel/protocols/net/apps/tftp/tftp_ota.c" 3 4
              ((void *)0)
# 15 "kernel/protocols/net/apps/tftp/tftp_ota.c"
                  ;

    if (write == 0)
        return 
# 18 "kernel/protocols/net/apps/tftp/tftp_ota.c" 3 4
              ((void *)0)
# 18 "kernel/protocols/net/apps/tftp/tftp_ota.c"
                  ;
...
static int tftp_fwrite(void* handle, struct pbuf* p)
{
    ...
    writebytes = hal_ota_write(hal_ota_get_default_module(), 
# 42 "kernel/protocols/net/apps/tftp/tftp_ota.c" 3 4
                                                            ((void *)0)
# 42 "kernel/protocols/net/apps/tftp/tftp_ota.c"
                                                                , buff, p->tot_len);
...
{
    if (error == 0) {
        do { if ( ((0x80U | 0x20U) & 0x80U) && ((0x80U | 0x20U) & 0x80U) && ((s16_t)((0x80U | 0x20U) & 0x03) >= 0x00)) { do {bk_printf ("ota get done, %d bytes reveived\n", len) ;} while(0); if ((0x80U | 0x20U) & 0x08U) { while(1); } } } while(0);
        ...
        do { if ( ((0x80U | 0x20U) & 0x80U) && ((0x80U | 0x20U) & 0x80U) && ((s16_t)((0x80U | 0x20U) & 0x03) >= 0x00)) { do {bk_printf ("ota get failed\n") ;} while(0); if ((0x80U | 0x20U) & 0x08U) { while(1); } } } while(0);
    }
}
