...
# 6 "kernel/rhino/core/k_obj.c" 2

kstat_t g_sys_stat;
uint8_t g_idle_task_spawned[1];

runqueue_t g_ready_queue;


uint8_t g_sched_lock[1];
uint8_t g_intrpt_nested_level[1];


ktask_t *g_preferred_ready_task[1];


ktask_t *g_active_task[1];


ktask_t g_idle_task[1];
idle_count_t g_idle_count[1];
cpu_stack_t g_idle_task_stack[1][200];
...
cpu_stack_t g_timer_task_stack[300];
kbuf_queue_t g_timer_queue;
k_timer_queue_cb timer_queue_cb[20];
# 73 "kernel/rhino/core/k_obj.c"
ksem_t g_res_sem;
klist_t g_res_list;
ktask_t g_dyn_task;
cpu_stack_t g_dyn_task_stack[256];
...
cpu_stack_t g_workqueue_stack[768];
