# 1 "utility/digest_algorithm/digest_algorithm.c"
...
# 6 "utility/digest_algorithm/digest_algorithm.c" 2
...
# 7 "utility/digest_algorithm/digest_algorithm.c" 2
# 1 "utility/digest_algorithm/digest_algorithm.h" 1
# 11 "utility/digest_algorithm/digest_algorithm.h"
...
# 12 "utility/digest_algorithm/digest_algorithm.h" 2
# 25 "utility/digest_algorithm/digest_algorithm.h"
...
# 9 "utility/digest_algorithm/digest_algorithm.c" 2
# 1 "utility/digest_algorithm/sha2.c" 1
# 35 "utility/digest_algorithm/sha2.c"
...
# 36 "utility/digest_algorithm/sha2.c" 2


# 37 "utility/digest_algorithm/sha2.c"
...
# 59 "utility/digest_algorithm/sha2.c"
...
# 142 "utility/digest_algorithm/sha2.c"
                          ...
                          uint32_t len)
{
    ...
    if (context == 
# 415 "utility/digest_algorithm/sha2.c" 3 4
                  ((void *)0) 
# 415 "utility/digest_algorithm/sha2.c"
                       || data == 
# 415 "utility/digest_algorithm/sha2.c" 3 4
                                  ((void *)0)
# 415 "utility/digest_algorithm/sha2.c"
...
static void SHA256_Final(sha2_byte digest[], SHA256_CTX *context)
{
    ...
    if (context == 
# 461 "utility/digest_algorithm/sha2.c" 3 4
                  ((void *)0)
# 461 "utility/digest_algorithm/sha2.c"
                      ) {
        return;
    }
                          ...
                          uint32_t len)
{
    ...
    if (context == 
# 611 "utility/digest_algorithm/sha2.c" 3 4
                  ((void *)0) 
# 611 "utility/digest_algorithm/sha2.c"
                       || data == 
# 611 "utility/digest_algorithm/sha2.c" 3 4
                                  ((void *)0)
# 611 "utility/digest_algorithm/sha2.c"
...
static void SHA512_Final(sha2_byte digest[], SHA512_CTX *context)
{
    ...
    if (context == 
# 701 "utility/digest_algorithm/sha2.c" 3 4
                  ((void *)0)
# 701 "utility/digest_algorithm/sha2.c"
                      ) {
        return;
    }
...
static void SHA384_Final(sha2_byte digest[], SHA384_CTX *context)
{
    ...
    if (context == 
# 747 "utility/digest_algorithm/sha2.c" 3 4
                  ((void *)0)
# 747 "utility/digest_algorithm/sha2.c"
                      ) {
        return;
    }
...
# 10 "utility/digest_algorithm/digest_algorithm.c" 2
# 1 "utility/digest_algorithm/hmac.c" 1
...
# 11 "utility/digest_algorithm/digest_algorithm.c" 2
...
# 12 "utility/digest_algorithm/digest_algorithm.c" 2

void *digest_md5_init(void)
{
    MD5_CTX *ctx = (MD5_CTX *) aos_malloc(sizeof(MD5_CTX));
    if (
# 16 "utility/digest_algorithm/digest_algorithm.c" 3 4
       ((void *)0) 
# 16 "utility/digest_algorithm/digest_algorithm.c"
            == ctx) {
        return 
# 17 "utility/digest_algorithm/digest_algorithm.c" 3 4
              ((void *)0)
# 17 "utility/digest_algorithm/digest_algorithm.c"
                  ;
    }
...
int digest_md5(const void *data, uint32_t length, unsigned char *digest)
{
    MD5_CTX *ctx = (MD5_CTX *) aos_malloc(sizeof(MD5_CTX));
    if (
# 40 "utility/digest_algorithm/digest_algorithm.c" 3 4
       ((void *)0) 
# 40 "utility/digest_algorithm/digest_algorithm.c"
            == ctx) {
        return -1;
    }
...
int digest_md5_file(const char *path, unsigned char *md5)
{
    ...
    fd = aos_open(path, 
# 58 "utility/digest_algorithm/digest_algorithm.c" 3
                       0
# 58 "utility/digest_algorithm/digest_algorithm.c"
                               );
    if (fd < 0) {
        return -1;
    }
    ...
    MD5_CTX *ctx = (MD5_CTX *) aos_malloc(sizeof(MD5_CTX));
    if (
# 64 "utility/digest_algorithm/digest_algorithm.c" 3 4
       ((void *)0) 
# 64 "utility/digest_algorithm/digest_algorithm.c"
            == ctx) {
        aos_close(fd);
        return -1;
    }
...
void *digest_sha256_init(void)
{
    ...
    if (
# 92 "utility/digest_algorithm/digest_algorithm.c" 3 4
       ((void *)0) 
# 92 "utility/digest_algorithm/digest_algorithm.c"
            == ctx) {
        return 
# 93 "utility/digest_algorithm/digest_algorithm.c" 3 4
              ((void *)0)
# 93 "utility/digest_algorithm/digest_algorithm.c"
                  ;
    }
...
int digest_sha256(const void *data, uint32_t length, unsigned char *digest)
{
    SHA256_CTX *ctx = (SHA256_CTX *) aos_malloc(sizeof(SHA256_CTX));
    if (
# 117 "utility/digest_algorithm/digest_algorithm.c" 3 4
       ((void *)0) 
# 117 "utility/digest_algorithm/digest_algorithm.c"
            == ctx) {
        return -1;
    }
...
void *digest_sha384_init(void)
{
    ...
    if (
# 134 "utility/digest_algorithm/digest_algorithm.c" 3 4
       ((void *)0) 
# 134 "utility/digest_algorithm/digest_algorithm.c"
            == ctx) {
        return 
# 135 "utility/digest_algorithm/digest_algorithm.c" 3 4
              ((void *)0)
# 135 "utility/digest_algorithm/digest_algorithm.c"
                  ;
    }
...
int digest_sha384(const void *data, uint32_t length, unsigned char *digest)
{
    SHA384_CTX *ctx = (SHA384_CTX *) aos_malloc(sizeof(SHA384_CTX));
    if (
# 159 "utility/digest_algorithm/digest_algorithm.c" 3 4
       ((void *)0) 
# 159 "utility/digest_algorithm/digest_algorithm.c"
            == ctx) {
        return -1;
    }
...
void *digest_sha512_init(void)
{
    ...
    if (
# 174 "utility/digest_algorithm/digest_algorithm.c" 3 4
       ((void *)0) 
# 174 "utility/digest_algorithm/digest_algorithm.c"
            == ctx) {
        return 
# 175 "utility/digest_algorithm/digest_algorithm.c" 3 4
              ((void *)0)
# 175 "utility/digest_algorithm/digest_algorithm.c"
                  ;
    }
...
int digest_sha512(const void *data, uint32_t length, unsigned char *digest)
{
    SHA512_CTX *ctx = (SHA512_CTX *) aos_malloc(sizeof(SHA512_CTX));
    if (
# 199 "utility/digest_algorithm/digest_algorithm.c" 3 4
       ((void *)0) 
# 199 "utility/digest_algorithm/digest_algorithm.c"
            == ctx) {
        return -1;
    }
