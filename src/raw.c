# 1 "kernel/protocols/net/core/raw.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/core/raw.c"
# 48 "kernel/protocols/net/core/raw.c"
...
# 49 "kernel/protocols/net/core/raw.c" 2
...
# 53 "kernel/protocols/net/core/raw.c" 2
...
# 54 "kernel/protocols/net/core/raw.c" 2
...
# 55 "kernel/protocols/net/core/raw.c" 2
...
# 56 "kernel/protocols/net/core/raw.c" 2
# 1 "./kernel/protocols/net/include/lwip/raw.h" 1
# 47 "./kernel/protocols/net/include/lwip/raw.h"
...
# 57 "kernel/protocols/net/core/raw.c" 2
...
# 61 "kernel/protocols/net/core/raw.c" 2
...
# 63 "kernel/protocols/net/core/raw.c" 2



# 65 "kernel/protocols/net/core/raw.c"
...
{
  (void)broadcast;
# 85 "kernel/protocols/net/core/raw.c"
  if (1) {
    ...
    if (broadcast != 0) {
      ...
      {
        if ((((&pcb->local_ip)) == 
# 94 "kernel/protocols/net/core/raw.c" 3 4
           ((void *)0) 
# 94 "kernel/protocols/net/core/raw.c"
    ...
    if (((&pcb->local_ip) == 
# 101 "kernel/protocols/net/core/raw.c" 3 4
       ((void *)0) 
# 101 "kernel/protocols/net/core/raw.c"
       || ((*(&pcb->local_ip)).addr == ((u32_t)0x00000000UL))) ||
...
# 127 "kernel/protocols/net/core/raw.c"
u8_t
raw_input(struct pbuf *p, struct netif *inp)
{
  ...
  (void)inp;
# 150 "kernel/protocols/net/core/raw.c"
  {
  ...
  prev = 
# 155 "kernel/protocols/net/core/raw.c" 3 4
        ((void *)0)
# 155 "kernel/protocols/net/core/raw.c"
            ;
  pcb = raw_pcbs;


  while ((eaten == 0) && (pcb != 
# 159 "kernel/protocols/net/core/raw.c" 3 4
                                ((void *)0)
# 159 "kernel/protocols/net/core/raw.c"
                                    )) {
    if ((pcb->protocol == proto) && raw_input_match(pcb, broadcast)) {

      if (pcb->recv != 
# 162 "kernel/protocols/net/core/raw.c" 3 4
                      ((void *)0)
# 162 "kernel/protocols/net/core/raw.c"
                          ) {
        ...
        if (eaten != 0) {
          ...
          p = 
# 170 "kernel/protocols/net/core/raw.c" 3 4
             ((void *)0)
# 170 "kernel/protocols/net/core/raw.c"
                 ;
          eaten = 1;
          if (prev != 
# 172 "kernel/protocols/net/core/raw.c" 3 4
                     ((void *)0)
# 172 "kernel/protocols/net/core/raw.c"
                         ) {
...
# 209 "kernel/protocols/net/core/raw.c"
err_t
raw_bind(struct raw_pcb *pcb, const ip_addr_t *ipaddr)
{
  if ((pcb == 
# 212 "kernel/protocols/net/core/raw.c" 3 4
             ((void *)0)
# 212 "kernel/protocols/net/core/raw.c"
                 ) || (ipaddr == 
# 212 "kernel/protocols/net/core/raw.c" 3 4
                                 ((void *)0)
# 212 "kernel/protocols/net/core/raw.c"
...
# 215 "kernel/protocols/net/core/raw.c" 3 4
 ((void *)0) 
# 215 "kernel/protocols/net/core/raw.c"
 ? 0 : (ipaddr)->addr));
  return ERR_OK;
}
# 233 "kernel/protocols/net/core/raw.c"
err_t
raw_connect(struct raw_pcb *pcb, const ip_addr_t *ipaddr)
{
  if ((pcb == 
# 236 "kernel/protocols/net/core/raw.c" 3 4
             ((void *)0)
# 236 "kernel/protocols/net/core/raw.c"
                 ) || (ipaddr == 
# 236 "kernel/protocols/net/core/raw.c" 3 4
                                 ((void *)0)
# 236 "kernel/protocols/net/core/raw.c"
...
# 239 "kernel/protocols/net/core/raw.c" 3 4
 ((void *)0) 
# 239 "kernel/protocols/net/core/raw.c"
 ? 0 : (ipaddr)->addr));
  return ERR_OK;
}
# 254 "kernel/protocols/net/core/raw.c"
void
...
# 275 "kernel/protocols/net/core/raw.c"
err_t
raw_sendto(struct raw_pcb *pcb, struct pbuf *p, const ip_addr_t *ipaddr)
{
  ...
  if ((pcb == 
# 285 "kernel/protocols/net/core/raw.c" 3 4
             ((void *)0)
# 285 "kernel/protocols/net/core/raw.c"
                 ) || (ipaddr == 
# 285 "kernel/protocols/net/core/raw.c" 3 4
                                 ((void *)0)
# 285 "kernel/protocols/net/core/raw.c"
  ...
  do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("raw_sendto\n") ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
  ...
  if (pbuf_header(p, header_size)) {
    ...
    if (q == 
# 305 "kernel/protocols/net/core/raw.c" 3 4
            ((void *)0)
# 305 "kernel/protocols/net/core/raw.c"
                ) {
      do { if ( ((0x00U | 0x40U | 0x02) & 0x80U) && ((0x00U | 0x40U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x40U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("raw_sendto: could not allocate header\n") ;} while(0); if ((0x00U | 0x40U | 0x02) & 0x08U) { while(1); } } } while(0);
      return ERR_MEM;
    }
    if (p->tot_len != 0) {
    ...
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("raw_sendto: added header pbuf %p before given pbuf %p\n", (void *)q, (void *)p) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  } else {
  ...
  if (netif == 
# 325 "kernel/protocols/net/core/raw.c" 3 4
              ((void *)0)
# 325 "kernel/protocols/net/core/raw.c"
                  ) {
    do { if ( ((0x00U | 0x01) & 0x80U) && ((0x00U | 0x01) & 0x80U) && ((s16_t)((0x00U | 0x01) & 0x03) >= 0x00)) { do {bk_printf ("raw_sendto: No route to ") ;} while(0); if ((0x00U | 0x01) & 0x08U) { while(1); } } } while(0);
    do { if ( ((0x00U | 0x01) & 0x80U) && ((0x00U | 0x01) & 0x80U) && ((s16_t)((0x00U | 0x01) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)((dst_ip) != 
# 327 "kernel/protocols/net/core/raw.c" 3 4
   ((void *)0) 
# 327 "kernel/protocols/net/core/raw.c"
...
# 327 "kernel/protocols/net/core/raw.c" 3 4
   ((void *)0) 
# 327 "kernel/protocols/net/core/raw.c"
   ? ((u16_t)(((const u8_t*)(&(dst_ip)->addr))[3])) : 0)) ;} while(0); if ((0x00U | 0x01) & 0x08U) { while(1); } } } while(0);
...
# 350 "kernel/protocols/net/core/raw.c"
  if (((&pcb->local_ip) == 
# 350 "kernel/protocols/net/core/raw.c" 3 4
     ((void *)0) 
# 350 "kernel/protocols/net/core/raw.c"
     || ((*(&pcb->local_ip)).addr == ((u32_t)0x00000000UL)))) {

    src_ip = (((netif) != 
# 352 "kernel/protocols/net/core/raw.c" 3 4
            ((void *)0)
# 352 "kernel/protocols/net/core/raw.c"
            ) ? ((const ip_addr_t*)&((netif)->ip_addr)) : 
# 352 "kernel/protocols/net/core/raw.c" 3 4
            ((void *)0)
# 352 "kernel/protocols/net/core/raw.c"
            );
# 361 "kernel/protocols/net/core/raw.c"
  } else {

    src_ip = &pcb->local_ip;
  }
# 376 "kernel/protocols/net/core/raw.c"
  ;
  err = ip4_output_if(q, src_ip, dst_ip, pcb->ttl, pcb->tos, pcb->protocol, netif);
  ;
...
# 396 "kernel/protocols/net/core/raw.c"
err_t
raw_send(struct raw_pcb *pcb, struct pbuf *p)
{
  return raw_sendto(pcb, p, &pcb->remote_ip);
}
# 411 "kernel/protocols/net/core/raw.c"
void
...
# 421 "kernel/protocols/net/core/raw.c" 3 4
                                 ((void *)0)
# 421 "kernel/protocols/net/core/raw.c"
                                     ; pcb2 = pcb2->next) {

      if (pcb2->next != 
# 423 "kernel/protocols/net/core/raw.c" 3 4
                       ((void *)0) 
# 423 "kernel/protocols/net/core/raw.c"
                            && pcb2->next == pcb) {
...
# 444 "kernel/protocols/net/core/raw.c"
struct raw_pcb *
raw_new(u8_t proto)
{
  struct raw_pcb *pcb;

  do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("raw_new\n") ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);

  pcb = (struct raw_pcb *)memp_malloc(MEMP_RAW_PCB);

  if (pcb != 
# 453 "kernel/protocols/net/core/raw.c" 3 4
            ((void *)0)
# 453 "kernel/protocols/net/core/raw.c"
                ) {
...
# 479 "kernel/protocols/net/core/raw.c"
struct raw_pcb *
...
void raw_netif_ip_addr_changed(const ip_addr_t* old_addr, const ip_addr_t* new_addr)
{
  ...
  if (!((old_addr) == 
# 504 "kernel/protocols/net/core/raw.c" 3 4
      ((void *)0) 
# 504 "kernel/protocols/net/core/raw.c"
...
# 505 "kernel/protocols/net/core/raw.c" 3 4
                                 ((void *)0)
# 505 "kernel/protocols/net/core/raw.c"
                                     ; rpcb = rpcb->next) {
