...
# 7 "kernel/vfs/select.c" 2
# 1 "./kernel/vfs/include/vfs_conf.h" 1
# 8 "kernel/vfs/select.c" 2
# 1 "./kernel/vfs/include/vfs_err.h" 1
# 9 "kernel/vfs/select.c" 2
...
# 10 "kernel/vfs/select.c" 2
# 1 "./kernel/vfs/include/vfs.h" 1
# 11 "kernel/vfs/select.c" 2
...
# 15 "kernel/vfs/select.c" 2
# 24 "kernel/vfs/select.c"
extern aos_mutex_t g_vfs_mutex;
# 150 "kernel/vfs/select.c"
struct poll_arg {
    int efd;
};
...
# 188 "kernel/vfs/select.c" 3
                             _types_fd_set 
# 188 "kernel/vfs/select.c"
...
# 195 "kernel/vfs/select.c" 3
   ((
# 195 "kernel/vfs/select.c"
   rfds
# 195 "kernel/vfs/select.c" 3
   )->fds_bits[(
# 195 "kernel/vfs/select.c"
...
# 195 "kernel/vfs/select.c"
    ...
    return lwip_select(maxfd + 1,rfds,
# 197 "kernel/vfs/select.c" 3 4
          ((void *)0)
# 197 "kernel/vfs/select.c"
          ,
# 197 "kernel/vfs/select.c" 3 4
          ((void *)0)
# 197 "kernel/vfs/select.c"
...
# 201 "kernel/vfs/select.c" 3
                                                 _types_fd_set 
# 201 "kernel/vfs/select.c"
                                                        *rfds, void *parg)
{
    int i;
    int maxfd = 0;
...
# 218 "kernel/vfs/select.c" 3
           ((
# 218 "kernel/vfs/select.c"
           rfds
# 218 "kernel/vfs/select.c" 3
           )->fds_bits[(
# 218 "kernel/vfs/select.c"
...
# 218 "kernel/vfs/select.c"
        ...
        if (f == 
# 225 "kernel/vfs/select.c" 3 4
                ((void *)0)
# 225 "kernel/vfs/select.c"
                    ) {
            return -1;
        }
...
# 230 "kernel/vfs/select.c" 3 4
                                     1
# 230 "kernel/vfs/select.c"
...
static int post_poll(struct pollfd *fds, int nfds)
{
    ...
    for (j = 0; j < nfds; j++) {
        ...
        if (f == 
# 253 "kernel/vfs/select.c" 3 4
                ((void *)0)
# 253 "kernel/vfs/select.c"
                    ) {
            continue;
        }

        (f->node->ops.i_ops->poll)(f, 
# 257 "kernel/vfs/select.c" 3 4
                                     0
# 257 "kernel/vfs/select.c"
                                          , 
# 257 "kernel/vfs/select.c" 3 4
                                            ((void *)0)
# 257 "kernel/vfs/select.c"
...
# 269 "kernel/vfs/select.c" 3
   _types_fd_set 
# 269 "kernel/vfs/select.c"
          rfds;
...
# 279 "kernel/vfs/select.c" 3
   (__extension__ (void)({ size_t __i; char *__tmp = (char *)
# 279 "kernel/vfs/select.c"
   &rfds
# 279 "kernel/vfs/select.c" 3
...
# 279 "kernel/vfs/select.c"
    ...
    if (ret >= 0) {
        ...
        for (i = 0; i < nfds; i++) {
            ...
            if (
# 294 "kernel/vfs/select.c" 3
               ((
# 294 "kernel/vfs/select.c"
               &rfds
# 294 "kernel/vfs/select.c" 3
               )->fds_bits[(
# 294 "kernel/vfs/select.c"
...
int aos_ioctl_in_loop(int cmd, unsigned long arg)
{
    ...
    for (fd = 64;
        ...
        if (f == 
# 344 "kernel/vfs/select.c" 3 4
                ((void *)0)
# 344 "kernel/vfs/select.c"
                    ) {
...
# 355 "kernel/vfs/select.c" 3 4
                                       ((void *)0)
# 355 "kernel/vfs/select.c"
                                           ) {
