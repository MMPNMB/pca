# 1 "kernel/protocols/net/core/tcp.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/core/tcp.c"
# 48 "kernel/protocols/net/core/tcp.c"
...
# 49 "kernel/protocols/net/core/tcp.c" 2
...
# 53 "kernel/protocols/net/core/tcp.c" 2
...
# 54 "kernel/protocols/net/core/tcp.c" 2
...
# 55 "kernel/protocols/net/core/tcp.c" 2
# 1 "./kernel/protocols/net/include/lwip/tcp.h" 1
# 46 "./kernel/protocols/net/include/lwip/tcp.h"
...
# 44 "./kernel/protocols/net/include/lwip/ip.h"
...
# 56 "kernel/protocols/net/core/tcp.c" 2
# 1 "./kernel/protocols/net/include/lwip/priv/tcp_priv.h" 1
# 52 "./kernel/protocols/net/include/lwip/priv/tcp_priv.h"
...
# 57 "kernel/protocols/net/core/tcp.c" 2




# 1 "./kernel/protocols/net/include/lwip/nd6.h" 1
# 62 "kernel/protocols/net/core/tcp.c" 2
...
# 64 "kernel/protocols/net/core/tcp.c" 2
# 88 "kernel/protocols/net/core/tcp.c"
...
tcp_init(void)
{
  ...
  tcp_port = ((u16_t)(((((u32_t)rand())) & ~0xc000) + 0xc000));
...
tcp_remove_listener(struct tcp_pcb *list, struct tcp_pcb_listen *lpcb)
{
   struct tcp_pcb *pcb;
   for (pcb = list; pcb != 
# 170 "kernel/protocols/net/core/tcp.c" 3 4
                          ((void *)0)
# 170 "kernel/protocols/net/core/tcp.c"
                              ; pcb = pcb->next) {
      if (pcb->listener == lpcb) {
         pcb->listener = 
# 172 "kernel/protocols/net/core/tcp.c" 3 4
                        ((void *)0)
# 172 "kernel/protocols/net/core/tcp.c"
                            ;
      }
   }
}
...
# 206 "kernel/protocols/net/core/tcp.c"
void
tcp_backlog_delayed(struct tcp_pcb* pcb)
{
  ...
  if ((pcb->flags & 0x0200U) == 0) {
    if (pcb->listener != 
# 211 "kernel/protocols/net/core/tcp.c" 3 4
                        ((void *)0)
# 211 "kernel/protocols/net/core/tcp.c"
                            ) {
...
# 228 "kernel/protocols/net/core/tcp.c"
void
tcp_backlog_accepted(struct tcp_pcb* pcb)
{
  ...
  if ((pcb->flags & 0x0200U) != 0) {
    if (pcb->listener != 
# 233 "kernel/protocols/net/core/tcp.c" 3 4
                        ((void *)0)
# 233 "kernel/protocols/net/core/tcp.c"
                            ) {
      ;
      pcb->listener->accepts_pending--;
      pcb->flags &= ~0x0200U;
...
# 258 "kernel/protocols/net/core/tcp.c"
static err_t
tcp_close_shutdown(struct tcp_pcb *pcb, u8_t rst_on_unacked_data)
{
  ...
  if (rst_on_unacked_data && ((pcb->state == ESTABLISHED) || (pcb->state == CLOSE_WAIT))) {
    if ((pcb->refused_data != 
# 264 "kernel/protocols/net/core/tcp.c" 3 4
                             ((void *)0)
# 264 "kernel/protocols/net/core/tcp.c"
                                 ) || (pcb->rcv_wnd != (3*(1500 - 40)))) {
...
# 275 "kernel/protocols/net/core/tcp.c" 3 4
     ((void *)0)
# 275 "kernel/protocols/net/core/tcp.c"
...
# 304 "kernel/protocols/net/core/tcp.c" 3 4
     ((void *)0)
# 304 "kernel/protocols/net/core/tcp.c"
     ; tcp_tmp_pcb = tcp_tmp_pcb->next) { if(tcp_tmp_pcb->next == (pcb)) { tcp_tmp_pcb->next = (pcb)->next; break; } } } (pcb)->next = 
# 304 "kernel/protocols/net/core/tcp.c" 3 4
     ((void *)0)
# 304 "kernel/protocols/net/core/tcp.c"
    ...
    memp_free(MEMP_TCP_PCB, pcb);
    pcb = 
# 307 "kernel/protocols/net/core/tcp.c" 3 4
         ((void *)0)
# 307 "kernel/protocols/net/core/tcp.c"
             ;
    break;
  case LISTEN:
    err = ERR_OK;
    ...
    pcb = 
# 314 "kernel/protocols/net/core/tcp.c" 3 4
         ((void *)0)
# 314 "kernel/protocols/net/core/tcp.c"
             ;
    break;
  case SYN_SENT:
    err = ERR_OK;
    ...
    memp_free(MEMP_TCP_PCB, pcb);
    pcb = 
# 320 "kernel/protocols/net/core/tcp.c" 3 4
         ((void *)0)
# 320 "kernel/protocols/net/core/tcp.c"
             ;
    ;
    break;
  case SYN_RCVD:
  ...
  default:
    ...
    err = ERR_OK;
    pcb = 
# 348 "kernel/protocols/net/core/tcp.c" 3 4
         ((void *)0)
# 348 "kernel/protocols/net/core/tcp.c"
             ;
    break;
  }

  if (pcb != 
# 352 "kernel/protocols/net/core/tcp.c" 3 4
            ((void *)0) 
# 352 "kernel/protocols/net/core/tcp.c"
                 && err == ERR_OK) {
...
# 378 "kernel/protocols/net/core/tcp.c"
err_t
tcp_close(struct tcp_pcb *pcb)
{
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_close: closing in ") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  ;
...
# 405 "kernel/protocols/net/core/tcp.c"
err_t
tcp_shutdown(struct tcp_pcb *pcb, int shut_rx, int shut_tx)
{
  ...
  if (shut_rx) {
    ...
    if (pcb->refused_data != 
# 419 "kernel/protocols/net/core/tcp.c" 3 4
                            ((void *)0)
# 419 "kernel/protocols/net/core/tcp.c"
                                ) {
      pbuf_free(pcb->refused_data);
      pcb->refused_data = 
# 421 "kernel/protocols/net/core/tcp.c" 3 4
                         ((void *)0)
# 421 "kernel/protocols/net/core/tcp.c"
                             ;
    }
  }
  if (shut_tx) {
...
# 449 "kernel/protocols/net/core/tcp.c"
void
  ...
  if (pcb->state == TIME_WAIT) {
    ...
    if (pcb->state == CLOSED) {
      if (pcb->local_port != 0) {
        ...
        do { if(*(&tcp_bound_pcbs) == (pcb)) { (*(&tcp_bound_pcbs)) = (*&tcp_bound_pcbs)->next; } else { struct tcp_pcb *tcp_tmp_pcb; for (tcp_tmp_pcb = *&tcp_bound_pcbs; tcp_tmp_pcb != 
# 479 "kernel/protocols/net/core/tcp.c" 3 4
       ((void *)0)
# 479 "kernel/protocols/net/core/tcp.c"
       ; tcp_tmp_pcb = tcp_tmp_pcb->next) { if(tcp_tmp_pcb->next == (pcb)) { tcp_tmp_pcb->next = (pcb)->next; break; } } } (pcb)->next = 
# 479 "kernel/protocols/net/core/tcp.c" 3 4
       ((void *)0)
# 479 "kernel/protocols/net/core/tcp.c"
    ...
    if (pcb->unacked != 
# 486 "kernel/protocols/net/core/tcp.c" 3 4
                       ((void *)0)
# 486 "kernel/protocols/net/core/tcp.c"
                           ) {
      tcp_segs_free(pcb->unacked);
    }
    if (pcb->unsent != 
# 489 "kernel/protocols/net/core/tcp.c" 3 4
                      ((void *)0)
# 489 "kernel/protocols/net/core/tcp.c"
                          ) {
      tcp_segs_free(pcb->unsent);
    }

    if (pcb->ooseq != 
# 493 "kernel/protocols/net/core/tcp.c" 3 4
                     ((void *)0)
# 493 "kernel/protocols/net/core/tcp.c"
                         ) {
    ...
    tcp_backlog_accepted(pcb);
    if (send_rst) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_abandon: sending RST\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      tcp_rst(seqno, ackno, &pcb->local_ip, &pcb->remote_ip, local_port, pcb->remote_port);
    }
    memp_free(MEMP_TCP_PCB, pcb);
    do { if((errf) != 
# 503 "kernel/protocols/net/core/tcp.c" 3 4
   ((void *)0)
# 503 "kernel/protocols/net/core/tcp.c"
   ) (errf)((errf_arg),(ERR_ABRT)); } while (0);
  }
}
# 518 "kernel/protocols/net/core/tcp.c"
void
tcp_abort(struct tcp_pcb *pcb)
{
  tcp_abandon(pcb, 1);
}
# 539 "kernel/protocols/net/core/tcp.c"
err_t
tcp_bind(struct tcp_pcb *pcb, const ip_addr_t *ipaddr, u16_t port)
{
  ...
  if (ipaddr == 
# 548 "kernel/protocols/net/core/tcp.c" 3 4
               ((void *)0)
# 548 "kernel/protocols/net/core/tcp.c"
                   ) {
    ipaddr = (&ip_addr_any);
  }
  ...
  if ((pcb == 
# 554 "kernel/protocols/net/core/tcp.c" 3 4
             ((void *)0)
# 554 "kernel/protocols/net/core/tcp.c"
                 ) || (ipaddr == 
# 554 "kernel/protocols/net/core/tcp.c" 3 4
                                 ((void *)0)
# 554 "kernel/protocols/net/core/tcp.c"
  ...
  do { if (!(pcb->state == CLOSED)) { do {bk_printf ("tcp_bind: can only bind in state CLOSED") ;} while(0); return ERR_VAL;}} while(0);
...
# 579 "kernel/protocols/net/core/tcp.c" 3 4
                                            ((void *)0)
# 579 "kernel/protocols/net/core/tcp.c"
                                                ; cpcb = cpcb->next) {
        if (cpcb->local_port == port) {
...

          {
            ...
            if ((0 == 0) &&
                (((&cpcb->local_ip) == 
# 591 "kernel/protocols/net/core/tcp.c" 3 4
                ((void *)0) 
# 591 "kernel/protocols/net/core/tcp.c"
                || ((*(&cpcb->local_ip)).addr == ((u32_t)0x00000000UL))) ||
                ((ipaddr) == 
# 592 "kernel/protocols/net/core/tcp.c" 3 4
               ((void *)0) 
# 592 "kernel/protocols/net/core/tcp.c"
  ...
  if (!((ipaddr) == 
# 602 "kernel/protocols/net/core/tcp.c" 3 4
      ((void *)0) 
# 602 "kernel/protocols/net/core/tcp.c"
      || ((*(ipaddr)).addr == ((u32_t)0x00000000UL)))) {
    ((&pcb->local_ip)->addr = ((ipaddr) == 
# 603 "kernel/protocols/net/core/tcp.c" 3 4
   ((void *)0) 
# 603 "kernel/protocols/net/core/tcp.c"
   ? 0 : (ipaddr)->addr));
  }
  pcb->local_port = port;
  do { (pcb)->next = *&tcp_bound_pcbs; *(&tcp_bound_pcbs) = (pcb); tcp_timer_needed(); } while (0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_bind: bind to port %""4d""\n", port) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  return ERR_OK;
}
...
# 641 "kernel/protocols/net/core/tcp.c"
struct tcp_pcb *
tcp_listen_with_backlog(struct tcp_pcb *pcb, u8_t backlog)
{
  ...
  (void)backlog;
  do { if (!(pcb->state == CLOSED)) { do {bk_printf ("tcp_listen: pcb already connected") ;} while(0); return 
# 647 "kernel/protocols/net/core/tcp.c" 3 4
 ((void *)0)
# 647 "kernel/protocols/net/core/tcp.c"
 ;}} while(0);
...
# 658 "kernel/protocols/net/core/tcp.c" 3 4
                                                    ((void *)0)
# 658 "kernel/protocols/net/core/tcp.c"
                                                        ; lpcb = lpcb->next) {
      if ((lpcb->local_port == pcb->local_port) &&
          ((&lpcb->local_ip)->addr == (&pcb->local_ip)->addr)) {

        return 
# 662 "kernel/protocols/net/core/tcp.c" 3 4
              ((void *)0)
# 662 "kernel/protocols/net/core/tcp.c"
                  ;
      }
    }
  }
  ...
  if (lpcb == 
# 668 "kernel/protocols/net/core/tcp.c" 3 4
             ((void *)0)
# 668 "kernel/protocols/net/core/tcp.c"
                 ) {
    return 
# 669 "kernel/protocols/net/core/tcp.c" 3 4
          ((void *)0)
# 669 "kernel/protocols/net/core/tcp.c"
              ;
  }
  ...
  if (pcb->local_port != 0) {
    do { if(*(&tcp_bound_pcbs) == (pcb)) { (*(&tcp_bound_pcbs)) = (*&tcp_bound_pcbs)->next; } else { struct tcp_pcb *tcp_tmp_pcb; for (tcp_tmp_pcb = *&tcp_bound_pcbs; tcp_tmp_pcb != 
# 683 "kernel/protocols/net/core/tcp.c" 3 4
   ((void *)0)
# 683 "kernel/protocols/net/core/tcp.c"
   ; tcp_tmp_pcb = tcp_tmp_pcb->next) { if(tcp_tmp_pcb->next == (pcb)) { tcp_tmp_pcb->next = (pcb)->next; break; } } } (pcb)->next = 
# 683 "kernel/protocols/net/core/tcp.c" 3 4
   ((void *)0)
# 683 "kernel/protocols/net/core/tcp.c"
  ...
  do { ; ((struct tcp_pcb_listen *)(lpcb))->backlog = ((backlog) ? (backlog) : 1); } while(0);
...
tcp_update_rcv_ann_wnd(struct tcp_pcb *pcb)
{
  ...
  if (((s32_t)((u32_t)(new_right_edge) - (u32_t)(pcb->rcv_ann_right_edge + (((((3*(1500 - 40)) / 2)) < (pcb->mss)) ? (((3*(1500 - 40)) / 2)) : (pcb->mss)))) >= 0)) {
...
# 738 "kernel/protocols/net/core/tcp.c"
void
tcp_recved(struct tcp_pcb *pcb, u16_t len)
{
  ...
  if (wnd_inflation >= (((((3*(1500 - 40)) / 4)) < (((1500 - 40) * 4))) ? (((3*(1500 - 40)) / 4)) : (((1500 - 40) * 4)))) {
    do { (pcb)->flags |= 0x02U; } while (0);
    tcp_output(pcb);
  }

  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_recved: received %""4d"" bytes, wnd %""4d"" (%""4d"").\n", len, pcb->rcv_wnd, (u16_t)((3*(1500 - 40)) - pcb->rcv_wnd)) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
                                                                      ;
}
...
# 795 "kernel/protocols/net/core/tcp.c" 3 4
                                        ((void *)0)
# 795 "kernel/protocols/net/core/tcp.c"
                                            ; pcb = pcb->next) {
...
# 821 "kernel/protocols/net/core/tcp.c"
err_t
      ...
      tcp_connected_fn connected)
{
  ...
  if ((pcb == 
# 829 "kernel/protocols/net/core/tcp.c" 3 4
             ((void *)0)
# 829 "kernel/protocols/net/core/tcp.c"
                 ) || (ipaddr == 
# 829 "kernel/protocols/net/core/tcp.c" 3 4
                                 ((void *)0)
# 829 "kernel/protocols/net/core/tcp.c"
  ...
  do { if (!(pcb->state == CLOSED)) { do {bk_printf ("tcp_connect: can only connect from state CLOSED") ;} while(0); return ERR_ISCONN;}} while(0);

  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_connect to port %""4d""\n", port) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  ((&pcb->remote_ip)->addr = ((ipaddr) == 
# 836 "kernel/protocols/net/core/tcp.c" 3 4
 ((void *)0) 
# 836 "kernel/protocols/net/core/tcp.c"
 ? 0 : (ipaddr)->addr));
  pcb->remote_port = port;


  if (((&pcb->local_ip) == 
# 840 "kernel/protocols/net/core/tcp.c" 3 4
     ((void *)0) 
# 840 "kernel/protocols/net/core/tcp.c"
     || ((*(&pcb->local_ip)).addr == ((u32_t)0x00000000UL)))) {

    struct netif *netif;
    const ip_addr_t *local_ip;
    do { (netif) = ip4_route(&pcb->remote_ip); (local_ip) = (((netif) != 
# 844 "kernel/protocols/net/core/tcp.c" 3 4
   ((void *)0)
# 844 "kernel/protocols/net/core/tcp.c"
...
# 844 "kernel/protocols/net/core/tcp.c"
    ...
    if ((netif == 
# 845 "kernel/protocols/net/core/tcp.c" 3 4
                 ((void *)0)
# 845 "kernel/protocols/net/core/tcp.c"
                     ) || (local_ip == 
# 845 "kernel/protocols/net/core/tcp.c" 3 4
                                       ((void *)0)
# 845 "kernel/protocols/net/core/tcp.c"
  ...
  if (pcb->local_port == 0) {
    ...
    if (((pcb)->so_options & (0x04U))) {
      ...
      for (i = 2; i < 4; i++) {
        for (cpcb = *tcp_pcb_lists[i]; cpcb != 
# 869 "kernel/protocols/net/core/tcp.c" 3 4
                                              ((void *)0)
# 869 "kernel/protocols/net/core/tcp.c"
                                                  ; cpcb = cpcb->next) {
  ...
  pcb->rcv_wnd = pcb->rcv_ann_wnd = (3*(1500 - 40));
  pcb->rcv_ann_right_edge = pcb->rcv_nxt;
  pcb->snd_wnd = (3*(1500 - 40));
  ...
  if (ret == ERR_OK) {
    ...
    if (old_local_port != 0) {
      do { if(*(&tcp_bound_pcbs) == (pcb)) { (*(&tcp_bound_pcbs)) = (*&tcp_bound_pcbs)->next; } else { struct tcp_pcb *tcp_tmp_pcb; for (tcp_tmp_pcb = *&tcp_bound_pcbs; tcp_tmp_pcb != 
# 913 "kernel/protocols/net/core/tcp.c" 3 4
     ((void *)0)
# 913 "kernel/protocols/net/core/tcp.c"
     ; tcp_tmp_pcb = tcp_tmp_pcb->next) { if(tcp_tmp_pcb->next == (pcb)) { tcp_tmp_pcb->next = (pcb)->next; break; } } } (pcb)->next = 
# 913 "kernel/protocols/net/core/tcp.c" 3 4
     ((void *)0)
# 913 "kernel/protocols/net/core/tcp.c"
...
# 930 "kernel/protocols/net/core/tcp.c"
void
tcp_slowtmr(void)
{
...
tcp_slowtmr_start:
  ...
  prev = 
# 946 "kernel/protocols/net/core/tcp.c" 3 4
        ((void *)0)
# 946 "kernel/protocols/net/core/tcp.c"
            ;
  pcb = tcp_active_pcbs;
  if (pcb == 
# 948 "kernel/protocols/net/core/tcp.c" 3 4
            ((void *)0)
# 948 "kernel/protocols/net/core/tcp.c"
                ) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_slowtmr: no active pcbs\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  }
  while (pcb != 
# 951 "kernel/protocols/net/core/tcp.c" 3 4
               ((void *)0)
# 951 "kernel/protocols/net/core/tcp.c"
                   ) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_slowtmr: processing active pcb\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    ;
    ;
    ;
    ...
    if (pcb->state == SYN_SENT && pcb->nrtx == 6) {
      ++pcb_remove;
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_slowtmr: max SYN retries reached\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    }
    else if (pcb->nrtx == 12) {
      ++pcb_remove;
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_slowtmr: max DATA retries reached\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    } else {
      if (pcb->persist_backoff > 0) {
        ...
        if (pcb->unacked != 
# 995 "kernel/protocols/net/core/tcp.c" 3 4
                           ((void *)0) 
# 995 "kernel/protocols/net/core/tcp.c"
                                && pcb->rtime >= pcb->rto) {

          do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_slowtmr: rtime %""4d" " pcb->rto %""4d""\n", pcb->rtime, pcb->rto) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
          ...
          pcb->cwnd = pcb->mss;
          do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_slowtmr: cwnd %""4d" " ssthresh %""4d""\n", pcb->cwnd, pcb->ssthresh) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
    ...
    if (pcb->state == FIN_WAIT_2) {
      ...
      if (pcb->flags & 0x10U) {
        ...
        if ((u32_t)(tcp_ticks - pcb->tmr) >
            20000 / (2*250)) {
          ++pcb_remove;
          do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_slowtmr: removing pcb stuck in FIN-WAIT-2\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        }
      }
    }
    ...
    if (((pcb)->so_options & (0x08U)) &&
      ...
      {
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_slowtmr: KEEPALIVE timeout. Aborting connection to ") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)((&pcb->remote_ip) != 
# 1049 "kernel/protocols/net/core/tcp.c" 3 4
       ((void *)0) 
# 1049 "kernel/protocols/net/core/tcp.c"
       ? ((u16_t)(((const u8_t*)(&(&pcb->remote_ip)->addr))[0])) : 0), (u16_t)((&pcb->remote_ip) != 
# 1049 "kernel/protocols/net/core/tcp.c" 3 4
       ((void *)0) 
# 1049 "kernel/protocols/net/core/tcp.c"
       ? ((u16_t)(((const u8_t*)(&(&pcb->remote_ip)->addr))[1])) : 0), (u16_t)((&pcb->remote_ip) != 
# 1049 "kernel/protocols/net/core/tcp.c" 3 4
       ((void *)0) 
# 1049 "kernel/protocols/net/core/tcp.c"
       ? ((u16_t)(((const u8_t*)(&(&pcb->remote_ip)->addr))[2])) : 0), (u16_t)((&pcb->remote_ip) != 
# 1049 "kernel/protocols/net/core/tcp.c" 3 4
       ((void *)0) 
# 1049 "kernel/protocols/net/core/tcp.c"
       ? ((u16_t)(((const u8_t*)(&(&pcb->remote_ip)->addr))[3])) : 0)) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    ...
    if (pcb->ooseq != 
# 1069 "kernel/protocols/net/core/tcp.c" 3 4
                     ((void *)0) 
# 1069 "kernel/protocols/net/core/tcp.c"
                          &&
        (u32_t)tcp_ticks - pcb->tmr >= pcb->rto * 24U) {
      tcp_segs_free(pcb->ooseq);
      pcb->ooseq = 
# 1072 "kernel/protocols/net/core/tcp.c" 3 4
                  ((void *)0)
# 1072 "kernel/protocols/net/core/tcp.c"
                      ;
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_slowtmr: dropping OOSEQ queued data\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    }
    ...
    if (pcb->state == SYN_RCVD) {
      if ((u32_t)(tcp_ticks - pcb->tmr) >
          20000 / (2*250)) {
        ++pcb_remove;
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_slowtmr: removing pcb stuck in SYN-RCVD\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      }
    }


    if (pcb->state == LAST_ACK) {
      if ((u32_t)(tcp_ticks - pcb->tmr) > 2 * (250) / (2*250)) {
        ++pcb_remove;
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_slowtmr: removing pcb stuck in LAST-ACK\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      }
    }
    ...
    if (pcb_remove) {
      ...
      if (prev != 
# 1103 "kernel/protocols/net/core/tcp.c" 3 4
                 ((void *)0)
# 1103 "kernel/protocols/net/core/tcp.c"
                     ) {
        ;
        prev->next = pcb->next;
      } else {
      ...
      do { if((err_fn) != 
# 1123 "kernel/protocols/net/core/tcp.c" 3 4
     ((void *)0)
# 1123 "kernel/protocols/net/core/tcp.c"
      ...
      if (prev->polltmr >= prev->pollinterval) {
        prev->polltmr = 0;
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_slowtmr: polling application\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        tcp_active_pcbs_changed = 0;
        do { if((prev)->poll != 
# 1138 "kernel/protocols/net/core/tcp.c" 3 4
       ((void *)0)
# 1138 "kernel/protocols/net/core/tcp.c"
  ...
  prev = 
# 1152 "kernel/protocols/net/core/tcp.c" 3 4
        ((void *)0)
# 1152 "kernel/protocols/net/core/tcp.c"
            ;
  pcb = tcp_tw_pcbs;
  while (pcb != 
# 1154 "kernel/protocols/net/core/tcp.c" 3 4
               ((void *)0)
# 1154 "kernel/protocols/net/core/tcp.c"
                   ) {
    ;
    pcb_remove = 0;
    ...
    if (pcb_remove) {
      ...
      if (prev != 
# 1168 "kernel/protocols/net/core/tcp.c" 3 4
                 ((void *)0)
# 1168 "kernel/protocols/net/core/tcp.c"
                     ) {
        ;
        prev->next = pcb->next;
      } else {
...
tcp_fasttmr_start:
  ...
  while (pcb != 
# 1202 "kernel/protocols/net/core/tcp.c" 3 4
               ((void *)0)
# 1202 "kernel/protocols/net/core/tcp.c"
                   ) {
    if (pcb->last_timer != tcp_timer_ctr) {
      struct tcp_pcb *next;
      pcb->last_timer = tcp_timer_ctr;
      ...
      if (pcb->flags & 0x01U) {
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_fasttmr: delayed ACK\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        do { (pcb)->flags |= 0x02U; } while (0);
        tcp_output(pcb);
      ...
      if (pcb->refused_data != 
# 1217 "kernel/protocols/net/core/tcp.c" 3 4
                              ((void *)0)
# 1217 "kernel/protocols/net/core/tcp.c"
                                  ) {
        tcp_active_pcbs_changed = 0;
...
# 1238 "kernel/protocols/net/core/tcp.c" 3 4
                                    ((void *)0)
# 1238 "kernel/protocols/net/core/tcp.c"
                                        ; pcb = pcb->next) {
    if (pcb->flags & 0x80U) {
      tcp_output(pcb);
    }
...
tcp_process_refused_data(struct tcp_pcb *pcb)
{
...

  {
    ...
    pcb->refused_data = 
# 1263 "kernel/protocols/net/core/tcp.c" 3 4
                       ((void *)0)
# 1263 "kernel/protocols/net/core/tcp.c"
                           ;


    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_input: notify kept packet\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    do { if((pcb)->recv != 
# 1267 "kernel/protocols/net/core/tcp.c" 3 4
   ((void *)0)
# 1267 "kernel/protocols/net/core/tcp.c"
   ...
   , (pcb), (refused_data), (ERR_OK)); } } while (0);
    if (err == ERR_OK) {
      ...
      if (refused_flags & 0x20U
        ...
        do { if(((pcb)->recv != 
# 1280 "kernel/protocols/net/core/tcp.c" 3 4
       ((void *)0)
# 1280 "kernel/protocols/net/core/tcp.c"
...
# 1280 "kernel/protocols/net/core/tcp.c"
      ...
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_input: drop incoming packets, because pcb is \"full\"\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      return ERR_ABRT;
    } else {
...
{
  while (seg != 
# 1313 "kernel/protocols/net/core/tcp.c" 3 4
               ((void *)0)
# 1313 "kernel/protocols/net/core/tcp.c"
                   ) {
...
{
  if (seg != 
# 1328 "kernel/protocols/net/core/tcp.c" 3 4
            ((void *)0)
# 1328 "kernel/protocols/net/core/tcp.c"
                ) {
    if (seg->p != 
# 1329 "kernel/protocols/net/core/tcp.c" 3 4
                 ((void *)0)
# 1329 "kernel/protocols/net/core/tcp.c"
                     ) {
      pbuf_free(seg->p);
...
# 1359 "kernel/protocols/net/core/tcp.c"
struct tcp_seg *
tcp_seg_copy(struct tcp_seg *seg)
{
  ...
  if (cseg == 
# 1365 "kernel/protocols/net/core/tcp.c" 3 4
             ((void *)0)
# 1365 "kernel/protocols/net/core/tcp.c"
                 ) {
    return 
# 1366 "kernel/protocols/net/core/tcp.c" 3 4
          ((void *)0)
# 1366 "kernel/protocols/net/core/tcp.c"
              ;
  }
...
tcp_recv_null(void *arg, struct tcp_pcb *pcb, struct pbuf *p, err_t err)
{
  (void)arg;
  if (p != 
# 1383 "kernel/protocols/net/core/tcp.c" 3 4
          ((void *)0)
# 1383 "kernel/protocols/net/core/tcp.c"
              ) {
...
# 1399 "kernel/protocols/net/core/tcp.c"
static void
tcp_kill_prio(u8_t prio)
{
  ...
  inactivity = 0;
  inactive = 
# 1410 "kernel/protocols/net/core/tcp.c" 3 4
            ((void *)0)
# 1410 "kernel/protocols/net/core/tcp.c"
                ;
  for (pcb = tcp_active_pcbs; pcb != 
# 1411 "kernel/protocols/net/core/tcp.c" 3 4
                                    ((void *)0)
# 1411 "kernel/protocols/net/core/tcp.c"
                                        ; pcb = pcb->next) {
    if (pcb->prio <= mprio &&
  ...
  if (inactive != 
# 1419 "kernel/protocols/net/core/tcp.c" 3 4
                 ((void *)0)
# 1419 "kernel/protocols/net/core/tcp.c"
                     ) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_kill_prio: killing oldest PCB %p (%""8ld"")\n", (void *)inactive, inactivity) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
                                         ;
    tcp_abort(inactive);
  }
}
...
tcp_kill_state(enum tcp_state state)
{
  ...
  inactivity = 0;
  inactive = 
# 1439 "kernel/protocols/net/core/tcp.c" 3 4
            ((void *)0)
# 1439 "kernel/protocols/net/core/tcp.c"
                ;


  for (pcb = tcp_active_pcbs; pcb != 
# 1442 "kernel/protocols/net/core/tcp.c" 3 4
                                    ((void *)0)
# 1442 "kernel/protocols/net/core/tcp.c"
                                        ; pcb = pcb->next) {
    if (pcb->state == state) {
  ...
  if (inactive != 
# 1450 "kernel/protocols/net/core/tcp.c" 3 4
                 ((void *)0)
# 1450 "kernel/protocols/net/core/tcp.c"
                     ) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_kill_closing: killing oldest %s PCB %p (%""8ld"")\n", tcp_state_str[state], (void *)inactive, inactivity) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
                                                               ;
...
tcp_kill_timewait(void)
{
  ...
  inactivity = 0;
  inactive = 
# 1469 "kernel/protocols/net/core/tcp.c" 3 4
            ((void *)0)
# 1469 "kernel/protocols/net/core/tcp.c"
                ;

  for (pcb = tcp_tw_pcbs; pcb != 
# 1471 "kernel/protocols/net/core/tcp.c" 3 4
                                ((void *)0)
# 1471 "kernel/protocols/net/core/tcp.c"
                                    ; pcb = pcb->next) {
    if ((u32_t)(tcp_ticks - pcb->tmr) >= inactivity) {
      inactivity = tcp_ticks - pcb->tmr;
      inactive = pcb;
  ...
  if (inactive != 
# 1477 "kernel/protocols/net/core/tcp.c" 3 4
                 ((void *)0)
# 1477 "kernel/protocols/net/core/tcp.c"
                     ) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_kill_timewait: killing oldest TIME-WAIT PCB %p (%""8ld"")\n", (void *)inactive, inactivity) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
                                         ;
    tcp_abort(inactive);
  }
}
...
tcp_alloc(u8_t prio)
{
  ...
  if (pcb == 
# 1497 "kernel/protocols/net/core/tcp.c" 3 4
            ((void *)0)
# 1497 "kernel/protocols/net/core/tcp.c"
                ) {

    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_alloc: killing off oldest TIME-WAIT connection\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    tcp_kill_timewait();

    pcb = (struct tcp_pcb *)memp_malloc(MEMP_TCP_PCB);
    if (pcb == 
# 1503 "kernel/protocols/net/core/tcp.c" 3 4
              ((void *)0)
# 1503 "kernel/protocols/net/core/tcp.c"
                  ) {

      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_alloc: killing off oldest LAST-ACK connection\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      tcp_kill_state(LAST_ACK);

      pcb = (struct tcp_pcb *)memp_malloc(MEMP_TCP_PCB);
      if (pcb == 
# 1509 "kernel/protocols/net/core/tcp.c" 3 4
                ((void *)0)
# 1509 "kernel/protocols/net/core/tcp.c"
                    ) {

        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_alloc: killing off oldest CLOSING connection\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        tcp_kill_state(CLOSING);

        pcb = (struct tcp_pcb *)memp_malloc(MEMP_TCP_PCB);
        if (pcb == 
# 1515 "kernel/protocols/net/core/tcp.c" 3 4
                  ((void *)0)
# 1515 "kernel/protocols/net/core/tcp.c"
                      ) {

          do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_alloc: killing connection with prio lower than %d\n", prio) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
          tcp_kill_prio(prio);

          pcb = (struct tcp_pcb *)memp_malloc(MEMP_TCP_PCB);
          if (pcb != 
# 1521 "kernel/protocols/net/core/tcp.c" 3 4
                    ((void *)0)
# 1521 "kernel/protocols/net/core/tcp.c"
                        ) {
        ...
        if (pcb != 
# 1526 "kernel/protocols/net/core/tcp.c" 3 4
                  ((void *)0)
# 1526 "kernel/protocols/net/core/tcp.c"
                      ) {
      ...
      if (pcb != 
# 1531 "kernel/protocols/net/core/tcp.c" 3 4
                ((void *)0)
# 1531 "kernel/protocols/net/core/tcp.c"
                    ) {
    ...
    if (pcb != 
# 1536 "kernel/protocols/net/core/tcp.c" 3 4
              ((void *)0)
# 1536 "kernel/protocols/net/core/tcp.c"
                  ) {
  ...
  if (pcb != 
# 1541 "kernel/protocols/net/core/tcp.c" 3 4
            ((void *)0)
# 1541 "kernel/protocols/net/core/tcp.c"
                ) {

    memset(pcb, 0, sizeof(struct tcp_pcb));
    pcb->prio = prio;
    pcb->snd_buf = (10*(1500 - 40));
...
# 1593 "kernel/protocols/net/core/tcp.c"
struct tcp_pcb *
tcp_new(void)
{
  return tcp_alloc(64);
}
# 1610 "kernel/protocols/net/core/tcp.c"
struct tcp_pcb *
...
# 1634 "kernel/protocols/net/core/tcp.c"
void
tcp_arg(struct tcp_pcb *pcb, void *arg)
{
  ...
  if (pcb != 
# 1639 "kernel/protocols/net/core/tcp.c" 3 4
            ((void *)0)
# 1639 "kernel/protocols/net/core/tcp.c"
                ) {
    pcb->callback_arg = arg;
  }
}
# 1653 "kernel/protocols/net/core/tcp.c"
void
tcp_recv(struct tcp_pcb *pcb, tcp_recv_fn recv)
{
  if (pcb != 
# 1656 "kernel/protocols/net/core/tcp.c" 3 4
            ((void *)0)
# 1656 "kernel/protocols/net/core/tcp.c"
                ) {
    ;
    pcb->recv = recv;
  }
}
# 1670 "kernel/protocols/net/core/tcp.c"
void
tcp_sent(struct tcp_pcb *pcb, tcp_sent_fn sent)
{
  if (pcb != 
# 1673 "kernel/protocols/net/core/tcp.c" 3 4
            ((void *)0)
# 1673 "kernel/protocols/net/core/tcp.c"
                ) {
    ;
    pcb->sent = sent;
  }
}
# 1690 "kernel/protocols/net/core/tcp.c"
void
tcp_err(struct tcp_pcb *pcb, tcp_err_fn err)
{
  if (pcb != 
# 1693 "kernel/protocols/net/core/tcp.c" 3 4
            ((void *)0)
# 1693 "kernel/protocols/net/core/tcp.c"
                ) {
    ;
    pcb->errf = err;
  }
}
# 1708 "kernel/protocols/net/core/tcp.c"
void
tcp_accept(struct tcp_pcb *pcb, tcp_accept_fn accept)
{
  if ((pcb != 
# 1711 "kernel/protocols/net/core/tcp.c" 3 4
             ((void *)0)
# 1711 "kernel/protocols/net/core/tcp.c"
                 ) && (pcb->state == LISTEN)) {
    struct tcp_pcb_listen *lpcb = (struct tcp_pcb_listen*)pcb;
    lpcb->accept = accept;
  }
}
# 1726 "kernel/protocols/net/core/tcp.c"
void
...
tcp_pcb_purge(struct tcp_pcb *pcb)
{
  if (pcb->state != CLOSED &&
    ...
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_pcb_purge\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);

    tcp_backlog_accepted(pcb);

    if (pcb->refused_data != 
# 1755 "kernel/protocols/net/core/tcp.c" 3 4
                            ((void *)0)
# 1755 "kernel/protocols/net/core/tcp.c"
                                ) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_pcb_purge: data left on ->refused_data\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      pbuf_free(pcb->refused_data);
      pcb->refused_data = 
# 1758 "kernel/protocols/net/core/tcp.c" 3 4
                         ((void *)0)
# 1758 "kernel/protocols/net/core/tcp.c"
                             ;
    }
    if (pcb->unsent != 
# 1760 "kernel/protocols/net/core/tcp.c" 3 4
                      ((void *)0)
# 1760 "kernel/protocols/net/core/tcp.c"
                          ) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_pcb_purge: not all data sent\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    }
    if (pcb->unacked != 
# 1763 "kernel/protocols/net/core/tcp.c" 3 4
                       ((void *)0)
# 1763 "kernel/protocols/net/core/tcp.c"
                           ) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_pcb_purge: data left on ->unacked\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    }

    if (pcb->ooseq != 
# 1767 "kernel/protocols/net/core/tcp.c" 3 4
                     ((void *)0)
# 1767 "kernel/protocols/net/core/tcp.c"
                         ) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("tcp_pcb_purge: data left on ->ooseq\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    }
    tcp_segs_free(pcb->ooseq);
    pcb->ooseq = 
# 1771 "kernel/protocols/net/core/tcp.c" 3 4
                ((void *)0)
# 1771 "kernel/protocols/net/core/tcp.c"
                    ;
...
# 1780 "kernel/protocols/net/core/tcp.c" 3 4
                                ((void *)0)
# 1780 "kernel/protocols/net/core/tcp.c"
                                    ;
...
# 1796 "kernel/protocols/net/core/tcp.c" 3 4
 ((void *)0)
# 1796 "kernel/protocols/net/core/tcp.c"
 ; tcp_tmp_pcb = tcp_tmp_pcb->next) { if(tcp_tmp_pcb->next == (pcb)) { tcp_tmp_pcb->next = (pcb)->next; break; } } } (pcb)->next = 
# 1796 "kernel/protocols/net/core/tcp.c" 3 4
 ((void *)0)
# 1796 "kernel/protocols/net/core/tcp.c"
...
# 1868 "kernel/protocols/net/core/tcp.c"
  {
    if (outif == 
# 1869 "kernel/protocols/net/core/tcp.c" 3 4
                ((void *)0)
# 1869 "kernel/protocols/net/core/tcp.c"
                    ) {
      return sendmss;
    }
    mtu = outif->mtu;
  ...
  if (mtu != 0) {
# 1889 "kernel/protocols/net/core/tcp.c"
    {
      mss_s = mtu - 20 - 20;
    }
...
tcp_netif_ip_addr_changed_pcblist(const ip_addr_t* old_addr, struct tcp_pcb* pcb_list)
{
  ...
  pcb = pcb_list;
  while (pcb != 
# 1909 "kernel/protocols/net/core/tcp.c" 3 4
               ((void *)0)
# 1909 "kernel/protocols/net/core/tcp.c"
                   ) {
    ...
    if (((&pcb->local_ip)->addr == (old_addr)->addr)
      ...
      do { if ( ((0x00U | 0x20U) & 0x80U) && ((0x00U | 0x20U) & 0x80U) && ((s16_t)((0x00U | 0x20U) & 0x03) >= 0x00)) { do {bk_printf ("netif_set_ipaddr: aborting TCP pcb %p\n", (void *)pcb) ;} while(0); if ((0x00U | 0x20U) & 0x08U) { while(1); } } } while(0);
      tcp_abort(pcb);
      pcb = next;
    } else {
      pcb = pcb->next;
...
tcp_netif_ip_addr_changed(const ip_addr_t* old_addr, const ip_addr_t* new_addr)
{
  ...
  if (!((old_addr) == 
# 1938 "kernel/protocols/net/core/tcp.c" 3 4
      ((void *)0) 
# 1938 "kernel/protocols/net/core/tcp.c"
      || ((*(old_addr)).addr == ((u32_t)0x00000000UL)))) {
    tcp_netif_ip_addr_changed_pcblist(old_addr, tcp_active_pcbs);
    tcp_netif_ip_addr_changed_pcblist(old_addr, tcp_bound_pcbs);

    if (!((new_addr) == 
# 1942 "kernel/protocols/net/core/tcp.c" 3 4
        ((void *)0) 
# 1942 "kernel/protocols/net/core/tcp.c"
        || ((*(new_addr)).addr == ((u32_t)0x00000000UL)))) {

      for (lpcb = tcp_listen_pcbs.listen_pcbs; lpcb != 
# 1944 "kernel/protocols/net/core/tcp.c" 3 4
                                                      ((void *)0)
# 1944 "kernel/protocols/net/core/tcp.c"
                                                          ; lpcb = next) {
        next = lpcb->next;
