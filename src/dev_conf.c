# 1 "framework/protocol/linkkit/iotkit/layers/config/src/dev_conf.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "framework/protocol/linkkit/iotkit/layers/config/src/dev_conf.c"
# 29 "framework/protocol/linkkit/iotkit/layers/config/src/dev_conf.c"
# 1 "./framework/protocol/linkkit/iotkit/layers/config/include/dev_conf.h" 1
# 30 "./framework/protocol/linkkit/iotkit/layers/config/include/dev_conf.h"
...
# 31 "./framework/protocol/linkkit/iotkit/layers/config/include/dev_conf.h" 2
...
# 32 "./framework/protocol/linkkit/iotkit/layers/config/include/dev_conf.h" 2
...
# 30 "framework/protocol/linkkit/iotkit/layers/config/src/dev_conf.c" 2
...
# 31 "framework/protocol/linkkit/iotkit/layers/config/src/dev_conf.c" 2
...
int config_init(void)
{
    ...
    if (!is_init) {
        ...
        if (!HAL_Config_Read((char *)&main_config, sizeof(main_config))
            && !strncmp(main_config.magic, "Alink+",
                        strlen("Alink+"))
            && main_config.crc == utils_crc16((uint8_t *) &main_config,
                                              ((long)(&((device_config_t *)0)->crc)))) {
            LITE_syslog(__FUNCTION__, 71, LOG_INFO_LEVEL, "config init ok");
        } else {
            LITE_syslog(__FUNCTION__, 73, LOG_WARNING_LEVEL, "config init fail, reset...");
            ret = config_factory();
        }
...
{
    LITE_syslog(__FUNCTION__, 91, LOG_DEBUG_LEVEL, "~~~~~dump device config~~~~~");
    LITE_syslog(__FUNCTION__, 92, LOG_DEBUG_LEVEL, "magic: %s", main_config.magic);
    LITE_syslog(__FUNCTION__, 93, LOG_DEBUG_LEVEL, "firmware_version: %s", main_config.firmware_version);
    LITE_syslog(__FUNCTION__, 94, LOG_DEBUG_LEVEL, "crc: %d", main_config.crc);
    LITE_syslog(__FUNCTION__, 95, LOG_DEBUG_LEVEL, "~~~~~~~~~~~~~~~~~~~~~~~~~~");
}

int config_update(void)
{
    main_config.crc = utils_crc16((uint8_t *) &main_config, ((long)(&((device_config_t *)0)->crc)));
...
int config_factory()
{
    ...
    strcpy(main_config.magic, "Alink+");
