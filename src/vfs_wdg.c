...
# 1 "././kernel/vfs/device/../include/device/vfs_wdg.h" 1
# 12 "././kernel/vfs/device/../include/device/vfs_wdg.h"
...
# 13 "././kernel/vfs/device/../include/device/vfs_wdg.h" 2
...
# 27 "././kernel/vfs/device/../include/device/vfs_wdg.h"
int vfs_wdg_open(inode_t *inode, file_t *fp);
# 36 "././kernel/vfs/device/../include/device/vfs_wdg.h"
int vfs_wdg_close(file_t *fp);
# 47 "././kernel/vfs/device/../include/device/vfs_wdg.h"
int vfs_wdg_ioctl(file_t *fp, int cmd, unsigned long arg);
# 6 "kernel/vfs/device/vfs_wdg.c" 2
...
# 7 "kernel/vfs/device/vfs_wdg.c" 2
# 1 "././kernel/vfs/device/../include/vfs_err.h" 1
# 8 "kernel/vfs/device/vfs_wdg.c" 2
...
int vfs_wdg_open(inode_t *inode, file_t *fp)
{
    int ret = -1;
    wdg_dev_t *wdg_dev = 
# 20 "kernel/vfs/device/vfs_wdg.c" 3 4
                        ((void *)0)
# 20 "kernel/vfs/device/vfs_wdg.c"
                            ;


    if ((fp != 
# 23 "kernel/vfs/device/vfs_wdg.c" 3 4
              ((void *)0)
# 23 "kernel/vfs/device/vfs_wdg.c"
                  ) && (fp->node != 
# 23 "kernel/vfs/device/vfs_wdg.c" 3 4
                                    ((void *)0)
# 23 "kernel/vfs/device/vfs_wdg.c"
        ...
        ret = -
# 37 "kernel/vfs/device/vfs_wdg.c" 3
              22
# 37 "kernel/vfs/device/vfs_wdg.c"
                    ;
    }
...
int vfs_wdg_close(file_t *fp)
{
    int ret = -1;
    wdg_dev_t *wdg_dev = 
# 46 "kernel/vfs/device/vfs_wdg.c" 3 4
                        ((void *)0)
# 46 "kernel/vfs/device/vfs_wdg.c"
                            ;


    if ((fp != 
# 49 "kernel/vfs/device/vfs_wdg.c" 3 4
              ((void *)0)
# 49 "kernel/vfs/device/vfs_wdg.c"
                  ) && (fp->node != 
# 49 "kernel/vfs/device/vfs_wdg.c" 3 4
                                    ((void *)0)
# 49 "kernel/vfs/device/vfs_wdg.c"
        ...
        ret = -
# 71 "kernel/vfs/device/vfs_wdg.c" 3
              22
# 71 "kernel/vfs/device/vfs_wdg.c"
                    ;
    }
...
int vfs_wdg_ioctl(file_t *fp, int cmd, unsigned long arg)
{
    int ret = -1;
    wdg_dev_t *wdg_dev = 
# 80 "kernel/vfs/device/vfs_wdg.c" 3 4
                        ((void *)0)
# 80 "kernel/vfs/device/vfs_wdg.c"
                            ;


    if ((fp == 
# 83 "kernel/vfs/device/vfs_wdg.c" 3 4
              ((void *)0)
# 83 "kernel/vfs/device/vfs_wdg.c"
                  ) || (fp->node == 
# 83 "kernel/vfs/device/vfs_wdg.c" 3 4
                                    ((void *)0)
# 83 "kernel/vfs/device/vfs_wdg.c"
        ...
        return -
# 84 "kernel/vfs/device/vfs_wdg.c" 3
               22
# 84 "kernel/vfs/device/vfs_wdg.c"
                     ;
    }
    ...
    switch(cmd) {
        ...
        default:
            ret = -
# 102 "kernel/vfs/device/vfs_wdg.c" 3
                  22
# 102 "kernel/vfs/device/vfs_wdg.c"
                        ;
            break;
    }
