# 1 "kernel/protocols/net/core/netif.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/core/netif.c"
# 51 "kernel/protocols/net/core/netif.c"
...
# 52 "kernel/protocols/net/core/netif.c" 2
...
# 54 "kernel/protocols/net/core/netif.c" 2
...
# 56 "kernel/protocols/net/core/netif.c" 2
...
# 57 "kernel/protocols/net/core/netif.c" 2
...
# 59 "kernel/protocols/net/core/netif.c" 2
...
# 60 "kernel/protocols/net/core/netif.c" 2
...
# 61 "kernel/protocols/net/core/netif.c" 2
...
void igmp_tmr(void);
# 64 "kernel/protocols/net/core/netif.c" 2
...
# 65 "kernel/protocols/net/core/netif.c" 2
...
# 67 "kernel/protocols/net/core/netif.c" 2
...
# 71 "kernel/protocols/net/core/netif.c" 2



# 1 "./kernel/protocols/net/include/netif/ethernet.h" 1
# 66 "./kernel/protocols/net/include/netif/ethernet.h"
...
# 75 "kernel/protocols/net/core/netif.c" 2
...
# 81 "kernel/protocols/net/core/netif.c" 2
# 104 "kernel/protocols/net/core/netif.c"
...
# 139 "kernel/protocols/net/core/netif.c"
static err_t
...
# 179 "kernel/protocols/net/core/netif.c" 3 4
                                        ((void *)0)
# 179 "kernel/protocols/net/core/netif.c"
...
# 202 "kernel/protocols/net/core/netif.c"
err_t
...
# 240 "kernel/protocols/net/core/netif.c"
struct netif *
          ...
          void *state, netif_init_fn init, netif_input_fn input)
{
  ...
  ((&netif->gw)->addr = 0);
# 266 "kernel/protocols/net/core/netif.c"
  ;
  netif->flags = 0;
...
# 279 "kernel/protocols/net/core/netif.c" 3 4
                          ((void *)0)
# 279 "kernel/protocols/net/core/netif.c"
                              ;
...
# 285 "kernel/protocols/net/core/netif.c" 3 4
                          ((void *)0)
# 285 "kernel/protocols/net/core/netif.c"
                              ;
  ...
  netif->loop_first = 
# 291 "kernel/protocols/net/core/netif.c" 3 4
                     ((void *)0)
# 291 "kernel/protocols/net/core/netif.c"
                         ;
  netif->loop_last = 
# 292 "kernel/protocols/net/core/netif.c" 3 4
                    ((void *)0)
# 292 "kernel/protocols/net/core/netif.c"
                        ;
  ...
  if (init(netif) != ERR_OK) {
    return 
# 311 "kernel/protocols/net/core/netif.c" 3 4
          ((void *)0)
# 311 "kernel/protocols/net/core/netif.c"
              ;
  }
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("netif: added interface %c%c IP", netif->name[0], netif->name[1]) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
                                    ;

  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf (" addr ") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)((ipaddr) != 
# 330 "kernel/protocols/net/core/netif.c" 3 4
 ((void *)0) 
# 330 "kernel/protocols/net/core/netif.c"
...
# 330 "kernel/protocols/net/core/netif.c"
 ? ((u16_t)(((const u8_t*)(&(ipaddr)->addr))[3])) : 0)) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf (" netmask ") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)((netmask) != 
# 332 "kernel/protocols/net/core/netif.c" 3 4
 ((void *)0) 
# 332 "kernel/protocols/net/core/netif.c"
...
# 332 "kernel/protocols/net/core/netif.c"
 ? ((u16_t)(((const u8_t*)(&(netmask)->addr))[3])) : 0)) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf (" gw ") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)((gw) != 
# 334 "kernel/protocols/net/core/netif.c" 3 4
 ((void *)0) 
# 334 "kernel/protocols/net/core/netif.c"
...
# 351 "kernel/protocols/net/core/netif.c"
void
netif_set_addr(struct netif *netif, const ip4_addr_t *ipaddr, const ip4_addr_t *netmask,
    const ip4_addr_t *gw)
{
  if (((ipaddr) == 
# 355 "kernel/protocols/net/core/netif.c" 3 4
     ((void *)0) 
# 355 "kernel/protocols/net/core/netif.c"
...
# 376 "kernel/protocols/net/core/netif.c"
void
netif_remove(struct netif *netif)
{
  ...
  if (netif == 
# 383 "kernel/protocols/net/core/netif.c" 3 4
              ((void *)0)
# 383 "kernel/protocols/net/core/netif.c"
                  ) {
    return;
  }
  ...
  if (!((*((const ip4_addr_t*)(&((netif)->ip_addr)))).addr == ((u32_t)0x00000000UL))) {
    ...
    tcp_netif_ip_addr_changed(((const ip_addr_t*)&((netif)->ip_addr)), 
# 390 "kernel/protocols/net/core/netif.c" 3 4
                                                    ((void *)0)
# 390 "kernel/protocols/net/core/netif.c"
                                                        );


    udp_netif_ip_addr_changed(((const ip_addr_t*)&((netif)->ip_addr)), 
# 393 "kernel/protocols/net/core/netif.c" 3 4
                                                    ((void *)0)
# 393 "kernel/protocols/net/core/netif.c"
                                                        );


    raw_netif_ip_addr_changed(((const ip_addr_t*)&((netif)->ip_addr)), 
# 396 "kernel/protocols/net/core/netif.c" 3 4
                                                    ((void *)0)
# 396 "kernel/protocols/net/core/netif.c"
                                                        );
...
# 427 "kernel/protocols/net/core/netif.c"
  ...
  if (netif_default == netif) {
    ...
    netif_set_default(
# 437 "kernel/protocols/net/core/netif.c" 3 4
                     ((void *)0)
# 437 "kernel/protocols/net/core/netif.c"
                         );
  }
...
# 445 "kernel/protocols/net/core/netif.c" 3 4
                                             ((void *)0)
# 445 "kernel/protocols/net/core/netif.c"
    ...
    if (tmp_netif == 
# 451 "kernel/protocols/net/core/netif.c" 3 4
                    ((void *)0)
# 451 "kernel/protocols/net/core/netif.c"
                        ) {
      return;
    }
  }
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("netif_remove: removed netif\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
}
# 471 "kernel/protocols/net/core/netif.c"
struct netif *
netif_find(const char *name)
{
  ...
  if (name == 
# 477 "kernel/protocols/net/core/netif.c" 3 4
             ((void *)0)
# 477 "kernel/protocols/net/core/netif.c"
                 ) {
    return 
# 478 "kernel/protocols/net/core/netif.c" 3 4
          ((void *)0)
# 478 "kernel/protocols/net/core/netif.c"
              ;
  }
...
# 483 "kernel/protocols/net/core/netif.c" 3 4
                                   ((void *)0)
# 483 "kernel/protocols/net/core/netif.c"
                                       ; netif = netif->next) {
    if (num == netif->num &&
       name[0] == netif->name[0] &&
       name[1] == netif->name[1]) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("netif_find: found %c%c\n", name[0], name[1]) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      return netif;
    }
  }
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("netif_find: didn't find %c%c\n", name[0], name[1]) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  return 
# 492 "kernel/protocols/net/core/netif.c" 3 4
        ((void *)0)
# 492 "kernel/protocols/net/core/netif.c"
            ;
}
# 506 "kernel/protocols/net/core/netif.c"
void
netif_set_ipaddr(struct netif *netif, const ip4_addr_t *ipaddr)
{
  ...
  *(&new_addr) = (ipaddr ? *ipaddr : *((&ip_addr_any)));
  ...
  if ((((&new_addr))->addr == (((const ip4_addr_t*)(&((netif)->ip_addr))))->addr) == 0) {
    do { if ( ((0x00U | 0x20U) & 0x80U) && ((0x00U | 0x20U) & 0x80U) && ((s16_t)((0x00U | 0x20U) & 0x03) >= 0x00)) { do {bk_printf ("netif_set_ipaddr: netif address being changed\n") ;} while(0); if ((0x00U | 0x20U) & 0x08U) { while(1); } } } while(0);
...
# 529 "kernel/protocols/net/core/netif.c" 3 4
   ((void *)0) 
# 529 "kernel/protocols/net/core/netif.c"
   ? 0 : (ipaddr)->addr));
    ;
    ;
    ;
  ...
  do { if ( ((0x00U | 0x40U | 0x20U) & 0x80U) && ((0x00U | 0x40U | 0x20U) & 0x80U) && ((s16_t)((0x00U | 0x40U | 0x20U) & 0x03) >= 0x00)) { do {bk_printf ("netif: IP address of interface %c%c set to %""4d"".%""4d"".%""4d"".%""4d""\n", netif->name[0], netif->name[1], ((u16_t)(((const u8_t*)(&(((const ip4_addr_t*)(&((netif)->ip_addr))))->addr))[0])), ((u16_t)(((const u8_t*)(&(((const ip4_addr_t*)(&((netif)->ip_addr))))->addr))[1])), ((u16_t)(((const u8_t*)(&(((const ip4_addr_t*)(&((netif)->ip_addr))))->addr))[2])), ((u16_t)(((const u8_t*)(&(((const ip4_addr_t*)(&((netif)->ip_addr))))->addr))[3]))) ;} while(0); if ((0x00U | 0x40U | 0x20U) & 0x08U) { while(1); } } } while(0)
...
# 579 "kernel/protocols/net/core/netif.c"
void
...
# 603 "kernel/protocols/net/core/netif.c"
void
netif_set_default(struct netif *netif)
{
  if (netif == 
# 606 "kernel/protocols/net/core/netif.c" 3 4
              ((void *)0)
# 606 "kernel/protocols/net/core/netif.c"
                  ) {
  ...
  netif_default = netif;
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("netif: setting default interface %c%c\n", netif ? netif->name[0] : '\'', netif ? netif->name[1] : '\'') ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
                                                                         ;
}
...
# 675 "kernel/protocols/net/core/netif.c"
}
...
# 734 "kernel/protocols/net/core/netif.c"
void
...
# 797 "kernel/protocols/net/core/netif.c"
err_t
netif_loop_output(struct netif *netif, struct pbuf *p)
{
  ...
  u16_t clen = 0;
# 815 "kernel/protocols/net/core/netif.c"
  sys_prot_t lev;


  r = pbuf_alloc(PBUF_LINK, p->tot_len, PBUF_RAM);
  if (r == 
# 819 "kernel/protocols/net/core/netif.c" 3 4
          ((void *)0)
# 819 "kernel/protocols/net/core/netif.c"
              ) {
    ;
    ;
    ;
...
# 852 "kernel/protocols/net/core/netif.c" 3 4
                              ((void *)0)
# 852 "kernel/protocols/net/core/netif.c"
                                  ; last = last->next);

  lev = sys_arch_protect();
  if (netif->loop_first != 
# 855 "kernel/protocols/net/core/netif.c" 3 4
                          ((void *)0)
# 855 "kernel/protocols/net/core/netif.c"
                              ) {
    ;
...
# 904 "kernel/protocols/net/core/netif.c"
void
netif_poll(struct netif *netif)
{
  struct pbuf *in;
# 917 "kernel/protocols/net/core/netif.c"
  sys_prot_t lev;
  ...
  do {
    ...
    in = netif->loop_first;
    if (in != 
# 923 "kernel/protocols/net/core/netif.c" 3 4
             ((void *)0)
# 923 "kernel/protocols/net/core/netif.c"
                 ) {
...
# 945 "kernel/protocols/net/core/netif.c" 3 4
                                              ((void *)0)
# 945 "kernel/protocols/net/core/netif.c"
                                                  ;
      } else {
      ...
      in_end->next = 
# 952 "kernel/protocols/net/core/netif.c" 3 4
                    ((void *)0)
# 952 "kernel/protocols/net/core/netif.c"
                        ;
    }
    sys_arch_unprotect(lev);

    if (in != 
# 956 "kernel/protocols/net/core/netif.c" 3 4
             ((void *)0)
# 956 "kernel/protocols/net/core/netif.c"
                 ) {
      ;
      ;
      ;
      ...
      in = 
# 965 "kernel/protocols/net/core/netif.c" 3 4
          ((void *)0)
# 965 "kernel/protocols/net/core/netif.c"
              ;
    }

  } while (netif->loop_first != 
# 968 "kernel/protocols/net/core/netif.c" 3 4
                               ((void *)0)
# 968 "kernel/protocols/net/core/netif.c"
                                   );
}
