# 1 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
...
# 1 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h" 1
# 10 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h"
# 1 "./security/alicrypto/./libalicrypto/inc/ali_crypto_types.h" 1
...
# 9 "./security/alicrypto/./libalicrypto/inc/ali_crypto_types.h" 2
...
# 10 "./security/alicrypto/./libalicrypto/inc/ali_crypto_types.h" 2
...
# 11 "./security/alicrypto/./libalicrypto/inc/ali_crypto_types.h" 2
# 11 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h" 2


# 12 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h"
typedef enum _ali_crypto_result {
    ALI_CRYPTO_ERROR = (int)0xffff0000,
    ALI_CRYPTO_NOSUPPORT,
    ALI_CRYPTO_INVALID_KEY,
    ALI_CRYPTO_INVALID_TYPE,
    ALI_CRYPTO_INVALID_CONTEXT,
    ALI_CRYPTO_INVALID_PADDING,
    ALI_CRYPTO_INVALID_AUTHENTICATION,
    ALI_CRYPTO_INVALID_ARG,
    ALI_CRYPTO_INVALID_PACKET,
    ALI_CRYPTO_LENGTH_ERR,
    ALI_CRYPTO_OUTOFMEM,
    ALI_CRYPTO_SHORT_BUFFER,
    ALI_CRYPTO_NULL,
    ALI_CRYPTO_ERR_STATE,
    ALI_CRYPTO_SUCCESS = 0,
} ali_crypto_result;
...
# 90 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h"
...
# 191 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h"
ali_crypto_result ali_aes_get_ctx_size(aes_type_t type, size_t *size);
# 205 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h"
ali_crypto_result ali_aes_init(aes_type_t type, 
# 205 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h" 3 4
                                               _Bool 
# 205 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h"
                                                    is_enc,
                      const uint8_t *key1, const uint8_t *key2,
                      size_t keybytes, const uint8_t *iv, void *context);
# 219 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h"
ali_crypto_result ali_aes_process(const uint8_t *src, uint8_t *dst,
                                  size_t size, void *context);
# 242 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h"
...
# 270 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h"
ali_crypto_result ali_des_init(des_type_t type, 
# 270 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h" 3 4
                                               _Bool 
# 270 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h"
                                                    is_enc,
                      const uint8_t *key, size_t keybytes,
                      const uint8_t *iv, void *context);
# 289 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h"
ali_crypto_result ali_des_process(const uint8_t *src, uint8_t *dst,
                                  size_t size, void *context);
# 317 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h"
...
# 331 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h"
ali_crypto_result ali_authenc_get_ctx_size(authenc_type_t type, size_t *size);
# 351 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h"
ali_crypto_result ali_authenc_init(authenc_type_t type, 
# 351 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h" 3 4
                                                       _Bool 
# 351 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h"
                                                            is_enc,
                      const uint8_t *key, size_t keybytes,
...
ali_crypto_result ali_cmac_digest(cmac_type_t type,
                      ...
                      const uint8_t *src, size_t size,
                      sym_padding_t padding, uint8_t *dgst);
# 519 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h"
...
# 541 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h"
...
# 560 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h"
ali_crypto_result ali_rsa_init_pubkey(size_t keybits,
                      const uint8_t *n, size_t n_size,
                      const uint8_t *e, size_t e_size,
                      rsa_pubkey_t *pubkey);
# 573 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h"
ali_crypto_result ali_rsa_gen_keypair(size_t keybits,
                      const uint8_t *e, size_t e_size,
                      rsa_keypair_t *keypair);
# 585 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h"
...
ali_crypto_result ali_rsa_verify(const rsa_pubkey_t *pub_key,
                      ...
                      rsa_padding_t padding, 
# 616 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h" 3 4
                                            _Bool 
# 616 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h"
                                                 *result);
# 626 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h"
...
ali_crypto_result ali_dsa_verify(const dsa_pubkey_t *pub_key,
                      ...
                      dsa_padding_t padding, 
# 653 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h" 3 4
                                            _Bool 
# 653 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h"
                                                 *result);

ali_crypto_result ali_dsa_get_key_attr(dsa_key_attr_t attr,
                      dsa_keypair_t *keypair,
                      void *buffer, uint32_t *size);
# 668 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h"
...
# 721 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h" 3 4
                     _Bool 
# 721 "./security/alicrypto/./libalicrypto/inc/ali_crypto.h"
                          *result);
...
# 6 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 2
# 1 "./security/alicrypto/./libalicrypto/test/inc/ali_crypto_test.h" 1
...
# 9 "./security/alicrypto/./libalicrypto/test/inc/ali_crypto_test.h" 2
...
# 10 "./security/alicrypto/./libalicrypto/test/inc/ali_crypto_test.h" 2
...
# 11 "./security/alicrypto/./libalicrypto/test/inc/ali_crypto_test.h" 2
# 35 "./security/alicrypto/./libalicrypto/test/inc/ali_crypto_test.h"
...
# 7 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 2
...
static int _rsa_test_gen_key(void)
{
    ...
    uint32_t p_size = (128);
    uint32_t q_size = (128);
    uint32_t dp_size = (128);
    uint32_t dq_size = (128);
    uint32_t qp_size = (128);
    uint8_t *pub_key = 
# 67 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                      ((void *)0)
# 67 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                          ;
    uint8_t *key_pair = 
# 68 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                       ((void *)0)
# 68 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                           ;
    ...
    printf("I %s %d: ""rsa gen key test!\n", __FUNCTION__, 78);

    ret = ali_rsa_get_pubkey_size((128) << 3, 
# 80 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                                                   ((void *)0)
# 80 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                                                       );
    ...
    ret = ali_rsa_get_keypair_size((128) << 3, 
# 92 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                                                    ((void *)0)
# 92 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                                                        );
    if (ret == ALI_CRYPTO_SUCCESS) {
        return -1;
    }
    ...
    ret = ali_rsa_init_keypair((128) << 3,
             rsa_n, n_size, rsa_e, e_size, rsa_d, d_size,
              
# 106 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
             ((void *)0) 
# 106 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                  , 0, 
# 106 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                       ((void *)0)
# 106 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
...
# 106 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
    ...
    ret = ali_rsa_init_pubkey((128) << 3,
             rsa_n, n_size, rsa_e, e_size, 
# 113 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                                          ((void *)0)
# 113 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                                              );
    if (ret == ALI_CRYPTO_SUCCESS) {
        return -1;
    }
    ...
    ret = ali_rsa_init_pubkey((128) << 3,
             rsa_n, n_size, rsa_e, e_size, 
# 120 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                                          ((void *)0)
# 120 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                                              );
    if (ret == ALI_CRYPTO_SUCCESS) {
        return -1;
    }

    ret = ali_rsa_get_pubkey_size((128) << 3, &pub_key_len);
    if (ret != ALI_CRYPTO_SUCCESS) {
        do { printf("E %s %d: ""init_key: get pubkey size fail(%08x)\n", __FUNCTION__, 127, ret); return -1; } while (0);
    }
    ret = ali_rsa_get_keypair_size((128) << 3, &key_pair_len);
    if (ret != ALI_CRYPTO_SUCCESS) {
        do { printf("E %s %d: ""init_key: get keypair size fail(%08x)\n", __FUNCTION__, 131, ret); return -1; } while (0);
    }

    pub_key = malloc(pub_key_len);
    if (pub_key == 
# 135 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                  ((void *)0)
# 135 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                      ) {
        do { printf("E %s %d: ""init_key: malloc(%d) fail\n", __FUNCTION__, 136, (int)pub_key_len); result = -1; goto _OUT; } while (0);;
    }
    key_pair = malloc(key_pair_len);
    if (pub_key == 
# 139 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                  ((void *)0)
# 139 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                      ) {
        do { printf("E %s %d: ""init_key: malloc(%d) fail\n", __FUNCTION__, 140, (int)pub_key_len); result = -1; goto _OUT; } while (0);;
    }


    ret = ali_rsa_gen_keypair((128) << 3, 
# 144 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                                               ((void *)0)
# 144 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                                                   , 0, 
# 144 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                                                        ((void *)0)
# 144 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
    ...
    if (ret == ALI_CRYPTO_SUCCESS) {
        do { printf("E %s %d: ""ali_rsa_gen_keypair: not expect\n", __FUNCTION__, 146); result = ALI_CRYPTO_ERROR; goto _OUT; } while (0);;
    }

    ret = ali_rsa_gen_keypair((128) << 3, 
# 149 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                                               ((void *)0)
# 149 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                                                   , 0, (rsa_keypair_t *)key_pair);
    if (ret != ALI_CRYPTO_SUCCESS) {
        do { printf("E %s %d: ""init_key: gen keypair fail(%08x)\n", __FUNCTION__, 151, ret); result = -1; goto _OUT; } while (0);;
    }


    ret = ali_rsa_get_key_attr(RSA_MODULUS,
                     
# 156 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                    ((void *)0)
# 156 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                        , rsa_n, (size_t *)&n_size);
    if (ret == ALI_CRYPTO_SUCCESS) {
        do { printf("E %s %d: ""ali_rsa_get_key_attr: not expect\n", __FUNCTION__, 158); result = ALI_CRYPTO_ERROR; goto _OUT; } while (0);;
    }

    ret = ali_rsa_get_key_attr((rsa_key_attr_t)-1,
                     (rsa_keypair_t *)key_pair, rsa_n, (size_t *)&n_size);
    if (ret == ALI_CRYPTO_SUCCESS) {
        do { printf("E %s %d: ""ali_rsa_get_key_attr: not expect\n", __FUNCTION__, 164); result = ALI_CRYPTO_ERROR; goto _OUT; } while (0);;
    }
...
# 212 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
             ((void *)0) 
# 212 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                  , 0, 
# 212 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                       ((void *)0)
# 212 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
...
# 212 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                                                      , 0, (rsa_keypair_t *)key_pair);
    if (ret == ALI_CRYPTO_SUCCESS) {
        do { printf("E %s %d: ""ali_rsa_init_keypair: not expect\n", __FUNCTION__, 214); result = ALI_CRYPTO_ERROR; goto _OUT; } while (0);;
    }
...
# 229 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
             ((void *)0) 
# 229 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                  , 0, 
# 229 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                       ((void *)0)
# 229 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
...
# 229 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                                                      , 0, (rsa_keypair_t *)key_pair);
    if (ret != ALI_CRYPTO_SUCCESS) {
        do { printf("E %s %d: ""init_key: init keypair fail(%08x)\n", __FUNCTION__, 231, ret); result = ret; goto _OUT; } while (0);;
    }
    ...
    if (ret == ALI_CRYPTO_SUCCESS) {
        do { printf("E %s %d: ""ali_rsa_init_pubkey: not expect\n", __FUNCTION__, 238); result = ALI_CRYPTO_ERROR; goto _OUT; } while (0);;
    }
    ...
    if (ret != ALI_CRYPTO_SUCCESS) {
        do { printf("E %s %d: ""init_key: init pub_key fail(%08x)\n", __FUNCTION__, 245, ret); result = ALI_CRYPTO_ERROR; goto _OUT; } while (0);;
    }
    ...
    src_size = (128);
    dst_size = (128);
    ret = ali_rsa_public_encrypt((const rsa_pubkey_t *)
# 252 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                                                      ((void *)0)
# 252 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                                                          , src_data, src_size,
                                 ciphertext, &dst_size, rsa_padding);
    if (ret == ALI_CRYPTO_SUCCESS) {
        do { printf("E %s %d: ""ali_rsa_public_encrypt: not expect\n", __FUNCTION__, 255); result = ALI_CRYPTO_ERROR; goto _OUT; } while (0);;
    }


    ret = ali_rsa_private_decrypt(
# 259 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                                 ((void *)0)
# 259 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                                     , ciphertext, (128),
                                  plaintext, &dst_size, rsa_padding);
    if (ret == ALI_CRYPTO_SUCCESS) {
        do { printf("E %s %d: ""ali_rsa_private_decrypt: not expect\n", __FUNCTION__, 262); result = ALI_CRYPTO_ERROR; goto _OUT; } while (0);;
    }
    ...
    ret = ali_rsa_public_encrypt((const rsa_pubkey_t *)pub_key, src_data, src_size,
                                 ciphertext, &dst_size, rsa_padding);
    if (ret != ALI_CRYPTO_SUCCESS) {
        do { printf("E %s %d: ""ali_rsa_public_encrypt: rsa_v1_5 fail %d\n", __FUNCTION__, 274, ret); result = ALI_CRYPTO_ERROR; goto _OUT; } while (0);;
    }

    ret = ali_rsa_private_decrypt((const rsa_keypair_t *)key_pair, ciphertext, (128),
                                  plaintext, &dst_size, rsa_padding);
    if (ret != ALI_CRYPTO_SUCCESS || dst_size != src_size) {
        do { printf("E %s %d: ""ali_rsa_private_decrypt: rsa_v1_5 fail %d\n", __FUNCTION__, 280, ret); result = ALI_CRYPTO_ERROR; goto _OUT; } while (0);;
    }
    if (memcmp(src_data, plaintext, src_size)) {
        ...
        do { printf("E %s %d: ""RSA encrypt/decrypt with PKCS1_V1_5 test fail!\n", __FUNCTION__, 285); return -1; } while (0);;
    } else {
        printf("I %s %d: ""RSA encrypt/decrypt with PKCS1_V1_5 test success!\n", __FUNCTION__, 287);
    }
               ...
               rsa_keypair_t **keypair, rsa_pubkey_t **pubkey)
{
    ...
    uint32_t d_size = (128);
    uint8_t *pub_key = 
# 314 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                      ((void *)0)
# 314 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                          ;
    uint8_t *key_pair = 
# 315 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                       ((void *)0)
# 315 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                           ;
    size_t pub_key_len, key_pair_len;
    ...
    (void)result;
    if (keypair == 
# 323 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                  ((void *)0) 
# 323 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                       || pubkey == 
# 323 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                                    ((void *)0)
# 323 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                                        ) {
        do { printf("E %s %d: ""init_key: invalid input args!\n", __FUNCTION__, 324); return -1; } while (0);;
    }

    ret = ali_rsa_get_pubkey_size((128) << 3, &pub_key_len);
    if (ret != ALI_CRYPTO_SUCCESS) {
        do { printf("E %s %d: ""init_key: get pubkey size fail(%08x)\n", __FUNCTION__, 329, ret); return -1; } while (0);;
    }
    ret = ali_rsa_get_keypair_size((128) << 3, &key_pair_len);
    if (ret != ALI_CRYPTO_SUCCESS) {
        do { printf("E %s %d: ""init_key: get keypair size fail(%08x)\n", __FUNCTION__, 333, ret); return -1; } while (0);;
    }

    pub_key = malloc(pub_key_len);
    if (pub_key == 
# 337 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                  ((void *)0)
# 337 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                      ) {
        do { printf("E %s %d: ""init_key: malloc(%d) fail\n", __FUNCTION__, 338, (int)pub_key_len); result = -1; goto _OUT; } while (0);;
    }
    key_pair = malloc(key_pair_len);
    if (pub_key == 
# 341 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                  ((void *)0)
# 341 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                      ) {
        do { printf("E %s %d: ""init_key: malloc(%d) fail\n", __FUNCTION__, 342, (int)pub_key_len); result = -1; goto _OUT; } while (0);;
    }
# 386 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
    memset(key_pair, 0, key_pair_len);
    ret = ali_rsa_init_keypair((128) << 3,
             RSA_1024_N, n_size, RSA_1024_E, 3, RSA_1024_D, d_size,
              
# 389 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
             ((void *)0) 
# 389 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                  , 0, 
# 389 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                       ((void *)0)
# 389 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
...
# 389 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                                                      , 0, (rsa_keypair_t *)key_pair);
    if (ret != ALI_CRYPTO_SUCCESS) {
        do { printf("E %s %d: ""init_key: init keypair fail(%08x)\n", __FUNCTION__, 391, ret); result = -1; goto _OUT; } while (0);;
    }
    ...
    if (ret != ALI_CRYPTO_SUCCESS) {
        do { printf("E %s %d: ""init_key: init pub_key fail(%08x)\n", __FUNCTION__, 398, ret); result = -1; goto _OUT; } while (0);;
    }
...
# 465 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                   ...
                   rsa_pubkey_t *pubkey, rsa_keypair_t *keypair)
{
    ...
    if (pubkey == 
# 475 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                 ((void *)0) 
# 475 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                      || keypair == 
# 475 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                                    ((void *)0)
# 475 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                                        ) {
        do { printf("E %s %d: ""rsa_v1_5: invalid input args!\n", __FUNCTION__, 476); return -1; } while (0);;
    }
    ...
    ret = ali_rsa_public_encrypt(pubkey, src_data, src_size,
                                 ciphertext, &dst_size, rsa_padding);
    if (ret != ALI_CRYPTO_SUCCESS) {
        do { printf("E %s %d: ""rsa_v1_5: public encrypt fail(%08x)\n", __FUNCTION__, 488, ret); return -1; } while (0);;
    }


    ret = ali_rsa_public_encrypt(pubkey, src_data, (128),
                                 ciphertext, &dst_size, rsa_padding);
    if (ret == ALI_CRYPTO_SUCCESS) {
        return -1;
    }

    ret = ali_rsa_private_decrypt(keypair, ciphertext, (128),
                                  plaintext, &dst_size, rsa_padding);
    if (ret != ALI_CRYPTO_SUCCESS || dst_size != src_size) {
        do { printf("E %s %d: ""rsa_v1_5: public decrypt fail(%08x)\n", __FUNCTION__, 501, ret); return -1; } while (0);;
    }

    if (memcmp(src_data, plaintext, src_size)) {
        ali_crypto_print_data("pliantext", plaintext, src_size);
        ali_crypto_print_data("ciphertext", ciphertext, dst_size);
        do { printf("E %s %d: ""RSA encrypt/decrypt with PKCS1_V1_5 test fail!\n", __FUNCTION__, 507); return -1; } while (0);;
    } else {
        printf("I %s %d: ""RSA encrypt/decrypt with PKCS1_V1_5 test success!\n", __FUNCTION__, 509);
    }
                   ...
                   rsa_pubkey_t *pubkey, rsa_keypair_t *keypair)
{
    ...
    if (pubkey == 
# 527 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                 ((void *)0) 
# 527 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                      || keypair == 
# 527 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                                    ((void *)0)
# 527 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                                        ) {
        printf("E %s %d: ""rsa_v1_5: invalid input args!\n", __FUNCTION__, 528);
        do { printf("E %s %d: ""rsa_v1_5: invalid input args!\n", __FUNCTION__, 529); return -1; } while (0);;
    }
    ...
    for (hash_type = SHA1; hash_type <= MD5; hash_type++) {
        if (hash_type == SHA512 || hash_type == SHA384) {
            printf("I %s %d: ""rsa oeap not support hash 384 512\n", __FUNCTION__, 536);
            continue;
        }

        if (2*(((hash_type) == SHA1) ? (SHA1_HASH_SIZE) : ( ((hash_type) == SHA224) ? (SHA224_HASH_SIZE) : ( ((hash_type) == SHA256) ? (SHA256_HASH_SIZE) : ( ((hash_type) == SHA384) ? (SHA384_HASH_SIZE) : ( ((hash_type) == SHA512) ? (SHA512_HASH_SIZE) : ( ((hash_type) == MD5) ? (MD5_HASH_SIZE) : (0))))))) >= (128) - 2) {
            continue;
        }

        src_size = (128) - 2*(((hash_type) == SHA1) ? (SHA1_HASH_SIZE) : ( ((hash_type) == SHA224) ? (SHA224_HASH_SIZE) : ( ((hash_type) == SHA256) ? (SHA256_HASH_SIZE) : ( ((hash_type) == SHA384) ? (SHA384_HASH_SIZE) : ( ((hash_type) == SHA512) ? (SHA512_HASH_SIZE) : ( ((hash_type) == MD5) ? (MD5_HASH_SIZE) : (0))))))) - 2;
        memset(src_data, 0xa, src_size);
        ...
        ret = ali_rsa_public_encrypt(pubkey, src_data, src_size,
                                     ciphertext, &dst_size, rsa_padding);
        if (ret != ALI_CRYPTO_SUCCESS) {
            do { printf("E %s %d: ""rsa_oaep: public encrypt(without lparam) fail(%08x)\n", __FUNCTION__,
                                                                            554
# 553 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
        ...
        ret = ali_rsa_private_decrypt(keypair, ciphertext, (128),
                                      plaintext, &dst_size, rsa_padding);
        if (ret != ALI_CRYPTO_SUCCESS || dst_size != src_size) {
            do { printf("E %s %d: ""rsa_oaep: private decrypt(without lparam) fail(%08x)\n", __FUNCTION__,
                                                                             560
# 559 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
            , ret); return -1; } while (0);
                                                                              ;
        }
        if (memcmp(src_data, plaintext, src_size)) {
            ali_crypto_print_data("pliantext", plaintext, src_size);
            ali_crypto_print_data("ciphertext", ciphertext, dst_size);
            do { printf("E %s %d: ""RSA encrypt/decrypt with PKCS1_OAEP(without lparam) test fail!\n", __FUNCTION__,
                                                                              566
# 565 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
            ); return -1; } while (0);
                                                                               ;
        } else {
            printf("I %s %d: ""RSA encrypt/decrypt with PKCS1_OAEP(without lparam) test success!\n", __FUNCTION__, 568);
        }
        ...
        ret = ali_rsa_public_encrypt(pubkey, src_data, src_size,
                                     ciphertext, &dst_size, rsa_padding);
        if (ret != ALI_CRYPTO_SUCCESS) {
            do { printf("E %s %d: ""rsa_oaep: public encrypt(with lparam) fail(%08x)\n", __FUNCTION__,
                                                                         578
# 577 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
            , ret); return -1; } while (0);
                                                                          ;
        }
        ret = ali_rsa_private_decrypt(keypair, ciphertext, (128),
                                      plaintext, &dst_size, rsa_padding);
        if (ret != ALI_CRYPTO_SUCCESS || dst_size != src_size) {
            do { printf("E %s %d: ""rsa_oaep: private decrypt(with lparam) fail(%08x)\n", __FUNCTION__,
                                                                          584
# 583 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
            , ret); return -1; } while (0);
                                                                           ;
        ...
        if (memcmp(src_data, plaintext, src_size)) {
            ali_crypto_print_data("pliantext", plaintext, src_size);
            ali_crypto_print_data("ciphertext", ciphertext, dst_size);
            do { printf("E %s %d: ""RSA encrypt/decrypt with PKCS1_OAEP(with lparam) test fail!\n", __FUNCTION__,
                                                                           591
# 590 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
            ); return -1; } while (0);
                                                                            ;
        } else {
            printf("I %s %d: ""RSA encrypt/decrypt with PKCS1_OAEP(with lparam) test success!\n", __FUNCTION__, 593);
        }
    }
...
# 603 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
   _Bool 
# 603 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
        result1, result2;
    ali_crypto_result ret;
    hash_type_t hash_type;
    uint8_t src_data[(128)];
    ...
    if (pubkey == 
# 611 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                 ((void *)0) 
# 611 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                      || keypair == 
# 611 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                                    ((void *)0)
# 611 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                                        ) {
        do { printf("E %s %d: ""rsa_v1_5: invalid input args!\n", __FUNCTION__, 612); return -1; } while (0);;
    }
    ...
    for (hash_type = SHA1; hash_type <= MD5; hash_type++) {
        ...
        if (hash_type == SHA512 || hash_type == SHA384) {
            printf("I %s %d: ""mbedtls rsa V1.5 not support hash 384 512\n", __FUNCTION__, 620);
            continue;
        }
        ...
        src_size = (((hash_type) == SHA1) ? (SHA1_HASH_SIZE) : ( ((hash_type) == SHA224) ? (SHA224_HASH_SIZE) : ( ((hash_type) == SHA256) ? (SHA256_HASH_SIZE) : ( ((hash_type) == SHA384) ? (SHA384_HASH_SIZE) : ( ((hash_type) == SHA512) ? (SHA512_HASH_SIZE) : ( ((hash_type) == MD5) ? (MD5_HASH_SIZE) : (0)))))));
        memset(src_data, 0xa, src_size);
        ...
        if (ret != ALI_CRYPTO_SUCCESS) {
            do { printf("E %s %d: ""rsa_v1_5: sign fail(%08x)\n", __FUNCTION__, 636, ret); return -1; } while (0);;
        }

        ret = ali_rsa_verify(pubkey, src_data, src_size,
                             signature, dst_size, rsa_padding, &result1);
        if (ret != ALI_CRYPTO_SUCCESS) {
            do { printf("E %s %d: ""rsa_v1_5: verify fail(%08x)\n", __FUNCTION__, 642, ret); return -1; } while (0);;
        }
        ...
        if (ret == ALI_CRYPTO_SUCCESS) {
            do { printf("E %s %d: ""rsa_v1_5: verify fail(%08x)\n", __FUNCTION__, 649, ret); return -1; } while (0);;
        }

        if (result1 == 
# 652 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                      1 
# 652 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                           && result2 == 
# 652 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                                         0
# 652 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                                              ) {
            printf("I %s %d: ""RSA sign/verify with PKCS1_V1_5 success!\n", __FUNCTION__, 653);
        } else {
            do { printf("E %s %d: ""RSA sign/verify with PKCS1_V1_5 fail!\n", __FUNCTION__, 655); return -1; } while (0);;
        }
    }
...
# 665 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
   _Bool 
# 665 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
        result1, result2;
    ali_crypto_result ret;
    hash_type_t hash_type;
    uint8_t src_data[(128)];
    ...
    if (pubkey == 
# 673 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                 ((void *)0) 
# 673 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                      || keypair == 
# 673 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                                    ((void *)0)
# 673 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                                        ) {
        do { printf("E %s %d: ""rsa_pss: invalid input args!\n", __FUNCTION__, 674); return -1; } while (0);;
    }
    ...
    for (hash_type = SHA1; hash_type <= MD5; hash_type++) {
        ...
        if (hash_type == SHA512 || hash_type == SHA384) {
            printf("I %s %d: ""mbedtls rsa pss not support hash 512\n", __FUNCTION__, 683);
            continue;
        }
        ...
        ret = ali_rsa_sign(keypair, src_data, src_size,
                           signature, &dst_size, rsa_padding);
        if (ret != ALI_CRYPTO_SUCCESS) {
            do { printf("E %s %d: ""rsa_pss: sign fail(%08x)\n", __FUNCTION__, 700, ret); return -1; } while (0);;
        }

        ret = ali_rsa_verify(pubkey, src_data, src_size,
                             signature, dst_size, rsa_padding, &result1);
        if (ret != ALI_CRYPTO_SUCCESS) {
            do { printf("E %s %d: ""rsa_pss: verify fail(%08x)\n", __FUNCTION__, 706, ret); return -1; } while (0);;
        }
        ...
        ret = ali_rsa_verify(pubkey, src_data, src_size,
                             signature, dst_size, rsa_padding, &result2);
        if (ret == ALI_CRYPTO_SUCCESS) {
            do { printf("E %s %d: ""rsa_pss: verify fail(%08x)\n", __FUNCTION__, 713, ret); return -1; } while (0);;
        }

        if (result1 == 
# 716 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                      1 
# 716 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                           && result2 == 
# 716 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                                         0
# 716 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                                              ) {
            printf("I %s %d: ""RSA sign/verify with PKCS1_PSS_MGF1 success!\n", __FUNCTION__, 717);
        } else {
            do { printf("E %s %d: ""RSA sign/verify with PKCS1_PSS_MGF1 fail!\n", __FUNCTION__, 719); return -1; } while (0);;
        }
    }
...
int ali_crypto_rsa_test(void)
{
    int ret;
    rsa_pubkey_t *pubkey = 
# 729 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                          ((void *)0)
# 729 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                              ;
    rsa_keypair_t *keypair = 
# 730 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c" 3 4
                            ((void *)0)
# 730 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
                                ;
...
# 750 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rsa.c"
...
_out:
    ...
    if (0 == ret) {
        printf("I %s %d: ""================ALI crypto test SUCCESS!\n", __FUNCTION__, 778);
    } else {
        printf("I %s %d: ""================ALI crypto test FAIL!\n", __FUNCTION__, 780);
    }
