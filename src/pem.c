# 1 "security/mbedtls/src/pem.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "security/mbedtls/src/pem.c"
# 23 "security/mbedtls/src/pem.c"
...
# 24 "security/mbedtls/src/pem.c" 2
...
# 31 "security/mbedtls/src/pem.c" 2
# 1 "./security/mbedtls/include/mbedtls/base64.h" 1
# 26 "./security/mbedtls/include/mbedtls/base64.h"
# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/lib/gcc/arm-none-eabi/5.4.1/include/stddef.h" 1 3 4
# 27 "./security/mbedtls/include/mbedtls/base64.h" 2
# 54 "./security/mbedtls/include/mbedtls/base64.h"
int mbedtls_base64_encode( unsigned char *dst, size_t dlen, size_t *olen,
                   const unsigned char *src, size_t slen );
# 74 "./security/mbedtls/include/mbedtls/base64.h"
...
# 32 "security/mbedtls/src/pem.c" 2
# 1 "./security/mbedtls/include/mbedtls/des.h" 1
# 27 "./security/mbedtls/include/mbedtls/des.h"
# 1 "./security/mbedtls/include/mbedtls/config.h" 1
# 28 "./security/mbedtls/include/mbedtls/des.h" 2




# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/lib/gcc/arm-none-eabi/5.4.1/include/stddef.h" 1 3 4
# 33 "./security/mbedtls/include/mbedtls/des.h" 2
...
# 34 "./security/mbedtls/include/mbedtls/des.h" 2
# 53 "./security/mbedtls/include/mbedtls/des.h"
...
# 104 "./security/mbedtls/include/mbedtls/des.h"
void mbedtls_des_key_set_parity( unsigned char key[8] );
# 116 "./security/mbedtls/include/mbedtls/des.h"
int mbedtls_des_key_check_key_parity( const unsigned char key[8] );
# 125 "./security/mbedtls/include/mbedtls/des.h"
int mbedtls_des_key_check_weak( const unsigned char key[8] );
# 135 "./security/mbedtls/include/mbedtls/des.h"
int mbedtls_des_setkey_enc( mbedtls_des_context *ctx, const unsigned char key[8] );
# 145 "./security/mbedtls/include/mbedtls/des.h"
int mbedtls_des_setkey_dec( mbedtls_des_context *ctx, const unsigned char key[8] );
# 155 "./security/mbedtls/include/mbedtls/des.h"
int mbedtls_des3_set2key_enc( mbedtls_des3_context *ctx,
                      const unsigned char key[8 * 2] );
# 166 "./security/mbedtls/include/mbedtls/des.h"
int mbedtls_des3_set2key_dec( mbedtls_des3_context *ctx,
                      const unsigned char key[8 * 2] );
# 177 "./security/mbedtls/include/mbedtls/des.h"
int mbedtls_des3_set3key_enc( mbedtls_des3_context *ctx,
                      const unsigned char key[8 * 3] );
# 188 "./security/mbedtls/include/mbedtls/des.h"
int mbedtls_des3_set3key_dec( mbedtls_des3_context *ctx,
                      const unsigned char key[8 * 3] );
# 200 "./security/mbedtls/include/mbedtls/des.h"
int mbedtls_des_crypt_ecb( mbedtls_des_context *ctx,
                    const unsigned char input[8],
                    unsigned char output[8] );
# 223 "./security/mbedtls/include/mbedtls/des.h"
...
# 240 "./security/mbedtls/include/mbedtls/des.h"
int mbedtls_des3_crypt_ecb( mbedtls_des3_context *ctx,
                     const unsigned char input[8],
                     unsigned char output[8] );
# 265 "./security/mbedtls/include/mbedtls/des.h"
int mbedtls_des3_crypt_cbc( mbedtls_des3_context *ctx,
                     ...
                     const unsigned char *input,
                     unsigned char *output );
# 281 "./security/mbedtls/include/mbedtls/des.h"
void mbedtls_des_setkey( uint32_t SK[32],
                         const unsigned char key[8] );
# 300 "./security/mbedtls/include/mbedtls/des.h"
int mbedtls_des_self_test( int verbose );
# 33 "security/mbedtls/src/pem.c" 2
...
# 34 "security/mbedtls/src/pem.c" 2
...
# 35 "security/mbedtls/src/pem.c" 2
...
int mbedtls_cipher_crypt( mbedtls_cipher_context_t *ctx,
                  ...
                  unsigned char *output, size_t *olen );
# 36 "security/mbedtls/src/pem.c" 2
...
# 38 "security/mbedtls/src/pem.c" 2
...
# 41 "security/mbedtls/src/pem.c" 2
# 49 "security/mbedtls/src/pem.c"
                        ...
                        const unsigned char *pwd, size_t pwdlen )
{
    ...
    size_t use_len;
# 143 "security/mbedtls/src/pem.c"
...
# 234 "security/mbedtls/src/pem.c"
                             ...
                             size_t pwdlen, size_t *use_len )
{
    ...
    if ( ctx == 
# 288 "security/mbedtls/src/pem.c" 3 4
               ((void *)0) 
# 288 "security/mbedtls/src/pem.c"
                    ) {
        return ( -0x1480 );
    }
    ...
    if ( s1 == 
# 294 "security/mbedtls/src/pem.c" 3 4
              ((void *)0) 
# 294 "security/mbedtls/src/pem.c"
                   ) {
        return ( -0x1080 );
    }
    ...
    if ( s2 == 
# 300 "security/mbedtls/src/pem.c" 3 4
              ((void *)0) 
# 300 "security/mbedtls/src/pem.c"
                   || s2 <= s1 ) {
        return ( -0x1080 );
    }
...
# 371 "security/mbedtls/src/pem.c"
...
# 415 "security/mbedtls/src/pem.c" 3 4
                                ((void *)0)
# 415 "security/mbedtls/src/pem.c"
                                    , 0, &len, s1, s2 - s1 );
...
# 421 "security/mbedtls/src/pem.c" 3 4
                                              ((void *)0) 
# 421 "security/mbedtls/src/pem.c"
                                                   ) {
        return ( -0x1180 );
    }
    ...
    if ( enc != 0 ) {
        ...
        if ( pwd == 
# 433 "security/mbedtls/src/pem.c" 3 4
                   ((void *)0) 
# 433 "security/mbedtls/src/pem.c"
                        ) {
            mbedtls_free( buf );
            return ( -0x1300 );
        }
# 447 "security/mbedtls/src/pem.c"
...
# 462 "security/mbedtls/src/pem.c"
