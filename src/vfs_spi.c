...
# 1 "././kernel/vfs/device/../include/device/vfs_spi.h" 1
# 12 "././kernel/vfs/device/../include/device/vfs_spi.h"
...
# 13 "././kernel/vfs/device/../include/device/vfs_spi.h" 2


extern const struct file_ops spi_ops;
# 24 "././kernel/vfs/device/../include/device/vfs_spi.h"
int vfs_spi_open(inode_t *inode, file_t *fp);
# 33 "././kernel/vfs/device/../include/device/vfs_spi.h"
int vfs_spi_close(file_t *fp);
# 45 "././kernel/vfs/device/../include/device/vfs_spi.h"
ssize_t vfs_spi_read(file_t *fp, void *buf, size_t nbytes);
# 57 "././kernel/vfs/device/../include/device/vfs_spi.h"
ssize_t vfs_spi_write(file_t *fp, const void *buf, size_t nbytes);
# 6 "kernel/vfs/device/vfs_spi.c" 2
...
# 7 "kernel/vfs/device/vfs_spi.c" 2
# 1 "././kernel/vfs/device/../include/vfs_err.h" 1
# 8 "kernel/vfs/device/vfs_spi.c" 2
...
int vfs_spi_open(inode_t *inode, file_t *fp)
{
    int ret = -1;
    spi_dev_t *spi_dev = 
# 21 "kernel/vfs/device/vfs_spi.c" 3 4
                        ((void *)0)
# 21 "kernel/vfs/device/vfs_spi.c"
                            ;


    if ((fp != 
# 24 "kernel/vfs/device/vfs_spi.c" 3 4
              ((void *)0)
# 24 "kernel/vfs/device/vfs_spi.c"
                  ) && (fp->node != 
# 24 "kernel/vfs/device/vfs_spi.c" 3 4
                                    ((void *)0)
# 24 "kernel/vfs/device/vfs_spi.c"
        ...
        ret = -
# 38 "kernel/vfs/device/vfs_spi.c" 3
              22
# 38 "kernel/vfs/device/vfs_spi.c"
                    ;
    }
...
int vfs_spi_close(file_t *fp)
{
    int ret = -1;
    spi_dev_t *spi_dev = 
# 47 "kernel/vfs/device/vfs_spi.c" 3 4
                        ((void *)0)
# 47 "kernel/vfs/device/vfs_spi.c"
                            ;


    if ((fp != 
# 50 "kernel/vfs/device/vfs_spi.c" 3 4
              ((void *)0)
# 50 "kernel/vfs/device/vfs_spi.c"
                  ) && (fp->node != 
# 50 "kernel/vfs/device/vfs_spi.c" 3 4
                                    ((void *)0)
# 50 "kernel/vfs/device/vfs_spi.c"
        ...
        ret = -
# 72 "kernel/vfs/device/vfs_spi.c" 3
              22
# 72 "kernel/vfs/device/vfs_spi.c"
                    ;
    }
...
ssize_t vfs_spi_read(file_t *fp, void *buf, size_t nbytes)
{
    int ret = -1;
    spi_dev_t *spi_dev = 
# 81 "kernel/vfs/device/vfs_spi.c" 3 4
                        ((void *)0)
# 81 "kernel/vfs/device/vfs_spi.c"
                            ;


    if ((fp != 
# 84 "kernel/vfs/device/vfs_spi.c" 3 4
              ((void *)0)
# 84 "kernel/vfs/device/vfs_spi.c"
                  ) && (fp->node != 
# 84 "kernel/vfs/device/vfs_spi.c" 3 4
                                    ((void *)0)
# 84 "kernel/vfs/device/vfs_spi.c"
        ...
        ret = -
# 106 "kernel/vfs/device/vfs_spi.c" 3
              22
# 106 "kernel/vfs/device/vfs_spi.c"
                    ;
    }
...
ssize_t vfs_spi_write(file_t *fp, const void *buf, size_t nbytes)
{
    int ret = -1;
    spi_dev_t *spi_dev = 
# 115 "kernel/vfs/device/vfs_spi.c" 3 4
                        ((void *)0)
# 115 "kernel/vfs/device/vfs_spi.c"
                            ;


    if ((fp != 
# 118 "kernel/vfs/device/vfs_spi.c" 3 4
              ((void *)0)
# 118 "kernel/vfs/device/vfs_spi.c"
                  ) && (fp->node != 
# 118 "kernel/vfs/device/vfs_spi.c" 3 4
                                    ((void *)0)
# 118 "kernel/vfs/device/vfs_spi.c"
        ...
        ret = -
# 140 "kernel/vfs/device/vfs_spi.c" 3
              22
# 140 "kernel/vfs/device/vfs_spi.c"
                    ;
    }
