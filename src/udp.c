# 1 "kernel/protocols/net/core/udp.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/core/udp.c"
# 48 "kernel/protocols/net/core/udp.c"
...
# 49 "kernel/protocols/net/core/udp.c" 2
...
# 53 "kernel/protocols/net/core/udp.c" 2
...
# 56 "kernel/protocols/net/core/udp.c" 2
...
# 61 "kernel/protocols/net/core/udp.c" 2
# 1 "./kernel/protocols/net/include/lwip/icmp6.h" 1
# 55 "./kernel/protocols/net/include/lwip/icmp6.h"
enum icmp6_type {
...
# 62 "kernel/protocols/net/core/udp.c" 2

# 1 "./kernel/protocols/net/include/lwip/snmp.h" 1
# 47 "./kernel/protocols/net/include/lwip/snmp.h"
struct udp_pcb;
struct netif;
# 64 "kernel/protocols/net/core/udp.c" 2
...
# 65 "kernel/protocols/net/core/udp.c" 2
...
# 67 "kernel/protocols/net/core/udp.c" 2
# 77 "kernel/protocols/net/core/udp.c"
...
udp_init(void)
{
  ...
  udp_port = ((u16_t)(((((u32_t)rand())) & ~0xc000) + 0xc000));
...
# 110 "kernel/protocols/net/core/udp.c" 3 4
                             ((void *)0)
# 110 "kernel/protocols/net/core/udp.c"
                                 ; pcb = pcb->next) {
  ...
  return udp_port;
# 137 "kernel/protocols/net/core/udp.c"
}
# 147 "kernel/protocols/net/core/udp.c"
static u8_t
udp_input_local_match(struct udp_pcb *pcb, struct netif *inp, u8_t broadcast)
{
  ...
  if (1) {
    ...
    if (broadcast != 0) {
      ...
      {
        if ((((&pcb->local_ip)) == 
# 173 "kernel/protocols/net/core/udp.c" 3 4
           ((void *)0) 
# 173 "kernel/protocols/net/core/udp.c"
    ...
    if (((&pcb->local_ip) == 
# 182 "kernel/protocols/net/core/udp.c" 3 4
       ((void *)0) 
# 182 "kernel/protocols/net/core/udp.c"
       || ((*(&pcb->local_ip)).addr == ((u32_t)0x00000000UL))) ||




       (!0 && ((((&ip_data.current_iphdr_dest))->addr & ((((0xf0000000UL) & 0xff) << 24) | (((0xf0000000UL) & 0xff00) << 8) | (((0xf0000000UL) & 0xff0000UL) >> 8) | (((0xf0000000UL) & 0xff000000UL) >> 24))) == ((((0xe0000000UL) & 0xff) << 24) | (((0xe0000000UL) & 0xff00) << 8) | (((0xe0000000UL) & 0xff0000UL) >> 8) | (((0xe0000000UL) & 0xff000000UL) >> 24)))) ||
...
# 209 "kernel/protocols/net/core/udp.c"
void
udp_input(struct pbuf *p, struct netif *inp)
{
  ...
  if (p->len < 8) {
    ...
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("udp_input: short UDP datagram (%""4d"" bytes) discarded\n", p->tot_len) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
                                                                                           ;
    ;
    ;
    ;
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("udp_input: received datagram of length %""4d""\n", p->tot_len) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("udp (") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)(((&ip_data.current_iphdr_dest)) != 
# 252 "kernel/protocols/net/core/udp.c" 3 4
 ((void *)0) 
# 252 "kernel/protocols/net/core/udp.c"
 ? ((u16_t)(((const u8_t*)(&((&ip_data.current_iphdr_dest))->addr))[0])) : 0), (u16_t)(((&ip_data.current_iphdr_dest)) != 
# 252 "kernel/protocols/net/core/udp.c" 3 4
 ((void *)0) 
# 252 "kernel/protocols/net/core/udp.c"
 ? ((u16_t)(((const u8_t*)(&((&ip_data.current_iphdr_dest))->addr))[1])) : 0), (u16_t)(((&ip_data.current_iphdr_dest)) != 
# 252 "kernel/protocols/net/core/udp.c" 3 4
 ((void *)0) 
# 252 "kernel/protocols/net/core/udp.c"
 ? ((u16_t)(((const u8_t*)(&((&ip_data.current_iphdr_dest))->addr))[2])) : 0), (u16_t)(((&ip_data.current_iphdr_dest)) != 
# 252 "kernel/protocols/net/core/udp.c" 3 4
 ((void *)0) 
# 252 "kernel/protocols/net/core/udp.c"
 ? ((u16_t)(((const u8_t*)(&((&ip_data.current_iphdr_dest))->addr))[3])) : 0)) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf (", %""4d"") <-- (", lwip_htons(udphdr->dest)) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)(((&ip_data.current_iphdr_src)) != 
# 254 "kernel/protocols/net/core/udp.c" 3 4
 ((void *)0) 
# 254 "kernel/protocols/net/core/udp.c"
 ? ((u16_t)(((const u8_t*)(&((&ip_data.current_iphdr_src))->addr))[0])) : 0), (u16_t)(((&ip_data.current_iphdr_src)) != 
# 254 "kernel/protocols/net/core/udp.c" 3 4
 ((void *)0) 
# 254 "kernel/protocols/net/core/udp.c"
 ? ((u16_t)(((const u8_t*)(&((&ip_data.current_iphdr_src))->addr))[1])) : 0), (u16_t)(((&ip_data.current_iphdr_src)) != 
# 254 "kernel/protocols/net/core/udp.c" 3 4
 ((void *)0) 
# 254 "kernel/protocols/net/core/udp.c"
 ? ((u16_t)(((const u8_t*)(&((&ip_data.current_iphdr_src))->addr))[2])) : 0), (u16_t)(((&ip_data.current_iphdr_src)) != 
# 254 "kernel/protocols/net/core/udp.c" 3 4
 ((void *)0) 
# 254 "kernel/protocols/net/core/udp.c"
 ? ((u16_t)(((const u8_t*)(&((&ip_data.current_iphdr_src))->addr))[3])) : 0)) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf (", %""4d"")\n", lwip_htons(udphdr->src)) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);

  pcb = 
# 257 "kernel/protocols/net/core/udp.c" 3 4
       ((void *)0)
# 257 "kernel/protocols/net/core/udp.c"
           ;
  prev = 
# 258 "kernel/protocols/net/core/udp.c" 3 4
        ((void *)0)
# 258 "kernel/protocols/net/core/udp.c"
            ;
  uncon_pcb = 
# 259 "kernel/protocols/net/core/udp.c" 3 4
             ((void *)0)
# 259 "kernel/protocols/net/core/udp.c"
                 ;
  ...
  for (pcb = udp_pcbs; pcb != 
# 264 "kernel/protocols/net/core/udp.c" 3 4
                             ((void *)0)
# 264 "kernel/protocols/net/core/udp.c"
                                 ; pcb = pcb->next) {

    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("pcb (") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)((&pcb->local_ip) != 
# 267 "kernel/protocols/net/core/udp.c" 3 4
   ((void *)0) 
# 267 "kernel/protocols/net/core/udp.c"
   ? ((u16_t)(((const u8_t*)(&(&pcb->local_ip)->addr))[0])) : 0), (u16_t)((&pcb->local_ip) != 
# 267 "kernel/protocols/net/core/udp.c" 3 4
   ((void *)0) 
# 267 "kernel/protocols/net/core/udp.c"
   ? ((u16_t)(((const u8_t*)(&(&pcb->local_ip)->addr))[1])) : 0), (u16_t)((&pcb->local_ip) != 
# 267 "kernel/protocols/net/core/udp.c" 3 4
   ((void *)0) 
# 267 "kernel/protocols/net/core/udp.c"
   ? ((u16_t)(((const u8_t*)(&(&pcb->local_ip)->addr))[2])) : 0), (u16_t)((&pcb->local_ip) != 
# 267 "kernel/protocols/net/core/udp.c" 3 4
   ((void *)0) 
# 267 "kernel/protocols/net/core/udp.c"
   ? ((u16_t)(((const u8_t*)(&(&pcb->local_ip)->addr))[3])) : 0)) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf (", %""4d"") <-- (", pcb->local_port) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)((&pcb->remote_ip) != 
# 269 "kernel/protocols/net/core/udp.c" 3 4
   ((void *)0) 
# 269 "kernel/protocols/net/core/udp.c"
   ...
   ? ((u16_t)(((const u8_t*)(&(&pcb->remote_ip)->addr))[3])) : 0)) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    ...
    if ((pcb->local_port == dest) &&
      ...
      if (((pcb->flags & 0x04U) == 0) &&
          ((uncon_pcb == 
# 276 "kernel/protocols/net/core/udp.c" 3 4
                        ((void *)0)
# 276 "kernel/protocols/net/core/udp.c"
                            )


          || !((&pcb->local_ip) == 
# 279 "kernel/protocols/net/core/udp.c" 3 4
             ((void *)0) 
# 279 "kernel/protocols/net/core/udp.c"
             || ((*(&pcb->local_ip)).addr == ((u32_t)0x00000000UL)))
      ...
      if ((pcb->remote_port == src) &&
        ...
        if (prev != 
# 291 "kernel/protocols/net/core/udp.c" 3 4
                   ((void *)0)
# 291 "kernel/protocols/net/core/udp.c"
                       ) {
  ...
  if (pcb == 
# 307 "kernel/protocols/net/core/udp.c" 3 4
            ((void *)0)
# 307 "kernel/protocols/net/core/udp.c"
                ) {
    pcb = uncon_pcb;
  }
  ...
  if (pcb != 
# 312 "kernel/protocols/net/core/udp.c" 3 4
            ((void *)0)
# 312 "kernel/protocols/net/core/udp.c"
                ) {
    for_us = 1;
  } else {
  ...
  if (for_us) {
    do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("udp_input: calculating checksum\n") ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);

    {
# 353 "kernel/protocols/net/core/udp.c"
      {
        if (udphdr->chksum != 0) {
    ...
    if (pcb != 
# 373 "kernel/protocols/net/core/udp.c" 3 4
              ((void *)0)
# 373 "kernel/protocols/net/core/udp.c"
                  ) {
      ;

      if (((pcb)->so_options & (0x04U)) &&
          (broadcast || ((((&ip_data.current_iphdr_dest))->addr & ((((0xf0000000UL) & 0xff) << 24) | (((0xf0000000UL) & 0xff00) << 8) | (((0xf0000000UL) & 0xff0000UL) >> 8) | (((0xf0000000UL) & 0xff000000UL) >> 24))) == ((((0xe0000000UL) & 0xff) << 24) | (((0xe0000000UL) & 0xff00) << 8) | (((0xe0000000UL) & 0xff0000UL) >> 8) | (((0xe0000000UL) & 0xff000000UL) >> 24))))) {
...
# 383 "kernel/protocols/net/core/udp.c" 3 4
                                     ((void *)0)
# 383 "kernel/protocols/net/core/udp.c"
                                         ; mpcb = mpcb->next) {
          if (mpcb != pcb) {
            ...
            if ((mpcb->local_port == dest) &&
              ...
              if (mpcb->recv != 
# 389 "kernel/protocols/net/core/udp.c" 3 4
                               ((void *)0)
# 389 "kernel/protocols/net/core/udp.c"
                                   ) {
                struct pbuf *q;
                ...
                if (q != 
# 397 "kernel/protocols/net/core/udp.c" 3 4
                        ((void *)0)
# 397 "kernel/protocols/net/core/udp.c"
                            ) {
      ...
      if (pcb->recv != 
# 416 "kernel/protocols/net/core/udp.c" 3 4
                      ((void *)0)
# 416 "kernel/protocols/net/core/udp.c"
                          ) {
      ...
      do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("udp_input: not for us.\n") ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
...
chkerr:
  do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("udp_input: UDP (or UDP Lite) datagram discarded due to failing checksum\n") ;} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0)
                                                                                            ;
  ;
  ;
  ;
...
# 479 "kernel/protocols/net/core/udp.c"
err_t
udp_send(struct udp_pcb *pcb, struct pbuf *p)
{
  if ((pcb == 
# 482 "kernel/protocols/net/core/udp.c" 3 4
             ((void *)0)
# 482 "kernel/protocols/net/core/udp.c"
                 ) || 0) {
    return ERR_VAL;
  }
...
# 526 "kernel/protocols/net/core/udp.c"
err_t
udp_sendto(struct udp_pcb *pcb, struct pbuf *p,
  const ip_addr_t *dst_ip, u16_t dst_port)
{
# 541 "kernel/protocols/net/core/udp.c"
  struct netif *netif;
  const ip_addr_t *dst_ip_route = dst_ip;

  if ((pcb == 
# 544 "kernel/protocols/net/core/udp.c" 3 4
             ((void *)0)
# 544 "kernel/protocols/net/core/udp.c"
                 ) || (dst_ip == 
# 544 "kernel/protocols/net/core/udp.c" 3 4
                                 ((void *)0)
# 544 "kernel/protocols/net/core/udp.c"
  ...
  do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("udp_send\n") ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);


  if ((((dst_ip_route)->addr & ((((0xf0000000UL) & 0xff) << 24) | (((0xf0000000UL) & 0xff00) << 8) | (((0xf0000000UL) & 0xff0000UL) >> 8) | (((0xf0000000UL) & 0xff000000UL) >> 24))) == ((((0xe0000000UL) & 0xff) << 24) | (((0xe0000000UL) & 0xff00) << 8) | (((0xe0000000UL) & 0xff0000UL) >> 8) | (((0xe0000000UL) & 0xff000000UL) >> 24)))) {
  ...
  if (netif == 
# 578 "kernel/protocols/net/core/udp.c" 3 4
              ((void *)0)
# 578 "kernel/protocols/net/core/udp.c"
                  ) {
    do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("udp_send: No route to ") ;} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0);
    do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)((dst_ip) != 
# 580 "kernel/protocols/net/core/udp.c" 3 4
   ((void *)0) 
# 580 "kernel/protocols/net/core/udp.c"
...
# 612 "kernel/protocols/net/core/udp.c"
err_t
udp_sendto_if(struct udp_pcb *pcb, struct pbuf *p,
  const ip_addr_t *dst_ip, u16_t dst_port, struct netif *netif)
{
# 627 "kernel/protocols/net/core/udp.c"
  const ip_addr_t *src_ip;

  if ((pcb == 
# 629 "kernel/protocols/net/core/udp.c" 3 4
             ((void *)0)
# 629 "kernel/protocols/net/core/udp.c"
                 ) || (dst_ip == 
# 629 "kernel/protocols/net/core/udp.c" 3 4
                                 ((void *)0)
# 629 "kernel/protocols/net/core/udp.c"
...
# 656 "kernel/protocols/net/core/udp.c"
  if ((((&pcb->local_ip)) == 
# 656 "kernel/protocols/net/core/udp.c" 3 4
     ((void *)0) 
# 656 "kernel/protocols/net/core/udp.c"
     || ((*((&pcb->local_ip))).addr == ((u32_t)0x00000000UL))) ||
...
{
# 696 "kernel/protocols/net/core/udp.c"
  struct udp_hdr *udphdr;
  err_t err;
  struct pbuf *q;
  u8_t ip_proto;
  ...
  if ((pcb == 
# 702 "kernel/protocols/net/core/udp.c" 3 4
             ((void *)0)
# 702 "kernel/protocols/net/core/udp.c"
                 ) || (dst_ip == 
# 702 "kernel/protocols/net/core/udp.c" 3 4
                                 ((void *)0)
# 702 "kernel/protocols/net/core/udp.c"
...
# 721 "kernel/protocols/net/core/udp.c"
  if (pcb->local_port == 0) {
    do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("udp_send: not yet bound to a port, binding now\n") ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
    err = udp_bind(pcb, &pcb->local_ip, pcb->local_port);
    if (err != ERR_OK) {
      do { if ( ((0x00U | 0x40U | 0x02) & 0x80U) && ((0x00U | 0x40U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x40U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("udp_send: forced port bind failed\n") ;} while(0); if ((0x00U | 0x40U | 0x02) & 0x08U) { while(1); } } } while(0);
      return err;
    }
  }
  ...
  if (pbuf_header(p, 8)) {
    ...
    if (q == 
# 735 "kernel/protocols/net/core/udp.c" 3 4
            ((void *)0)
# 735 "kernel/protocols/net/core/udp.c"
                ) {
      do { if ( ((0x00U | 0x40U | 0x02) & 0x80U) && ((0x00U | 0x40U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x40U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("udp_send: could not allocate header\n") ;} while(0); if ((0x00U | 0x40U | 0x02) & 0x08U) { while(1); } } } while(0);
      return ERR_MEM;
    }
    if (p->tot_len != 0) {
    ...
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("udp_send: added header pbuf %p before given pbuf %p\n", (void *)q, (void *)p) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
                                                                                                ;
  } else {


    q = p;
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("udp_send: added header in given pbuf %p\n", (void *)p) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  }
  ...
  if (((pcb->flags & 0x08U) != 0) && (((dst_ip)->addr & ((((0xf0000000UL) & 0xff) << 24) | (((0xf0000000UL) & 0xff00) << 8) | (((0xf0000000UL) & 0xff0000UL) >> 8) | (((0xf0000000UL) & 0xff000000UL) >> 24))) == ((((0xe0000000UL) & 0xff) << 24) | (((0xe0000000UL) & 0xff00) << 8) | (((0xe0000000UL) & 0xff0000UL) >> 8) | (((0xe0000000UL) & 0xff000000UL) >> 24)))) {
    q->flags |= 0x04U;
  }


  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("udp_send: sending datagram of length %""4d""\n", q->tot_len) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
# 819 "kernel/protocols/net/core/udp.c"
  {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("udp_send: UDP packet length %""4d""\n", q->tot_len) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
...

    {
      ...
      if (0 || (pcb->flags & 0x01U) == 0) {
        u16_t udpchksum;
# 837 "kernel/protocols/net/core/udp.c"
        {
  ...
  ttl = ((((dst_ip)->addr & ((((0xf0000000UL) & 0xff) << 24) | (((0xf0000000UL) & 0xff00) << 8) | (((0xf0000000UL) & 0xff0000UL) >> 8) | (((0xf0000000UL) & 0xff000000UL) >> 24))) == ((((0xe0000000UL) & 0xff) << 24) | (((0xe0000000UL) & 0xff00) << 8) | (((0xe0000000UL) & 0xff0000UL) >> 8) | (((0xe0000000UL) & 0xff000000UL) >> 24))) ? ((pcb)->mcast_ttl) : pcb->ttl);




  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("udp_send: UDP checksum 0x%04""4x""\n", udphdr->chksum) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("udp_send: ip_output_if (,,,,0x%02""4x"",)\n", (u16_t)ip_proto) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  ...
  if (q != p) {
    ...
    pbuf_free(q);
    q = 
# 874 "kernel/protocols/net/core/udp.c" 3 4
       ((void *)0)
# 874 "kernel/protocols/net/core/udp.c"
           ;
...
# 902 "kernel/protocols/net/core/udp.c"
err_t
udp_bind(struct udp_pcb *pcb, const ip_addr_t *ipaddr, u16_t port)
{
  ...
  if (ipaddr == 
# 910 "kernel/protocols/net/core/udp.c" 3 4
               ((void *)0)
# 910 "kernel/protocols/net/core/udp.c"
                   ) {
    ipaddr = (&ip_addr_any);
  }
  ...
  if ((pcb == 
# 916 "kernel/protocols/net/core/udp.c" 3 4
             ((void *)0)
# 916 "kernel/protocols/net/core/udp.c"
                 ) || (ipaddr == 
# 916 "kernel/protocols/net/core/udp.c" 3 4
                                 ((void *)0)
# 916 "kernel/protocols/net/core/udp.c"
  ...
  do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("udp_bind(ipaddr = ") ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)((ipaddr) != 
# 921 "kernel/protocols/net/core/udp.c" 3 4
 ((void *)0) 
# 921 "kernel/protocols/net/core/udp.c"
...
# 921 "kernel/protocols/net/core/udp.c"
 ? ((u16_t)(((const u8_t*)(&(ipaddr)->addr))[3])) : 0)) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf (", port = %""4d"")\n", port) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);

  rebind = 0;

  for (ipcb = udp_pcbs; ipcb != 
# 926 "kernel/protocols/net/core/udp.c" 3 4
                               ((void *)0)
# 926 "kernel/protocols/net/core/udp.c"
                                   ; ipcb = ipcb->next) {
  ...
  if (port == 0) {
    ...
    if (port == 0) {
      ...
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("udp_bind: out of free UDP ports\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      return ERR_USE;
    }
  } else {
    for (ipcb = udp_pcbs; ipcb != 
# 943 "kernel/protocols/net/core/udp.c" 3 4
                                 ((void *)0)
# 943 "kernel/protocols/net/core/udp.c"
                                     ; ipcb = ipcb->next) {
      if (pcb != ipcb) {
...

        {
          ...
          if ((ipcb->local_port == port) &&
            ...
            do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("udp_bind: local port %""4d"" already bound by another pcb\n", port) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
                                                                                               ;
            return ERR_USE;
          }
        }
...
# 967 "kernel/protocols/net/core/udp.c" 3 4
 ((void *)0) 
# 967 "kernel/protocols/net/core/udp.c"
 ? 0 : (ipaddr)->addr));
  ...
  do { if ( ((0x00U | 0x40U | 0x20U) & 0x80U) && ((0x00U | 0x40U | 0x20U) & 0x80U) && ((s16_t)((0x00U | 0x40U | 0x20U) & 0x03) >= 0x00)) { do {bk_printf ("udp_bind: bound to ") ;} while(0); if ((0x00U | 0x40U | 0x20U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U | 0x40U | 0x20U) & 0x80U) && ((0x00U | 0x40U | 0x20U) & 0x80U) && ((s16_t)((0x00U | 0x40U | 0x20U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)((&pcb->local_ip) != 
# 978 "kernel/protocols/net/core/udp.c" 3 4
 ((void *)0) 
# 978 "kernel/protocols/net/core/udp.c"
 ? ((u16_t)(((const u8_t*)(&(&pcb->local_ip)->addr))[0])) : 0), (u16_t)((&pcb->local_ip) != 
# 978 "kernel/protocols/net/core/udp.c" 3 4
 ((void *)0) 
# 978 "kernel/protocols/net/core/udp.c"
...
# 978 "kernel/protocols/net/core/udp.c" 3 4
 ((void *)0) 
# 978 "kernel/protocols/net/core/udp.c"
 ? ((u16_t)(((const u8_t*)(&(&pcb->local_ip)->addr))[3])) : 0)) ;} while(0); if ((0x00U | 0x40U | 0x20U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U | 0x40U | 0x20U) & 0x80U) && ((0x00U | 0x40U | 0x20U) & 0x80U) && ((s16_t)((0x00U | 0x40U | 0x20U) & 0x03) >= 0x00)) { do {bk_printf (", port %""4d"")\n", pcb->local_port) ;} while(0); if ((0x00U | 0x40U | 0x20U) & 0x08U) { while(1); } } } while(0);
  return ERR_OK;
}
# 1001 "kernel/protocols/net/core/udp.c"
err_t
udp_connect(struct udp_pcb *pcb, const ip_addr_t *ipaddr, u16_t port)
{
  ...
  if ((pcb == 
# 1006 "kernel/protocols/net/core/udp.c" 3 4
             ((void *)0)
# 1006 "kernel/protocols/net/core/udp.c"
                 ) || (ipaddr == 
# 1006 "kernel/protocols/net/core/udp.c" 3 4
                                 ((void *)0)
# 1006 "kernel/protocols/net/core/udp.c"
...
# 1017 "kernel/protocols/net/core/udp.c" 3 4
 ((void *)0) 
# 1017 "kernel/protocols/net/core/udp.c"
 ? 0 : (ipaddr)->addr));
  pcb->remote_port = port;
  pcb->flags |= 0x04U;

  do { if ( ((0x00U | 0x40U | 0x20U) & 0x80U) && ((0x00U | 0x40U | 0x20U) & 0x80U) && ((s16_t)((0x00U | 0x40U | 0x20U) & 0x03) >= 0x00)) { do {bk_printf ("udp_connect: connected to ") ;} while(0); if ((0x00U | 0x40U | 0x20U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U | 0x40U | 0x20U) & 0x80U) && ((0x00U | 0x40U | 0x20U) & 0x80U) && ((s16_t)((0x00U | 0x40U | 0x20U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)((&pcb->remote_ip) != 
# 1022 "kernel/protocols/net/core/udp.c" 3 4
 ((void *)0) 
# 1022 "kernel/protocols/net/core/udp.c"
 ? ((u16_t)(((const u8_t*)(&(&pcb->remote_ip)->addr))[0])) : 0), (u16_t)((&pcb->remote_ip) != 
# 1022 "kernel/protocols/net/core/udp.c" 3 4
 ((void *)0) 
# 1022 "kernel/protocols/net/core/udp.c"
...
# 1022 "kernel/protocols/net/core/udp.c" 3 4
 ((void *)0) 
# 1022 "kernel/protocols/net/core/udp.c"
 ? ((u16_t)(((const u8_t*)(&(&pcb->remote_ip)->addr))[3])) : 0)) ;} while(0); if ((0x00U | 0x40U | 0x20U) & 0x08U) { while(1); } } } while(0)
                                      ;
  do { if ( ((0x00U | 0x40U | 0x20U) & 0x80U) && ((0x00U | 0x40U | 0x20U) & 0x80U) && ((s16_t)((0x00U | 0x40U | 0x20U) & 0x03) >= 0x00)) { do {bk_printf (", port %""4d"")\n", pcb->remote_port) ;} while(0); if ((0x00U | 0x40U | 0x20U) & 0x08U) { while(1); } } } while(0);


  for (ipcb = udp_pcbs; ipcb != 
# 1027 "kernel/protocols/net/core/udp.c" 3 4
                               ((void *)0)
# 1027 "kernel/protocols/net/core/udp.c"
                                   ; ipcb = ipcb->next) {
    if (pcb == ipcb) {
...
# 1073 "kernel/protocols/net/core/udp.c"
void
...
# 1090 "kernel/protocols/net/core/udp.c"
void
...
# 1102 "kernel/protocols/net/core/udp.c" 3 4
                                 ((void *)0)
# 1102 "kernel/protocols/net/core/udp.c"
                                     ; pcb2 = pcb2->next) {

      if (pcb2->next != 
# 1104 "kernel/protocols/net/core/udp.c" 3 4
                       ((void *)0) 
# 1104 "kernel/protocols/net/core/udp.c"
                            && pcb2->next == pcb) {
...
# 1123 "kernel/protocols/net/core/udp.c"
struct udp_pcb *
udp_new(void)
{
  struct udp_pcb *pcb;
  ...
  if (pcb != 
# 1129 "kernel/protocols/net/core/udp.c" 3 4
            ((void *)0)
# 1129 "kernel/protocols/net/core/udp.c"
                ) {
...
# 1155 "kernel/protocols/net/core/udp.c"
struct udp_pcb *
...
void udp_netif_ip_addr_changed(const ip_addr_t* old_addr, const ip_addr_t* new_addr)
{
  ...
  if (!((old_addr) == 
# 1180 "kernel/protocols/net/core/udp.c" 3 4
      ((void *)0) 
# 1180 "kernel/protocols/net/core/udp.c"
...
# 1181 "kernel/protocols/net/core/udp.c" 3 4
                                 ((void *)0)
# 1181 "kernel/protocols/net/core/udp.c"
                                     ; upcb = upcb->next) {
