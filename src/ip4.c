# 1 "kernel/protocols/net/core/ipv4/ip4.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/core/ipv4/ip4.c"
# 41 "kernel/protocols/net/core/ipv4/ip4.c"
...
# 42 "kernel/protocols/net/core/ipv4/ip4.c" 2
...
# 44 "./kernel/protocols/net/include/lwip/ip.h" 2
...
# 46 "kernel/protocols/net/core/ipv4/ip4.c" 2


# 1 "./kernel/protocols/net/include/lwip/ip4_frag.h" 1
# 49 "kernel/protocols/net/core/ipv4/ip4.c" 2
...
# 50 "kernel/protocols/net/core/ipv4/ip4.c" 2
...
# 52 "kernel/protocols/net/core/ipv4/ip4.c" 2
...
void igmp_tmr(void);
# 53 "kernel/protocols/net/core/ipv4/ip4.c" 2
...
# 54 "kernel/protocols/net/core/ipv4/ip4.c" 2
...
# 55 "kernel/protocols/net/core/ipv4/ip4.c" 2
...
# 56 "kernel/protocols/net/core/ipv4/ip4.c" 2
# 1 "./kernel/protocols/net/include/lwip/autoip.h" 1
# 57 "kernel/protocols/net/core/ipv4/ip4.c" 2
...
# 59 "kernel/protocols/net/core/ipv4/ip4.c" 2
...
# 61 "kernel/protocols/net/core/ipv4/ip4.c" 2
# 103 "kernel/protocols/net/core/ipv4/ip4.c"
...
# 147 "kernel/protocols/net/core/ipv4/ip4.c"
struct netif *
...
# 160 "kernel/protocols/net/core/ipv4/ip4.c" 3 4
                                   ((void *)0)
# 160 "kernel/protocols/net/core/ipv4/ip4.c"
                                       ; netif = netif->next) {
...
# 205 "kernel/protocols/net/core/ipv4/ip4.c"
  if ((netif_default == 
# 205 "kernel/protocols/net/core/ipv4/ip4.c" 3 4
                       ((void *)0)
# 205 "kernel/protocols/net/core/ipv4/ip4.c"
    ...
    do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("ip4_route: No route to %""4d"".%""4d"".%""4d"".%""4d""\n", ((u16_t)(((const u8_t*)(&(dest)->addr))[0])), ((u16_t)(((const u8_t*)(&(dest)->addr))[1])), ((u16_t)(((const u8_t*)(&(dest)->addr))[2])), ((u16_t)(((const u8_t*)(&(dest)->addr))[3]))) ;} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0)
                                                                                      ;
    ;
    ;
    return 
# 213 "kernel/protocols/net/core/ipv4/ip4.c" 3 4
          ((void *)0)
# 213 "kernel/protocols/net/core/ipv4/ip4.c"
              ;
  }

  return netif_default;
}
# 369 "kernel/protocols/net/core/ipv4/ip4.c"
err_t
ip4_input(struct pbuf *p, struct netif *inp)
{
  ...
  if (((iphdr)->_v_hl >> 4) != 4) {
    do { if ( ((0x00U | 0x01) & 0x80U) && ((0x00U | 0x01) & 0x80U) && ((s16_t)((0x00U | 0x01) & 0x03) >= 0x00)) { do {bk_printf ("IP packet dropped due to bad version number %""4d""\n", (u16_t)((iphdr)->_v_hl >> 4)) ;} while(0); if ((0x00U | 0x01) & 0x08U) { while(1); } } } while(0);
    ;
    pbuf_free(p);
    ;
    ;
...
# 403 "kernel/protocols/net/core/ipv4/ip4.c"
  ...
  if ((iphdr_hlen > p->len) || (iphdr_len > p->tot_len) || (iphdr_hlen < 20)) {
    if (iphdr_hlen < 20) {
      do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("ip4_input: short IP header (%""4d"" bytes) received, IP packet dropped\n", iphdr_hlen) ;} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0)
                                                                                                  ;
    }
    if (iphdr_hlen > p->len) {
      do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("IP header (len %""4d"") does not fit in first pbuf (len %""4d""), IP packet dropped.\n", iphdr_hlen, p->len) ;} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0)

                            ;
    }
    if (iphdr_len > p->tot_len) {
      do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("IP (len %""4d"") is longer than pbuf (len %""4d""), IP packet dropped.\n", iphdr_len, p->tot_len) ;} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0)
...

  {
    if (inet_chksum(iphdr, iphdr_hlen) != 0) {
      ...
      do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("Checksum (0x%""4x"") failed, IP packet dropped.\n", inet_chksum(iphdr, iphdr_hlen)) ;} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0)
                                                                                               ;
      ;
      pbuf_free(p);
      ;
...
# 467 "kernel/protocols/net/core/ipv4/ip4.c" 3 4
         ((void *)0) 
# 467 "kernel/protocols/net/core/ipv4/ip4.c"
      ...
      netif = 
# 472 "kernel/protocols/net/core/ipv4/ip4.c" 3 4
             ((void *)0)
# 472 "kernel/protocols/net/core/ipv4/ip4.c"
                 ;
    }
    ...
    netif = inp;
    do {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("ip_input: iphdr->dest 0x%""8lx"" netif->ip_addr 0x%""8lx"" (0x%""8lx"", 0x%""8lx"", 0x%""8lx"")\n", ((&iphdr->dest)->addr), ((((const ip4_addr_t*)(&((netif)->ip_addr))))->addr), ((&iphdr->dest)->addr) & ((((const ip4_addr_t*)(&((netif)->netmask))))->addr), ((((const ip4_addr_t*)(&((netif)->ip_addr))))->addr) & ((((const ip4_addr_t*)(&((netif)->netmask))))->addr), ((&iphdr->dest)->addr) & ~((((const ip4_addr_t*)(&((netif)->netmask))))->addr)) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
      ...
      if (((((netif)->flags & 0x01U) ? (u8_t)1 : (u8_t)0)) && (!((*((const ip4_addr_t*)(&((netif)->ip_addr)))).addr == ((u32_t)0x00000000UL)))) {
        ...
        if ((((&ip_data.current_iphdr_dest))->addr == (((const ip4_addr_t*)(&((netif)->ip_addr))))->addr) ||
          ...
          do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("ip4_input: packet accepted on interface %c%c\n", netif->name[0], netif->name[1]) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
                                              ;

          break;
        }
# 519 "kernel/protocols/net/core/ipv4/ip4.c"
      }
      if (first) {
        first = 0;
        netif = netif_list;
...
# 529 "kernel/protocols/net/core/ipv4/ip4.c" 3 4
                     ((void *)0)
# 529 "kernel/protocols/net/core/ipv4/ip4.c"
                         );
  }
# 542 "kernel/protocols/net/core/ipv4/ip4.c"
  if (netif == 
# 542 "kernel/protocols/net/core/ipv4/ip4.c" 3 4
              ((void *)0)
# 542 "kernel/protocols/net/core/ipv4/ip4.c"
                  ) {
    ...
    if (((iphdr)->_proto) == 17) {
      ...
      do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("ip4_input: UDP packet to DHCP client port %""4d""\n", lwip_htons(udphdr->dest)) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0)
                                  ;
      if (((udphdr->dest) == ((((68) & 0xff) << 8) | (((68) & 0xff00) >> 8)))) {
        do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("ip4_input: DHCP packet accepted.\n") ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
        netif = inp;
        check_ip_src = 0;
      }
    }
...

  {
    if ((ip4_addr_isbroadcast_u32(((&ip_data.current_iphdr_src))->addr, inp)) ||
      ...
      do { if ( ((0x00U | 0x40U | 0x01) & 0x80U) && ((0x00U | 0x40U | 0x01) & 0x80U) && ((s16_t)((0x00U | 0x40U | 0x01) & 0x03) >= 0x00)) { do {bk_printf ("ip4_input: packet source is not valid.\n") ;} while(0); if ((0x00U | 0x40U | 0x01) & 0x08U) { while(1); } } } while(0);
  ...
  if (netif == 
# 581 "kernel/protocols/net/core/ipv4/ip4.c" 3 4
              ((void *)0)
# 581 "kernel/protocols/net/core/ipv4/ip4.c"
                  ) {

    do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("ip4_input: packet not for us.\n") ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
...
# 611 "kernel/protocols/net/core/ipv4/ip4.c"
    pbuf_free(p);
    do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("IP packet dropped since it was fragmented (0x%""4x"") (while IP_REASSEMBLY == 0).\n", lwip_htons(((iphdr)->_offset))) ;} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0)
                                     ;
    ;
    ;
...
# 641 "kernel/protocols/net/core/ipv4/ip4.c"
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("ip4_input: \n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  ;
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("ip4_input: p->len %""4d"" p->tot_len %""4d""\n", p->len, p->tot_len) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
...

  {
    ...
    default:
      ...
      do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("Unsupported transport protocol %""4d""\n", (u16_t)((iphdr)->_proto)) ;} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0);
...
# 705 "kernel/protocols/net/core/ipv4/ip4.c" 3 4
                         ((void *)0)
# 705 "kernel/protocols/net/core/ipv4/ip4.c"
                             ;
  ip_data.current_input_netif = 
# 706 "kernel/protocols/net/core/ipv4/ip4.c" 3 4
                               ((void *)0)
# 706 "kernel/protocols/net/core/ipv4/ip4.c"
                                   ;
  ip_data.current_ip4_header = 
# 707 "kernel/protocols/net/core/ipv4/ip4.c" 3 4
                              ((void *)0)
# 707 "kernel/protocols/net/core/ipv4/ip4.c"
                                  ;
...
# 740 "kernel/protocols/net/core/ipv4/ip4.c"
err_t
...
# 746 "kernel/protocols/net/core/ipv4/ip4.c" 3 4
                                                                ((void *)0)
# 746 "kernel/protocols/net/core/ipv4/ip4.c"
                                                                    , 0);
}
       ...
       u16_t optlen)
{
  ...
  if (dest != 
# 762 "kernel/protocols/net/core/ipv4/ip4.c" 3 4
             ((void *)0)
# 762 "kernel/protocols/net/core/ipv4/ip4.c"
                            ) {
    if (((src) == 
# 763 "kernel/protocols/net/core/ipv4/ip4.c" 3 4
       ((void *)0) 
# 763 "kernel/protocols/net/core/ipv4/ip4.c"
...
# 786 "kernel/protocols/net/core/ipv4/ip4.c" 3 4
                                                                    ((void *)0)
# 786 "kernel/protocols/net/core/ipv4/ip4.c"
                                                                        , 0);
}
       ...
       u16_t optlen)
{
  ...
  if (dest != 
# 810 "kernel/protocols/net/core/ipv4/ip4.c" 3 4
             ((void *)0)
# 810 "kernel/protocols/net/core/ipv4/ip4.c"
                            ) {
    u16_t ip_hlen = 20;
    ...
    if (optlen != 0) {
      ...
      if (pbuf_header(p, optlen_aligned)) {
        do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("ip4_output_if_opt: not enough room for IP options in pbuf\n") ;} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0);
        ;
        ;
        return ERR_BUF;
      }
    ...
    if (pbuf_header(p, 20)) {
      do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("ip4_output: not enough room for IP header in pbuf\n") ;} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0);
    ...
    if (src == 
# 882 "kernel/protocols/net/core/ipv4/ip4.c" 3 4
              ((void *)0)
# 882 "kernel/protocols/net/core/ipv4/ip4.c"
                  ) {
...
# 911 "kernel/protocols/net/core/ipv4/ip4.c"
  } else {
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("ip4_output_if: %c%c%""4d""\n", netif->name[0], netif->name[1], (u16_t)netif->num) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  ;
  ...
  if (((dest)->addr == (((const ip4_addr_t*)(&((netif)->ip_addr))))->addr)
    ...
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("netif_loop_output()") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
...
# 946 "kernel/protocols/net/core/ipv4/ip4.c"
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("ip4_output_if: call netif->output()\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  return netif->output(netif, p, dest);
}
# 967 "kernel/protocols/net/core/ipv4/ip4.c"
err_t
...
# 975 "kernel/protocols/net/core/ipv4/ip4.c" 3 4
                                           ((void *)0)
# 975 "kernel/protocols/net/core/ipv4/ip4.c"
                                               ) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("ip4_output: No route to %""4d"".%""4d"".%""4d"".%""4d""\n", ((u16_t)(((const u8_t*)(&(dest)->addr))[0])), ((u16_t)(((const u8_t*)(&(dest)->addr))[1])), ((u16_t)(((const u8_t*)(&(dest)->addr))[2])), ((u16_t)(((const u8_t*)(&(dest)->addr))[3]))) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
                                                                                      ;
    ;
    return ERR_RTE;
  }
