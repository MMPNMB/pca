...
# 8 "kernel/vfs/vfs_register.c" 2
# 1 "./kernel/vfs/include/vfs_conf.h" 1
# 9 "kernel/vfs/vfs_register.c" 2
# 1 "./kernel/vfs/include/vfs_err.h" 1
# 10 "kernel/vfs/vfs_register.c" 2
...
# 11 "kernel/vfs/vfs_register.c" 2
...
{
    inode_t *node = 
# 16 "kernel/vfs/vfs_register.c" 3 4
                   ((void *)0)
# 16 "kernel/vfs/vfs_register.c"
                       ;
    int err, ret;

    err = aos_mutex_lock(&g_vfs_mutex, 0xffffffffu);
    if (err != 0) {
        return err;
    }
    ...
    if (err != 0) {
        if (node->i_name != 
# 39 "kernel/vfs/vfs_register.c" 3 4
                           ((void *)0)
# 39 "kernel/vfs/vfs_register.c"
                               ) {
...
{
    inode_t *node = 
# 71 "kernel/vfs/vfs_register.c" 3 4
                   ((void *)0)
# 71 "kernel/vfs/vfs_register.c"
                       ;
    int err, ret;
    ...
    if (err != 0) {
        if (node->i_name != 
# 89 "kernel/vfs/vfs_register.c" 3 4
                           ((void *)0)
# 89 "kernel/vfs/vfs_register.c"
                               ) {
            aos_free(node->i_name);
        }
