# 1 "kernel/protocols/net/core/ipv4/etharp.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/core/ipv4/etharp.c"
# 46 "kernel/protocols/net/core/ipv4/etharp.c"
...
# 47 "kernel/protocols/net/core/ipv4/etharp.c" 2



# 1 "./kernel/protocols/net/include/lwip/etharp.h" 1
# 49 "./kernel/protocols/net/include/lwip/etharp.h"
...
# 50 "./kernel/protocols/net/include/lwip/etharp.h" 2
# 1 "./kernel/protocols/net/include/lwip/ip4_addr.h" 1
# 41 "./kernel/protocols/net/include/lwip/ip4_addr.h"
...
# 42 "./kernel/protocols/net/include/lwip/ip4_addr.h" 2
...
# 51 "./kernel/protocols/net/include/lwip/etharp.h" 2
...
# 44 "./kernel/protocols/net/include/lwip/ip_addr.h"
...
# 52 "./kernel/protocols/net/include/lwip/etharp.h" 2
...
# 53 "./kernel/protocols/net/include/lwip/etharp.h" 2
...
# 47 "./kernel/protocols/net/include/lwip/dhcp.h" 2
...
# 54 "kernel/protocols/net/core/ipv4/etharp.c" 2
# 1 "./kernel/protocols/net/include/lwip/autoip.h" 1
# 55 "kernel/protocols/net/core/ipv4/etharp.c" 2
...
# 56 "kernel/protocols/net/core/ipv4/etharp.c" 2
...
# 58 "kernel/protocols/net/core/ipv4/etharp.c" 2
# 76 "kernel/protocols/net/core/ipv4/etharp.c"
...
# 130 "kernel/protocols/net/core/ipv4/etharp.c"
static err_t etharp_request_dst(struct netif *netif, const ip4_addr_t *ipaddr, const struct eth_addr* hw_dst_addr);
# 161 "kernel/protocols/net/core/ipv4/etharp.c"
static void
etharp_free_entry(int i)
{
  ...
  if (arp_table[i].q != 
# 167 "kernel/protocols/net/core/ipv4/etharp.c" 3 4
                       ((void *)0)
# 167 "kernel/protocols/net/core/ipv4/etharp.c"
                           ) {

    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_free_entry: freeing entry %""4d"", packet queue %p.\n", (u16_t)i, (void *)(arp_table[i].q)) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    pbuf_free(arp_table[i].q);
    arp_table[i].q = 
# 171 "kernel/protocols/net/core/ipv4/etharp.c" 3 4
                    ((void *)0)
# 171 "kernel/protocols/net/core/ipv4/etharp.c"
                        ;
  }
  ...
  arp_table[i].ctime = 0;
  arp_table[i].netif = 
# 178 "kernel/protocols/net/core/ipv4/etharp.c" 3 4
                      ((void *)0)
# 178 "kernel/protocols/net/core/ipv4/etharp.c"
                          ;
...
etharp_tmr(void)
{
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_timer\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
...
# 249 "kernel/protocols/net/core/ipv4/etharp.c"
static s8_t
etharp_find_entry(const ip4_addr_t *ipaddr, u8_t flags, struct netif* netif)
{
  ...
  (void)netif;
# 277 "kernel/protocols/net/core/ipv4/etharp.c"
  for (i = 0; i < 10; ++i) {
    u8_t state = arp_table[i].state;

    if ((empty == 10) && (state == ETHARP_STATE_EMPTY)) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_find_entry: found empty entry %""4d""\n", (u16_t)i) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      ...
      if (ipaddr && ((ipaddr)->addr == (&arp_table[i].ipaddr)->addr)
        ...
        do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_find_entry: found matching entry %""4d""\n", (u16_t)i) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
      ...
      if (state == ETHARP_STATE_PENDING) {
        ...
        if (arp_table[i].q != 
# 300 "kernel/protocols/net/core/ipv4/etharp.c" 3 4
                             ((void *)0)
# 300 "kernel/protocols/net/core/ipv4/etharp.c"
                                 ) {
  ...
  if (((flags & 2) != 0) ||
      ...
      ((empty == 10) && ((flags & 1) == 0))) {
    do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_find_entry: no empty entry found and not allowed to recycle\n") ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
    return (s8_t)ERR_MEM;
  }
# 349 "kernel/protocols/net/core/ipv4/etharp.c"
  if (empty < 10) {
    i = empty;
    do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_find_entry: selecting empty entry %""4d""\n", (u16_t)i) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
  } else {

    if (old_stable < 10) {

      i = old_stable;
      do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_find_entry: selecting oldest stable entry %""4d""\n", (u16_t)i) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
      ...
      i = old_pending;
      do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_find_entry: selecting oldest pending entry %""4d"" (without queue)\n", (u16_t)i) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);

    } else if (old_queue < 10) {

      i = old_queue;
      do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_find_entry: selecting oldest pending entry %""4d"", freeing packet queue %p\n", (u16_t)i, (void *)(arp_table[i].q)) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);

    } else {
      do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_find_entry: no empty or recyclable entries found\n") ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
      return (s8_t)ERR_MEM;
    }
  ...
  if (ipaddr != 
# 386 "kernel/protocols/net/core/ipv4/etharp.c" 3 4
               ((void *)0)
# 386 "kernel/protocols/net/core/ipv4/etharp.c"
                   ) {
...
# 425 "kernel/protocols/net/core/ipv4/etharp.c"
    ...
    do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_update_arp_entry: will not add non-unicast IP address to ARP cache\n") ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
    return ERR_ARG;
  }
...
# 447 "kernel/protocols/net/core/ipv4/etharp.c"
  {
  ...
  do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_update_arp_entry: updating stable entry %""4d""\n", (s16_t)i) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);

  memcpy(&arp_table[i].ethaddr,ethaddr,6);

  arp_table[i].ctime = 0;
# 475 "kernel/protocols/net/core/ipv4/etharp.c"
  if (arp_table[i].q != 
# 475 "kernel/protocols/net/core/ipv4/etharp.c" 3 4
                       ((void *)0)
# 475 "kernel/protocols/net/core/ipv4/etharp.c"
                           ) {
    struct pbuf *p = arp_table[i].q;
    arp_table[i].q = 
# 477 "kernel/protocols/net/core/ipv4/etharp.c" 3 4
                    ((void *)0)
# 477 "kernel/protocols/net/core/ipv4/etharp.c"
                        ;
...
# 550 "kernel/protocols/net/core/ipv4/etharp.c"
void
...
# 574 "kernel/protocols/net/core/ipv4/etharp.c"
s8_t
...
# 603 "kernel/protocols/net/core/ipv4/etharp.c"
u8_t
...
# 632 "kernel/protocols/net/core/ipv4/etharp.c"
void
etharp_input(struct pbuf *p, struct netif *netif)
{
  ...
  do { if (!((netif != 
# 640 "kernel/protocols/net/core/ipv4/etharp.c" 3 4
 ((void *)0)
# 640 "kernel/protocols/net/core/ipv4/etharp.c"
  ...
  if ((hdr->hwtype != ((((HWTYPE_ETHERNET) & 0xff) << 8) | (((HWTYPE_ETHERNET) & 0xff00) >> 8))) ||
    ...
    do { if ( ((0x00U | 0x40U | 0x01) & 0x80U) && ((0x00U | 0x40U | 0x01) & 0x80U) && ((s16_t)((0x00U | 0x40U | 0x01) & 0x03) >= 0x00)) { do {bk_printf ("etharp_input: packet dropped, wrong hw type, hwlen, proto, protolen or ethernet type (%""4d""/%""4d""/%""4d""/%""4d"")\n", hdr->hwtype, (u16_t)hdr->hwlen, hdr->proto, (u16_t)hdr->protolen) ;} while(0); if ((0x00U | 0x40U | 0x01) & 0x08U) { while(1); } } } while(0)
  ...
  ;
# 668 "kernel/protocols/net/core/ipv4/etharp.c"
  ...
  case ((((ARP_REQUEST) & 0xff) << 8) | (((ARP_REQUEST) & 0xff00) >> 8)):
    ...
    do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_input: incoming ARP request\n") ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);

    if (for_us) {

      do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_input: replying to ARP request for our IP address\n") ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
...
# 726 "kernel/protocols/net/core/ipv4/etharp.c"
      {
      ...
      do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_input: we are unconfigured, ARP request ignored.\n") ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);

    } else {

      do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_input: ARP request was not for us.\n") ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
    }
    break;
  case ((((ARP_REPLY) & 0xff) << 8) | (((ARP_REPLY) & 0xff00) >> 8)):

    do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_input: incoming ARP reply\n") ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
    ...
    break;
  default:
    do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_input: ARP unknown opcode type %""4d""\n", lwip_htons(hdr->opcode)) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
    ;
    break;
  }
...
# 806 "kernel/protocols/net/core/ipv4/etharp.c"
err_t
...
# 850 "kernel/protocols/net/core/ipv4/etharp.c"
      {
...
# 947 "kernel/protocols/net/core/ipv4/etharp.c"
err_t
etharp_query(struct netif *netif, const ip4_addr_t *ipaddr, struct pbuf *q)
{
  ...
  if (ip4_addr_isbroadcast_u32((ipaddr)->addr, netif) ||
      (((ipaddr)->addr & ((((0xf0000000UL) & 0xff) << 24) | (((0xf0000000UL) & 0xff00) << 8) | (((0xf0000000UL) & 0xff0000UL) >> 8) | (((0xf0000000UL) & 0xff000000UL) >> 24))) == ((((0xe0000000UL) & 0xff) << 24) | (((0xe0000000UL) & 0xff00) << 8) | (((0xe0000000UL) & 0xff0000UL) >> 8) | (((0xe0000000UL) & 0xff000000UL) >> 24))) ||
      ((ipaddr) == 
# 958 "kernel/protocols/net/core/ipv4/etharp.c" 3 4
     ((void *)0) 
# 958 "kernel/protocols/net/core/ipv4/etharp.c"
     || ((*(ipaddr)).addr == ((u32_t)0x00000000UL)))) {
    do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_query: will not add non-unicast IP address to ARP cache\n") ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
    return ERR_ARG;
  }
  ...
  if (i < 0) {
    do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_query: could not create ARP entry\n") ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
    if (q) {
      do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_query: packet dropped\n") ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
      ;
    }
    return (err_t)i;
  }
  ...
  if (is_new_entry || (q == 
# 990 "kernel/protocols/net/core/ipv4/etharp.c" 3 4
                           ((void *)0)
# 990 "kernel/protocols/net/core/ipv4/etharp.c"
                               )) {
    ...
    if (q == 
# 999 "kernel/protocols/net/core/ipv4/etharp.c" 3 4
            ((void *)0)
# 999 "kernel/protocols/net/core/ipv4/etharp.c"
                ) {
      return result;
    }
  }
  ...
  if (arp_table[i].state >= ETHARP_STATE_STABLE) {
    ...
    if (copy_needed) {
      ...
      if (p != 
# 1032 "kernel/protocols/net/core/ipv4/etharp.c" 3 4
              ((void *)0)
# 1032 "kernel/protocols/net/core/ipv4/etharp.c"
                  ) {
        if (pbuf_copy(p, q) != ERR_OK) {
          pbuf_free(p);
          p = 
# 1035 "kernel/protocols/net/core/ipv4/etharp.c" 3 4
             ((void *)0)
# 1035 "kernel/protocols/net/core/ipv4/etharp.c"
                 ;
        }
      }
    } else {
    ...
    if (p != 
# 1044 "kernel/protocols/net/core/ipv4/etharp.c" 3 4
            ((void *)0)
# 1044 "kernel/protocols/net/core/ipv4/etharp.c"
                ) {
# 1087 "kernel/protocols/net/core/ipv4/etharp.c"
      if (arp_table[i].q != 
# 1087 "kernel/protocols/net/core/ipv4/etharp.c" 3 4
                           ((void *)0)
# 1087 "kernel/protocols/net/core/ipv4/etharp.c"
                               ) {
        do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_query: dropped previously queued packet %p for ARP entry %""4d""\n", (void *)q, (s16_t)i) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
        pbuf_free(arp_table[i].q);
      }
      arp_table[i].q = p;
      result = ERR_OK;
      do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_query: queued packet %p on ARP entry %""4d""\n", (void *)q, (s16_t)i) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);

    } else {
      ;
      do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_query: could not queue a copy of PBUF_REF packet %p (out of memory)\n", (void *)q) ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
      result = ERR_MEM;
    }
  }
  return result;
}
# 1119 "kernel/protocols/net/core/ipv4/etharp.c"
static err_t
           ...
           const u16_t opcode)
{
  ...
  if (p == 
# 1135 "kernel/protocols/net/core/ipv4/etharp.c" 3 4
          ((void *)0)
# 1135 "kernel/protocols/net/core/ipv4/etharp.c"
              ) {
    do { if ( ((0x00U | 0x40U | 0x02) & 0x80U) && ((0x00U | 0x40U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x40U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("etharp_raw: could not allocate pbuf for ARP request.\n") ;} while(0); if ((0x00U | 0x40U | 0x02) & 0x08U) { while(1); } } } while(0)
                                                                 ;
    ;
    return ERR_MEM;
  }
  ...
  hdr = (struct etharp_hdr *)p->payload;
  do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_raw: sending raw ARP packet.\n") ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
  ...
  hdr->hwlen = 6;
  hdr->protolen = sizeof(ip4_addr_t);
# 1174 "kernel/protocols/net/core/ipv4/etharp.c"
  {
  ...
  pbuf_free(p);
  p = 
# 1181 "kernel/protocols/net/core/ipv4/etharp.c" 3 4
     ((void *)0)
# 1181 "kernel/protocols/net/core/ipv4/etharp.c"
         ;


  return result;
}
# 1199 "kernel/protocols/net/core/ipv4/etharp.c"
static err_t
...
# 1216 "kernel/protocols/net/core/ipv4/etharp.c"
err_t
etharp_request(struct netif *netif, const ip4_addr_t *ipaddr)
{
  do { if ( ((0x00U | 0x40U) & 0x80U) && ((0x00U | 0x40U) & 0x80U) && ((s16_t)((0x00U | 0x40U) & 0x03) >= 0x00)) { do {bk_printf ("etharp_request: sending ARP request.\n") ;} while(0); if ((0x00U | 0x40U) & 0x08U) { while(1); } } } while(0);
