# 1 "kernel/protocols/net/core/ipv4/igmp.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/core/ipv4/igmp.c"
# 83 "kernel/protocols/net/core/ipv4/igmp.c"
...
# 84 "kernel/protocols/net/core/ipv4/igmp.c" 2



# 1 "./kernel/protocols/net/include/lwip/igmp.h" 1
# 44 "./kernel/protocols/net/include/lwip/igmp.h"
...
# 45 "./kernel/protocols/net/include/lwip/igmp.h" 2
# 1 "./kernel/protocols/net/include/lwip/netif.h" 1
# 44 "./kernel/protocols/net/include/lwip/netif.h"
...
# 45 "./kernel/protocols/net/include/lwip/netif.h" 2
...
void igmp_tmr(void);
# 88 "kernel/protocols/net/core/ipv4/igmp.c" 2
...
# 92 "kernel/protocols/net/core/ipv4/igmp.c" 2
...
# 93 "kernel/protocols/net/core/ipv4/igmp.c" 2


# 1 "./kernel/protocols/net/include/lwip/prot/igmp.h" 1
# 74 "./kernel/protocols/net/include/lwip/prot/igmp.h"
...
# 96 "kernel/protocols/net/core/ipv4/igmp.c" 2
...
# 98 "kernel/protocols/net/core/ipv4/igmp.c" 2


# 99 "kernel/protocols/net/core/ipv4/igmp.c"
...
igmp_init(void)
{
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("igmp_init: initializing\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
...
igmp_start(struct netif *netif)
{
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("igmp_start: starting IGMP processing on if %p\n", (void*)netif) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);

  group = igmp_lookup_group(netif, &allsystems);

  if (group != 
# 136 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
              ((void *)0)
# 136 "kernel/protocols/net/core/ipv4/igmp.c"
                  ) {
    group->group_state = 2;
    group->use++;
...
# 141 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
                                 ((void *)0)
# 141 "kernel/protocols/net/core/ipv4/igmp.c"
                                     ) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("igmp_start: igmp_mac_filter(ADD ") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", ((u16_t)(((const u8_t*)(&(&(allsystems))->addr))[0])), ((u16_t)(((const u8_t*)(&(&(allsystems))->addr))[1])), ((u16_t)(((const u8_t*)(&(&(allsystems))->addr))[2])), ((u16_t)(((const u8_t*)(&(&(allsystems))->addr))[3]))) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf (") on if %p\n", (void*)netif) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
...
# 164 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
 ((void *)0)
# 164 "kernel/protocols/net/core/ipv4/igmp.c"
 );

  while (group != 
# 166 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
                 ((void *)0)
# 166 "kernel/protocols/net/core/ipv4/igmp.c"
                     ) {
    struct igmp_group *next = group->next;


    if (netif->igmp_mac_filter != 
# 170 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
                                 ((void *)0)
# 170 "kernel/protocols/net/core/ipv4/igmp.c"
                                     ) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("igmp_stop: igmp_mac_filter(DEL ") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)((&group->group_address) != 
# 172 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
     ((void *)0) 
# 172 "kernel/protocols/net/core/ipv4/igmp.c"
     ? ((u16_t)(((const u8_t*)(&(&group->group_address)->addr))[0])) : 0), (u16_t)((&group->group_address) != 
# 172 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
     ((void *)0) 
# 172 "kernel/protocols/net/core/ipv4/igmp.c"
     ? ((u16_t)(((const u8_t*)(&(&group->group_address)->addr))[1])) : 0), (u16_t)((&group->group_address) != 
# 172 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
     ((void *)0) 
# 172 "kernel/protocols/net/core/ipv4/igmp.c"
     ? ((u16_t)(((const u8_t*)(&(&group->group_address)->addr))[2])) : 0), (u16_t)((&group->group_address) != 
# 172 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
     ((void *)0) 
# 172 "kernel/protocols/net/core/ipv4/igmp.c"
...
igmp_report_groups(struct netif *netif)
{
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("igmp_report_groups: sending IGMP reports on if %p\n", (void*)netif) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);


  if(group != 
# 199 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
             ((void *)0)
# 199 "kernel/protocols/net/core/ipv4/igmp.c"
                 ) {
    group = group->next;
  }

  while (group != 
# 203 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
                 ((void *)0)
# 203 "kernel/protocols/net/core/ipv4/igmp.c"
                     ) {
    igmp_delaying_member(group, (500 /100));
    group = group->next;
  }
}
# 217 "kernel/protocols/net/core/ipv4/igmp.c"
struct igmp_group *
igmp_lookfor_group(struct netif *ifp, const ip4_addr_t *addr)
{
  ...
  while (group != 
# 222 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
                 ((void *)0)
# 222 "kernel/protocols/net/core/ipv4/igmp.c"
                     ) {
  ...
  return 
# 232 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
        ((void *)0)
# 232 "kernel/protocols/net/core/ipv4/igmp.c"
            ;
}
# 243 "kernel/protocols/net/core/ipv4/igmp.c"
struct igmp_group *
igmp_lookup_group(struct netif *ifp, const ip4_addr_t *addr)
{
  ...
  if (group != 
# 250 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
              ((void *)0)
# 250 "kernel/protocols/net/core/ipv4/igmp.c"
                  ) {
  ...
  if (group != 
# 257 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
              ((void *)0)
# 257 "kernel/protocols/net/core/ipv4/igmp.c"
                  ) {
    ((&(group->group_address))->addr = ((addr) == 
# 258 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
   ((void *)0) 
# 258 "kernel/protocols/net/core/ipv4/igmp.c"
   ? 0 : (addr)->addr));
    group->timer = 0;
    group->group_state = 0;
    group->last_reporter_flag = 0;
    group->use = 0;
    group->next = ((struct igmp_group *)(ifp)->client_data[(LWIP_NETIF_CLIENT_DATA_INDEX_IGMP)]);

    (ifp)->client_data[(LWIP_NETIF_CLIENT_DATA_INDEX_IGMP)] = (group);
  }

  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("igmp_lookup_group: %sallocated a new group with address ", (group?"":"impossible to ")) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)((addr) != 
# 269 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
 ((void *)0) 
# 269 "kernel/protocols/net/core/ipv4/igmp.c"
 ? ((u16_t)(((const u8_t*)(&(addr)->addr))[0])) : 0), (u16_t)((addr) != 
# 269 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
 ((void *)0) 
# 269 "kernel/protocols/net/core/ipv4/igmp.c"
 ? ((u16_t)(((const u8_t*)(&(addr)->addr))[1])) : 0), (u16_t)((addr) != 
# 269 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
 ((void *)0) 
# 269 "kernel/protocols/net/core/ipv4/igmp.c"
 ? ((u16_t)(((const u8_t*)(&(addr)->addr))[2])) : 0), (u16_t)((addr) != 
# 269 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
 ((void *)0) 
# 269 "kernel/protocols/net/core/ipv4/igmp.c"
...
igmp_remove_group(struct netif* netif, struct igmp_group *group)
{
  ...
  if (((struct igmp_group *)(netif)->client_data[(LWIP_NETIF_CLIENT_DATA_INDEX_IGMP)]) == group) {
    (netif)->client_data[(LWIP_NETIF_CLIENT_DATA_INDEX_IGMP)] = (group->next);
  } else {

    struct igmp_group *tmpGroup;
    for (tmpGroup = ((struct igmp_group *)(netif)->client_data[(LWIP_NETIF_CLIENT_DATA_INDEX_IGMP)]); tmpGroup != 
# 292 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
                                                       ((void *)0)
# 292 "kernel/protocols/net/core/ipv4/igmp.c"
    ...
    if (tmpGroup == 
# 299 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
                   ((void *)0)
# 299 "kernel/protocols/net/core/ipv4/igmp.c"
                       ) {
      err = ERR_ARG;
    }
  }
...
# 314 "kernel/protocols/net/core/ipv4/igmp.c"
void
igmp_input(struct pbuf *p, struct netif *inp, const ip4_addr_t *dest)
{
  ...
  if (p->len < 8) {
    pbuf_free(p);
    ;
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("igmp_input: length error\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    return;
  }

  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("igmp_input: message from ") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)((&(((const struct ip_hdr*)(ip_data.current_ip4_header))->src)) != 
# 332 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
 ((void *)0) 
# 332 "kernel/protocols/net/core/ipv4/igmp.c"
 ? ((u16_t)(((const u8_t*)(&(&(((const struct ip_hdr*)(ip_data.current_ip4_header))->src))->addr))[0])) : 0), (u16_t)((&(((const struct ip_hdr*)(ip_data.current_ip4_header))->src)) != 
# 332 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
 ((void *)0) 
# 332 "kernel/protocols/net/core/ipv4/igmp.c"
 ? ((u16_t)(((const u8_t*)(&(&(((const struct ip_hdr*)(ip_data.current_ip4_header))->src))->addr))[1])) : 0), (u16_t)((&(((const struct ip_hdr*)(ip_data.current_ip4_header))->src)) != 
# 332 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
 ((void *)0) 
# 332 "kernel/protocols/net/core/ipv4/igmp.c"
 ? ((u16_t)(((const u8_t*)(&(&(((const struct ip_hdr*)(ip_data.current_ip4_header))->src))->addr))[2])) : 0), (u16_t)((&(((const struct ip_hdr*)(ip_data.current_ip4_header))->src)) != 
# 332 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
 ((void *)0) 
# 332 "kernel/protocols/net/core/ipv4/igmp.c"
 ? ((u16_t)(((const u8_t*)(&(&(((const struct ip_hdr*)(ip_data.current_ip4_header))->src))->addr))[3])) : 0)) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf (" to address ") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)((&(((const struct ip_hdr*)(ip_data.current_ip4_header))->dest)) != 
# 334 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
 ((void *)0) 
# 334 "kernel/protocols/net/core/ipv4/igmp.c"
 ? ((u16_t)(((const u8_t*)(&(&(((const struct ip_hdr*)(ip_data.current_ip4_header))->dest))->addr))[0])) : 0), (u16_t)((&(((const struct ip_hdr*)(ip_data.current_ip4_header))->dest)) != 
# 334 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
 ((void *)0) 
# 334 "kernel/protocols/net/core/ipv4/igmp.c"
 ? ((u16_t)(((const u8_t*)(&(&(((const struct ip_hdr*)(ip_data.current_ip4_header))->dest))->addr))[1])) : 0), (u16_t)((&(((const struct ip_hdr*)(ip_data.current_ip4_header))->dest)) != 
# 334 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
 ((void *)0) 
# 334 "kernel/protocols/net/core/ipv4/igmp.c"
 ? ((u16_t)(((const u8_t*)(&(&(((const struct ip_hdr*)(ip_data.current_ip4_header))->dest))->addr))[2])) : 0), (u16_t)((&(((const struct ip_hdr*)(ip_data.current_ip4_header))->dest)) != 
# 334 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
 ((void *)0) 
# 334 "kernel/protocols/net/core/ipv4/igmp.c"
 ? ((u16_t)(((const u8_t*)(&(&(((const struct ip_hdr*)(ip_data.current_ip4_header))->dest))->addr))[3])) : 0)) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  ...
  if (inet_chksum(igmp, p->len)) {
    pbuf_free(p);
    ;
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("igmp_input: checksum error\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    return;
  }
  ...
  if (!group) {
    pbuf_free(p);
    ;
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("igmp_input: IGMP frame not for us\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    return;
  }
...
# 361 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
                                            ((void *)0) 
# 361 "kernel/protocols/net/core/ipv4/igmp.c"
                                            || ((*(&igmp->igmp_group_address)).addr == ((u32_t)0x00000000UL)))) {

      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("igmp_input: General IGMP_MEMB_QUERY on \"ALL SYSTEMS\" address (224.0.0.1) [igmp_maxresp=%i]\n", (int)(igmp->igmp_maxresp)) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);

      if (igmp->igmp_maxresp == 0) {
        ;
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("igmp_input: got an all hosts query with time== 0 - this is V1 and not implemented - treat as v2\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      ...
      if(groupref != 
# 377 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
                    ((void *)0)
# 377 "kernel/protocols/net/core/ipv4/igmp.c"
                        ) {
...
# 387 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
          ((void *)0) 
# 387 "kernel/protocols/net/core/ipv4/igmp.c"
          || ((*(&igmp->igmp_group_address)).addr == ((u32_t)0x00000000UL)))) {
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("igmp_input: IGMP_MEMB_QUERY to a specific group ") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)((&igmp->igmp_group_address) != 
# 389 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
       ((void *)0) 
# 389 "kernel/protocols/net/core/ipv4/igmp.c"
       ? ((u16_t)(((const u8_t*)(&(&igmp->igmp_group_address)->addr))[0])) : 0), (u16_t)((&igmp->igmp_group_address) != 
# 389 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
       ((void *)0) 
# 389 "kernel/protocols/net/core/ipv4/igmp.c"
       ? ((u16_t)(((const u8_t*)(&(&igmp->igmp_group_address)->addr))[1])) : 0), (u16_t)((&igmp->igmp_group_address) != 
# 389 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
       ((void *)0) 
# 389 "kernel/protocols/net/core/ipv4/igmp.c"
       ? ((u16_t)(((const u8_t*)(&(&igmp->igmp_group_address)->addr))[2])) : 0), (u16_t)((&igmp->igmp_group_address) != 
# 389 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
       ((void *)0) 
# 389 "kernel/protocols/net/core/ipv4/igmp.c"
       ? ((u16_t)(((const u8_t*)(&(&igmp->igmp_group_address)->addr))[3])) : 0)) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        if (((dest)->addr == (&allsystems)->addr)) {
          ...
          do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf (" using \"ALL SYSTEMS\" address (224.0.0.1) [igmp_maxresp=%i]\n", (int)(igmp->igmp_maxresp)) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);

          ((groupaddr).addr = (igmp->igmp_group_address).addr);
          group = igmp_lookfor_group(inp, &groupaddr);
        } else {
          do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf (" with the group address as destination [igmp_maxresp=%i]\n", (int)(igmp->igmp_maxresp)) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        }

        if (group != 
# 400 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
                    ((void *)0)
# 400 "kernel/protocols/net/core/ipv4/igmp.c"
                        ) {
          ;
    ...
    break;
  case 0x16:
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("igmp_input: IGMP_V2_MEMB_REPORT\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    ;
    ...
    break;
  default:
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("igmp_input: unexpected msg %d in state %d on group %p on if %p\n", igmp->igmp_msgtype, group->group_state, (void*)&group, (void*)inp) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
                                                                         ;
    ;
    break;
  }
...
# 440 "kernel/protocols/net/core/ipv4/igmp.c"
err_t
igmp_joingroup(const ip4_addr_t *ifaddr, const ip4_addr_t *groupaddr)
{
  ...
  do { if (!((((groupaddr)->addr & ((((0xf0000000UL) & 0xff) << 24) | (((0xf0000000UL) & 0xff00) << 8) | (((0xf0000000UL) & 0xff0000UL) >> 8) | (((0xf0000000UL) & 0xff000000UL) >> 24))) == ((((0xe0000000UL) & 0xff) << 24) | (((0xe0000000UL) & 0xff00) << 8) | (((0xe0000000UL) & 0xff0000UL) >> 8) | (((0xe0000000UL) & 0xff000000UL) >> 24))))) { do {bk_printf ("igmp_joingroup: attempt to join non-multicast address") ;} while(0); return ERR_VAL;;}} while(0);
  do { if (!((!((groupaddr)->addr == (&allsystems)->addr)))) { do {bk_printf ("igmp_joingroup: attempt to join allsystems address") ;} while(0); return ERR_VAL;;}} while(0);


  netif = netif_list;
  while (netif != 
# 452 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
                 ((void *)0)
# 452 "kernel/protocols/net/core/ipv4/igmp.c"
                     ) {

    if ((netif->flags & 0x20U) && ((((ifaddr) == 
# 454 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
                                             ((void *)0) 
# 454 "kernel/protocols/net/core/ipv4/igmp.c"
...
# 477 "kernel/protocols/net/core/ipv4/igmp.c"
err_t
igmp_joingroup_netif(struct netif *netif, const ip4_addr_t *groupaddr)
{
  ...
  do { if (!((((groupaddr)->addr & ((((0xf0000000UL) & 0xff) << 24) | (((0xf0000000UL) & 0xff00) << 8) | (((0xf0000000UL) & 0xff0000UL) >> 8) | (((0xf0000000UL) & 0xff000000UL) >> 24))) == ((((0xe0000000UL) & 0xff) << 24) | (((0xe0000000UL) & 0xff00) << 8) | (((0xe0000000UL) & 0xff0000UL) >> 8) | (((0xe0000000UL) & 0xff000000UL) >> 24))))) { do {bk_printf ("igmp_joingroup_netif: attempt to join non-multicast address") ;} while(0); return ERR_VAL;;}} while(0);
  do { if (!((!((groupaddr)->addr == (&allsystems)->addr)))) { do {bk_printf ("igmp_joingroup_netif: attempt to join allsystems address") ;} while(0); return ERR_VAL;;}} while(0);


  do { if (!(netif->flags & 0x20U)) { do {bk_printf ("igmp_joingroup_netif: attempt to join on non-IGMP netif") ;} while(0); return ERR_VAL;;}} while(0);


  group = igmp_lookup_group(netif, groupaddr);

  if (group != 
# 492 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
              ((void *)0)
# 492 "kernel/protocols/net/core/ipv4/igmp.c"
                  ) {

    if (group->group_state != 0) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("igmp_joingroup_netif: join to group not in state IGMP_GROUP_NON_MEMBER\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    } else {

      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("igmp_joingroup_netif: join to new group: ") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)((groupaddr) != 
# 499 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
     ((void *)0) 
# 499 "kernel/protocols/net/core/ipv4/igmp.c"
     ? ((u16_t)(((const u8_t*)(&(groupaddr)->addr))[0])) : 0), (u16_t)((groupaddr) != 
# 499 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
     ((void *)0) 
# 499 "kernel/protocols/net/core/ipv4/igmp.c"
     ? ((u16_t)(((const u8_t*)(&(groupaddr)->addr))[1])) : 0), (u16_t)((groupaddr) != 
# 499 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
     ((void *)0) 
# 499 "kernel/protocols/net/core/ipv4/igmp.c"
     ? ((u16_t)(((const u8_t*)(&(groupaddr)->addr))[2])) : 0), (u16_t)((groupaddr) != 
# 499 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
     ((void *)0) 
# 499 "kernel/protocols/net/core/ipv4/igmp.c"
...
# 503 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
                                                       ((void *)0)
# 503 "kernel/protocols/net/core/ipv4/igmp.c"
                                                           )) {
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("igmp_joingroup_netif: igmp_mac_filter(ADD ") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)((groupaddr) != 
# 505 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
       ((void *)0) 
# 505 "kernel/protocols/net/core/ipv4/igmp.c"
       ? ((u16_t)(((const u8_t*)(&(groupaddr)->addr))[0])) : 0), (u16_t)((groupaddr) != 
# 505 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
       ((void *)0) 
# 505 "kernel/protocols/net/core/ipv4/igmp.c"
...
# 505 "kernel/protocols/net/core/ipv4/igmp.c"
    ...
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("igmp_joingroup_netif: Not enough memory to join to group\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    return ERR_MEM;
  }
}
# 536 "kernel/protocols/net/core/ipv4/igmp.c"
err_t
igmp_leavegroup(const ip4_addr_t *ifaddr, const ip4_addr_t *groupaddr)
{
  ...
  do { if (!((((groupaddr)->addr & ((((0xf0000000UL) & 0xff) << 24) | (((0xf0000000UL) & 0xff00) << 8) | (((0xf0000000UL) & 0xff0000UL) >> 8) | (((0xf0000000UL) & 0xff000000UL) >> 24))) == ((((0xe0000000UL) & 0xff) << 24) | (((0xe0000000UL) & 0xff00) << 8) | (((0xe0000000UL) & 0xff0000UL) >> 8) | (((0xe0000000UL) & 0xff000000UL) >> 24))))) { do {bk_printf ("igmp_leavegroup: attempt to leave non-multicast address") ;} while(0); return ERR_VAL;;}} while(0);
  do { if (!((!((groupaddr)->addr == (&allsystems)->addr)))) { do {bk_printf ("igmp_leavegroup: attempt to leave allsystems address") ;} while(0); return ERR_VAL;;}} while(0);


  netif = netif_list;
  while (netif != 
# 548 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
                 ((void *)0)
# 548 "kernel/protocols/net/core/ipv4/igmp.c"
                     ) {

    if ((netif->flags & 0x20U) && ((((ifaddr) == 
# 550 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
                                             ((void *)0) 
# 550 "kernel/protocols/net/core/ipv4/igmp.c"
                                             || ((*(ifaddr)).addr == ((u32_t)0x00000000UL))) || ((((const ip4_addr_t*)(&((netif)->ip_addr))))->addr == (ifaddr)->addr)))) {
...
# 572 "kernel/protocols/net/core/ipv4/igmp.c"
err_t
igmp_leavegroup_netif(struct netif *netif, const ip4_addr_t *groupaddr)
{
  ...
  do { if (!((((groupaddr)->addr & ((((0xf0000000UL) & 0xff) << 24) | (((0xf0000000UL) & 0xff00) << 8) | (((0xf0000000UL) & 0xff0000UL) >> 8) | (((0xf0000000UL) & 0xff000000UL) >> 24))) == ((((0xe0000000UL) & 0xff) << 24) | (((0xe0000000UL) & 0xff00) << 8) | (((0xe0000000UL) & 0xff0000UL) >> 8) | (((0xe0000000UL) & 0xff000000UL) >> 24))))) { do {bk_printf ("igmp_leavegroup_netif: attempt to leave non-multicast address") ;} while(0); return ERR_VAL;;}} while(0);
  do { if (!((!((groupaddr)->addr == (&allsystems)->addr)))) { do {bk_printf ("igmp_leavegroup_netif: attempt to leave allsystems address") ;} while(0); return ERR_VAL;;}} while(0);


  do { if (!(netif->flags & 0x20U)) { do {bk_printf ("igmp_leavegroup_netif: attempt to leave on non-IGMP netif") ;} while(0); return ERR_VAL;;}} while(0);


  group = igmp_lookfor_group(netif, groupaddr);

  if (group != 
# 587 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
              ((void *)0)
# 587 "kernel/protocols/net/core/ipv4/igmp.c"
                  ) {

    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("igmp_leavegroup_netif: Leaving group: ") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)((groupaddr) != 
# 590 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
   ((void *)0) 
# 590 "kernel/protocols/net/core/ipv4/igmp.c"
   ? ((u16_t)(((const u8_t*)(&(groupaddr)->addr))[0])) : 0), (u16_t)((groupaddr) != 
# 590 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
   ((void *)0) 
# 590 "kernel/protocols/net/core/ipv4/igmp.c"
   ...
   ? ((u16_t)(((const u8_t*)(&(groupaddr)->addr))[3])) : 0)) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    ...
    if (group->use <= 1) {
      ...
      if (group->last_reporter_flag) {
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("igmp_leavegroup_netif: sending leaving group\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        ;
      ...
      if (netif->igmp_mac_filter != 
# 606 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
                                   ((void *)0)
# 606 "kernel/protocols/net/core/ipv4/igmp.c"
                                       ) {
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("igmp_leavegroup_netif: igmp_mac_filter(DEL ") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)((groupaddr) != 
# 608 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
       ((void *)0) 
# 608 "kernel/protocols/net/core/ipv4/igmp.c"
       ? ((u16_t)(((const u8_t*)(&(groupaddr)->addr))[0])) : 0), (u16_t)((groupaddr) != 
# 608 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
       ((void *)0) 
# 608 "kernel/protocols/net/core/ipv4/igmp.c"
...
# 608 "kernel/protocols/net/core/ipv4/igmp.c"
    ...
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("igmp_leavegroup_netif: not member of group\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    return ERR_VAL;
  }
}
...
igmp_tmr(void)
{
  ...
  while (netif != 
# 635 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
                 ((void *)0)
# 635 "kernel/protocols/net/core/ipv4/igmp.c"
                     ) {
    struct igmp_group *group = ((struct igmp_group *)(netif)->client_data[(LWIP_NETIF_CLIENT_DATA_INDEX_IGMP)]);

    while (group != 
# 638 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
                   ((void *)0)
# 638 "kernel/protocols/net/core/ipv4/igmp.c"
                       ) {
      if (group->timer > 0) {
        group->timer--;
        if (group->timer == 0) {
...
igmp_timeout(struct netif *netif, struct igmp_group *group)
{
  ...
  if ((group->group_state == 1) &&
    ...
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("igmp_timeout: report membership for group with address ") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", (u16_t)((&(group->group_address)) != 
# 665 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
   ((void *)0) 
# 665 "kernel/protocols/net/core/ipv4/igmp.c"
   ? ((u16_t)(((const u8_t*)(&(&(group->group_address))->addr))[0])) : 0), (u16_t)((&(group->group_address)) != 
# 665 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
   ((void *)0) 
# 665 "kernel/protocols/net/core/ipv4/igmp.c"
...
# 682 "kernel/protocols/net/core/ipv4/igmp.c"
static void
igmp_start_timer(struct igmp_group *group, u8_t max_time)
{

  group->timer = max_time > 2 ? (((u32_t)rand()) % max_time) : 1;
...
# 731 "kernel/protocols/net/core/ipv4/igmp.c"
static err_t
...
{
  struct pbuf* p = 
# 751 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
                         ((void *)0)
# 751 "kernel/protocols/net/core/ipv4/igmp.c"
                             ;
  struct igmp_msg* igmp = 
# 752 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
                         ((void *)0)
# 752 "kernel/protocols/net/core/ipv4/igmp.c"
                             ;
  ip4_addr_t src = *((&ip_addr_any));
  ip4_addr_t* dest = 
# 754 "kernel/protocols/net/core/ipv4/igmp.c" 3 4
                     ((void *)0)
# 754 "kernel/protocols/net/core/ipv4/igmp.c"
                         ;
  ...
  if (p) {
    ...
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("igmp_send: not enough memory for igmp_send\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    ;
  }
}
