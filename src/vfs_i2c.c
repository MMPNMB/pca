...
# 1 "././kernel/vfs/device/../include/device/vfs_i2c.h" 1
# 12 "././kernel/vfs/device/../include/device/vfs_i2c.h"
...
# 13 "././kernel/vfs/device/../include/device/vfs_i2c.h" 2


extern const struct file_ops i2c_ops;
# 24 "././kernel/vfs/device/../include/device/vfs_i2c.h"
int vfs_i2c_open(inode_t *inode, file_t *fp);
# 33 "././kernel/vfs/device/../include/device/vfs_i2c.h"
int vfs_i2c_close(file_t *fp);
# 45 "././kernel/vfs/device/../include/device/vfs_i2c.h"
ssize_t vfs_i2c_read(file_t *fp, void *buf, size_t nbytes);
# 57 "././kernel/vfs/device/../include/device/vfs_i2c.h"
ssize_t vfs_i2c_write(file_t *fp, const void *buf, size_t nbytes);
# 6 "kernel/vfs/device/vfs_i2c.c" 2
...
# 7 "kernel/vfs/device/vfs_i2c.c" 2
# 1 "././kernel/vfs/device/../include/vfs_err.h" 1
# 8 "kernel/vfs/device/vfs_i2c.c" 2
...
int vfs_i2c_open(inode_t *inode, file_t *fp)
{
    int ret = -1;
    i2c_dev_t *i2c_dev = 
# 21 "kernel/vfs/device/vfs_i2c.c" 3 4
                        ((void *)0)
# 21 "kernel/vfs/device/vfs_i2c.c"
                            ;


    if ((fp != 
# 24 "kernel/vfs/device/vfs_i2c.c" 3 4
              ((void *)0)
# 24 "kernel/vfs/device/vfs_i2c.c"
                  ) && (fp->node != 
# 24 "kernel/vfs/device/vfs_i2c.c" 3 4
                                    ((void *)0)
# 24 "kernel/vfs/device/vfs_i2c.c"
        ...
        ret = -
# 38 "kernel/vfs/device/vfs_i2c.c" 3
              22
# 38 "kernel/vfs/device/vfs_i2c.c"
                    ;
    }
...
int vfs_i2c_close(file_t *fp)
{
    int ret = -1;
    i2c_dev_t *i2c_dev = 
# 47 "kernel/vfs/device/vfs_i2c.c" 3 4
                        ((void *)0)
# 47 "kernel/vfs/device/vfs_i2c.c"
                            ;


    if ((fp != 
# 50 "kernel/vfs/device/vfs_i2c.c" 3 4
              ((void *)0)
# 50 "kernel/vfs/device/vfs_i2c.c"
                  ) && (fp->node != 
# 50 "kernel/vfs/device/vfs_i2c.c" 3 4
                                    ((void *)0)
# 50 "kernel/vfs/device/vfs_i2c.c"
        ...
        ret = -
# 72 "kernel/vfs/device/vfs_i2c.c" 3
              22
# 72 "kernel/vfs/device/vfs_i2c.c"
                    ;
    }
...
ssize_t vfs_i2c_read(file_t *fp, void *buf, size_t nbytes)
{
    int ret = -1;
    i2c_dev_t *i2c_dev = 
# 81 "kernel/vfs/device/vfs_i2c.c" 3 4
                        ((void *)0)
# 81 "kernel/vfs/device/vfs_i2c.c"
                            ;
    uint16_t dev_addr = 0;


    if ((fp != 
# 85 "kernel/vfs/device/vfs_i2c.c" 3 4
              ((void *)0)
# 85 "kernel/vfs/device/vfs_i2c.c"
                  ) && (fp->node != 
# 85 "kernel/vfs/device/vfs_i2c.c" 3 4
                                    ((void *)0)
# 85 "kernel/vfs/device/vfs_i2c.c"
        ...
        if (ret == 0) {
            ...
            ret = hal_i2c_master_recv(i2c_dev, dev_addr, (uint8_t *)buf, nbytes, 0xFFFFFFFFU);
        ...
        ret = -
# 110 "kernel/vfs/device/vfs_i2c.c" 3
              22
# 110 "kernel/vfs/device/vfs_i2c.c"
                    ;
    }
...
ssize_t vfs_i2c_write(file_t *fp, const void *buf, size_t nbytes)
{
    int ret = -1;
    i2c_dev_t *i2c_dev = 
# 119 "kernel/vfs/device/vfs_i2c.c" 3 4
                        ((void *)0)
# 119 "kernel/vfs/device/vfs_i2c.c"
                            ;
    uint16_t dev_addr = 0;


    if ((fp != 
# 123 "kernel/vfs/device/vfs_i2c.c" 3 4
              ((void *)0)
# 123 "kernel/vfs/device/vfs_i2c.c"
                  ) && (fp->node != 
# 123 "kernel/vfs/device/vfs_i2c.c" 3 4
                                    ((void *)0)
# 123 "kernel/vfs/device/vfs_i2c.c"
        ...
        if (ret == 0) {
            ...
            ret = hal_i2c_master_send(i2c_dev, dev_addr, (const uint8_t *)buf, nbytes, 0xFFFFFFFFU);
        ...
        ret = -
# 148 "kernel/vfs/device/vfs_i2c.c" 3
              22
# 148 "kernel/vfs/device/vfs_i2c.c"
                    ;
    }
