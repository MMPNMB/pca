# 1 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c"
...
# 6 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c" 2
...
# 7 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c" 2
...
static uint8_t _g_test_data[(141)] = {
    0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08,
    0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08,
    0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08,
    0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08,
...
int ali_crypto_hmac_test(void)
{
    ...
    hash_type_t type;
    void *hmac_ctx = 
# 78 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c" 3 4
                    ((void *)0)
# 78 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c"
                        ;
    uint32_t hmac_ctx_size;
    uint8_t md[MAX_HASH_SIZE];


    result = ali_hmac_get_ctx_size(MD5, 
# 83 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c" 3 4
                                       ((void *)0)
# 83 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c"
                                           );
    ...
    result = ali_hmac_init(MD5, test_key, (16), 
# 91 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c" 3 4
                                                        ((void *)0)
# 91 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c"
                                                            );
    if (result == ALI_CRYPTO_SUCCESS) {
        return -1;
    }
    result = ali_hmac_init(HASH_NONE, test_key, (16), 
# 95 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c" 3 4
                                                              ((void *)0)
# 95 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c"
                                                                  );
    if (result == ALI_CRYPTO_SUCCESS) {
        return -1;
    }
    result = ali_hmac_update(_g_test_data, 13, 
# 99 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c" 3 4
                                              ((void *)0)
# 99 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c"
                                                  );
    if (result == ALI_CRYPTO_SUCCESS) {
        return -1;
    }
    result = ali_hmac_final(md, 
# 103 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c" 3 4
                               ((void *)0)
# 103 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c"
                                   );
    if (result == ALI_CRYPTO_SUCCESS) {
        return -1;
    }
    result = ali_hmac_digest(MD5, 
# 107 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c" 3 4
                                 ((void *)0)
# 107 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c"
                                     , (16),
                             _g_test_data, (141), md);
    if (result == ALI_CRYPTO_SUCCESS) {
        return -1;
    }
    result = ali_hmac_reset(
# 112 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c" 3 4
                           ((void *)0)
# 112 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c"
                               );
    if (result == ALI_CRYPTO_SUCCESS) {
        return -1;
    }
    result = ali_hmac_copy_context(
# 116 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c" 3 4
                                  ((void *)0)
# 116 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c"
                                      , 
# 116 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c" 3 4
                                        ((void *)0)
# 116 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c"
    ...
    for (type = SHA1; type <= MD5; type++) {
        if (type == SHA512 || type == SHA384) {
            printf("I %s %d: ""hmac not support hash 384 512\n", __FUNCTION__, 123);
            continue;
        }
        result = ali_hmac_get_ctx_size(type, (size_t *)(&hmac_ctx_size));
        if (result != ALI_CRYPTO_SUCCESS) {
            do { printf("E %s %d: ""get ctx size fail(%08x)\n", __FUNCTION__, 128, result); result = result; goto _OUT; } while (0);;
        }

        hmac_ctx = malloc(hmac_ctx_size);
        if (hmac_ctx == 
# 132 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c" 3 4
                       ((void *)0)
# 132 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c"
                           ) {
            do { printf("E %s %d: ""kmalloc(%08x) fail\n", __FUNCTION__, 133, (int)hmac_ctx_size); result = ALI_CRYPTO_OUTOFMEM; goto _OUT; } while (0);;
        }
        memset(hmac_ctx, 0, hmac_ctx_size);

        {
            result = ali_hmac_init(type, test_key, (16), hmac_ctx);
            if (result != ALI_CRYPTO_SUCCESS) {
                do { printf("E %s %d: ""init fail(%08x)", __FUNCTION__, 140, result); result = result; goto _OUT; } while (0);;
            }


            result = ali_hmac_update(
# 144 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c" 3 4
                                    ((void *)0)
# 144 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c"
                                        , 13, hmac_ctx);
            if (result == ALI_CRYPTO_SUCCESS) {
                goto _OUT;
            }
            ...
            if (result != ALI_CRYPTO_SUCCESS) {
                do { printf("E %s %d: ""update 1th fail(%08x)", __FUNCTION__, 151, result); result = result; goto _OUT; } while (0);;
            }
            result = ali_hmac_update(_g_test_data + 13, 63, hmac_ctx);
            if (result != ALI_CRYPTO_SUCCESS) {
                do { printf("E %s %d: ""update 2th fail(%08x)", __FUNCTION__, 155, result); result = result; goto _OUT; } while (0);;
            }
            result = ali_hmac_update(_g_test_data + 13 + 63, 65, hmac_ctx);
            if (result != ALI_CRYPTO_SUCCESS) {
                do { printf("E %s %d: ""update 3th fail(%08x)", __FUNCTION__, 159, result); result = result; goto _OUT; } while (0);;
            }

            result = ali_hmac_final(md, hmac_ctx);
            if (result != ALI_CRYPTO_SUCCESS) {
                do { printf("E %s %d: ""final fail(%08x)", __FUNCTION__, 164, result); result = result; goto _OUT; } while (0);;
            }


            result = ali_hmac_digest(HASH_NONE, test_key, (16),
                                     _g_test_data, (141), md);
            if (result == ALI_CRYPTO_SUCCESS) {
                goto _OUT;
            }

            result = ali_hmac_digest(type, test_key, (16),
                                     _g_test_data, (141), md);
            if (result != ALI_CRYPTO_SUCCESS) {
                do { printf("E %s %d: ""digest fail(%08x)", __FUNCTION__, 177, result); result = result; goto _OUT; } while (0);;
            }
        }
        ...
        free(hmac_ctx);
        hmac_ctx = 
# 184 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c" 3 4
                  ((void *)0)
# 184 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c"
                      ;

        if (type == SHA1) {
            if (memcmp(md, hmac_sha1, SHA1_HASH_SIZE)) {
                ali_crypto_print_data("hmac-sha1", md, SHA1_HASH_SIZE);
                do { printf("E %s %d: ""HMAC-SHA1 test fail!\n", __FUNCTION__, 189); result = -1; goto _OUT; } while (0);;
            } else {
                printf("I %s %d: ""HMAC-SHA1 test success!\n", __FUNCTION__, 191);
            }
        } else if (type == SHA224) {
            if (memcmp(md, hmac_sha224, SHA224_HASH_SIZE)) {
                ali_crypto_print_data("hmac-sha224", md, SHA224_HASH_SIZE);
                do { printf("E %s %d: ""HMAC-SHA224 test fail!\n", __FUNCTION__, 196); result = -1; goto _OUT; } while (0);;
            } else {
                printf("I %s %d: ""HMAC-SHA224 test success!\n", __FUNCTION__, 198);
            }
        } else if (type == SHA256) {
            if (memcmp(md, hmac_sha256, SHA256_HASH_SIZE)) {
                ali_crypto_print_data("hmac-sha256", md, SHA256_HASH_SIZE);
                do { printf("E %s %d: ""HMAC-SHA256 test fail!\n", __FUNCTION__, 203); result = -1; goto _OUT; } while (0);;
            } else {
                printf("I %s %d: ""HMAC-SHA256 test success!\n", __FUNCTION__, 205);
            }
# 222 "security/alicrypto/./libalicrypto/test/ali_crypto_test_hmac.c"
        } else if (type == MD5) {
            if (memcmp(md, hmac_md5, MD5_HASH_SIZE)) {
                ali_crypto_print_data("hmac-md5", md, MD5_HASH_SIZE);
                do { printf("E %s %d: ""HMAC-MD5 test fail!\n", __FUNCTION__, 225); result = -1; goto _OUT; } while (0);;
            } else {
                printf("I %s %d: ""HMAC-MD5 test success!\n", __FUNCTION__, 227);
            }
        }
    }
