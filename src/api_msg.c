# 1 "kernel/protocols/net/api/api_msg.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/api/api_msg.c"
# 39 "kernel/protocols/net/api/api_msg.c"
...
# 40 "kernel/protocols/net/api/api_msg.c" 2



# 1 "./kernel/protocols/net/include/lwip/priv/api_msg.h" 1
# 46 "./kernel/protocols/net/include/lwip/priv/api_msg.h"
# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/lib/gcc/arm-none-eabi/5.4.1/include/stddef.h" 1 3 4
# 47 "./kernel/protocols/net/include/lwip/priv/api_msg.h" 2
...
# 49 "./kernel/protocols/net/include/lwip/priv/api_msg.h" 2
...
# 50 "./kernel/protocols/net/include/lwip/priv/api_msg.h" 2
...
# 51 "./kernel/protocols/net/include/lwip/priv/api_msg.h" 2
...
# 49 "./kernel/protocols/net/include/lwip/netif.h"
...
# 50 "./kernel/protocols/net/include/lwip/netif.h" 2
...
void igmp_tmr(void);
# 52 "./kernel/protocols/net/include/lwip/priv/api_msg.h" 2
...
# 53 "./kernel/protocols/net/include/lwip/priv/api_msg.h" 2
...
# 54 "./kernel/protocols/net/include/lwip/priv/api_msg.h" 2
# 80 "./kernel/protocols/net/include/lwip/priv/api_msg.h"
struct api_msg {
...
# 160 "./kernel/protocols/net/include/lwip/priv/api_msg.h"
struct dns_api_msg {
...
# 44 "kernel/protocols/net/api/api_msg.c" 2
...
# 46 "kernel/protocols/net/api/api_msg.c" 2
...
# 47 "kernel/protocols/net/api/api_msg.c" 2
# 1 "./kernel/protocols/net/include/lwip/tcp.h" 1
# 48 "./kernel/protocols/net/include/lwip/tcp.h"
...
# 48 "kernel/protocols/net/api/api_msg.c" 2
...
# 49 "kernel/protocols/net/api/api_msg.c" 2
...
err_t dns_gethostbyname_addrtype(const char *hostname, ip_addr_t *addr,
                                   dns_found_callback found, void *callback_arg,
                                   u8_t dns_addrtype);
# 53 "kernel/protocols/net/api/api_msg.c" 2
# 1 "./kernel/protocols/net/include/lwip/mld6.h" 1
# 54 "kernel/protocols/net/api/api_msg.c" 2
...
# 57 "kernel/protocols/net/api/api_msg.c" 2
# 76 "kernel/protocols/net/api/api_msg.c"
...
# 87 "kernel/protocols/net/api/api_msg.c"
u8_t netconn_aborted;
# 98 "kernel/protocols/net/api/api_msg.c"
static u8_t
    ...
    const ip_addr_t *addr)
{
  ...
  if ((conn != 
# 109 "kernel/protocols/net/api/api_msg.c" 3 4
              ((void *)0)
# 109 "kernel/protocols/net/api/api_msg.c"
                  ) && aos_queue_is_valid(&conn->recvmbox)) {
# 118 "kernel/protocols/net/api/api_msg.c"
    q = pbuf_alloc(PBUF_RAW, p->tot_len, PBUF_RAM);
    if (q != 
# 119 "kernel/protocols/net/api/api_msg.c" 3 4
            ((void *)0)
# 119 "kernel/protocols/net/api/api_msg.c"
                ) {
      if (pbuf_copy(q, p) != ERR_OK) {
        pbuf_free(q);
        q = 
# 122 "kernel/protocols/net/api/api_msg.c" 3 4
           ((void *)0)
# 122 "kernel/protocols/net/api/api_msg.c"
               ;
      }
    }

    if (q != 
# 126 "kernel/protocols/net/api/api_msg.c" 3 4
            ((void *)0)
# 126 "kernel/protocols/net/api/api_msg.c"
                ) {
      u16_t len;
      buf = (struct netbuf *)memp_malloc(MEMP_NETBUF);
      if (buf == 
# 129 "kernel/protocols/net/api/api_msg.c" 3 4
                ((void *)0)
# 129 "kernel/protocols/net/api/api_msg.c"
                    ) {
        pbuf_free(q);
        return 0;
      }
...
# 164 "kernel/protocols/net/api/api_msg.c"
static void
   ...
   const ip_addr_t *addr, u16_t port)
{
  ...
  if ((conn == 
# 186 "kernel/protocols/net/api/api_msg.c" 3 4
              ((void *)0)
# 186 "kernel/protocols/net/api/api_msg.c"
                  ) || !aos_queue_is_valid(&conn->recvmbox)) {
  ...
  buf = (struct netbuf *)memp_malloc(MEMP_NETBUF);
  if (buf == 
# 193 "kernel/protocols/net/api/api_msg.c" 3 4
            ((void *)0)
# 193 "kernel/protocols/net/api/api_msg.c"
                ) {
    pbuf_free(p);
    return;
  } else {
    ...
    buf->ptr = p;
    ((&buf->addr)->addr = ((addr) == 
# 199 "kernel/protocols/net/api/api_msg.c" 3 4
   ((void *)0) 
# 199 "kernel/protocols/net/api/api_msg.c"
   ? 0 : (addr)->addr));
    buf->port = port;
# 212 "kernel/protocols/net/api/api_msg.c"
  }
...
# 235 "kernel/protocols/net/api/api_msg.c"
static err_t
recv_tcp(void *arg, struct tcp_pcb *pcb, struct pbuf *p, err_t err)
{
  ...
  if (conn == 
# 246 "kernel/protocols/net/api/api_msg.c" 3 4
             ((void *)0)
# 246 "kernel/protocols/net/api/api_msg.c"
                 ) {
    return ERR_VAL;
  }
  ;

  if (!aos_queue_is_valid(&conn->recvmbox)) {

    if (p != 
# 253 "kernel/protocols/net/api/api_msg.c" 3 4
            ((void *)0)
# 253 "kernel/protocols/net/api/api_msg.c"
                ) {
  ...
  if (err != ERR_OK) {
    do { if ((conn) != 
# 265 "kernel/protocols/net/api/api_msg.c" 3 4
   ((void *)0)
# 265 "kernel/protocols/net/api/api_msg.c"
  ...
  if (p != 
# 268 "kernel/protocols/net/api/api_msg.c" 3 4
          ((void *)0)
# 268 "kernel/protocols/net/api/api_msg.c"
              ) {
    len = p->tot_len;
  } else {
    len = 0;
...
# 299 "kernel/protocols/net/api/api_msg.c"
static err_t
poll_tcp(void *arg, struct tcp_pcb *pcb)
{
  ...
  if (conn->flags & 0x10) {
    ...
    if ((conn->pcb.tcp != 
# 323 "kernel/protocols/net/api/api_msg.c" 3 4
                         ((void *)0)
# 323 "kernel/protocols/net/api/api_msg.c"
                             ) && ((((conn->pcb.tcp)->snd_buf)) > (((((((((10*(1500 - 40)))/2)) > ((2 * (1500 - 40)) + 1)) ? ((((10*(1500 - 40)))/2)) : ((2 * (1500 - 40)) + 1))) < (((10*(1500 - 40))) - 1)) ? (((((((10*(1500 - 40)))/2)) > ((2 * (1500 - 40)) + 1)) ? ((((10*(1500 - 40)))/2)) : ((2 * (1500 - 40)) + 1))) : (((10*(1500 - 40))) - 1))) &&
      (((conn->pcb.tcp)->snd_queuelen) < ((((((20))/2)) > (5)) ? ((((20))/2)) : (5)))) {
      conn->flags &= ~0x10;
...
# 340 "kernel/protocols/net/api/api_msg.c"
static err_t
sent_tcp(void *arg, struct tcp_pcb *pcb, u16_t len)
{
  ...
  if (conn) {
    ...
    if ((conn->pcb.tcp != 
# 357 "kernel/protocols/net/api/api_msg.c" 3 4
                         ((void *)0)
# 357 "kernel/protocols/net/api/api_msg.c"
                             ) && ((((conn->pcb.tcp)->snd_buf)) > (((((((((10*(1500 - 40)))/2)) > ((2 * (1500 - 40)) + 1)) ? ((((10*(1500 - 40)))/2)) : ((2 * (1500 - 40)) + 1))) < (((10*(1500 - 40))) - 1)) ? (((((((10*(1500 - 40)))/2)) > ((2 * (1500 - 40)) + 1)) ? ((((10*(1500 - 40)))/2)) : ((2 * (1500 - 40)) + 1))) : (((10*(1500 - 40))) - 1))) &&
      (((conn->pcb.tcp)->snd_queuelen) < ((((((20))/2)) > (5)) ? ((((20))/2)) : (5)))) {
      conn->flags &= ~0x10;
...
# 374 "kernel/protocols/net/api/api_msg.c"
static void
err_tcp(void *arg, err_t err)
{
  ...
  conn->pcb.tcp = 
# 383 "kernel/protocols/net/api/api_msg.c" 3 4
                 ((void *)0)
# 383 "kernel/protocols/net/api/api_msg.c"
                     ;
  ...
  if (old_state == NETCONN_CLOSE) {
    ...
    err = ERR_OK;
    do { if ((conn) != 
# 392 "kernel/protocols/net/api/api_msg.c" 3 4
   ((void *)0)
# 392 "kernel/protocols/net/api/api_msg.c"
...
# 410 "kernel/protocols/net/api/api_msg.c" 3 4
                                     ((void *)0)
# 410 "kernel/protocols/net/api/api_msg.c"
                                         );
  }

  if (aos_queue_is_valid(&conn->acceptmbox)) {

    sys_mbox_trypost(&conn->acceptmbox, 
# 415 "kernel/protocols/net/api/api_msg.c" 3 4
                                       ((void *)0)
# 415 "kernel/protocols/net/api/api_msg.c"
                                           );
  }
  ...
  if ((old_state == NETCONN_WRITE) || (old_state == NETCONN_CLOSE) ||
    ...
    if (!was_nonblocking_connect) {
      ...
      ;
      conn->current_msg = 
# 432 "kernel/protocols/net/api/api_msg.c" 3 4
                         ((void *)0)
# 432 "kernel/protocols/net/api/api_msg.c"
                             ;

      do { if ((conn) != 
# 434 "kernel/protocols/net/api/api_msg.c" 3 4
     ((void *)0)
# 434 "kernel/protocols/net/api/api_msg.c"
     ) { sys_prot_t netconn_set_safe_err_lev; netconn_set_safe_err_lev = sys_arch_protect(); if (!(((conn)->last_err) <= ERR_ABRT)) { (conn)->last_err = err; } sys_arch_unprotect(netconn_set_safe_err_lev); }} while(0);;
...
accept_function(void *arg, struct tcp_pcb *newpcb, err_t err)
{
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("accept_function: newpcb->tate: %s\n", tcp_debug_state_str(newpcb->state)) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);

  if (conn == 
# 475 "kernel/protocols/net/api/api_msg.c" 3 4
             ((void *)0)
# 475 "kernel/protocols/net/api/api_msg.c"
                 ) {
    return ERR_VAL;
  }
  if (!aos_queue_is_valid(&conn->acceptmbox)) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("accept_function: acceptmbox already deleted\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    return ERR_VAL;
  }

  if (newpcb == 
# 483 "kernel/protocols/net/api/api_msg.c" 3 4
               ((void *)0)
# 483 "kernel/protocols/net/api/api_msg.c"
                   ) {
  ...
  if (newconn == 
# 495 "kernel/protocols/net/api/api_msg.c" 3 4
                ((void *)0)
# 495 "kernel/protocols/net/api/api_msg.c"
                    ) {
  ...
  if (sys_mbox_trypost(&conn->acceptmbox, newconn) != ERR_OK) {
    ...
    tcp_arg(pcb, 
# 517 "kernel/protocols/net/api/api_msg.c" 3 4
                ((void *)0)
# 517 "kernel/protocols/net/api/api_msg.c"
                    );
    tcp_recv(pcb, 
# 518 "kernel/protocols/net/api/api_msg.c" 3 4
                 ((void *)0)
# 518 "kernel/protocols/net/api/api_msg.c"
                     );
    tcp_sent(pcb, 
# 519 "kernel/protocols/net/api/api_msg.c" 3 4
                 ((void *)0)
# 519 "kernel/protocols/net/api/api_msg.c"
                     );
    tcp_poll(pcb, 
# 520 "kernel/protocols/net/api/api_msg.c" 3 4
                 ((void *)0)
# 520 "kernel/protocols/net/api/api_msg.c"
                     , 0);
    tcp_err(pcb, 
# 521 "kernel/protocols/net/api/api_msg.c" 3 4
                ((void *)0)
# 521 "kernel/protocols/net/api/api_msg.c"
                    );

    newconn->pcb.tcp = 
# 523 "kernel/protocols/net/api/api_msg.c" 3 4
                      ((void *)0)
# 523 "kernel/protocols/net/api/api_msg.c"
                          ;

    sys_mbox_free(&newconn->recvmbox);
    do { if(&(newconn->recvmbox) != 
# 526 "kernel/protocols/net/api/api_msg.c" 3 4
   ((void *)0)
# 526 "kernel/protocols/net/api/api_msg.c"
   ) { (&(newconn->recvmbox))->hdl = 
# 526 "kernel/protocols/net/api/api_msg.c" 3 4
   ((void *)0)
# 526 "kernel/protocols/net/api/api_msg.c"
   ; }}while(0);
...
# 544 "kernel/protocols/net/api/api_msg.c"
static void
pcb_new(struct api_msg *msg)
{
  ...
  case NETCONN_RAW:
    ...
    if (msg->conn->pcb.raw != 
# 554 "kernel/protocols/net/api/api_msg.c" 3 4
                             ((void *)0)
# 554 "kernel/protocols/net/api/api_msg.c"
                                 ) {
  ...
  case NETCONN_UDP:
    ...
    if (msg->conn->pcb.udp != 
# 562 "kernel/protocols/net/api/api_msg.c" 3 4
                             ((void *)0)
# 562 "kernel/protocols/net/api/api_msg.c"
                                 ) {
  ...
  case NETCONN_TCP:
    ...
    if (msg->conn->pcb.tcp != 
# 578 "kernel/protocols/net/api/api_msg.c" 3 4
                             ((void *)0)
# 578 "kernel/protocols/net/api/api_msg.c"
                                 ) {
      setup_tcp(msg->conn);
    }
    break;
  ...
  if (msg->conn->pcb.ip == 
# 588 "kernel/protocols/net/api/api_msg.c" 3 4
                          ((void *)0)
# 588 "kernel/protocols/net/api/api_msg.c"
                              ) {
    msg->err = ERR_MEM;
  }
# 600 "kernel/protocols/net/api/api_msg.c"
}
...
lwip_netconn_do_newconn(void *m)
{
  ...
  msg->err = ERR_OK;
  if (msg->conn->pcb.tcp == 
# 614 "kernel/protocols/net/api/api_msg.c" 3 4
                           ((void *)0)
# 614 "kernel/protocols/net/api/api_msg.c"
                               ) {
    pcb_new(msg);
  }
  ...
  do { if (((msg)->conn) != 
# 621 "kernel/protocols/net/api/api_msg.c" 3 4
 ((void *)0)
# 621 "kernel/protocols/net/api/api_msg.c"
...
# 633 "kernel/protocols/net/api/api_msg.c"
struct netconn*
netconn_alloc(enum netconn_type t, netconn_callback callback)
{
  ...
  if (conn == 
# 640 "kernel/protocols/net/api/api_msg.c" 3 4
             ((void *)0)
# 640 "kernel/protocols/net/api/api_msg.c"
                 ) {
    return 
# 641 "kernel/protocols/net/api/api_msg.c" 3 4
          ((void *)0)
# 641 "kernel/protocols/net/api/api_msg.c"
              ;
  }
  ...
  conn->type = t;
  conn->pcb.tcp = 
# 646 "kernel/protocols/net/api/api_msg.c" 3 4
                 ((void *)0)
# 646 "kernel/protocols/net/api/api_msg.c"
                     ;
...
# 681 "kernel/protocols/net/api/api_msg.c" 3 4
 ((void *)0)
# 681 "kernel/protocols/net/api/api_msg.c"
 ) { (&conn->acceptmbox)->hdl = 
# 681 "kernel/protocols/net/api/api_msg.c" 3 4
 ((void *)0)
# 681 "kernel/protocols/net/api/api_msg.c"
 ; }}while(0);
  ...
  conn->current_msg = 
# 690 "kernel/protocols/net/api/api_msg.c" 3 4
                      ((void *)0)
# 690 "kernel/protocols/net/api/api_msg.c"
                          ;
  conn->write_offset = 0;
  ...
  conn->recv_timeout = 0;
# 706 "kernel/protocols/net/api/api_msg.c"
  conn->flags = 0;
  return conn;
free_and_return:
  memp_free(MEMP_NETCONN, conn);
  return 
# 710 "kernel/protocols/net/api/api_msg.c" 3 4
        ((void *)0)
# 710 "kernel/protocols/net/api/api_msg.c"
            ;
}
...
netconn_free(struct netconn *conn)
{
  ...
  do { if(&conn->op_completed != 
# 732 "kernel/protocols/net/api/api_msg.c" 3 4
 ((void *)0)
# 732 "kernel/protocols/net/api/api_msg.c"
 ) { (&conn->op_completed)->hdl = 
# 732 "kernel/protocols/net/api/api_msg.c" 3 4
 ((void *)0)
# 732 "kernel/protocols/net/api/api_msg.c"
 ; }}while(0);
...
# 746 "kernel/protocols/net/api/api_msg.c"
static void
  ...
  if (aos_queue_is_valid(&conn->recvmbox)) {
    while (sys_arch_mbox_tryfetch(&conn->recvmbox, &mem) != 0xffffffffUL) {
      ...
      if (((conn->type)&0xF0) == NETCONN_TCP) {
        if (mem != 
# 761 "kernel/protocols/net/api/api_msg.c" 3 4
                  ((void *)0)
# 761 "kernel/protocols/net/api/api_msg.c"
                      ) {
          p = (struct pbuf*)mem;

          if (conn->pcb.tcp != 
# 764 "kernel/protocols/net/api/api_msg.c" 3 4
                              ((void *)0)
# 764 "kernel/protocols/net/api/api_msg.c"
                                  ) {
    ...
    sys_mbox_free(&conn->recvmbox);
    do { if(&conn->recvmbox != 
# 776 "kernel/protocols/net/api/api_msg.c" 3 4
   ((void *)0)
# 776 "kernel/protocols/net/api/api_msg.c"
   ) { (&conn->recvmbox)->hdl = 
# 776 "kernel/protocols/net/api/api_msg.c" 3 4
   ((void *)0)
# 776 "kernel/protocols/net/api/api_msg.c"
  ...
  if (aos_queue_is_valid(&conn->acceptmbox)) {
    while (sys_arch_mbox_tryfetch(&conn->acceptmbox, &mem) != 0xffffffffUL) {
      if (mem != &netconn_aborted) {
        ...
        if (newconn->pcb.tcp != 
# 789 "kernel/protocols/net/api/api_msg.c" 3 4
                               ((void *)0)
# 789 "kernel/protocols/net/api/api_msg.c"
                                   ) {
          tcp_abort(newconn->pcb.tcp);
          newconn->pcb.tcp = 
# 791 "kernel/protocols/net/api/api_msg.c" 3 4
                            ((void *)0)
# 791 "kernel/protocols/net/api/api_msg.c"
                                ;
        }
        netconn_free(newconn);
      }
    ...
    do { if(&conn->acceptmbox != 
# 797 "kernel/protocols/net/api/api_msg.c" 3 4
   ((void *)0)
# 797 "kernel/protocols/net/api/api_msg.c"
   ) { (&conn->acceptmbox)->hdl = 
# 797 "kernel/protocols/net/api/api_msg.c" 3 4
   ((void *)0)
# 797 "kernel/protocols/net/api/api_msg.c"
...
# 810 "kernel/protocols/net/api/api_msg.c"
static err_t
lwip_netconn_do_close_internal(struct netconn *conn , u8_t delayed)
{
  ...
  if (close) {
    tcp_arg(tpcb, 
# 848 "kernel/protocols/net/api/api_msg.c" 3 4
                 ((void *)0)
# 848 "kernel/protocols/net/api/api_msg.c"
                     );
  }
  if (tpcb->state == LISTEN) {
    tcp_accept(tpcb, 
# 851 "kernel/protocols/net/api/api_msg.c" 3 4
                    ((void *)0)
# 851 "kernel/protocols/net/api/api_msg.c"
                        );
  } else {

    if (shut_rx) {
      tcp_recv(tpcb, 
# 855 "kernel/protocols/net/api/api_msg.c" 3 4
                    ((void *)0)
# 855 "kernel/protocols/net/api/api_msg.c"
                        );
      tcp_accept(tpcb, 
# 856 "kernel/protocols/net/api/api_msg.c" 3 4
                      ((void *)0)
# 856 "kernel/protocols/net/api/api_msg.c"
                          );
    }
    if (shut_tx) {
      tcp_sent(tpcb, 
# 859 "kernel/protocols/net/api/api_msg.c" 3 4
                    ((void *)0)
# 859 "kernel/protocols/net/api/api_msg.c"
                        );
    }
    if (close) {
      tcp_poll(tpcb, 
# 862 "kernel/protocols/net/api/api_msg.c" 3 4
                    ((void *)0)
# 862 "kernel/protocols/net/api/api_msg.c"
                        , 0);
      tcp_err(tpcb, 
# 863 "kernel/protocols/net/api/api_msg.c" 3 4
                   ((void *)0)
# 863 "kernel/protocols/net/api/api_msg.c"
                       );
    }
  }

  if (close) {
# 896 "kernel/protocols/net/api/api_msg.c"
    {
      err = tcp_close(tpcb);
    }
  } else {
  ...
  if (close_finished) {
    ...
    conn->current_msg->err = err;
    conn->current_msg = 
# 951 "kernel/protocols/net/api/api_msg.c" 3 4
                       ((void *)0)
# 951 "kernel/protocols/net/api/api_msg.c"
                           ;
    conn->state = NETCONN_NONE;
    if (err == ERR_OK) {
      if (close) {
        ...
        conn->pcb.tcp = 
# 956 "kernel/protocols/net/api/api_msg.c" 3 4
                       ((void *)0)
# 956 "kernel/protocols/net/api/api_msg.c"
                           ;
    ...
    do { if ((conn) != 
# 968 "kernel/protocols/net/api/api_msg.c" 3 4
   ((void *)0)
# 968 "kernel/protocols/net/api/api_msg.c"
   ) { sys_prot_t netconn_set_safe_err_lev; netconn_set_safe_err_lev = sys_arch_protect(); if (!(((conn)->last_err) <= ERR_ABRT)) { (conn)->last_err = err; } sys_arch_unprotect(netconn_set_safe_err_lev); }} while(0);;
...
# 1004 "kernel/protocols/net/api/api_msg.c"
void
lwip_netconn_do_delconn(void *m)
{
  ...
  enum netconn_state state = msg->conn->state;
                                                                                   ...
                                                                                   ;
# 1030 "kernel/protocols/net/api/api_msg.c"
...

  {
    ...
    if (msg->conn->pcb.tcp != 
# 1046 "kernel/protocols/net/api/api_msg.c" 3 4
                             ((void *)0)
# 1046 "kernel/protocols/net/api/api_msg.c"
                                 ) {
...
# 1056 "kernel/protocols/net/api/api_msg.c" 3 4
                                      ((void *)0)
# 1056 "kernel/protocols/net/api/api_msg.c"
                                          ;
      ...
      msg->conn->pcb.tcp = 
# 1085 "kernel/protocols/net/api/api_msg.c" 3 4
                          ((void *)0)
# 1085 "kernel/protocols/net/api/api_msg.c"
                              ;
    }
  ...
  if (aos_sem_is_valid((&(msg)->conn->op_completed))) {
    do { if (((msg)->conn) != 
# 1095 "kernel/protocols/net/api/api_msg.c" 3 4
   ((void *)0)
# 1095 "kernel/protocols/net/api/api_msg.c"
   ) { sys_prot_t netconn_set_safe_err_lev; netconn_set_safe_err_lev = sys_arch_protect(); if (!((((msg)->conn)->last_err) <= ERR_ABRT)) { ((msg)->conn)->last_err = (msg)->err; } sys_arch_unprotect(netconn_set_safe_err_lev); }} while(0);;
  }
}
# 1106 "kernel/protocols/net/api/api_msg.c"
void
lwip_netconn_do_bind(void *m)
{
  ...
  if (((msg->conn->last_err) <= ERR_ABRT)) {
    ...
    msg->err = ERR_VAL;
    if (msg->conn->pcb.tcp != 
# 1115 "kernel/protocols/net/api/api_msg.c" 3 4
                             ((void *)0)
# 1115 "kernel/protocols/net/api/api_msg.c"
                                 ) {
      const ip_addr_t *ipaddr = msg->msg.bc.ipaddr;
# 1133 "kernel/protocols/net/api/api_msg.c"
      switch (((msg->conn->type)&0xF0)) {
  ...
  do { if (((msg)->conn) != 
# 1154 "kernel/protocols/net/api/api_msg.c" 3 4
 ((void *)0)
# 1154 "kernel/protocols/net/api/api_msg.c"
 ) { sys_prot_t netconn_set_safe_err_lev; netconn_set_safe_err_lev = sys_arch_protect(); if (!((((msg)->conn)->last_err) <= ERR_ABRT)) { ((msg)->conn)->last_err = (msg)->err; } sys_arch_unprotect(netconn_set_safe_err_lev); }} while(0);;
}
# 1164 "kernel/protocols/net/api/api_msg.c"
static err_t
lwip_netconn_do_connected(void *arg, struct tcp_pcb *pcb, err_t err)
{
  ...
  int was_blocking;
  sys_sem_t* op_completed_sem = 
# 1169 "kernel/protocols/net/api/api_msg.c" 3 4
                               ((void *)0)
# 1169 "kernel/protocols/net/api/api_msg.c"
                                   ;
  ...
  if (conn == 
# 1175 "kernel/protocols/net/api/api_msg.c" 3 4
             ((void *)0)
# 1175 "kernel/protocols/net/api/api_msg.c"
                 ) {
    return ERR_VAL;
  }
  ...
  if (conn->current_msg != 
# 1183 "kernel/protocols/net/api/api_msg.c" 3 4
                          ((void *)0)
# 1183 "kernel/protocols/net/api/api_msg.c"
                              ) {
    conn->current_msg->err = err;
    op_completed_sem = (&(conn->current_msg)->conn->op_completed);
  }
  ...
  do { if (0) { (conn)->flags |= 0x04; } else { (conn)->flags &= ~ 0x04; }} while(0);
                                                ...
                                                ;
  conn->current_msg = 
# 1195 "kernel/protocols/net/api/api_msg.c" 3 4
                     ((void *)0)
# 1195 "kernel/protocols/net/api/api_msg.c"
                         ;
  conn->state = NETCONN_NONE;
  do { if ((conn) != 
# 1197 "kernel/protocols/net/api/api_msg.c" 3 4
 ((void *)0)
# 1197 "kernel/protocols/net/api/api_msg.c"
 ) { sys_prot_t netconn_set_safe_err_lev; netconn_set_safe_err_lev = sys_arch_protect(); if (!(((conn)->last_err) <= ERR_ABRT)) { (conn)->last_err = ERR_OK; } sys_arch_unprotect(netconn_set_safe_err_lev); }} while(0);;
  if (conn->callback) { (*conn->callback)(conn, NETCONN_EVT_SENDPLUS, 0); };
...
# 1214 "kernel/protocols/net/api/api_msg.c"
void
lwip_netconn_do_connect(void *m)
{
  ...
  if (msg->conn->pcb.tcp == 
# 1219 "kernel/protocols/net/api/api_msg.c" 3 4
                           ((void *)0)
# 1219 "kernel/protocols/net/api/api_msg.c"
                               ) {
    ...
    default:
      do { if (!(0)) { do {bk_printf ("Invalid netconn type") ;} while(0); do{ msg->err = ERR_VAL; }while(0);}} while(0);
      break;
    }
  }
  ...
  do { if (((msg)->conn) != 
# 1275 "kernel/protocols/net/api/api_msg.c" 3 4
 ((void *)0)
# 1275 "kernel/protocols/net/api/api_msg.c"
 ) { sys_prot_t netconn_set_safe_err_lev; netconn_set_safe_err_lev = sys_arch_protect(); if (!((((msg)->conn)->last_err) <= ERR_ABRT)) { ((msg)->conn)->last_err = (msg)->err; } sys_arch_unprotect(netconn_set_safe_err_lev); }} while(0);;
}
# 1285 "kernel/protocols/net/api/api_msg.c"
void
lwip_netconn_do_disconnect(void *m)
{
  ...
  do { if (((msg)->conn) != 
# 1299 "kernel/protocols/net/api/api_msg.c" 3 4
 ((void *)0)
# 1299 "kernel/protocols/net/api/api_msg.c"
 ) { sys_prot_t netconn_set_safe_err_lev; netconn_set_safe_err_lev = sys_arch_protect(); if (!((((msg)->conn)->last_err) <= ERR_ABRT)) { ((msg)->conn)->last_err = (msg)->err; } sys_arch_unprotect(netconn_set_safe_err_lev); }} while(0);;
}
# 1309 "kernel/protocols/net/api/api_msg.c"
void
lwip_netconn_do_listen(void *m)
{
  ...
  if (((msg->conn->last_err) <= ERR_ABRT)) {
    ...
    msg->err = ERR_CONN;
    if (msg->conn->pcb.tcp != 
# 1318 "kernel/protocols/net/api/api_msg.c" 3 4
                             ((void *)0)
# 1318 "kernel/protocols/net/api/api_msg.c"
                                 ) {
...
# 1339 "kernel/protocols/net/api/api_msg.c"
            ...
            if (lpcb == 
# 1344 "kernel/protocols/net/api/api_msg.c" 3 4
                       ((void *)0)
# 1344 "kernel/protocols/net/api/api_msg.c"
                           ) {

              msg->err = ERR_MEM;
            } else {

              if (aos_queue_is_valid(&msg->conn->recvmbox)) {

                sys_mbox_free(&msg->conn->recvmbox);
                do { if(&msg->conn->recvmbox != 
# 1352 "kernel/protocols/net/api/api_msg.c" 3 4
               ((void *)0)
# 1352 "kernel/protocols/net/api/api_msg.c"
               ) { (&msg->conn->recvmbox)->hdl = 
# 1352 "kernel/protocols/net/api/api_msg.c" 3 4
               ((void *)0)
# 1352 "kernel/protocols/net/api/api_msg.c"
               ; }}while(0);
              ...
              msg->err = ERR_OK;
              if (!aos_queue_is_valid(&msg->conn->acceptmbox)) {
                msg->err = sys_mbox_new(&msg->conn->acceptmbox, 8);
              }
              if (msg->err == ERR_OK) {
                ...
                tcp_close(lpcb);
                msg->conn->pcb.tcp = 
# 1366 "kernel/protocols/net/api/api_msg.c" 3 4
                                    ((void *)0)
# 1366 "kernel/protocols/net/api/api_msg.c"
                                        ;
              }
            }
          }
          ...
          msg->err = ERR_OK;
          do { ; ((struct tcp_pcb_listen *)(msg->conn->pcb.tcp))->backlog = ((msg->msg.lb.backlog) ? (msg->msg.lb.backlog) : 1); } while(0);
        }
      } else {
        msg->err = ERR_ARG;
      }
  ...
  do { if (((msg)->conn) != 
# 1380 "kernel/protocols/net/api/api_msg.c" 3 4
 ((void *)0)
# 1380 "kernel/protocols/net/api/api_msg.c"
 ) { sys_prot_t netconn_set_safe_err_lev; netconn_set_safe_err_lev = sys_arch_protect(); if (!((((msg)->conn)->last_err) <= ERR_ABRT)) { ((msg)->conn)->last_err = (msg)->err; } sys_arch_unprotect(netconn_set_safe_err_lev); }} while(0);;
}
# 1390 "kernel/protocols/net/api/api_msg.c"
void
lwip_netconn_do_send(void *m)
{
  ...
  if (((msg->conn->last_err) <= ERR_ABRT)) {
    ...
    msg->err = ERR_CONN;
    if (msg->conn->pcb.tcp != 
# 1399 "kernel/protocols/net/api/api_msg.c" 3 4
                             ((void *)0)
# 1399 "kernel/protocols/net/api/api_msg.c"
                                 ) {
      switch (((msg->conn->type)&0xF0)) {

      case NETCONN_RAW:
        if (((&msg->msg.b->addr) == 
# 1403 "kernel/protocols/net/api/api_msg.c" 3 4
           ((void *)0) 
# 1403 "kernel/protocols/net/api/api_msg.c"
           || ((*(&msg->msg.b->addr)).addr == ((u32_t)0x00000000UL)))) {
      ...
      case NETCONN_UDP:
# 1422 "kernel/protocols/net/api/api_msg.c"
  ...
  do { if (((msg)->conn) != 
# 1435 "kernel/protocols/net/api/api_msg.c" 3 4
 ((void *)0)
# 1435 "kernel/protocols/net/api/api_msg.c"
 ) { sys_prot_t netconn_set_safe_err_lev; netconn_set_safe_err_lev = sys_arch_protect(); if (!((((msg)->conn)->last_err) <= ERR_ABRT)) { ((msg)->conn)->last_err = (msg)->err; } sys_arch_unprotect(netconn_set_safe_err_lev); }} while(0);;
}
# 1445 "kernel/protocols/net/api/api_msg.c"
void
lwip_netconn_do_recv(void *m)
{
  ...
  msg->err = ERR_OK;
  if (msg->conn->pcb.tcp != 
# 1451 "kernel/protocols/net/api/api_msg.c" 3 4
                           ((void *)0)
# 1451 "kernel/protocols/net/api/api_msg.c"
                               ) {
    if (((msg->conn->type)&0xF0) == NETCONN_TCP) {
  ...
  do { if (((msg)->conn) != 
# 1461 "kernel/protocols/net/api/api_msg.c" 3 4
 ((void *)0)
# 1461 "kernel/protocols/net/api/api_msg.c"
 ) { sys_prot_t netconn_set_safe_err_lev; netconn_set_safe_err_lev = sys_arch_protect(); if (!((((msg)->conn)->last_err) <= ERR_ABRT)) { ((msg)->conn)->last_err = (msg)->err; } sys_arch_unprotect(netconn_set_safe_err_lev); }} while(0);;
}
...
lwip_netconn_do_accepted(void *m)
{
  ...
  msg->err = ERR_OK;
  if (msg->conn->pcb.tcp != 
# 1476 "kernel/protocols/net/api/api_msg.c" 3 4
                           ((void *)0)
# 1476 "kernel/protocols/net/api/api_msg.c"
                               ) {
    if (((msg->conn->type)&0xF0) == NETCONN_TCP) {
  ...
  do { if (((msg)->conn) != 
# 1481 "kernel/protocols/net/api/api_msg.c" 3 4
 ((void *)0)
# 1481 "kernel/protocols/net/api/api_msg.c"
 ) { sys_prot_t netconn_set_safe_err_lev; netconn_set_safe_err_lev = sys_arch_protect(); if (!((((msg)->conn)->last_err) <= ERR_ABRT)) { ((msg)->conn)->last_err = (msg)->err; } sys_arch_unprotect(netconn_set_safe_err_lev); }} while(0);;
}
# 1496 "kernel/protocols/net/api/api_msg.c"
static err_t
...
err_mem:
      if (dontblock && (len < conn->current_msg->msg.w.len)) {
        ...
        conn->flags |= 0x10;
      } else if (((((conn->pcb.tcp)->snd_buf)) <= (((((((((10*(1500 - 40)))/2)) > ((2 * (1500 - 40)) + 1)) ? ((((10*(1500 - 40)))/2)) : ((2 * (1500 - 40)) + 1))) < (((10*(1500 - 40))) - 1)) ? (((((((10*(1500 - 40)))/2)) > ((2 * (1500 - 40)) + 1)) ? ((((10*(1500 - 40)))/2)) : ((2 * (1500 - 40)) + 1))) : (((10*(1500 - 40))) - 1))) ||
                 (((conn->pcb.tcp)->snd_queuelen) >= ((((((20))/2)) > (5)) ? ((((20))/2)) : (5)))) {
  ...
  if (write_finished) {
    ...
    conn->current_msg->err = err;
    conn->current_msg = 
# 1618 "kernel/protocols/net/api/api_msg.c" 3 4
                       ((void *)0)
# 1618 "kernel/protocols/net/api/api_msg.c"
                           ;
    conn->write_offset = 0;
    conn->state = NETCONN_NONE;
    do { if ((conn) != 
# 1621 "kernel/protocols/net/api/api_msg.c" 3 4
   ((void *)0)
# 1621 "kernel/protocols/net/api/api_msg.c"
   ) { sys_prot_t netconn_set_safe_err_lev; netconn_set_safe_err_lev = sys_arch_protect(); if (!(((conn)->last_err) <= ERR_ABRT)) { (conn)->last_err = err; } sys_arch_unprotect(netconn_set_safe_err_lev); }} while(0);;
...
# 1644 "kernel/protocols/net/api/api_msg.c"
void
...
# 1657 "kernel/protocols/net/api/api_msg.c" 3 4
                                      ((void *)0)
# 1657 "kernel/protocols/net/api/api_msg.c"
                                          ) {
  ...
  do { if (((msg)->conn) != 
# 1691 "kernel/protocols/net/api/api_msg.c" 3 4
 ((void *)0)
# 1691 "kernel/protocols/net/api/api_msg.c"
 ) { sys_prot_t netconn_set_safe_err_lev; netconn_set_safe_err_lev = sys_arch_protect(); if (!((((msg)->conn)->last_err) <= ERR_ABRT)) { ((msg)->conn)->last_err = (msg)->err; } sys_arch_unprotect(netconn_set_safe_err_lev); }} while(0);;
}
...
lwip_netconn_do_getaddr(void *m)
{
  ...
  if (msg->conn->pcb.ip != 
# 1705 "kernel/protocols/net/api/api_msg.c" 3 4
                          ((void *)0)
# 1705 "kernel/protocols/net/api/api_msg.c"
                              ) {
    if (msg->msg.ad.local) {
  ...
  do { if (((msg)->conn) != 
# 1756 "kernel/protocols/net/api/api_msg.c" 3 4
 ((void *)0)
# 1756 "kernel/protocols/net/api/api_msg.c"
 ) { sys_prot_t netconn_set_safe_err_lev; netconn_set_safe_err_lev = sys_arch_protect(); if (!((((msg)->conn)->last_err) <= ERR_ABRT)) { ((msg)->conn)->last_err = (msg)->err; } sys_arch_unprotect(netconn_set_safe_err_lev); }} while(0);;
}
# 1766 "kernel/protocols/net/api/api_msg.c"
void
lwip_netconn_do_close(void *m)
{
  ...
  if ((msg->conn->pcb.tcp != 
# 1775 "kernel/protocols/net/api/api_msg.c" 3 4
                            ((void *)0)
# 1775 "kernel/protocols/net/api/api_msg.c"
                                ) &&
...
# 1802 "kernel/protocols/net/api/api_msg.c"
      msg->err = ERR_INPROGRESS;
  ...
  do { if (((msg)->conn) != 
# 1832 "kernel/protocols/net/api/api_msg.c" 3 4
 ((void *)0)
# 1832 "kernel/protocols/net/api/api_msg.c"
 ) { sys_prot_t netconn_set_safe_err_lev; netconn_set_safe_err_lev = sys_arch_protect(); if (!((((msg)->conn)->last_err) <= ERR_ABRT)) { ((msg)->conn)->last_err = (msg)->err; } sys_arch_unprotect(netconn_set_safe_err_lev); }} while(0);;
}
# 1842 "kernel/protocols/net/api/api_msg.c"
void
lwip_netconn_do_join_leave_group(void *m)
{
  ...
  if (((msg->conn->last_err) <= ERR_ABRT)) {
    ...
    if (msg->conn->pcb.tcp != 
# 1850 "kernel/protocols/net/api/api_msg.c" 3 4
                             ((void *)0)
# 1850 "kernel/protocols/net/api/api_msg.c"
                                 ) {
      if (((msg->conn->type)&0xF0) == NETCONN_UDP) {
# 1865 "kernel/protocols/net/api/api_msg.c"
        {
  ...
  do { if (((msg)->conn) != 
# 1886 "kernel/protocols/net/api/api_msg.c" 3 4
 ((void *)0)
# 1886 "kernel/protocols/net/api/api_msg.c"
 ) { sys_prot_t netconn_set_safe_err_lev; netconn_set_safe_err_lev = sys_arch_protect(); if (!((((msg)->conn)->last_err) <= ERR_ABRT)) { ((msg)->conn)->last_err = (msg)->err; } sys_arch_unprotect(netconn_set_safe_err_lev); }} while(0);;
}
# 1896 "kernel/protocols/net/api/api_msg.c"
static void
lwip_netconn_do_dns_found(const char *name, const ip_addr_t *ipaddr, void *arg)
{
  ...
  if (ipaddr == 
# 1904 "kernel/protocols/net/api/api_msg.c" 3 4
               ((void *)0)
# 1904 "kernel/protocols/net/api/api_msg.c"
                   ) {
