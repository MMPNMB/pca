# 1 "framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log.c"
# 19 "framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log.c"
# 1 "framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log_internal.h" 1
# 21 "framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log_internal.h"
...
# 22 "framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log_internal.h" 2
...
# 23 "framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log_internal.h" 2
# 1 "/home/stone/Documents/Ali_IOT/build/compiler/gcc-arm-none-eabi/Linux64/lib/gcc/arm-none-eabi/5.4.1/include/stdarg.h" 1 3 4
# 24 "framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log_internal.h" 2
...
# 26 "framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log_internal.h" 2
...
# 20 "framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log.c" 2
# 33 "framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log.c"
int LITE_hexdump(const char *title, const void *buff, const int len)
{
    ...
    for (i = 0; i < len; ++ i) {
        ...
        sprintf((char *)ascii + i % 16, "%c", ((buf[i] >= ' ' && buf[i] <= '~') ? buf[i] : '.'));
...
void LITE_syslog_routine(const char *f, const int l, const int level, const char *fmt, va_list* params)
{
    ...
    o = tmpbuf;
    o += vsnprintf(o, (255) + 1, fmt, *params);
...
# 124 "framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log.c" 3 4
   __builtin_va_start(
# 124 "framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log.c"
   ap
# 124 "framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log.c" 3 4
   ,
# 124 "framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log.c"
...
# 126 "framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log.c" 3 4
   __builtin_va_end(
# 126 "framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log.c"
   ap
# 126 "framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log.c" 3 4
   )
# 126 "framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log.c"
                            ...
                            const char *title, int level, char *payload, const char *mark)
{
    ...
    while (pos && *pos) {
        ...
        endl = strchr(pos + 1, '\r');
        if (endl == 
# 205 "framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log.c" 3 4
                   ((void *)0)
# 205 "framework/protocol/linkkit/iotkit/base/log/LITE-log/lite-log.c"
                       ) {
            endl = pos;
            do {
                ++endl;
