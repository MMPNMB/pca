# 1 "kernel/rhino/core/k_buf_queue.c"
...
# 6 "kernel/rhino/core/k_buf_queue.c" 2
                                ...
                                void *buf, size_t size, size_t max_msg, uint8_t mm_alloc_flag, size_t type)
{
    ...
    do { if (queue == 
# 14 "kernel/rhino/core/k_buf_queue.c" 3 4
   ((void *)0)
# 14 "kernel/rhino/core/k_buf_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    do { if (buf == 
# 15 "kernel/rhino/core/k_buf_queue.c" 3 4
   ((void *)0)
# 15 "kernel/rhino/core/k_buf_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    do { if (name == 
# 16 "kernel/rhino/core/k_buf_queue.c" 3 4
   ((void *)0)
# 16 "kernel/rhino/core/k_buf_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
...
{
    return buf_queue_create(queue, name, buf, size, max_msg, 1u, 1);
}

kstat_t krhino_fix_buf_queue_create(kbuf_queue_t *queue, const name_t *name,
                                   void *buf, size_t msg_size, size_t msg_num)
{
    return buf_queue_create(queue, name, buf, msg_size * msg_num, msg_size, 1u, 0);
}
...
kstat_t krhino_buf_queue_del(kbuf_queue_t *queue)
{
    ...
    do { if (queue == 
# 70 "kernel/rhino/core/k_buf_queue.c" 3 4
   ((void *)0)
# 70 "kernel/rhino/core/k_buf_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    ...
    while (!is_klist_empty(head)) {
        ...
        pend_task_rm(((ktask_t *)((uint8_t *)(head->next) - (size_t)(&((ktask_t *)0)->task_list))));
    }
                                    ...
                                    size_t size, size_t max_msg)
{
    ...
    do { if (queue == 
# 114 "kernel/rhino/core/k_buf_queue.c" 3 4
   ((void *)0)
# 114 "kernel/rhino/core/k_buf_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    ...
    if (queue_obj == 
# 122 "kernel/rhino/core/k_buf_queue.c" 3 4
                    ((void *)0)
# 122 "kernel/rhino/core/k_buf_queue.c"
                        ) {
        return RHINO_NO_MEM;
    }
    ...
    if (queue_obj->buf == 
# 128 "kernel/rhino/core/k_buf_queue.c" 3 4
                         ((void *)0)
# 128 "kernel/rhino/core/k_buf_queue.c"
                             ) {
...
kstat_t krhino_buf_queue_dyn_del(kbuf_queue_t *queue)
{
    ...
    do { if (queue == 
# 152 "kernel/rhino/core/k_buf_queue.c" 3 4
   ((void *)0)
# 152 "kernel/rhino/core/k_buf_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
...
static kstat_t buf_queue_send(kbuf_queue_t *queue, void *msg, size_t msg_size)
{
    ...
    task = ((ktask_t *)((uint8_t *)(head->next) - (size_t)(&((ktask_t *)0)->task_list)));
...
{
    do { if (queue == 
# 272 "kernel/rhino/core/k_buf_queue.c" 3 4
   ((void *)0)
# 272 "kernel/rhino/core/k_buf_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    do { if (msg == 
# 273 "kernel/rhino/core/k_buf_queue.c" 3 4
   ((void *)0)
# 273 "kernel/rhino/core/k_buf_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
                              ...
                              size_t *size)
{
    ...
    do { if (queue == 
# 286 "kernel/rhino/core/k_buf_queue.c" 3 4
   ((void *)0)
# 286 "kernel/rhino/core/k_buf_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    do { if (msg == 
# 287 "kernel/rhino/core/k_buf_queue.c" 3 4
   ((void *)0)
# 287 "kernel/rhino/core/k_buf_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    do { if (size == 
# 288 "kernel/rhino/core/k_buf_queue.c" 3 4
   ((void *)0)
# 288 "kernel/rhino/core/k_buf_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
...
kstat_t krhino_buf_queue_flush(kbuf_queue_t *queue)
{
    ...
    do { if (queue == 
# 355 "kernel/rhino/core/k_buf_queue.c" 3 4
   ((void *)0)
# 355 "kernel/rhino/core/k_buf_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
...
kstat_t krhino_buf_queue_info_get(kbuf_queue_t *queue, kbuf_queue_info_t *info)
{
    ...
    do { if (queue == 
# 380 "kernel/rhino/core/k_buf_queue.c" 3 4
   ((void *)0)
# 380 "kernel/rhino/core/k_buf_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    do { if (info == 
# 381 "kernel/rhino/core/k_buf_queue.c" 3 4
   ((void *)0)
# 381 "kernel/rhino/core/k_buf_queue.c"
   ) { return RHINO_NULL_PTR; } } while (0);
