...
# 8 "kernel/vfs/device.c" 2

# 1 "./kernel/vfs/include/vfs_conf.h" 1
# 10 "kernel/vfs/device.c" 2
# 1 "./kernel/vfs/include/vfs_err.h" 1
# 11 "kernel/vfs/device.c" 2
# 1 "./kernel/vfs/include/vfs_register.h" 1
...
# 9 "./kernel/vfs/include/vfs_register.h" 2
...
# 12 "kernel/vfs/device.c" 2
# 1 "./kernel/vfs/include/event_device.h" 1
# 13 "kernel/vfs/device.c" 2
...
# 67 "kernel/vfs/device.c" 3 4
                                                                   _Bool 
# 67 "kernel/vfs/device.c"
                                                                        urgent)
{
    ...
    if (evt == 
# 83 "kernel/vfs/device.c" 3 4
              ((void *)0)
# 83 "kernel/vfs/device.c"
                  ) {
        ret = -1;
        goto out;
    }
    ...
    if (pdev->poll_cb != 
# 98 "kernel/vfs/device.c" 3 4
                        ((void *)0)
# 98 "kernel/vfs/device.c"
                            ) {
        pdev->fd->revents |= 0x1;
...
# 109 "kernel/vfs/device.c" 3 4
                                    0
# 109 "kernel/vfs/device.c"
                                         );
}
...
static int event_ioctl(file_t *f, int cmd, unsigned long arg)
{
    ...
    switch (cmd) {
        case 0x1:
            return _event_write(f, buf, len, 
# 119 "kernel/vfs/device.c" 3 4
                                            0
# 119 "kernel/vfs/device.c"
                                                 );
        case 0x2:
            return _event_write(f, buf, len, 
# 121 "kernel/vfs/device.c" 3 4
                                            1
# 121 "kernel/vfs/device.c"
                                                );
    }
...
# 157 "kernel/vfs/device.c" 3 4
                                _Bool 
# 157 "kernel/vfs/device.c"
                      ...
                      struct pollfd *fd, void *opa)
{
    ...
    if (!setup) {
        pdev->poll_cb = 
# 164 "kernel/vfs/device.c" 3 4
                       ((void *)0)
# 164 "kernel/vfs/device.c"
                           ;
        pdev->poll_data = 
# 165 "kernel/vfs/device.c" 3 4
                         ((void *)0)
# 165 "kernel/vfs/device.c"
                             ;
        goto out;
    }
...
# 200 "kernel/vfs/device.c" 3 4
                                                        ((void *)0)
# 200 "kernel/vfs/device.c"
                                                            );
