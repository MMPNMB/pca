# 1 "kernel/protocols/net/core/ipv4/icmp.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/core/ipv4/icmp.c"
# 42 "kernel/protocols/net/core/ipv4/icmp.c"
...
# 43 "kernel/protocols/net/core/ipv4/icmp.c" 2



# 1 "./kernel/protocols/net/include/lwip/icmp.h" 1
# 41 "./kernel/protocols/net/include/lwip/icmp.h"
...
# 42 "./kernel/protocols/net/include/lwip/icmp.h" 2
...
# 43 "./kernel/protocols/net/include/lwip/icmp.h" 2
...
# 44 "./kernel/protocols/net/include/lwip/icmp.h" 2
...
# 47 "kernel/protocols/net/core/ipv4/icmp.c" 2
...
# 48 "kernel/protocols/net/core/ipv4/icmp.c" 2
...
# 49 "kernel/protocols/net/core/ipv4/icmp.c" 2
...
# 53 "kernel/protocols/net/core/ipv4/icmp.c" 2
# 64 "kernel/protocols/net/core/ipv4/icmp.c"

# 64 "kernel/protocols/net/core/ipv4/icmp.c"
static void icmp_send_response(struct pbuf *p, u8_t type, u8_t code);
# 75 "kernel/protocols/net/core/ipv4/icmp.c"
void
icmp_input(struct pbuf *p, struct netif *inp)
{
  ...
  if (hlen < 20) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("icmp_input: short IP header (%""4d"" bytes) received\n", hlen) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    goto lenerr;
  }
  if (p->len < sizeof(u16_t)*2) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("icmp_input: short ICMP (%""4d"" bytes) received\n", p->tot_len) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    goto lenerr;
  }
  ...
  case 8:
    ...
    if (((((&ip_data.current_iphdr_dest))->addr & ((((0xf0000000UL) & 0xff) << 24) | (((0xf0000000UL) & 0xff00) << 8) | (((0xf0000000UL) & 0xff0000UL) >> 8) | (((0xf0000000UL) & 0xff000000UL) >> 24))) == ((((0xe0000000UL) & 0xff) << 24) | (((0xe0000000UL) & 0xff00) << 8) | (((0xe0000000UL) & 0xff0000UL) >> 8) | (((0xe0000000UL) & 0xff000000UL) >> 24)))) {
      ...
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("icmp_input: Not echoing to multicast pings\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      goto icmperr;
    ...
    if (ip4_addr_isbroadcast_u32(((&ip_data.current_iphdr_dest))->addr, (ip_data.current_netif))) {
      ...
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("icmp_input: Not echoing to broadcast pings\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      goto icmperr;

    }
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("icmp_input: ping\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    if (p->tot_len < sizeof(struct icmp_echo_hdr)) {
      do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("icmp_input: bad ICMP echo received\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      goto lenerr;
    }

    {
      if (inet_chksum_pbuf(p) != 0) {
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("icmp_input: checksum failed for received ICMP echo\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        pbuf_free(p);
        ;
        ;
        return;
    ...
    if (pbuf_header(p, (hlen + (14 + 0) + 0))) {
      ...
      if (r == 
# 158 "kernel/protocols/net/core/ipv4/icmp.c" 3 4
              ((void *)0)
# 158 "kernel/protocols/net/core/ipv4/icmp.c"
                  ) {
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("icmp_input: allocating new pbuf failed\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
        goto icmperr;
      }
      if (r->len < hlen + sizeof(struct icmp_echo_hdr)) {
        do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("first pbuf cannot hold the ICMP header") ;} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0);
        pbuf_free(r);
        goto icmperr;
      }
      ...
      if (pbuf_copy(r, p) != ERR_OK) {
        do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("icmp_input: copying to new pbuf failed") ;} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0);
        pbuf_free(r);
        goto icmperr;
      }
    ...
    if (pbuf_header(p, hlen)) {
      do { if ( ((0x00U | 0x02) & 0x80U) && ((0x00U | 0x02) & 0x80U) && ((s16_t)((0x00U | 0x02) & 0x03) >= 0x00)) { do {bk_printf ("Can't move over header in packet") ;} while(0); if ((0x00U | 0x02) & 0x08U) { while(1); } } } while(0);
    } else {
      err_t ret;
...
# 224 "kernel/protocols/net/core/ipv4/icmp.c"
      (iphdr)->_ttl = (u8_t)((255));
      (iphdr)->_chksum = (0);
...
# 239 "kernel/protocols/net/core/ipv4/icmp.c" 3 4
                                 ((void *)0)
# 239 "kernel/protocols/net/core/ipv4/icmp.c"
                                                ,
                   (255), 0, 1, inp);
      if (ret != ERR_OK) {
        do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("icmp_input: ip_output_if returned an error: %s\n", lwip_strerr(ret)) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
      }
    }
    break;
  default:
    ...
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("icmp_input: ICMP type %""4d"" code %""4d"" not supported.\n", (s16_t)type, (s16_t)code) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0)
                                          ;
    ;
    ;
  }
...
# 296 "kernel/protocols/net/core/ipv4/icmp.c"
void
...
# 328 "kernel/protocols/net/core/ipv4/icmp.c"
static void
icmp_send_response(struct pbuf *p, u8_t type, u8_t code)
{
  ...
  q = pbuf_alloc(PBUF_IP, sizeof(struct icmp_echo_hdr) + 20 + 8,
                 PBUF_RAM);
  if (q == 
# 344 "kernel/protocols/net/core/ipv4/icmp.c" 3 4
          ((void *)0)
# 344 "kernel/protocols/net/core/ipv4/icmp.c"
              ) {
    do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("icmp_time_exceeded: failed to allocate pbuf for ICMP packet.\n") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
    ;
    return;
  }
  ...
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("icmp_time_exceeded from ") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", ((u16_t)(((const u8_t*)(&(&(iphdr->src))->addr))[0])), ((u16_t)(((const u8_t*)(&(&(iphdr->src))->addr))[1])), ((u16_t)(((const u8_t*)(&(&(iphdr->src))->addr))[2])), ((u16_t)(((const u8_t*)(&(&(iphdr->src))->addr))[3]))) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf (" to ") ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x00U) & 0x80U) && ((0x00U) & 0x80U) && ((s16_t)((0x00U) & 0x03) >= 0x00)) { do {bk_printf ("%" "4d" ".%" "4d" ".%" "4d" ".%" "4d", ((u16_t)(((const u8_t*)(&(&(iphdr->dest))->addr))[0])), ((u16_t)(((const u8_t*)(&(&(iphdr->dest))->addr))[1])), ((u16_t)(((const u8_t*)(&(&(iphdr->dest))->addr))[2])), ((u16_t)(((const u8_t*)(&(&(iphdr->dest))->addr))[3]))) ;} while(0); if ((0x00U) & 0x08U) { while(1); } } } while(0);
  ...
  if (netif != 
# 379 "kernel/protocols/net/core/ipv4/icmp.c" 3 4
              ((void *)0)
# 379 "kernel/protocols/net/core/ipv4/icmp.c"
                  ) {
    ...
    ;
    ip4_output_if(q, 
# 388 "kernel/protocols/net/core/ipv4/icmp.c" 3 4
                    ((void *)0)
# 388 "kernel/protocols/net/core/ipv4/icmp.c"
