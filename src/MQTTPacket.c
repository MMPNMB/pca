# 1 "framework/connectivity/mqtt/MQTTPacket/MQTTPacket.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "framework/connectivity/mqtt/MQTTPacket/MQTTPacket.c"
# 18 "framework/connectivity/mqtt/MQTTPacket/MQTTPacket.c"
...
# 19 "framework/connectivity/mqtt/MQTTPacket/MQTTPacket.c" 2
...
# 21 "framework/connectivity/mqtt/MQTTPacket/MQTTPacket.c" 2
...
# 28 "framework/connectivity/mqtt/MQTTPacket/MQTTPacket.c"
int MQTTPacket_encode(unsigned char* buf, int length)
{
 int rc = 0;
...
# 51 "framework/connectivity/mqtt/MQTTPacket/MQTTPacket.c"
int MQTTPacket_decode(int (*getcharfn)(unsigned char*, int), int* value)
{
 unsigned char c;
 int multiplier = 1;
...
# 210 "framework/connectivity/mqtt/MQTTPacket/MQTTPacket.c"
int readMQTTLenString(MQTTString* mqttstring, unsigned char** pptr, unsigned char* enddata)
{
 int rc = 0;
 ...
 mqttstring->cstring = 
# 225 "framework/connectivity/mqtt/MQTTPacket/MQTTPacket.c" 3 4
                      ((void *)0)
# 225 "framework/connectivity/mqtt/MQTTPacket/MQTTPacket.c"
                          ;
 return rc;
}
...
# 253 "framework/connectivity/mqtt/MQTTPacket/MQTTPacket.c"
...
# 283 "framework/connectivity/mqtt/MQTTPacket/MQTTPacket.c"
int MQTTPacket_read(unsigned char* buf, int buflen, int (*getfn)(unsigned char*, int))
{
 int rc = -1;
 MQTTHeader header = {0};
...
# 352 "framework/connectivity/mqtt/MQTTPacket/MQTTPacket.c"
int MQTTPacket_readnb(unsigned char* buf, int buflen, MQTTTransport *trp)
{
 int rc = -1, frc;
 MQTTHeader header = {0};
