# 1 "kernel/protocols/net/apps/tftp/tftp_common.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/apps/tftp/tftp_common.c"
# 51 "kernel/protocols/net/apps/tftp/tftp_common.c"
...
# 52 "kernel/protocols/net/apps/tftp/tftp_common.c" 2
...
# 53 "kernel/protocols/net/apps/tftp/tftp_common.c" 2
...
# 55 "kernel/protocols/net/apps/tftp/tftp_common.c" 2
...
# 57 "kernel/protocols/net/apps/tftp/tftp_common.c" 2


# 58 "kernel/protocols/net/apps/tftp/tftp_common.c"
void
                ...
                tftp_error_t code, const char *str)
{
  ...
  if(p == 
# 67 "kernel/protocols/net/apps/tftp/tftp_common.c" 3 4
         ((void *)0)
# 67 "kernel/protocols/net/apps/tftp/tftp_common.c"
             ) {
    return;
  }
...
tftp_send_ack(struct udp_pcb *pcb, const ip_addr_t *addr, u16_t port, u16_t blknum)
{
  ...
  if(p == 
# 87 "kernel/protocols/net/apps/tftp/tftp_common.c" 3 4
         ((void *)0)
# 87 "kernel/protocols/net/apps/tftp/tftp_common.c"
             ) {
    return;
  }
  payload = (u16_t*) p->payload;
