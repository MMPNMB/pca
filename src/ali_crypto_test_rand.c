# 1 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rand.c"
...
# 12 "./security/alicrypto/./libalicrypto/test/inc/ali_crypto_test.h" 2
...
# 6 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rand.c" 2
...
int ali_crypto_rand_test(void)
{
    ...
    if (result != ALI_CRYPTO_SUCCESS) {
        do { printf("E %s %d: ""ali_seed fail(%08x)\n", __FUNCTION__, 19, result); return -1; } while (0);;
    }


    result = ali_rand_gen(
# 23 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rand.c" 3 4
                         ((void *)0)
# 23 "security/alicrypto/./libalicrypto/test/ali_crypto_test_rand.c"
                             , rand_len);
    if (result == ALI_CRYPTO_SUCCESS) {
        do { printf("E %s %d: ""gen rand fail(%08x)\n", __FUNCTION__, 25, result); return -1; } while (0);;
    }

    result = ali_rand_gen(rand_buf, rand_len);
    if (result != ALI_CRYPTO_SUCCESS) {
        do { printf("E %s %d: ""gen rand fail(%08x)\n", __FUNCTION__, 30, result); return -1; } while (0);;
    }

    while (i++ < 10) {
        memcpy(tmp_buf, rand_buf, rand_len);

        result = ali_rand_gen(rand_buf, rand_len);
        if (result != ALI_CRYPTO_SUCCESS) {
            do { printf("E %s %d: ""gen rand fail(%08x)\n", __FUNCTION__, 38, result); return -1; } while (0);;
        }

        if (!memcmp(tmp_buf, rand_buf, rand_len)) {
            ali_crypto_print_data("tmp_buf", tmp_buf, rand_len);
            ali_crypto_print_data("rand_buf", rand_buf, rand_len);
            do { printf("E %s %d: ""RAND test fail!\n", __FUNCTION__, 44); return -1; } while (0);;
        }
    }

    printf("I %s %d: ""RAND test success!\n", __FUNCTION__, 48);
