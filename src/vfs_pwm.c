...
# 1 "././kernel/vfs/device/../include/device/vfs_pwm.h" 1
# 12 "././kernel/vfs/device/../include/device/vfs_pwm.h"
...
# 13 "././kernel/vfs/device/../include/device/vfs_pwm.h" 2
...
# 28 "././kernel/vfs/device/../include/device/vfs_pwm.h"
int vfs_pwm_open(inode_t *inode, file_t *fp);
# 37 "././kernel/vfs/device/../include/device/vfs_pwm.h"
int vfs_pwm_close(file_t *fp);
# 48 "././kernel/vfs/device/../include/device/vfs_pwm.h"
int vfs_pwm_ioctl(file_t *fp, int cmd, unsigned long arg);
# 6 "kernel/vfs/device/vfs_pwm.c" 2
...
# 7 "kernel/vfs/device/vfs_pwm.c" 2
# 1 "././kernel/vfs/device/../include/vfs_err.h" 1
# 8 "kernel/vfs/device/vfs_pwm.c" 2
...
int vfs_pwm_open(inode_t *inode, file_t *fp)
{
    int ret = -1;
    pwm_dev_t *pwm_dev = 
# 20 "kernel/vfs/device/vfs_pwm.c" 3 4
                        ((void *)0)
# 20 "kernel/vfs/device/vfs_pwm.c"
                            ;


    if ((fp != 
# 23 "kernel/vfs/device/vfs_pwm.c" 3 4
              ((void *)0)
# 23 "kernel/vfs/device/vfs_pwm.c"
                  ) && (fp->node != 
# 23 "kernel/vfs/device/vfs_pwm.c" 3 4
                                    ((void *)0)
# 23 "kernel/vfs/device/vfs_pwm.c"
        ...
        ret = -
# 37 "kernel/vfs/device/vfs_pwm.c" 3
              22
# 37 "kernel/vfs/device/vfs_pwm.c"
                    ;
    }
...
int vfs_pwm_close(file_t *fp)
{
    int ret = -1;
    pwm_dev_t *pwm_dev = 
# 46 "kernel/vfs/device/vfs_pwm.c" 3 4
                        ((void *)0)
# 46 "kernel/vfs/device/vfs_pwm.c"
                            ;


    if ((fp != 
# 49 "kernel/vfs/device/vfs_pwm.c" 3 4
              ((void *)0)
# 49 "kernel/vfs/device/vfs_pwm.c"
                  ) && (fp->node != 
# 49 "kernel/vfs/device/vfs_pwm.c" 3 4
                                    ((void *)0)
# 49 "kernel/vfs/device/vfs_pwm.c"
        ...
        ret = -
# 71 "kernel/vfs/device/vfs_pwm.c" 3
              22
# 71 "kernel/vfs/device/vfs_pwm.c"
                    ;
    }
...
int vfs_pwm_ioctl(file_t *fp, int cmd, unsigned long arg)
{
    int ret = -1;
    pwm_dev_t *pwm_dev = 
# 80 "kernel/vfs/device/vfs_pwm.c" 3 4
                        ((void *)0)
# 80 "kernel/vfs/device/vfs_pwm.c"
                            ;


    if ((fp == 
# 83 "kernel/vfs/device/vfs_pwm.c" 3 4
              ((void *)0)
# 83 "kernel/vfs/device/vfs_pwm.c"
                  ) || (fp->node == 
# 83 "kernel/vfs/device/vfs_pwm.c" 3 4
                                    ((void *)0)
# 83 "kernel/vfs/device/vfs_pwm.c"
        ...
        return -
# 84 "kernel/vfs/device/vfs_pwm.c" 3
               22
# 84 "kernel/vfs/device/vfs_pwm.c"
                     ;
    }
    ...
    switch(cmd) {
        ...
        default:
            ret = -
# 104 "kernel/vfs/device/vfs_pwm.c" 3
                  22
# 104 "kernel/vfs/device/vfs_pwm.c"
                        ;
            break;
    }
