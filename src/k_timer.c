...
# 6 "kernel/rhino/core/k_timer.c" 2
...
static void timer_list_rm(ktimer_t *timer)
{
    ...
    head = timer->to_head;
    if (head != 
# 34 "kernel/rhino/core/k_timer.c" 3 4
               ((void *)0)
# 34 "kernel/rhino/core/k_timer.c"
                   ) {
        klist_rm(&timer->timer_list);
        timer->to_head = 
# 36 "kernel/rhino/core/k_timer.c" 3 4
                        ((void *)0)
# 36 "kernel/rhino/core/k_timer.c"
                            ;
    }
}
                            ...
                            uint8_t mm_alloc_flag)
{
    ...
    do { if (timer == 
# 46 "kernel/rhino/core/k_timer.c" 3 4
   ((void *)0)
# 46 "kernel/rhino/core/k_timer.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    do { if (name == 
# 47 "kernel/rhino/core/k_timer.c" 3 4
   ((void *)0)
# 47 "kernel/rhino/core/k_timer.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    do { if (cb == 
# 48 "kernel/rhino/core/k_timer.c" 3 4
   ((void *)0)
# 48 "kernel/rhino/core/k_timer.c"
   ) { return RHINO_NULL_PTR; } } while (0);
    ...
    timer->to_head = 
# 69 "kernel/rhino/core/k_timer.c" 3 4
                          ((void *)0)
# 69 "kernel/rhino/core/k_timer.c"
                              ;
...
kstat_t krhino_timer_del(ktimer_t *timer)
{
    ...
    do { if (timer == 
# 97 "kernel/rhino/core/k_timer.c" 3 4
   ((void *)0)
# 97 "kernel/rhino/core/k_timer.c"
   ) { return RHINO_NULL_PTR; } } while (0);
                                ...
                                sys_time_t first, sys_time_t round, void *arg, uint8_t auto_run)
{
    ...
    do { if (timer == 
# 113 "kernel/rhino/core/k_timer.c" 3 4
   ((void *)0)
# 113 "kernel/rhino/core/k_timer.c"
   ) { return RHINO_NULL_PTR; } } while (0);

    timer_obj = krhino_mm_alloc(sizeof(ktimer_t));
    if (timer_obj == 
# 116 "kernel/rhino/core/k_timer.c" 3 4
                    ((void *)0)
# 116 "kernel/rhino/core/k_timer.c"
                        ) {
        return RHINO_NO_MEM;
    }
...
kstat_t krhino_timer_dyn_del(ktimer_t *timer)
{
    ...
    do { if (timer == 
# 137 "kernel/rhino/core/k_timer.c" 3 4
   ((void *)0)
# 137 "kernel/rhino/core/k_timer.c"
   ) { return RHINO_NULL_PTR; } } while (0);
...
kstat_t krhino_timer_start(ktimer_t *timer)
{
    ...
    do { if (timer == 
# 152 "kernel/rhino/core/k_timer.c" 3 4
   ((void *)0)
# 152 "kernel/rhino/core/k_timer.c"
   ) { return RHINO_NULL_PTR; } } while (0);
...
kstat_t krhino_timer_stop(ktimer_t *timer)
{
    ...
    do { if (timer == 
# 165 "kernel/rhino/core/k_timer.c" 3 4
   ((void *)0)
# 165 "kernel/rhino/core/k_timer.c"
   ) { return RHINO_NULL_PTR; } } while (0);
...
kstat_t krhino_timer_change(ktimer_t *timer, sys_time_t first, sys_time_t round)
{
    ...
    do { if (timer == 
# 178 "kernel/rhino/core/k_timer.c" 3 4
   ((void *)0)
# 178 "kernel/rhino/core/k_timer.c"
   ) { return RHINO_NULL_PTR; } } while (0);
...
kstat_t krhino_timer_arg_change(ktimer_t *timer, void *arg)
{
    ...
    do { if (timer == 
# 205 "kernel/rhino/core/k_timer.c" 3 4
   ((void *)0)
# 205 "kernel/rhino/core/k_timer.c"
   ) { return RHINO_NULL_PTR; } } while (0);
...
kstat_t krhino_timer_arg_change_auto(ktimer_t *timer, void *arg)
{
    ...
    do { if (timer == 
# 219 "kernel/rhino/core/k_timer.c" 3 4
   ((void *)0)
# 219 "kernel/rhino/core/k_timer.c"
   ) { return RHINO_NULL_PTR; } } while (0);
...
# 433 "kernel/rhino/core/k_timer.c" 3 4
                                                   ((void *)0)
# 433 "kernel/rhino/core/k_timer.c"
                                                       ,
