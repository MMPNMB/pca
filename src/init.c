# 1 "kernel/protocols/net/core/init.c"
# 1 "/home/stone/Documents/Ali_IOT//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "kernel/protocols/net/core/init.c"
# 38 "kernel/protocols/net/core/init.c"
...
# 39 "kernel/protocols/net/core/init.c" 2

# 1 "./kernel/protocols/net/include/lwip/init.h" 1
# 94 "./kernel/protocols/net/include/lwip/init.h"
void lwip_init(void);
# 41 "kernel/protocols/net/core/init.c" 2
...
# 42 "kernel/protocols/net/core/init.c" 2
...
# 43 "kernel/protocols/net/core/init.c" 2
...
# 46 "kernel/protocols/net/core/init.c" 2
...
# 47 "kernel/protocols/net/core/init.c" 2
...
# 48 "kernel/protocols/net/core/init.c" 2
...
# 49 "kernel/protocols/net/core/init.c" 2
...
# 50 "kernel/protocols/net/core/init.c" 2
...
# 51 "kernel/protocols/net/core/init.c" 2
...
# 52 "kernel/protocols/net/core/init.c" 2
...
void igmp_tmr(void);
# 53 "kernel/protocols/net/core/init.c" 2
...
err_t dns_gethostbyname_addrtype(const char *hostname, ip_addr_t *addr,
                                   dns_found_callback found, void *callback_arg,
                                   u8_t dns_addrtype);
# 54 "kernel/protocols/net/core/init.c" 2
...
# 55 "kernel/protocols/net/core/init.c" 2
...
# 56 "kernel/protocols/net/core/init.c" 2

# 1 "./kernel/protocols/net/include/lwip/nd6.h" 1
# 58 "kernel/protocols/net/core/init.c" 2
# 1 "./kernel/protocols/net/include/lwip/mld6.h" 1
# 59 "kernel/protocols/net/core/init.c" 2
...
# 60 "kernel/protocols/net/core/init.c" 2

# 1 "./kernel/protocols/net/include/netif/ppp/ppp_opts.h" 1
# 62 "kernel/protocols/net/core/init.c" 2
# 1 "./kernel/protocols/net/include/netif/ppp/ppp_impl.h" 1
# 63 "kernel/protocols/net/core/init.c" 2
...
# 346 "kernel/protocols/net/core/init.c"
void
lwip_init(void)
{
