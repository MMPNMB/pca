...
# 7 "./framework/fota/./platform/ota_transport.h" 2
...
# 8 "./framework/fota/./platform/ota_transport.h" 2
...
# 10 "framework/fota/ota_util.c" 2
# 1 "./framework/fota/./platform/ota_platform_os.h" 1
# 9 "./framework/fota/./platform/ota_platform_os.h"
...
# 11 "framework/fota/ota_util.c" 2
# 1 "framework/fota/ota_util.h" 1
# 12 "framework/fota/ota_util.h"
...
# 13 "framework/fota/ota_util.h" 2
...
# 12 "framework/fota/ota_util.c" 2
...
# 13 "framework/fota/ota_util.c" 2
...
# 14 "framework/fota/ota_util.c" 2
...
static ota_info_t g_ota_info_storage = {
    ...
    .mutex = 
# 20 "framework/fota/ota_util.c" 3 4
            ((void *)0)
# 20 "framework/fota/ota_util.c"
                ,
    .splict_size = 0,
    .diff_version = 0
};
...
{
    if (g_ota_info->mutex != 
# 35 "framework/fota/ota_util.c" 3 4
                            ((void *)0)
# 35 "framework/fota/ota_util.c"
                                ) {
        ota_mutex_destroy(g_ota_info->mutex);
        g_ota_info->mutex = 
# 37 "framework/fota/ota_util.c" 3 4
                           ((void *)0)
# 37 "framework/fota/ota_util.c"
                               ;
    }
}
...
{
    const char *version = 
# 102 "framework/fota/ota_util.c" 3 4
                         ((void *)0)
# 102 "framework/fota/ota_util.c"
                             ;
    ota_mutex_lock(g_ota_info_storage.mutex);
