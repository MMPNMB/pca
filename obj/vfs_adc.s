	...
	.text
.Ltext0:
	.section	.text.unlikely.vfs_adc_open,"ax",@progbits
.LCOLDB0:
	.section	.text.vfs_adc_open,"ax",@progbits
.LHOTB0:
	.section	.text.unlikely.vfs_adc_open
.Ltext_cold0:
	.section	.text.vfs_adc_open
	.globl	vfs_adc_open
...
.LCOLDE0:
	.section	.text.vfs_adc_open
.LHOTE0:
	.section	.text.unlikely.vfs_adc_close,"ax",@progbits
.LCOLDB1:
...
.LCOLDE1:
	.section	.text.vfs_adc_close
.LHOTE1:
	.section	.text.unlikely.vfs_adc_read,"ax",@progbits
.LCOLDB2:
...
.LCOLDE2:
	.section	.text.vfs_adc_read
.LHOTE2:
	.globl	adc_ops
	.section	.rodata.adc_ops,"a",@progbits
	.align 4
	.type	adc_ops, @object
	.size	adc_ops, 20
adc_ops:
